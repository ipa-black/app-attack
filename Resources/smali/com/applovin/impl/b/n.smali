...
.field private f:Lcom/applovin/impl/b/g;
...
.method private constructor <init>()V
    ...
    iput-object v0, p0, Lcom/applovin/impl/b/n;->a:Ljava/util/List;

    invoke-static {}, Ljava/util/Collections;->emptyList()Ljava/util/List;

    move-result-object v0

    iput-object v0, p0, Lcom/applovin/impl/b/n;->b:Ljava/util/List;

    new-instance v0, Ljava/util/HashSet;

    invoke-direct {v0}, Ljava/util/HashSet;-><init>()V

    iput-object v0, p0, Lcom/applovin/impl/b/n;->e:Ljava/util/Set;

    invoke-static {}, Lcom/applovin/impl/sdk/utils/CollectionUtils;->map()Ljava/util/Map;

    move-result-object v0

    iput-object v0, p0, Lcom/applovin/impl/b/n;->g:Ljava/util/Map;
...
.method private constructor <init>(Lcom/applovin/impl/b/e;)V
    ...
    invoke-virtual {p1}, Lcom/applovin/impl/b/e;->g()Ljava/util/List;

    move-result-object p1

    iput-object p1, p0, Lcom/applovin/impl/b/n;->b:Ljava/util/List;
...
.method private static a(Ljava/lang/String;Lcom/applovin/impl/sdk/n;)I
    ...
    invoke-virtual {p1, v1, p0}, Lcom/applovin/impl/sdk/v;->e(Ljava/lang/String;Ljava/lang/String;)V

    :cond_0
    return v0
.end method

.method public static a(Lcom/applovin/impl/sdk/utils/s;Lcom/applovin/impl/b/n;Lcom/applovin/impl/b/e;Lcom/applovin/impl/sdk/n;)Lcom/applovin/impl/b/n;
    .locals 4
    ...
    :goto_0
    iget v0, p1, Lcom/applovin/impl/b/n;->c:I
    ...
    invoke-static {v0, p3}, Lcom/applovin/impl/b/n;->a(Ljava/lang/String;Lcom/applovin/impl/sdk/n;)I

    move-result v0

    if-lez v0, :cond_1

    iput v0, p1, Lcom/applovin/impl/b/n;->c:I
    ...
    invoke-static {v0, p3}, Lcom/applovin/impl/b/n;->a(Lcom/applovin/impl/sdk/utils/s;Lcom/applovin/impl/sdk/n;)Ljava/util/List;
    ...
    iget-object v1, p1, Lcom/applovin/impl/b/n;->a:Ljava/util/List;
    ...
    :cond_2
    iput-object v0, p1, Lcom/applovin/impl/b/n;->a:Ljava/util/List;
    ...
    iget-object v1, p1, Lcom/applovin/impl/b/n;->d:Landroid/net/Uri;
    ...
    iput-object v1, p1, Lcom/applovin/impl/b/n;->d:Landroid/net/Uri;
    ...
    iget-object v1, p1, Lcom/applovin/impl/b/n;->e:Ljava/util/Set;
    ...
    invoke-static {v0, p3}, Lcom/applovin/impl/b/g;->a(Lcom/applovin/impl/sdk/utils/s;Lcom/applovin/impl/sdk/n;)Lcom/applovin/impl/b/g;
    ...
    iget-object v3, v1, Lcom/applovin/impl/b/g;->a:Ljava/util/Set;
    ...
    iget-object v2, v1, Lcom/applovin/impl/b/g;->b:Ljava/util/Set;
    ...
    :cond_7
    iput-object v1, p1, Lcom/applovin/impl/b/n;->f:Lcom/applovin/impl/b/g;

    :cond_8
    iget-object v0, p1, Lcom/applovin/impl/b/n;->g:Ljava/util/Map;
...
.method private static a(Lcom/applovin/impl/sdk/utils/s;Lcom/applovin/impl/sdk/n;)Ljava/util/List;
    ...
    invoke-static {v4, p1}, Lcom/applovin/impl/b/o;->a(Lcom/applovin/impl/sdk/utils/s;Lcom/applovin/impl/sdk/n;)Lcom/applovin/impl/b/o;
    ...
    :cond_1
    :try_start_0
    invoke-virtual {v4}, Lcom/applovin/impl/b/o;->c()Ljava/lang/String;
    ...
    invoke-virtual {v4}, Lcom/applovin/impl/b/o;->b()Landroid/net/Uri;
    ...
    invoke-virtual {v5, v0, v6}, Lcom/applovin/impl/sdk/v;->d(Ljava/lang/String;Ljava/lang/String;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    invoke-virtual {v6, v0, v4, v5}, Lcom/applovin/impl/sdk/v;->b(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
# virtual methods
.method public a(Lcom/applovin/impl/b/n$a;)Lcom/applovin/impl/b/o;
    .locals 7

    iget-object v0, p0, Lcom/applovin/impl/b/n;->a:Ljava/util/List;
    ...
    iget-object v1, p0, Lcom/applovin/impl/b/n;->b:Ljava/util/List;
    ...
    iget-object v3, p0, Lcom/applovin/impl/b/n;->a:Ljava/util/List;
    ...
    check-cast v4, Lcom/applovin/impl/b/o;
    ...
    new-instance v1, Lcom/applovin/impl/b/n$1;

    invoke-direct {v1, p0}, Lcom/applovin/impl/b/n$1;-><init>(Lcom/applovin/impl/b/n;)V

    invoke-static {v0, v1}, Ljava/util/Collections;->sort(Ljava/util/List;Ljava/util/Comparator;)V

    :cond_6
    sget-object v1, Lcom/applovin/impl/b/n$a;->b:Lcom/applovin/impl/b/n$a;
    ...
    :cond_7
    sget-object v1, Lcom/applovin/impl/b/n$a;->c:Lcom/applovin/impl/b/n$a;
...
.method public b()I
    ...
    iget v0, p0, Lcom/applovin/impl/b/n;->c:I
...
.method public c()Landroid/net/Uri;
    ...
    iget-object v0, p0, Lcom/applovin/impl/b/n;->d:Landroid/net/Uri;
...
.method public d()Ljava/util/Set;
    ...
    iget-object v0, p0, Lcom/applovin/impl/b/n;->e:Ljava/util/Set;
...
.method public e()Ljava/util/Map;
    ...
    iget-object v0, p0, Lcom/applovin/impl/b/n;->g:Ljava/util/Map;
...
.method public equals(Ljava/lang/Object;)Z
    ...
    iget v1, p0, Lcom/applovin/impl/b/n;->c:I

    iget v3, p1, Lcom/applovin/impl/b/n;->c:I
    ...
    :cond_2
    iget-object v1, p0, Lcom/applovin/impl/b/n;->a:Ljava/util/List;

    if-eqz v1, :cond_3

    iget-object v3, p1, Lcom/applovin/impl/b/n;->a:Ljava/util/List;
    ...
    :cond_4
    iget-object v1, p0, Lcom/applovin/impl/b/n;->d:Landroid/net/Uri;

    if-eqz v1, :cond_5

    iget-object v3, p1, Lcom/applovin/impl/b/n;->d:Landroid/net/Uri;
    ...
    :cond_6
    iget-object v1, p0, Lcom/applovin/impl/b/n;->e:Ljava/util/Set;

    if-eqz v1, :cond_7

    iget-object v3, p1, Lcom/applovin/impl/b/n;->e:Ljava/util/Set;
    ...
    :cond_8
    iget-object v1, p0, Lcom/applovin/impl/b/n;->g:Ljava/util/Map;

    iget-object p1, p1, Lcom/applovin/impl/b/n;->g:Ljava/util/Map;
...
.method public f()Lcom/applovin/impl/b/g;
    .locals 1

    iget-object v0, p0, Lcom/applovin/impl/b/n;->f:Lcom/applovin/impl/b/g;
...
.method public hashCode()I
    ...
    iget v2, p0, Lcom/applovin/impl/b/n;->c:I

    add-int/2addr v0, v2

    mul-int/lit8 v0, v0, 0x1f

    iget-object v2, p0, Lcom/applovin/impl/b/n;->d:Landroid/net/Uri;
    ...
    iget-object v2, p0, Lcom/applovin/impl/b/n;->e:Ljava/util/Set;
    ...
    iget-object v2, p0, Lcom/applovin/impl/b/n;->g:Ljava/util/Map;
...
.method public toString()Ljava/lang/String;
    ...
    iget-object v1, p0, Lcom/applovin/impl/b/n;->f:Lcom/applovin/impl/b/g;
