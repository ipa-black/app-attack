...
.method static constructor <clinit>()V
    ...
    const-string v2, "AD_DISPLAYED"

    const/4 v3, 0x1

    invoke-direct {v1, v2, v3, v3}, Lcom/applovin/impl/adview/activity/FullscreenAdService$b;-><init>(Ljava/lang/String;II)V
    ...
    new-instance v2, Lcom/applovin/impl/adview/activity/FullscreenAdService$b;

    const-string v3, "AD_CLICKED"

    const/4 v4, 0x2

    invoke-direct {v2, v3, v4, v4}, Lcom/applovin/impl/adview/activity/FullscreenAdService$b;-><init>(Ljava/lang/String;II)V

    sput-object v2, Lcom/applovin/impl/adview/activity/FullscreenAdService$b;->c:Lcom/applovin/impl/adview/activity/FullscreenAdService$b;

    new-instance v3, Lcom/applovin/impl/adview/activity/FullscreenAdService$b;

    const-string v4, "AD_VIDEO_STARTED"

    const/4 v5, 0x3

    invoke-direct {v3, v4, v5, v5}, Lcom/applovin/impl/adview/activity/FullscreenAdService$b;-><init>(Ljava/lang/String;II)V

    sput-object v3, Lcom/applovin/impl/adview/activity/FullscreenAdService$b;->d:Lcom/applovin/impl/adview/activity/FullscreenAdService$b;

    new-instance v4, Lcom/applovin/impl/adview/activity/FullscreenAdService$b;

    const-string v5, "AD_VIDEO_ENDED"

    const/4 v6, 0x4

    invoke-direct {v4, v5, v6, v6}, Lcom/applovin/impl/adview/activity/FullscreenAdService$b;-><init>(Ljava/lang/String;II)V

    sput-object v4, Lcom/applovin/impl/adview/activity/FullscreenAdService$b;->e:Lcom/applovin/impl/adview/activity/FullscreenAdService$b;

    new-instance v5, Lcom/applovin/impl/adview/activity/FullscreenAdService$b;

    const-string v6, "AD_HIDDEN"

    const/4 v7, 0x5

    invoke-direct {v5, v6, v7, v7}, Lcom/applovin/impl/adview/activity/FullscreenAdService$b;-><init>(Ljava/lang/String;II)V

    sput-object v5, Lcom/applovin/impl/adview/activity/FullscreenAdService$b;->f:Lcom/applovin/impl/adview/activity/FullscreenAdService$b;

    filled-new-array/range {v0 .. v5}, [Lcom/applovin/impl/adview/activity/FullscreenAdService$b;

    move-result-object v0

    sput-object v0, Lcom/applovin/impl/adview/activity/FullscreenAdService$b;->h:[Lcom/applovin/impl/adview/activity/FullscreenAdService$b;
