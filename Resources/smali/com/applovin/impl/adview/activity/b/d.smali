...
# instance fields
.field private final F:Lcom/applovin/impl/b/a;
...
.method public constructor <init>(Lcom/applovin/impl/sdk/ad/e;Landroid/app/Activity;Lcom/applovin/impl/sdk/n;Lcom/applovin/sdk/AppLovinAdClickListener;Lcom/applovin/sdk/AppLovinAdDisplayListener;Lcom/applovin/sdk/AppLovinAdVideoPlaybackListener;)V
    ...
    invoke-direct/range {p0 .. p6}, Lcom/applovin/impl/adview/activity/b/f;-><init>(Lcom/applovin/impl/sdk/ad/e;Landroid/app/Activity;Lcom/applovin/impl/sdk/n;Lcom/applovin/sdk/AppLovinAdClickListener;Lcom/applovin/sdk/AppLovinAdDisplayListener;Lcom/applovin/sdk/AppLovinAdVideoPlaybackListener;)V

    new-instance p4, Ljava/util/HashSet;

    invoke-direct {p4}, Ljava/util/HashSet;-><init>()V

    iput-object p4, p0, Lcom/applovin/impl/adview/activity/b/d;->G:Ljava/util/Set;

    check-cast p1, Lcom/applovin/impl/b/a;

    iput-object p1, p0, Lcom/applovin/impl/adview/activity/b/d;->F:Lcom/applovin/impl/b/a;

    invoke-virtual {p1}, Lcom/applovin/impl/b/a;->aQ()Z
    ...
    iput-object p5, p0, Lcom/applovin/impl/adview/activity/b/d;->A:Landroid/widget/ImageView;

    iget-object p5, p0, Lcom/applovin/impl/adview/activity/b/d;->A:Landroid/widget/ImageView;
    ...
    new-instance p6, Lcom/applovin/impl/adview/activity/b/d$1;

    invoke-direct {p6, p0, p2, p3}, Lcom/applovin/impl/adview/activity/b/d$1;-><init>(Lcom/applovin/impl/adview/activity/b/d;Landroid/app/Activity;Lcom/applovin/impl/sdk/n;)V

    invoke-virtual {p5, p6}, Landroid/widget/ImageView;->setOnClickListener(Landroid/view/View$OnClickListener;)V

    :cond_0
    sget-object p2, Lcom/applovin/impl/b/a$c;->d:Lcom/applovin/impl/b/a$c;

    sget-object p3, Lcom/applovin/impl/b/l;->a:[Ljava/lang/String;
    ...
    sget-object p2, Lcom/applovin/impl/b/a$c;->a:Lcom/applovin/impl/b/a$c;

    invoke-direct {p0, p2}, Lcom/applovin/impl/adview/activity/b/d;->a(Lcom/applovin/impl/b/a$c;)V

    sget-object p2, Lcom/applovin/impl/b/a$c;->d:Lcom/applovin/impl/b/a$c;

    const-string p3, "creativeView"

    invoke-direct {p0, p2, p3}, Lcom/applovin/impl/adview/activity/b/d;->a(Lcom/applovin/impl/b/a$c;Ljava/lang/String;)V

    invoke-virtual {p1}, Lcom/applovin/impl/b/a;->g()Lcom/applovin/impl/sdk/a/g;
...
.method private C()V
    ...
    iget-object v0, p0, Lcom/applovin/impl/adview/activity/b/d;->G:Ljava/util/Set;
    ...
    iget-object v2, p0, Lcom/applovin/impl/adview/activity/b/d;->G:Ljava/util/Set;
...
.method private D()Z
    ...
    iget-object v0, p0, Lcom/applovin/impl/adview/activity/b/d;->A:Landroid/widget/ImageView;

    if-eqz v0, :cond_0

    iget-object v0, p0, Lcom/applovin/impl/adview/activity/b/d;->F:Lcom/applovin/impl/b/a;

    invoke-virtual {v0}, Lcom/applovin/impl/b/a;->aQ()Z
...
.method static synthetic a(Lcom/applovin/impl/adview/activity/b/d;)Lcom/applovin/impl/b/a;
    .locals 0

    iget-object p0, p0, Lcom/applovin/impl/adview/activity/b/d;->F:Lcom/applovin/impl/b/a;

    return-object p0
.end method

.method static synthetic a(Lcom/applovin/impl/adview/activity/b/d;Lcom/applovin/impl/b/a$c;)V
    .locals 0

    invoke-direct {p0, p1}, Lcom/applovin/impl/adview/activity/b/d;->a(Lcom/applovin/impl/b/a$c;)V
...
.method private a(Lcom/applovin/impl/b/a$c;)V
    .locals 1

    sget-object v0, Lcom/applovin/impl/b/f;->a:Lcom/applovin/impl/b/f;

    invoke-direct {p0, p1, v0}, Lcom/applovin/impl/adview/activity/b/d;->a(Lcom/applovin/impl/b/a$c;Lcom/applovin/impl/b/f;)V

    return-void
.end method

.method private a(Lcom/applovin/impl/b/a$c;Lcom/applovin/impl/b/f;)V
    .locals 1

    const-string v0, ""

    invoke-direct {p0, p1, v0, p2}, Lcom/applovin/impl/adview/activity/b/d;->a(Lcom/applovin/impl/b/a$c;Ljava/lang/String;Lcom/applovin/impl/b/f;)V

    return-void
.end method

.method private a(Lcom/applovin/impl/b/a$c;Ljava/lang/String;)V
    .locals 1

    sget-object v0, Lcom/applovin/impl/b/f;->a:Lcom/applovin/impl/b/f;

    invoke-direct {p0, p1, p2, v0}, Lcom/applovin/impl/adview/activity/b/d;->a(Lcom/applovin/impl/b/a$c;Ljava/lang/String;Lcom/applovin/impl/b/f;)V

    return-void
.end method

.method private a(Lcom/applovin/impl/b/a$c;Ljava/lang/String;Lcom/applovin/impl/b/f;)V
    .locals 1
    ...
    invoke-direct {p0, p1, p3}, Lcom/applovin/impl/adview/activity/b/d;->a(Ljava/util/Set;Lcom/applovin/impl/b/f;)V
...
.method private a(Ljava/util/Set;)V
    ...
    invoke-direct {p0, p1, v0}, Lcom/applovin/impl/adview/activity/b/d;->a(Ljava/util/Set;Lcom/applovin/impl/b/f;)V

    return-void
.end method

.method private a(Ljava/util/Set;Lcom/applovin/impl/b/f;)V
    .locals 9
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iget-object v1, p0, Lcom/applovin/impl/adview/activity/b/d;->u:Lcom/applovin/impl/adview/AppLovinVideoView;
    ...
    invoke-virtual {v0}, Lcom/applovin/impl/b/o;->a()Landroid/net/Uri;
    ...
    :cond_1
    iget-object v8, p0, Lcom/applovin/impl/adview/activity/b/d;->b:Lcom/applovin/impl/sdk/n;
...
.method static synthetic b(Lcom/applovin/impl/adview/activity/b/d;)Ljava/util/Set;
    ...
    iget-object p0, p0, Lcom/applovin/impl/adview/activity/b/d;->G:Ljava/util/Set;
...
.method public A()V
    ...
    iget-boolean v0, p0, Lcom/applovin/impl/adview/activity/b/d;->E:Z
    ...
    invoke-direct {p0, v0, v1}, Lcom/applovin/impl/adview/activity/b/d;->a(Lcom/applovin/impl/b/a$c;Ljava/lang/String;)V
...
.method public a(Landroid/graphics/PointF;)V
    ...
    invoke-direct {p0, v0}, Lcom/applovin/impl/adview/activity/b/d;->a(Lcom/applovin/impl/b/a$c;)V
...
.method public a(Landroid/view/ViewGroup;)V
    ...
    sget-object p1, Lcom/applovin/impl/b/a$c;->f:Lcom/applovin/impl/b/a$c;

    invoke-direct {p0, p1}, Lcom/applovin/impl/adview/activity/b/d;->a(Lcom/applovin/impl/b/a$c;)V

    iget-object p1, p0, Lcom/applovin/impl/adview/activity/b/d;->F:Lcom/applovin/impl/b/a;

    invoke-virtual {p1}, Lcom/applovin/impl/b/a;->aP()Lcom/applovin/impl/b/g;

    move-result-object p1

    invoke-virtual {p1}, Lcom/applovin/impl/b/g;->a()Landroid/net/Uri;
    ...
    iget-object v1, p0, Lcom/applovin/impl/adview/activity/b/d;->b:Lcom/applovin/impl/sdk/n;

    invoke-static {p1, v0, v1}, Lcom/applovin/impl/sdk/utils/Utils;->setImageUrl(Ljava/lang/String;Landroid/widget/ImageView;Lcom/applovin/impl/sdk/n;)V

    iget-object p1, p0, Lcom/applovin/impl/adview/activity/b/d;->A:Landroid/widget/ImageView;
    ...
    :cond_0
    iget-object p1, p0, Lcom/applovin/impl/adview/activity/b/d;->B:Lcom/applovin/impl/adview/j;
    ...
    iget-object v0, p0, Lcom/applovin/impl/adview/activity/b/d;->v:Lcom/applovin/impl/adview/a;

    if-eqz v0, :cond_1

    new-instance v0, Lcom/applovin/impl/sdk/a/d;

    iget-object v1, p0, Lcom/applovin/impl/adview/activity/b/d;->v:Lcom/applovin/impl/adview/a;
    ...
    :cond_1
    iget-object v0, p0, Lcom/applovin/impl/adview/activity/b/d;->w:Lcom/applovin/impl/adview/m;

    if-eqz v0, :cond_2

    new-instance v0, Lcom/applovin/impl/sdk/a/d;

    iget-object v1, p0, Lcom/applovin/impl/adview/activity/b/d;->w:Lcom/applovin/impl/adview/m;
    ...
    :cond_2
    iget-object v0, p0, Lcom/applovin/impl/adview/activity/b/d;->z:Landroid/widget/ProgressBar;

    if-eqz v0, :cond_3

    new-instance v0, Lcom/applovin/impl/sdk/a/d;

    iget-object v1, p0, Lcom/applovin/impl/adview/activity/b/d;->z:Landroid/widget/ProgressBar;
    ...
    :cond_3
    iget-object v0, p0, Lcom/applovin/impl/adview/activity/b/d;->x:Landroid/widget/ImageView;

    if-eqz v0, :cond_4

    new-instance v0, Lcom/applovin/impl/sdk/a/d;

    iget-object v1, p0, Lcom/applovin/impl/adview/activity/b/d;->x:Landroid/widget/ImageView;
    ...
    :cond_4
    iget-object v0, p0, Lcom/applovin/impl/adview/activity/b/d;->y:Lcom/applovin/impl/adview/t;

    if-eqz v0, :cond_5

    new-instance v0, Lcom/applovin/impl/sdk/a/d;

    iget-object v1, p0, Lcom/applovin/impl/adview/activity/b/d;->y:Lcom/applovin/impl/adview/t;
...
.method protected c(J)V
    ...
    iget-object p2, p0, Lcom/applovin/impl/adview/activity/b/d;->b:Lcom/applovin/impl/sdk/n;
...
.method public c(Ljava/lang/String;)V
    ...
    sget-object v1, Lcom/applovin/impl/b/f;->m:Lcom/applovin/impl/b/f;

    invoke-direct {p0, v0, v1}, Lcom/applovin/impl/adview/activity/b/d;->a(Lcom/applovin/impl/b/a$c;Lcom/applovin/impl/b/f;)V
...
.method public e()V
    ...
    iget-object v0, p0, Lcom/applovin/impl/adview/activity/b/d;->B:Lcom/applovin/impl/adview/j;
...
.method protected u()V
    ...
    invoke-virtual {v0}, Lcom/applovin/impl/b/a;->ad()J
    ...
    invoke-virtual {v0}, Lcom/applovin/impl/b/a;->ae()I
    ...
    invoke-virtual {v1}, Lcom/applovin/impl/b/n;->b()I
    ...
    :cond_2
    iget-wide v4, p0, Lcom/applovin/impl/adview/activity/b/d;->D:J

    cmp-long v1, v4, v2

    if-lez v1, :cond_3

    iget-wide v2, p0, Lcom/applovin/impl/adview/activity/b/d;->D:J

    :cond_3
    :goto_0
    invoke-virtual {v0}, Lcom/applovin/impl/b/a;->af()Z

    move-result v1

    if-eqz v1, :cond_4

    invoke-virtual {v0}, Lcom/applovin/impl/b/a;->t()J
    ...
    iget-object v2, p0, Lcom/applovin/impl/adview/activity/b/d;->F:Lcom/applovin/impl/b/a;

    invoke-virtual {v2}, Lcom/applovin/impl/b/a;->ae()I
...
.method public z()V
    ...
    iget-boolean v1, p0, Lcom/applovin/impl/adview/activity/b/d;->C:Z
