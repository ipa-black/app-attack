...
.method public verifyThatHierarchyIsComplete()Z
    ...
    invoke-virtual {v2}, Lantlr/preprocessor/Grammar;->getName()Ljava/lang/String;

    move-result-object v2

    invoke-virtual {v0, v2}, Lantlr/preprocessor/Grammar;->setType(Ljava/lang/String;)V
    ...
    check-cast v3, Lantlr/preprocessor/Grammar;

    .line 123
    invoke-virtual {v3}, Lantlr/preprocessor/Grammar;->getSuperGrammarName()Ljava/lang/String;
    ...
    .line 126
    :cond_5
    invoke-virtual {v3}, Lantlr/preprocessor/Grammar;->getSuperGrammar()Lantlr/preprocessor/Grammar;
    ...
    invoke-virtual {v2, v5}, Lantlr/Tool;->toolError(Ljava/lang/String;)V

    .line 130
    iget-object v2, p0, Lantlr/preprocessor/Hierarchy;->symbols:Ljava/util/Hashtable;
