...
.method protected final mARG(Z)V
    ...
    invoke-virtual {v3, v8}, Lantlr/collections/impl/BitSet;->member(I)Z
    ...
    invoke-virtual {v0, v6}, Lantlr/CharScanner;->LA(I)C
    ...
    .line 1789
    invoke-virtual {v0, v7}, Lantlr/actions/cpp/ActionLexer;->mTREE_ELEMENT(Z)V
    ...
    .line 1792
    invoke-virtual {v0, v7}, Lantlr/actions/cpp/ActionLexer;->mSTRING(Z)V
    ...
    .line 1784
    :pswitch_0
    invoke-virtual {v0, v7}, Lantlr/actions/cpp/ActionLexer;->mINT_OR_FLOAT(Z)V

    goto :goto_0

    .line 1777
    :cond_2
    invoke-virtual {v0, v7}, Lantlr/actions/cpp/ActionLexer;->mCHAR(Z)V
    ...
    .line 1807
    :cond_4
    invoke-virtual {v0, v7}, Lantlr/actions/cpp/ActionLexer;->mWS(Z)V
    ...
    .line 1824
    :cond_8
    invoke-virtual {v0, v12}, Lantlr/CharScanner;->match(C)V

    goto :goto_2

    .line 1834
    :cond_9
    invoke-virtual {v0, v13}, Lantlr/CharScanner;->match(C)V
    ...
    :cond_b
    :pswitch_1
    invoke-virtual {v0, v7}, Lantlr/actions/cpp/ActionLexer;->mARG(Z)V
...
.method protected final mAST_CONSTRUCTOR(Z)V
    ...
    .line 1113
    iget-object v8, v0, Lantlr/CharScanner;->text:Lantlr/ANTLRStringBuffer;
...
.method protected final mAST_CTOR_ELEMENT(Z)V
    ...
    .line 1723
    invoke-virtual {p0, v6}, Lantlr/actions/cpp/ActionLexer;->mSTRING(Z)V
    ...
    .line 1726
    invoke-virtual {p0, v6}, Lantlr/actions/cpp/ActionLexer;->mTREE_ELEMENT(Z)V
    ...
    .line 1729
    invoke-virtual {p0, v6}, Lantlr/actions/cpp/ActionLexer;->mINT(Z)V
...
.method protected final mID(Z)V
    ...
    .line 943
    :pswitch_0
    invoke-virtual {p0, v5, v4}, Lantlr/CharScanner;->matchRange(CC)V
...
.method protected final mID_ELEMENT(Z)Z
    ...
    .line 1666
    iget-object v9, v0, Lantlr/actions/cpp/ActionLexer;->generator:Lantlr/CodeGenerator;

    invoke-virtual {v3}, Lantlr/Token;->getText()Ljava/lang/String;

    move-result-object v3

    iget-object v10, v0, Lantlr/actions/cpp/ActionLexer;->transInfo:Lantlr/ActionTransInfo;

    invoke-virtual {v9, v3, v10}, Lantlr/CodeGenerator;->mapTreeId(Ljava/lang/String;Lantlr/ActionTransInfo;)Ljava/lang/String;
    ...
    .line 1669
    iget-object v9, v0, Lantlr/CharScanner;->text:Lantlr/ANTLRStringBuffer;

    invoke-virtual {v9, v1}, Lantlr/ANTLRStringBuffer;->setLength(I)V

    iget-object v9, v0, Lantlr/CharScanner;->text:Lantlr/ANTLRStringBuffer;

    invoke-virtual {v9, v3}, Lantlr/ANTLRStringBuffer;->append(Ljava/lang/String;)V
    ...
    .line 1430
    invoke-virtual {v0, v11}, Lantlr/CharScanner;->matchNot(C)V
    ...
    .line 1498
    iget-object v12, v0, Lantlr/CharScanner;->text:Lantlr/ANTLRStringBuffer;

    invoke-virtual {v12, v3}, Lantlr/ANTLRStringBuffer;->setLength(I)V
...
.method protected final mTEXT_ARG(Z)V
    ...
    .line 1289
    invoke-virtual {p0, v5}, Lantlr/CharScanner;->makeToken(I)Lantlr/Token;
...
.method protected final mTEXT_ITEM(Z)V
    ...
    invoke-virtual {v0, v10}, Lantlr/CharScanner;->LA(I)C
    ...
    const-string v14, "): unknown rule or bad lookahead computation"
    ...
    invoke-virtual {v4, v3, v2}, Lantlr/CodeGenerator;->getFIRSTBitSet(Ljava/lang/String;I)Ljava/lang/String;
    ...
    invoke-virtual {v12, v2}, Lantlr/Token;->setText(Ljava/lang/String;)V

    .line 644
    :cond_18
    iput-object v12, v0, Lantlr/CharScanner;->_returnToken:Lantlr/Token;
...
.method protected final mTREE_ELEMENT(Z)V
    ...
    invoke-virtual {v1, v2, v5}, Lantlr/CodeGenerator;->mapTreeId(Ljava/lang/String;Lantlr/ActionTransInfo;)Ljava/lang/String;
    ...
    invoke-virtual {v5, p1}, Lantlr/Token;->setText(Ljava/lang/String;)V

    .line 1389
    :cond_9
    iput-object v5, p0, Lantlr/CharScanner;->_returnToken:Lantlr/Token;
