...
.method public create(Lantlr/Token;Ljava/lang/String;)Lantlr/collections/AST;
    ...
    .line 212
    invoke-interface {p2, p1}, Lantlr/collections/AST;->initialize(Lantlr/Token;)V
...
.method protected create(Ljava/lang/String;)Lantlr/collections/AST;
    .locals 3
...
.method protected createUsingCtor(Lantlr/Token;Ljava/lang/String;)Lantlr/collections/AST;
    ...
    sget-object v2, Lantlr/ASTFactory;->class$antlr$Token:Ljava/lang/Class;

    if-nez v2, :cond_0

    const-string v2, "antlr.Token"

    invoke-static {v2}, Lantlr/ASTFactory;->class$(Ljava/lang/String;)Ljava/lang/Class;

    move-result-object v2

    sput-object v2, Lantlr/ASTFactory;->class$antlr$Token:Ljava/lang/Class;
...
.method public make([Lantlr/collections/AST;)Lantlr/collections/AST;
    ...
    .line 333
    invoke-interface {v1, v3}, Lantlr/collections/AST;->setFirstChild(Lantlr/collections/AST;)V
    ...
    .line 341
    :goto_1
    invoke-interface {v3}, Lantlr/collections/AST;->getNextSibling()Lantlr/collections/AST;
