...
.method protected setupDebugging(Lantlr/TokenStream;Lantlr/TokenBuffer;)V
    ...
    sget-object v3, Lantlr/debug/LLkDebuggingParser;->class$antlr$debug$LLkDebuggingParser:Ljava/lang/Class;

    if-nez v3, :cond_0

    const-string v3, "antlr.debug.LLkDebuggingParser"

    invoke-static {v3}, Lantlr/debug/LLkDebuggingParser;->class$(Ljava/lang/String;)Ljava/lang/Class;

    move-result-object v3

    sput-object v3, Lantlr/debug/LLkDebuggingParser;->class$antlr$debug$LLkDebuggingParser:Ljava/lang/Class;
    ...
    sget-object v3, Lantlr/debug/LLkDebuggingParser;->class$antlr$TokenStream:Ljava/lang/Class;

    if-nez v3, :cond_1

    const-string v3, "antlr.TokenStream"

    invoke-static {v3}, Lantlr/debug/LLkDebuggingParser;->class$(Ljava/lang/String;)Ljava/lang/Class;

    move-result-object v3

    sput-object v3, Lantlr/debug/LLkDebuggingParser;->class$antlr$TokenStream:Ljava/lang/Class;

    :cond_1
    aput-object v3, v2, v0

    sget-object v3, Lantlr/debug/LLkDebuggingParser;->class$antlr$TokenBuffer:Ljava/lang/Class;

    if-nez v3, :cond_2

    const-string v3, "antlr.TokenBuffer"

    invoke-static {v3}, Lantlr/debug/LLkDebuggingParser;->class$(Ljava/lang/String;)Ljava/lang/Class;

    move-result-object v3

    sput-object v3, Lantlr/debug/LLkDebuggingParser;->class$antlr$TokenBuffer:Ljava/lang/Class;
