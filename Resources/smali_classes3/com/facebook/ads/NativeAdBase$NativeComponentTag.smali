...
.method static constructor <clinit>()V
    ...
    invoke-direct {v1, v2, v3}, Lcom/facebook/ads/NativeAdBase$NativeComponentTag;-><init>(Ljava/lang/String;I)V
    ...
    const-string v3, "AD_COVER_IMAGE"

    const/4 v4, 0x2

    invoke-direct {v2, v3, v4}, Lcom/facebook/ads/NativeAdBase$NativeComponentTag;-><init>(Ljava/lang/String;I)V
    ...
    const-string v4, "AD_SUBTITLE"

    const/4 v5, 0x3

    invoke-direct {v3, v4, v5}, Lcom/facebook/ads/NativeAdBase$NativeComponentTag;-><init>(Ljava/lang/String;I)V

    sput-object v3, Lcom/facebook/ads/NativeAdBase$NativeComponentTag;->AD_SUBTITLE:Lcom/facebook/ads/NativeAdBase$NativeComponentTag;
    ...
    invoke-direct {v4, v5, v6}, Lcom/facebook/ads/NativeAdBase$NativeComponentTag;-><init>(Ljava/lang/String;I)V

    sput-object v4, Lcom/facebook/ads/NativeAdBase$NativeComponentTag;->AD_BODY:Lcom/facebook/ads/NativeAdBase$NativeComponentTag;

    .line 167
    new-instance v5, Lcom/facebook/ads/NativeAdBase$NativeComponentTag;

    const-string v6, "AD_CALL_TO_ACTION"

    const/4 v7, 0x5

    invoke-direct {v5, v6, v7}, Lcom/facebook/ads/NativeAdBase$NativeComponentTag;-><init>(Ljava/lang/String;I)V

    sput-object v5, Lcom/facebook/ads/NativeAdBase$NativeComponentTag;->AD_CALL_TO_ACTION:Lcom/facebook/ads/NativeAdBase$NativeComponentTag;

    .line 168
    new-instance v6, Lcom/facebook/ads/NativeAdBase$NativeComponentTag;

    const-string v7, "AD_SOCIAL_CONTEXT"

    const/4 v8, 0x6

    invoke-direct {v6, v7, v8}, Lcom/facebook/ads/NativeAdBase$NativeComponentTag;-><init>(Ljava/lang/String;I)V

    sput-object v6, Lcom/facebook/ads/NativeAdBase$NativeComponentTag;->AD_SOCIAL_CONTEXT:Lcom/facebook/ads/NativeAdBase$NativeComponentTag;

    .line 169
    new-instance v7, Lcom/facebook/ads/NativeAdBase$NativeComponentTag;

    const-string v8, "AD_CHOICES_ICON"

    const/4 v9, 0x7

    invoke-direct {v7, v8, v9}, Lcom/facebook/ads/NativeAdBase$NativeComponentTag;-><init>(Ljava/lang/String;I)V

    sput-object v7, Lcom/facebook/ads/NativeAdBase$NativeComponentTag;->AD_CHOICES_ICON:Lcom/facebook/ads/NativeAdBase$NativeComponentTag;

    .line 170
    new-instance v8, Lcom/facebook/ads/NativeAdBase$NativeComponentTag;

    const-string v9, "AD_OPTIONS_VIEW"

    const/16 v10, 0x8

    invoke-direct {v8, v9, v10}, Lcom/facebook/ads/NativeAdBase$NativeComponentTag;-><init>(Ljava/lang/String;I)V

    sput-object v8, Lcom/facebook/ads/NativeAdBase$NativeComponentTag;->AD_OPTIONS_VIEW:Lcom/facebook/ads/NativeAdBase$NativeComponentTag;

    .line 171
    new-instance v9, Lcom/facebook/ads/NativeAdBase$NativeComponentTag;

    const-string v10, "AD_MEDIA"

    const/16 v11, 0x9

    invoke-direct {v9, v10, v11}, Lcom/facebook/ads/NativeAdBase$NativeComponentTag;-><init>(Ljava/lang/String;I)V

    sput-object v9, Lcom/facebook/ads/NativeAdBase$NativeComponentTag;->AD_MEDIA:Lcom/facebook/ads/NativeAdBase$NativeComponentTag;
