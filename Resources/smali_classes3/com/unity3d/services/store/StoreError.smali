...
.method static constructor <clinit>()V
    ...
    invoke-direct {v1, v2, v3}, Lcom/unity3d/services/store/StoreError;-><init>(Ljava/lang/String;I)V

    sput-object v1, Lcom/unity3d/services/store/StoreError;->CLASS_NOT_FOUND:Lcom/unity3d/services/store/StoreError;

    .line 6
    new-instance v2, Lcom/unity3d/services/store/StoreError;

    const-string v3, "NO_SUCH_METHOD"

    const/4 v4, 0x2

    invoke-direct {v2, v3, v4}, Lcom/unity3d/services/store/StoreError;-><init>(Ljava/lang/String;I)V

    sput-object v2, Lcom/unity3d/services/store/StoreError;->NO_SUCH_METHOD:Lcom/unity3d/services/store/StoreError;

    .line 7
    new-instance v3, Lcom/unity3d/services/store/StoreError;

    const-string v4, "INVOCATION_TARGET"

    const/4 v5, 0x3

    invoke-direct {v3, v4, v5}, Lcom/unity3d/services/store/StoreError;-><init>(Ljava/lang/String;I)V

    sput-object v3, Lcom/unity3d/services/store/StoreError;->INVOCATION_TARGET:Lcom/unity3d/services/store/StoreError;

    .line 8
    new-instance v4, Lcom/unity3d/services/store/StoreError;

    const-string v5, "ILLEGAL_ACCESS"

    const/4 v6, 0x4

    invoke-direct {v4, v5, v6}, Lcom/unity3d/services/store/StoreError;-><init>(Ljava/lang/String;I)V

    sput-object v4, Lcom/unity3d/services/store/StoreError;->ILLEGAL_ACCESS:Lcom/unity3d/services/store/StoreError;
    ...
    invoke-direct {v5, v6, v7}, Lcom/unity3d/services/store/StoreError;-><init>(Ljava/lang/String;I)V

    sput-object v5, Lcom/unity3d/services/store/StoreError;->JSON_ERROR:Lcom/unity3d/services/store/StoreError;

    .line 10
    new-instance v6, Lcom/unity3d/services/store/StoreError;

    const-string v7, "STORE_ERROR"

    const/4 v8, 0x6

    invoke-direct {v6, v7, v8}, Lcom/unity3d/services/store/StoreError;-><init>(Ljava/lang/String;I)V

    sput-object v6, Lcom/unity3d/services/store/StoreError;->STORE_ERROR:Lcom/unity3d/services/store/StoreError;
    ...
    invoke-direct {v7, v8, v9}, Lcom/unity3d/services/store/StoreError;-><init>(Ljava/lang/String;I)V

    sput-object v7, Lcom/unity3d/services/store/StoreError;->UNKNOWN_ERROR:Lcom/unity3d/services/store/StoreError;
