...
.method static constructor <clinit>()V
    ...
    const-string v2, "APPLICATION_INFO_NOT_AVAILABLE"

    const/4 v3, 0x1

    invoke-direct {v1, v2, v3}, Lcom/unity3d/services/core/device/DeviceError;-><init>(Ljava/lang/String;I)V
    ...
    .line 6
    new-instance v2, Lcom/unity3d/services/core/device/DeviceError;

    const-string v3, "AUDIOMANAGER_NULL"

    const/4 v4, 0x2

    invoke-direct {v2, v3, v4}, Lcom/unity3d/services/core/device/DeviceError;-><init>(Ljava/lang/String;I)V

    sput-object v2, Lcom/unity3d/services/core/device/DeviceError;->AUDIOMANAGER_NULL:Lcom/unity3d/services/core/device/DeviceError;

    .line 7
    new-instance v3, Lcom/unity3d/services/core/device/DeviceError;

    const-string v4, "INVALID_STORAGETYPE"

    const/4 v5, 0x3

    invoke-direct {v3, v4, v5}, Lcom/unity3d/services/core/device/DeviceError;-><init>(Ljava/lang/String;I)V

    sput-object v3, Lcom/unity3d/services/core/device/DeviceError;->INVALID_STORAGETYPE:Lcom/unity3d/services/core/device/DeviceError;

    .line 8
    new-instance v4, Lcom/unity3d/services/core/device/DeviceError;

    const-string v5, "COULDNT_GET_STORAGE_LOCATION"

    const/4 v6, 0x4

    invoke-direct {v4, v5, v6}, Lcom/unity3d/services/core/device/DeviceError;-><init>(Ljava/lang/String;I)V

    sput-object v4, Lcom/unity3d/services/core/device/DeviceError;->COULDNT_GET_STORAGE_LOCATION:Lcom/unity3d/services/core/device/DeviceError;

    .line 9
    new-instance v5, Lcom/unity3d/services/core/device/DeviceError;

    const-string v6, "COULDNT_GET_GL_VERSION"

    const/4 v7, 0x5

    invoke-direct {v5, v6, v7}, Lcom/unity3d/services/core/device/DeviceError;-><init>(Ljava/lang/String;I)V

    sput-object v5, Lcom/unity3d/services/core/device/DeviceError;->COULDNT_GET_GL_VERSION:Lcom/unity3d/services/core/device/DeviceError;

    .line 10
    new-instance v6, Lcom/unity3d/services/core/device/DeviceError;

    const-string v7, "JSON_ERROR"

    const/4 v8, 0x6

    invoke-direct {v6, v7, v8}, Lcom/unity3d/services/core/device/DeviceError;-><init>(Ljava/lang/String;I)V

    sput-object v6, Lcom/unity3d/services/core/device/DeviceError;->JSON_ERROR:Lcom/unity3d/services/core/device/DeviceError;

    .line 11
    new-instance v7, Lcom/unity3d/services/core/device/DeviceError;

    const-string v8, "COULDNT_GET_DIGEST"

    const/4 v9, 0x7

    invoke-direct {v7, v8, v9}, Lcom/unity3d/services/core/device/DeviceError;-><init>(Ljava/lang/String;I)V

    sput-object v7, Lcom/unity3d/services/core/device/DeviceError;->COULDNT_GET_DIGEST:Lcom/unity3d/services/core/device/DeviceError;

    .line 12
    new-instance v8, Lcom/unity3d/services/core/device/DeviceError;

    const-string v9, "COULDNT_GET_FINGERPRINT"

    const/16 v10, 0x8

    invoke-direct {v8, v9, v10}, Lcom/unity3d/services/core/device/DeviceError;-><init>(Ljava/lang/String;I)V

    sput-object v8, Lcom/unity3d/services/core/device/DeviceError;->COULDNT_GET_FINGERPRINT:Lcom/unity3d/services/core/device/DeviceError;

    .line 13
    new-instance v9, Lcom/unity3d/services/core/device/DeviceError;

    const-string v10, "COULDNT_GET_ADB_STATUS"

    const/16 v11, 0x9

    invoke-direct {v9, v10, v11}, Lcom/unity3d/services/core/device/DeviceError;-><init>(Ljava/lang/String;I)V

    sput-object v9, Lcom/unity3d/services/core/device/DeviceError;->COULDNT_GET_ADB_STATUS:Lcom/unity3d/services/core/device/DeviceError;
