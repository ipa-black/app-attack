...
.method static constructor <clinit>()V
    ...
    const-string v2, "INIT_QUEUE_NOT_EMPTY"

    const/4 v3, 0x1

    invoke-direct {v1, v2, v3, v3}, Lcom/unity3d/services/core/api/DownloadLatestWebViewStatus;-><init>(Ljava/lang/String;II)V
    ...
    const-string v3, "MISSING_LATEST_CONFIG"

    const/4 v4, 0x2

    invoke-direct {v2, v3, v4, v4}, Lcom/unity3d/services/core/api/DownloadLatestWebViewStatus;-><init>(Ljava/lang/String;II)V

    sput-object v2, Lcom/unity3d/services/core/api/DownloadLatestWebViewStatus;->MISSING_LATEST_CONFIG:Lcom/unity3d/services/core/api/DownloadLatestWebViewStatus;

    .line 7
    new-instance v3, Lcom/unity3d/services/core/api/DownloadLatestWebViewStatus;

    const-string v4, "BACKGROUND_DOWNLOAD_STARTED"

    const/4 v5, 0x3

    invoke-direct {v3, v4, v5, v5}, Lcom/unity3d/services/core/api/DownloadLatestWebViewStatus;-><init>(Ljava/lang/String;II)V

    sput-object v3, Lcom/unity3d/services/core/api/DownloadLatestWebViewStatus;->BACKGROUND_DOWNLOAD_STARTED:Lcom/unity3d/services/core/api/DownloadLatestWebViewStatus;
