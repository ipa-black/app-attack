...
.method private static getBaseUrl(Ljava/lang/String;)Ljava/lang/String;
    ...
    sget-object v0, Lcom/ironsource/mediationsdk/server/ServerURL;->BASE_URL_SUFFIX:Ljava/lang/String;
...
.method public static getCPVProvidersURL(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;ZLjava/util/Vector;)Ljava/lang/String;
    ...
    invoke-direct {p1, p5, p2}, Landroid/util/Pair;-><init>(Ljava/lang/Object;Ljava/lang/Object;)V
    ...
    invoke-virtual {p1}, Lcom/ironsource/mediationsdk/utils/k;->d()Ljava/util/concurrent/ConcurrentHashMap;
    ...
    iget-object p1, p0, Lcom/ironsource/environment/d/b;->b:Lcom/ironsource/mediationsdk/m;

    iget-object p0, p0, Lcom/ironsource/environment/d/b;->a:Ljava/util/ArrayList;

    invoke-virtual {p1, p0}, Lcom/ironsource/mediationsdk/m;->a(Ljava/util/ArrayList;)Lorg/json/JSONObject;

    move-result-object p0

    const-string p1, "mGlobalDataReader.getDataByKeys(mInitKeyList)"
