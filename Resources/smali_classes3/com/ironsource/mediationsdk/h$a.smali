...
.method private a()Z
    ...
    iget-boolean v11, v1, Lcom/ironsource/mediationsdk/h$a;->t:Z
    ...
    sget-object v11, Lcom/ironsource/mediationsdk/logger/IronLog;->INTERNAL:Lcom/ironsource/mediationsdk/logger/IronLog;

    const-string v7, "compressing and encrypting auction request"

    invoke-virtual {v11, v7}, Lcom/ironsource/mediationsdk/logger/IronLog;->verbose(Ljava/lang/String;)V

    invoke-static {v6, v8}, Lcom/ironsource/mediationsdk/utils/IronSourceAES;->compressAndEncrypt(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    :cond_2
    invoke-static {v6, v8}, Lcom/ironsource/mediationsdk/utils/IronSourceAES;->encode(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v6

    :goto_3
    iget v7, v1, Lcom/ironsource/mediationsdk/h$a;->l:I

    if-ne v7, v5, :cond_3

    const-string v7, "{\"sk\" : \"%1$s\", \"ct\" : \"%2$s\"}"
    ...
    :cond_5
    invoke-static {v12}, Lcom/ironsource/mediationsdk/h$a;->a(Ljava/net/HttpURLConnection;)Ljava/lang/String;
    ...
    :try_start_5
    iget-boolean v6, v1, Lcom/ironsource/mediationsdk/h$a;->q:Z

    iget-boolean v7, v1, Lcom/ironsource/mediationsdk/h$a;->u:Z
    ...
    iget v6, v1, Lcom/ironsource/mediationsdk/h$a;->l:I
    ...
    invoke-static {v8}, Lcom/ironsource/mediationsdk/f;->a(Lorg/json/JSONObject;)Lcom/ironsource/mediationsdk/f$a;
    ...
    iput v0, v1, Lcom/ironsource/mediationsdk/h$a;->b:I
