...
.method static a(Lorg/json/JSONObject;)Lcom/ironsource/mediationsdk/f$a;
    ...
    invoke-direct {v2, v0}, Lcom/ironsource/mediationsdk/server/b;-><init>(Lorg/json/JSONObject;)V

    iput-object v2, v1, Lcom/ironsource/mediationsdk/f$a;->c:Lcom/ironsource/mediationsdk/server/b;
    ...
    iput-object v0, v1, Lcom/ironsource/mediationsdk/f$a;->e:Lorg/json/JSONObject;
    ...
    iput-object v0, v1, Lcom/ironsource/mediationsdk/f$a;->b:Ljava/util/List;
    ...
    invoke-direct {v2, v4, v3}, Lcom/ironsource/mediationsdk/server/b;-><init>(Lorg/json/JSONObject;Lorg/json/JSONObject;)V

    invoke-virtual {v2}, Lcom/ironsource/mediationsdk/server/b;->g()Z
...
.method final a(Landroid/content/Context;Ljava/util/Map;Ljava/util/List;Lcom/ironsource/mediationsdk/i;ILjava/lang/String;Lcom/ironsource/mediationsdk/utils/c;Lcom/ironsource/mediationsdk/ISBannerSize;Lorg/json/JSONObject;)Lorg/json/JSONObject;
    ...
    invoke-virtual {v0, v9}, Lcom/ironsource/mediationsdk/i;->a(Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object v5, v5, Lcom/ironsource/mediationsdk/H;->k:Ljava/lang/String;
    ...
    iget-object v5, v5, Lcom/ironsource/mediationsdk/H;->y:Ljava/lang/Boolean;
    ...
    invoke-static {p1, v5}, Lcom/ironsource/environment/c;->c(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object v5, v5, Lcom/ironsource/mediationsdk/H;->j:Ljava/lang/String;
...
.method final a(Ljava/lang/String;ZLjava/util/Map;Ljava/util/List;Lcom/ironsource/mediationsdk/i;ILcom/ironsource/mediationsdk/ISBannerSize;Lorg/json/JSONObject;)Lorg/json/JSONObject;
    ...
    iget-object v3, v0, Lcom/ironsource/environment/a/b;->b:Lcom/ironsource/mediationsdk/m;

    iget-object v0, v0, Lcom/ironsource/environment/a/b;->a:Ljava/util/ArrayList;

    invoke-virtual {v3, v0}, Lcom/ironsource/mediationsdk/m;->a(Ljava/util/ArrayList;)Lorg/json/JSONObject;

    move-result-object v0

    const-string v3, "mGlobalDataReader.getDataByKeys(mAuctionKeyList)"
    ...
    invoke-static {v5}, Lcom/ironsource/environment/c/b;->a(Lorg/json/JSONObject;)Lorg/json/JSONObject;
...
.method public final a(Lorg/json/JSONObject;Lorg/json/JSONObject;Ljava/util/List;)Lorg/json/JSONObject;
    ...
    invoke-static {}, Lcom/ironsource/mediationsdk/ah;->c()Lorg/json/JSONObject;

    move-result-object v1

    invoke-virtual {v0, v1}, Lcom/ironsource/mediationsdk/ah;->a(Lorg/json/JSONObject;)V

    invoke-static {}, Lcom/ironsource/mediationsdk/ah;->b()Lorg/json/JSONObject;

    move-result-object v1

    invoke-virtual {v0, v1}, Lcom/ironsource/mediationsdk/ah;->a(Lorg/json/JSONObject;)V

    iget-object v0, v0, Lcom/ironsource/mediationsdk/ah;->a:Lorg/json/JSONObject;
