...
.method static constructor <clinit>()V
    ...
    invoke-direct {v1, v2, v3, v3}, Lcom/ironsource/mediationsdk/b$a;-><init>(Ljava/lang/String;II)V

    sput-object v1, Lcom/ironsource/mediationsdk/b$a;->b:Lcom/ironsource/mediationsdk/b$a;

    new-instance v2, Lcom/ironsource/mediationsdk/b$a;

    const-string v3, "INITIATED"

    const/4 v4, 0x2

    invoke-direct {v2, v3, v4, v4}, Lcom/ironsource/mediationsdk/b$a;-><init>(Ljava/lang/String;II)V

    sput-object v2, Lcom/ironsource/mediationsdk/b$a;->c:Lcom/ironsource/mediationsdk/b$a;
    ...
    invoke-direct {v3, v4, v5, v5}, Lcom/ironsource/mediationsdk/b$a;-><init>(Ljava/lang/String;II)V

    sput-object v3, Lcom/ironsource/mediationsdk/b$a;->d:Lcom/ironsource/mediationsdk/b$a;

    new-instance v4, Lcom/ironsource/mediationsdk/b$a;

    const-string v5, "NOT_AVAILABLE"

    const/4 v6, 0x4

    invoke-direct {v4, v5, v6, v6}, Lcom/ironsource/mediationsdk/b$a;-><init>(Ljava/lang/String;II)V

    sput-object v4, Lcom/ironsource/mediationsdk/b$a;->e:Lcom/ironsource/mediationsdk/b$a;

    new-instance v5, Lcom/ironsource/mediationsdk/b$a;

    const-string v6, "EXHAUSTED"

    const/4 v7, 0x5

    invoke-direct {v5, v6, v7, v7}, Lcom/ironsource/mediationsdk/b$a;-><init>(Ljava/lang/String;II)V

    sput-object v5, Lcom/ironsource/mediationsdk/b$a;->f:Lcom/ironsource/mediationsdk/b$a;

    new-instance v6, Lcom/ironsource/mediationsdk/b$a;

    const-string v7, "CAPPED_PER_SESSION"

    const/4 v8, 0x6

    invoke-direct {v6, v7, v8, v8}, Lcom/ironsource/mediationsdk/b$a;-><init>(Ljava/lang/String;II)V

    sput-object v6, Lcom/ironsource/mediationsdk/b$a;->g:Lcom/ironsource/mediationsdk/b$a;

    new-instance v7, Lcom/ironsource/mediationsdk/b$a;

    const-string v8, "INIT_PENDING"

    const/4 v9, 0x7

    invoke-direct {v7, v8, v9, v9}, Lcom/ironsource/mediationsdk/b$a;-><init>(Ljava/lang/String;II)V

    sput-object v7, Lcom/ironsource/mediationsdk/b$a;->h:Lcom/ironsource/mediationsdk/b$a;

    new-instance v8, Lcom/ironsource/mediationsdk/b$a;

    const-string v9, "LOAD_PENDING"

    const/16 v10, 0x8

    invoke-direct {v8, v9, v10, v10}, Lcom/ironsource/mediationsdk/b$a;-><init>(Ljava/lang/String;II)V

    sput-object v8, Lcom/ironsource/mediationsdk/b$a;->i:Lcom/ironsource/mediationsdk/b$a;

    new-instance v9, Lcom/ironsource/mediationsdk/b$a;

    const-string v10, "CAPPED_PER_DAY"

    const/16 v11, 0x9

    invoke-direct {v9, v10, v11, v11}, Lcom/ironsource/mediationsdk/b$a;-><init>(Ljava/lang/String;II)V

    sput-object v9, Lcom/ironsource/mediationsdk/b$a;->j:Lcom/ironsource/mediationsdk/b$a;

    new-instance v10, Lcom/ironsource/mediationsdk/b$a;

    const-string v11, "NEEDS_RELOAD"

    const/16 v12, 0xa

    invoke-direct {v10, v11, v12, v12}, Lcom/ironsource/mediationsdk/b$a;-><init>(Ljava/lang/String;II)V

    sput-object v10, Lcom/ironsource/mediationsdk/b$a;->k:Lcom/ironsource/mediationsdk/b$a;

    filled-new-array/range {v0 .. v10}, [Lcom/ironsource/mediationsdk/b$a;
