.class public Lorg/apache/ldap/server/invocation/HasEntry;
.super Lorg/apache/ldap/server/invocation/Invocation;
.source "HasEntry.java"


# static fields
.field private static final serialVersionUID:J = 0x2d36363335383432L
...
.method public constructor <init>(Ljavax/naming/Name;)V
    ...
    .line 46
    iput-object p1, p0, Lorg/apache/ldap/server/invocation/HasEntry;->name:Ljavax/naming/Name;
...
.method protected doExecute(Lorg/apache/ldap/server/BackingStore;)Ljava/lang/Object;
    ...
    .line 58
    iget-object v0, p0, Lorg/apache/ldap/server/invocation/HasEntry;->name:Ljavax/naming/Name;
    ...
    :cond_0
    invoke-interface {p1, v0}, Lorg/apache/ldap/server/BackingStore;->hasEntry(Ljavax/naming/Name;)Z
