.class public Lorg/apache/ldap/server/invocation/IsSuffix;
.super Lorg/apache/ldap/server/invocation/Invocation;
.source "IsSuffix.java"


# static fields
.field private static final serialVersionUID:J = 0x2d32353632373134L
...
.method public constructor <init>(Ljavax/naming/Name;)V
    ...
    .line 46
    iput-object p1, p0, Lorg/apache/ldap/server/invocation/IsSuffix;->name:Ljavax/naming/Name;
...
.method protected doExecute(Lorg/apache/ldap/server/BackingStore;)Ljava/lang/Object;
    ...
    .line 58
    iget-object v0, p0, Lorg/apache/ldap/server/invocation/IsSuffix;->name:Ljavax/naming/Name;
    ...
    :cond_0
    invoke-interface {p1, v0}, Lorg/apache/ldap/server/BackingStore;->isSuffix(Ljavax/naming/Name;)Z
