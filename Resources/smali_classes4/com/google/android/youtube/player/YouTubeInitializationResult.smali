...
.method static constructor <clinit>()V
    ...
    invoke-direct {v1, v2, v3}, Lcom/google/android/youtube/player/YouTubeInitializationResult;-><init>(Ljava/lang/String;I)V
    ...
    new-instance v2, Lcom/google/android/youtube/player/YouTubeInitializationResult;

    const-string v3, "UNKNOWN_ERROR"

    const/4 v4, 0x2

    invoke-direct {v2, v3, v4}, Lcom/google/android/youtube/player/YouTubeInitializationResult;-><init>(Ljava/lang/String;I)V

    sput-object v2, Lcom/google/android/youtube/player/YouTubeInitializationResult;->UNKNOWN_ERROR:Lcom/google/android/youtube/player/YouTubeInitializationResult;

    new-instance v3, Lcom/google/android/youtube/player/YouTubeInitializationResult;

    const-string v4, "SERVICE_MISSING"

    const/4 v5, 0x3

    invoke-direct {v3, v4, v5}, Lcom/google/android/youtube/player/YouTubeInitializationResult;-><init>(Ljava/lang/String;I)V

    sput-object v3, Lcom/google/android/youtube/player/YouTubeInitializationResult;->SERVICE_MISSING:Lcom/google/android/youtube/player/YouTubeInitializationResult;

    new-instance v4, Lcom/google/android/youtube/player/YouTubeInitializationResult;

    const-string v5, "SERVICE_VERSION_UPDATE_REQUIRED"

    const/4 v6, 0x4

    invoke-direct {v4, v5, v6}, Lcom/google/android/youtube/player/YouTubeInitializationResult;-><init>(Ljava/lang/String;I)V

    sput-object v4, Lcom/google/android/youtube/player/YouTubeInitializationResult;->SERVICE_VERSION_UPDATE_REQUIRED:Lcom/google/android/youtube/player/YouTubeInitializationResult;
    ...
    invoke-direct {v5, v6, v7}, Lcom/google/android/youtube/player/YouTubeInitializationResult;-><init>(Ljava/lang/String;I)V

    sput-object v5, Lcom/google/android/youtube/player/YouTubeInitializationResult;->SERVICE_DISABLED:Lcom/google/android/youtube/player/YouTubeInitializationResult;

    new-instance v6, Lcom/google/android/youtube/player/YouTubeInitializationResult;

    const-string v7, "SERVICE_INVALID"

    const/4 v8, 0x6

    invoke-direct {v6, v7, v8}, Lcom/google/android/youtube/player/YouTubeInitializationResult;-><init>(Ljava/lang/String;I)V

    sput-object v6, Lcom/google/android/youtube/player/YouTubeInitializationResult;->SERVICE_INVALID:Lcom/google/android/youtube/player/YouTubeInitializationResult;

    new-instance v7, Lcom/google/android/youtube/player/YouTubeInitializationResult;

    const-string v8, "ERROR_CONNECTING_TO_SERVICE"

    const/4 v9, 0x7

    invoke-direct {v7, v8, v9}, Lcom/google/android/youtube/player/YouTubeInitializationResult;-><init>(Ljava/lang/String;I)V

    sput-object v7, Lcom/google/android/youtube/player/YouTubeInitializationResult;->ERROR_CONNECTING_TO_SERVICE:Lcom/google/android/youtube/player/YouTubeInitializationResult;

    new-instance v8, Lcom/google/android/youtube/player/YouTubeInitializationResult;

    const-string v9, "CLIENT_LIBRARY_UPDATE_REQUIRED"

    const/16 v10, 0x8

    invoke-direct {v8, v9, v10}, Lcom/google/android/youtube/player/YouTubeInitializationResult;-><init>(Ljava/lang/String;I)V

    sput-object v8, Lcom/google/android/youtube/player/YouTubeInitializationResult;->CLIENT_LIBRARY_UPDATE_REQUIRED:Lcom/google/android/youtube/player/YouTubeInitializationResult;
    ...
    invoke-direct {v9, v10, v11}, Lcom/google/android/youtube/player/YouTubeInitializationResult;-><init>(Ljava/lang/String;I)V

    sput-object v9, Lcom/google/android/youtube/player/YouTubeInitializationResult;->NETWORK_ERROR:Lcom/google/android/youtube/player/YouTubeInitializationResult;

    new-instance v10, Lcom/google/android/youtube/player/YouTubeInitializationResult;

    const-string v11, "DEVELOPER_KEY_INVALID"

    const/16 v12, 0xa

    invoke-direct {v10, v11, v12}, Lcom/google/android/youtube/player/YouTubeInitializationResult;-><init>(Ljava/lang/String;I)V

    sput-object v10, Lcom/google/android/youtube/player/YouTubeInitializationResult;->DEVELOPER_KEY_INVALID:Lcom/google/android/youtube/player/YouTubeInitializationResult;

    new-instance v11, Lcom/google/android/youtube/player/YouTubeInitializationResult;

    const-string v12, "INVALID_APPLICATION_SIGNATURE"

    const/16 v13, 0xb

    invoke-direct {v11, v12, v13}, Lcom/google/android/youtube/player/YouTubeInitializationResult;-><init>(Ljava/lang/String;I)V

    sput-object v11, Lcom/google/android/youtube/player/YouTubeInitializationResult;->INVALID_APPLICATION_SIGNATURE:Lcom/google/android/youtube/player/YouTubeInitializationResult;

    filled-new-array/range {v0 .. v11}, [Lcom/google/android/youtube/player/YouTubeInitializationResult;
...
.method public final getErrorDialog(Landroid/app/Activity;ILandroid/content/DialogInterface$OnCancelListener;)Landroid/app/Dialog;
    ...
    :goto_0
    new-instance v4, Lcom/google/android/youtube/player/YouTubeInitializationResult$a;

    invoke-direct {v4, p1, p3, p2}, Lcom/google/android/youtube/player/YouTubeInitializationResult$a;-><init>(Landroid/app/Activity;Landroid/content/Intent;I)V
    ...
    const-string v0, "Unexpected errorReason: "
