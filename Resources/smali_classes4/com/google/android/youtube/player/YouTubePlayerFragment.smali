...
.method static synthetic a(Lcom/google/android/youtube/player/YouTubePlayerFragment;)Lcom/google/android/youtube/player/YouTubePlayer$OnInitializedListener;
    ...
    iget-object p0, p0, Lcom/google/android/youtube/player/YouTubePlayerFragment;->e:Lcom/google/android/youtube/player/YouTubePlayer$OnInitializedListener;
...
.method private a()V
    ...
    iget-object v1, p0, Lcom/google/android/youtube/player/YouTubePlayerFragment;->e:Lcom/google/android/youtube/player/YouTubePlayer$OnInitializedListener;
    ...
    iget-object v2, p0, Lcom/google/android/youtube/player/YouTubePlayerFragment;->c:Lcom/google/android/youtube/player/YouTubePlayerView;

    invoke-virtual {p0}, Lcom/google/android/youtube/player/YouTubePlayerFragment;->getActivity()Landroid/app/Activity;

    move-result-object v3

    iget-object v5, p0, Lcom/google/android/youtube/player/YouTubePlayerFragment;->d:Ljava/lang/String;

    iget-object v6, p0, Lcom/google/android/youtube/player/YouTubePlayerFragment;->e:Lcom/google/android/youtube/player/YouTubePlayer$OnInitializedListener;

    iget-object v7, p0, Lcom/google/android/youtube/player/YouTubePlayerFragment;->b:Landroid/os/Bundle;

    move-object v4, p0

    invoke-virtual/range {v2 .. v7}, Lcom/google/android/youtube/player/YouTubePlayerView;->a(Landroid/app/Activity;Lcom/google/android/youtube/player/YouTubePlayer$Provider;Ljava/lang/String;Lcom/google/android/youtube/player/YouTubePlayer$OnInitializedListener;Landroid/os/Bundle;)V

    const/4 v0, 0x0

    iput-object v0, p0, Lcom/google/android/youtube/player/YouTubePlayerFragment;->b:Landroid/os/Bundle;

    iput-object v0, p0, Lcom/google/android/youtube/player/YouTubePlayerFragment;->e:Lcom/google/android/youtube/player/YouTubePlayer$OnInitializedListener;
...
.method public initialize(Ljava/lang/String;Lcom/google/android/youtube/player/YouTubePlayer$OnInitializedListener;)V
    ...
    iput-object p1, p0, Lcom/google/android/youtube/player/YouTubePlayerFragment;->d:Ljava/lang/String;
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    :goto_0
    iput-object p1, p0, Lcom/google/android/youtube/player/YouTubePlayerFragment;->b:Landroid/os/Bundle;
...
.method public onCreateView(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/os/Bundle;)Landroid/view/View;
    ...
    iget-object v0, p0, Lcom/google/android/youtube/player/YouTubePlayerFragment;->a:Lcom/google/android/youtube/player/YouTubePlayerFragment$a;

    const/4 v1, 0x0

    invoke-direct {p1, p2, v1, p3, v0}, Lcom/google/android/youtube/player/YouTubePlayerView;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;ILcom/google/android/youtube/player/YouTubePlayerView$b;)V

    iput-object p1, p0, Lcom/google/android/youtube/player/YouTubePlayerFragment;->c:Lcom/google/android/youtube/player/YouTubePlayerView;

    invoke-direct {p0}, Lcom/google/android/youtube/player/YouTubePlayerFragment;->a()V

    iget-object p1, p0, Lcom/google/android/youtube/player/YouTubePlayerFragment;->c:Lcom/google/android/youtube/player/YouTubePlayerView;
