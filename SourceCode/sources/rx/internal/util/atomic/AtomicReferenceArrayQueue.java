...
abstract class AtomicReferenceArrayQueue<E> extends AbstractQueue<E> {
    ...
    protected final void spElement(AtomicReferenceArray<E> atomicReferenceArray, int i, E e2) {
        atomicReferenceArray.lazySet(i, e2);
    }

    protected final void spElement(int i, E e2) {
        this.buffer.lazySet(i, e2);
    }

    /* JADX INFO: Access modifiers changed from: protected */
    public final void soElement(AtomicReferenceArray<E> atomicReferenceArray, int i, E e2) {
        atomicReferenceArray.lazySet(i, e2);
    }

    protected final void soElement(int i, E e2) {
        this.buffer.lazySet(i, e2);
    }

    protected final void svElement(AtomicReferenceArray<E> atomicReferenceArray, int i, E e2) {
