...
public class MpmcArrayQueue<E> extends MpmcArrayQueueConsumerField<E> {
    ...
    public boolean offer(E e2) {
        ...
        while (true) {
            ...
            int i = ((lvSequence(jArr, calcSequenceOffset) - lvProducerIndex) > 0L ? 1 : ((lvSequence(jArr, calcSequenceOffset) - lvProducerIndex) == 0L ? 0 : -1));
            if (i == 0) {
    ...
    public E poll() {
        ...
        while (true) {
            ...
            int i = ((lvSequence(jArr, calcSequenceOffset) - j2) > 0L ? 1 : ((lvSequence(jArr, calcSequenceOffset) - j2) == 0L ? 0 : -1));
            if (i == 0) {
