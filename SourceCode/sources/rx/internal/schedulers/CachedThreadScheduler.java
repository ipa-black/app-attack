...
public final class CachedThreadScheduler extends Scheduler implements SchedulerLifecycle {
    ...
    public void start() {
        ...
        if (b$$ExternalSyntheticBackportWithForwarding0.m(this.pool, NONE, cachedWorkerPool)) {
            return;
        }
        cachedWorkerPool.shutdown();
    }
    ...
    public void shutdown() {
        ...
        } while (!b$$ExternalSyntheticBackportWithForwarding0.m(this.pool, cachedWorkerPool, cachedWorkerPool2));
        cachedWorkerPool.shutdown();
    }
