...
public final class EventLoopsScheduler extends Scheduler implements SchedulerLifecycle {
    ...
    public void start() {
        ...
        if (b$$ExternalSyntheticBackportWithForwarding0.m(this.pool, NONE, fixedSchedulerPool)) {
            return;
        }
    ...
    public void shutdown() {
        ...
        } while (!b$$ExternalSyntheticBackportWithForwarding0.m(this.pool, fixedSchedulerPool, fixedSchedulerPool2));
        fixedSchedulerPool.shutdown();
    }
