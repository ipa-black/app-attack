...
public final class GenericScheduledExecutorService implements SchedulerLifecycle {
    ...
    public void start() {
        ...
        if (!b$$ExternalSyntheticBackportWithForwarding0.m(this.executor, NONE, scheduledExecutorServiceArr)) {
    ...
    public void shutdown() {
        ...
        } while (!b$$ExternalSyntheticBackportWithForwarding0.m(this.executor, scheduledExecutorServiceArr, scheduledExecutorServiceArr2));
