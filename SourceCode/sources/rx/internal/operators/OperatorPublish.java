...
public final class OperatorPublish<T> extends ConnectableObservable<T> {
            ...
            public void call(Subscriber<? super T> subscriber) {
                while (true) {
                    ...
                    if (publishSubscriber == null || publishSubscriber.isUnsubscribed()) {
                        ...
                        if (b$$ExternalSyntheticBackportWithForwarding0.m(atomicReference, publishSubscriber, publishSubscriber2)) {
    ...
    public void connect(Action1<? super Subscription> action1) {
        ...
        while (true) {
            ...
            publishSubscriber2.init();
            if (b$$ExternalSyntheticBackportWithForwarding0.m(this.current, publishSubscriber, publishSubscriber2)) {
                publishSubscriber = publishSubscriber2;
                break;
            }
        }
    ...
    public static final class PublishSubscriber<T> extends Subscriber<T> implements Subscription {
        ...
        void init() {
            add(Subscriptions.create(new Action0() { // from class: rx.internal.operators.OperatorPublish.PublishSubscriber.1
                ...
                public void call() {
                    ...
                    b$$ExternalSyntheticBackportWithForwarding0.m(PublishSubscriber.this.current, PublishSubscriber.this, null);
                }
            }));
        }
        ...
        boolean add(InnerProducer<T> innerProducer) {
            ...
            } while (!b$$ExternalSyntheticBackportWithForwarding0.m(this.producers, innerProducerArr, innerProducerArr2));
            return true;
        }
        ...
        boolean checkTerminated(Object obj, boolean z) {
            ...
            if (obj != null) {
                if (!NotificationLite.isCompleted(obj)) {
                    ...
                    b$$ExternalSyntheticBackportWithForwarding0.m(this.current, this, null);
                    try {
                ...
                while (true) {
                    try {
                        ...
                        if (!isEmpty) {
                            ...
                            if (length == i) {
                                if (checkTerminated(this.terminalEvent, this.queue.poll() == null ? z2 : false)) {
                                    return;
                                }
                                request(1L);
                            } else {
