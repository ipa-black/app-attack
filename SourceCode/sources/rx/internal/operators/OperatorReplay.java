...
public final class OperatorReplay<T> extends ConnectableObservable<T> implements Subscription {
        ...
        return new OperatorReplay(new Observable.OnSubscribe<T>() { // from class: rx.internal.operators.OperatorReplay.7
            ...
            public void call(Subscriber<? super T> subscriber) {
                ...
                while (true) {
                    ...
                    if (b$$ExternalSyntheticBackportWithForwarding0.m(atomicReference, replaySubscriber, replaySubscriber2)) {
    ...
    public void connect(Action1<? super Subscription> action1) {
        ...
        while (true) {
            ...
            replaySubscriber2.init();
            if (b$$ExternalSyntheticBackportWithForwarding0.m(this.current, replaySubscriber, replaySubscriber2)) {
                replaySubscriber = replaySubscriber2;
                break;
            }
        }
