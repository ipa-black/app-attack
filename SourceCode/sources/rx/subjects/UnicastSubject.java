...
public final class UnicastSubject<T> extends Subject<T, T> {
    ...
    public static final class State<T> extends AtomicLong implements Producer, Observer<T>, Observable.OnSubscribe<T>, Subscription {
        ...
        public void call(Subscriber<? super T> subscriber) {
            if (b$$ExternalSyntheticBackportWithForwarding0.m(this.subscriber, null, subscriber)) {
                subscriber.add(this);
        ...
        */
        ...
        void doTerminate() {
            ...
            if (atomicReference == null || (action0 = atomicReference.get()) == null || !b$$ExternalSyntheticBackportWithForwarding0.m(atomicReference, action0, null)) {
                return;
            }
            action0.call();
        }
