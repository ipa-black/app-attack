...
public class JavaCodeGenerator extends CodeGenerator {
    ...
    public void gen(ActionElement actionElement) {
        ...
        if (actionTransInfo.assignToRoot) {
            ...
            println(new StringBuffer("currentAST.child = ").append(actionTransInfo.refRuleRoot).append("!=null &&").append(actionTransInfo.refRuleRoot).append(".getFirstChild()!=null ?").toString());
            this.tabs++;
    ...
    */
    ...
    public void gen(CharRangeElement charRangeElement) {
        ...
        println(new StringBuffer("matchRange(").append(charRangeElement.beginText).append(",").append(charRangeElement.endText).append(");").toString());
        if (z) {
    ...
    public void gen(LexerGrammar lexerGrammar) throws IOException {
        ...
        println(new StringBuffer("import antlr.").append(this.grammar.getSuperClass()).append(";").toString());
        ...
        print(new StringBuffer().append((token == null || (r5 = StringUtils.stripFrontBack(token.getText(), "\"", "\"")) == null) ? "public" : "public").append(" ").toString());
        print(new StringBuffer("class ").append(this.grammar.getClassName()).append(" extends ").append(stringBuffer).toString());
        println(new StringBuffer(" implements ").append(this.grammar.tokenManager.getName()).append(CodeGenerator.TokenTypesFileSuffix).append(", TokenStream").toString());
        ...
        println(new StringBuffer("public ").append(this.grammar.getClassName()).append("(InputStream in) {").toString());
        this.tabs++;
        println("this(new ByteBuffer(in));");
        this.tabs--;
        println("}");
        println(new StringBuffer("public ").append(this.grammar.getClassName()).append("(Reader in) {").toString());
        this.tabs++;
        println("this(new CharBuffer(in));");
        this.tabs--;
        println("}");
        println(new StringBuffer("public ").append(this.grammar.getClassName()).append("(InputBuffer ib) {").toString());
        this.tabs++;
        ...
        this.tabs--;
        println("}");
        println(new StringBuffer("public ").append(this.grammar.getClassName()).append("(LexerSharedInputState state) {").toString());
        this.tabs++;
        println("super(state);");
        if (this.grammar.debuggingOutput) {
        ...
        while (tokenSymbolKeys.hasMoreElements()) {
            ...
            if (str.charAt(0) == '\"') {
                ...
                if (tokenSymbol instanceof StringLiteralSymbol) {
                    ...
                    println(new StringBuffer("literals.put(new ANTLRHashString(").append(stringLiteralSymbol.getId()).append(", this), new Integer(").append(stringLiteralSymbol.getTokenType()).append("));").toString());
                }
            }
        }
        this.tabs--;
    ...
    */
    ...
    public void gen(ParserGrammar parserGrammar) throws IOException {
        ...
        Token token = (Token) this.grammar.options.get("classHeaderPrefix");
        print(new StringBuffer().append((token == null || (r2 = StringUtils.stripFrontBack(token.getText(), "\"", "\"")) == null) ? "public" : "public").append(" ").toString());
        print(new StringBuffer("class ").append(this.grammar.getClassName()).append(" extends ").append(stringBuffer).toString());
        println(new StringBuffer("       implements ").append(this.grammar.tokenManager.getName()).append(CodeGenerator.TokenTypesFileSuffix).toString());
        Token token2 = (Token) this.grammar.options.get("classHeaderSuffix");
        if (token2 != null && (stripFrontBack = StringUtils.stripFrontBack(token2.getText(), "\"", "\"")) != null) {
            print(new StringBuffer(", ").append(stripFrontBack).toString());
        }
        ...
        print(processActionForSpecialSymbols(this.grammar.classMemberAction.getText(), this.grammar.classMemberAction.getLine(), this.currentRule, null));
        println("");
        println(new StringBuffer("protected ").append(this.grammar.getClassName()).append("(TokenBuffer tokenBuf, int k) {").toString());
        ...
        println("}");
        println("");
        println(new StringBuffer("public ").append(this.grammar.getClassName()).append("(TokenBuffer tokenBuf) {").toString());
        println(new StringBuffer("  this(tokenBuf,").append(this.grammar.maxk).append(");").toString());
        println("}");
        println("");
        println(new StringBuffer("protected ").append(this.grammar.getClassName()).append("(TokenStream lexer, int k) {").toString());
        ...
        println("}");
        println("");
        println(new StringBuffer("public ").append(this.grammar.getClassName()).append("(TokenStream lexer) {").toString());
        println(new StringBuffer("  this(lexer,").append(this.grammar.maxk).append(");").toString());
        println("}");
        println("");
        println(new StringBuffer("public ").append(this.grammar.getClassName()).append("(ParserSharedInputState state) {").toString());
        println(new StringBuffer("  super(state,").append(this.grammar.maxk).append(");").toString());
        println("  tokenNames = _tokenNames;");
        if (this.grammar.buildAST) {
            println("  buildTokenTypeASTClassMap();");
            println("  astFactory = new ASTFactory(getTokenTypeToASTClassMap());");
    ...
    */
    ...
    public void gen(TreeElement treeElement) {
        ...
        if (treeElement.root.getLabel() != null) {
            println(new StringBuffer().append(treeElement.root.getLabel()).append(" = _t==ASTNULL ? null :(").append(this.labeledElementASTType).append(")_t;").toString());
        }
    ...
    */
    ...
    protected void genAlt(Alternative alternative, AlternativeBlock alternativeBlock) {
        ...
        if (this.genAST) {
            if (alternativeBlock instanceof RuleBlock) {
                ...
                println(new StringBuffer().append(((RuleBlock) alternativeBlock).getRuleName()).append("_AST = (").append(this.labeledElementASTType).append(")currentAST.root;").toString());
    ...
    private void genBitSet(BitSet bitSet, int i) {
        println(new StringBuffer("private static final long[] mk").append(getBitsetName(i)).append("() {").toString());
        ...
        if (lengthInLongWords < 8) {
            ...
            while (i2 < packedArray.length) {
                long j = packedArray[i2];
                if (j == 0) {
                    i2++;
                } else {
                    int i3 = i2 + 1;
                    if (i3 == packedArray.length || j != packedArray[i3]) {
        ...
        println("\treturn data;");
        println("}");
        println(new StringBuffer("public static final BitSet ").append(getBitsetName(i)).append(" = new BitSet(mk").append(getBitsetName(i)).append("());").toString());
    }
    ...
    public JavaBlockFinishingInfo genCommonBlock(AlternativeBlock alternativeBlock, boolean z) {
        ...
        if (alternativeBlock.not && this.analyzer.subruleCanBeInverted(alternativeBlock, this.grammar instanceof LexerGrammar)) {
            ...
            println(new StringBuffer("match(").append(this.grammar instanceof TreeWalkerGrammar ? "_t," : "").append(getBitsetName(markBitsetForGen(look.fset))).append(");").toString());
            if (this.grammar instanceof TreeWalkerGrammar) {
                println("_t = _t.getNextSibling();");
            }
        ...
        if (z2) {
            this.tabs -= z7 ? 1 : 0;
            javaBlockFinishingInfo2.postscript = new StringBuffer().append(str).append("}").toString();
            javaBlockFinishingInfo2.generatedSwitch = z7;
            if (i9 <= 0) {
                z7 = false;
            }
            javaBlockFinishingInfo2.generatedAnIf = z7;
        } else {
    ...
    private void genErrorHandler(ExceptionSpec exceptionSpec) {
        for (int i = 0; i < exceptionSpec.handlers.size(); i++) {
            ...
            if (this.grammar.hasSyntacticPredicate) {
                ...
                println("} else {");
                this.tabs++;
                println(new StringBuffer("throw ").append(extractIdOfAction(exceptionHandler.exceptionTypeAndName)).append(";").toString());
                this.tabs--;
                println("}");
            }
            this.tabs--;
    ...
    protected void genHeader() {
        println(new StringBuffer("// $ANTLR ").append(Tool.version).append(": \"").append(this.antlrTool.fileMinusPath(this.antlrTool.grammarFile)).append("\" -> \"").append(this.grammar.getClassName()).append(".java\"$").toString());
    }
    ...
    public void genNextToken() {
        ...
        for (int i = 0; i < this.grammar.rules.size(); i++) {
            ...
            if (ruleSymbol.isDefined() && ruleSymbol.access.equals("public")) {
                ...
                String stringBuffer2 = new StringBuffer("if (LA(1)==EOF_CHAR) {uponEOF(); _returnToken = makeToken(Token.EOF_TYPE);}").append(property).append("\t\t\t\t").toString();
                if (!((LexerGrammar) this.grammar).filterMode) {
                    stringBuffer = new StringBuffer().append(stringBuffer2).append("else {").append(this.throwNoViable).append("}").toString();
                } else if (str == null) {
                    stringBuffer = new StringBuffer().append(stringBuffer2).append("else {consume(); continue tryAgain;}").toString();
                } else {
                    stringBuffer = new StringBuffer().append(stringBuffer2).append("else {").append(property).append("\t\t\t\t\tcommit();").append(property).append("\t\t\t\t\ttry {m").append(str).append("(false);}").append(property).append("\t\t\t\t\tcatch(RecognitionException e) {").append(property).append("\t\t\t\t\t\t// catastrophic failure").append(property).append("\t\t\t\t\t\treportError(e);").append(property).append("\t\t\t\t\t\tconsume();").append(property).append("\t\t\t\t\t}").append(property).append("\t\t\t\t\tcontinue tryAgain;").append(property).append("\t\t\t\t}").toString();
                }
        ...
        if (this.grammar.debuggingOutput || this.grammar.traceRules) {
            ...
            if (this.grammar.traceRules) {
                if (this.grammar instanceof TreeWalkerGrammar) {
                    ...
                    println(new StringBuffer("traceOut(\"").append(ruleSymbol.getId()).append("\");").toString());
                }
            }
            i3 = 1;
            this.tabs--;
    ...
    protected void genSynPred(SynPredBlock synPredBlock, String str) {
        ...
        println(new StringBuffer("boolean synPredMatched").append(synPredBlock.ID).append(" = false;").toString());
    ...
    protected void genTokenASTNodeMap() {
        ...
        for (int i2 = 0; i2 < vocabulary.size(); i2++) {
            ...
            if (str != null && (tokenSymbol = this.grammar.tokenManager.getTokenSymbol(str)) != null && tokenSymbol.getASTNodeType() != null) {
                ...
                println(new StringBuffer("tokenTypeToASTClassMap.put(new Integer(").append(str).append("), ").append(tokenSymbol.getASTNodeType()).append(".class);").toString());
            }
        }
        if (i == 0) {
    ...
    protected void genTokenTypes(TokenManager tokenManager) throws IOException {
        ...
        genHeader();
        println(this.behavior.getHeaderAction(""));
        println(new StringBuffer("public interface ").append(tokenManager.getName()).append(CodeGenerator.TokenTypesFileSuffix).append(" {").toString());
        this.tabs++;
            ...
            if (str != null) {
                if (str.startsWith("\"")) {
                    ...
                    if (stringLiteralSymbol == null) {
                        ...
                        println(new StringBuffer("int ").append(stringLiteralSymbol.label).append(" = ").append(i).append(";").toString());
                    } else {
                        String mangleLiteral = mangleLiteral(str);
                        if (mangleLiteral != null) {
                            println(new StringBuffer("int ").append(mangleLiteral).append(" = ").append(i).append(";").toString());
                    ...
                    println(new StringBuffer("int ").append(str).append(" = ").append(i).append(";").toString());
                }
            }
        }
        this.tabs--;
    ...
    public String getASTCreateString(String str) {
        ...
        if (i >= 2) {
            return new StringBuffer("(").append(this.labeledElementASTType).append(")astFactory.create(").append(str).append(")").toString();
        }
        ...
        if (tokenSymbol != null) {
            ...
            if (aSTNodeType != null) {
                return new StringBuffer("(").append(aSTNodeType).append(")astFactory.create(").append(str).append(str2).append(",\"").append(aSTNodeType).append("\")").toString();
            }
        }
        return this.labeledElementASTType.equals("AST") ? new StringBuffer("astFactory.create(").append(str).append(")").toString() : new StringBuffer("(").append(this.labeledElementASTType).append(")astFactory.create(").append(str).append(")").toString();
    }
    ...
    */
    ...
    public void setupOutput(String str) throws IOException {
        this.currentOutput = this.antlrTool.openOutputFile(new StringBuffer().append(str).append(".java").toString());
    }
}
