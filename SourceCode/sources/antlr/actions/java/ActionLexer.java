...
public class ActionLexer extends CharScanner implements ActionLexerTokenTypes, TokenStream {
    ...
    protected final void mTEXT_ITEM(boolean z) throws RecognitionException, CharStreamException, TokenStreamException {
        ...
        if (LA(1) == '$' && LA(2) == 'F' && LA(3) == 'O') {
            ...
            match(')');
            String stringBuffer = new StringBuffer("text.append(").append(token4.getText()).append(")").toString();
            this.text.setLength(length);
            this.text.append(stringBuffer);
        } else if (LA(1) == '$' && LA(2) == 's') {
            match("$set");
            if (LA(1) == 'T' && LA(2) == 'e') {
                ...
                match(')');
                String stringBuffer2 = new StringBuffer("text.setLength(_begin); text.append(").append(token5.getText()).append(")").toString();
                this.text.setLength(length);
                ...
                match(')');
                String stringBuffer3 = new StringBuffer("_token = ").append(token6.getText()).toString();
                this.text.setLength(length);
                ...
                match(')');
                String stringBuffer4 = new StringBuffer("_ttype = ").append(token7.getText()).toString();
                this.text.setLength(length);
    ...
    protected final void mAST_CONSTRUCTOR(boolean z) throws RecognitionException, CharStreamException, TokenStreamException {
        ...
        if (LA(1) == ',' && _tokenSet_10.member(LA(2)) && LA(3) >= 3 && LA(3) <= 255) {
            int length6 = this.text.length();
            match(',');
            this.text.setLength(length6);
            char LA3 = LA(1);
        ...
        String text = token4.getText();
        if (token != null) {
            text = new StringBuffer().append(text).append(",").append(token.getText()).toString();
        }
        if (token2 != null) {
            text = new StringBuffer().append(text).append(",").append(token2.getText()).toString();
        }
        this.text.setLength(length);
    ...
    */
    protected final void mTEXT_ARG(boolean r9) throws antlr.RecognitionException, antlr.CharStreamException, antlr.TokenStreamException {
        ...
        L52:
            r2 = r4
        L53:
            antlr.collections.impl.BitSet r3 = antlr.actions.java.ActionLexer._tokenSet_11
            char r6 = r8.LA(r1)
            ...
            antlr.collections.impl.BitSet r6 = antlr.actions.java.ActionLexer._tokenSet_4
            char r7 = r8.LA(r1)
            boolean r6 = r6.member(r7)
            if (r6 == 0) goto L8e
            antlr.collections.impl.BitSet r6 = antlr.actions.java.ActionLexer._tokenSet_12
            char r3 = r8.LA(r3)
            ...
            goto L9a
        L8e:
            antlr.collections.impl.BitSet r3 = antlr.actions.java.ActionLexer._tokenSet_12
            char r6 = r8.LA(r1)
            boolean r3 = r3.member(r6)
            if (r3 == 0) goto L9d
        L9a:
        ...
        Ld5:
            ...
            throw r9
        */
        throw new UnsupportedOperationException("Method not decompiled: antlr.actions.java.ActionLexer.mTEXT_ARG(boolean):void");
    }
    ...
    */
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    protected final void mARG(boolean r17) throws antlr.RecognitionException, antlr.CharStreamException, antlr.TokenStreamException {
        /*
            Method dump skipped, instructions count: 544
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: antlr.actions.java.ActionLexer.mARG(boolean):void");
    }
    ...
    protected final void mTEXT_ARG_ID_ELEMENT(boolean z) throws RecognitionException, CharStreamException, TokenStreamException {
        ...
        if (bitSet.member(LA(1)) && _tokenSet_21.member(LA(2))) {
            int length2 = this.text.length();
            mWS(false);
            this.text.setLength(length2);
        ...
        if (LA != '\t' && LA != '\n' && LA != '\r' && LA != ' ' && LA != '\"' && LA != '$') {
            if (LA == '.') {
                ...
                switch (LA) {
                    ...
                    case '(':
                        match('(');
                        if (bitSet.member(LA(1)) && _tokenSet_22.member(LA(2)) && LA(3) >= 3 && LA(3) <= 255) {
                            int length3 = this.text.length();
                            mWS(false);
                            this.text.setLength(length3);
    ...
    /* JADX WARN: Code restructure failed: missing block: B:14:0x0040, code lost:
        if (antlr.actions.java.ActionLexer._tokenSet_25.member(LA(2)) == false) goto L22;
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:19:0x0058, code lost:
        if (antlr.actions.java.ActionLexer._tokenSet_25.member(LA(2)) == false) goto L27;
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:29:0x007f, code lost:
        if (antlr.actions.java.ActionLexer._tokenSet_25.member(LA(2)) == false) goto L37;
     */
    /* JADX WARN: Code restructure failed: missing block: B:30:0x0081, code lost:
        mDIGIT(false);
     */
    /* JADX WARN: Code restructure failed: missing block: B:32:0x008f, code lost:
        if (antlr.actions.java.ActionLexer._tokenSet_25.member(LA(1)) == false) goto L42;
     */
    ...
    */
    protected final void mINT_OR_FLOAT(boolean r10) throws antlr.RecognitionException, antlr.CharStreamException, antlr.TokenStreamException {
        ...
        L8:
            ...
            char r4 = r9.LA(r3)
            if (r4 > r5) goto L2c
            antlr.collections.impl.BitSet r4 = antlr.actions.java.ActionLexer._tokenSet_24
            char r8 = r9.LA(r7)
        ...
        L2c:
            ...
            r4 = 76
            if (r2 != r4) goto L46
            antlr.collections.impl.BitSet r2 = antlr.actions.java.ActionLexer._tokenSet_25
            char r8 = r9.LA(r7)
        ...
        L69:
            ...
            goto L69
        L85:
            antlr.collections.impl.BitSet r1 = antlr.actions.java.ActionLexer._tokenSet_25
            char r2 = r9.LA(r3)
        ...
        Lc9:
            ...
            throw r10
        */
        throw new UnsupportedOperationException("Method not decompiled: antlr.actions.java.ActionLexer.mINT_OR_FLOAT(boolean):void");
    }
