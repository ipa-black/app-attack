...
public class NetworkConfigFactory {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static NetworkConfig create(Context context, AdNetwork adNetwork) {
    ...
    public static NetworkConfig create(Context context, JSONObject jSONObject) {
        ...
        try {
            ...
            try {
                ...
                Logger.log(String.format("Load network from json config completed successfully: %s", create.getNetworkKey()));
                return create;
            } catch (Throwable th) {
                th = th;
