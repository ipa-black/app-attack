...
class AdColonyAdapter extends HeaderBiddingAdapter {
    ...
    protected void onNetworkInitialize(ContextProvider contextProvider, InitializationParams initializationParams, NetworkConfigParams networkConfigParams, NetworkInitializationCallback networkInitializationCallback) throws Throwable {
        ...
        if (TextUtils.isEmpty(str2)) {
            networkInitializationCallback.onFail(String.format("%s not provided", AppLovinEventParameters.IN_APP_PURCHASE_TRANSACTION_IDENTIFIER));
            return;
        }
    ...
    protected void onCollectHeaderBiddingParams(ContextProvider contextProvider, UnifiedAdRequestParams unifiedAdRequestParams, NetworkAdUnit networkAdUnit, HeaderBiddingAdRequestParams headerBiddingAdRequestParams, final HeaderBiddingCollectParamsCallback headerBiddingCollectParamsCallback) throws Throwable {
        ...
        synchronized (AdColonyAdapter.class) {
            ...
            AdColony.collectSignals(new AdColonySignalsListener() { // from class: io.bidmachine.ads.networks.adcolony.AdColonyAdapter.1
