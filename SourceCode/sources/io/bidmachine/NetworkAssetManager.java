...
class NetworkAssetManager {
    ...
    public static Map<String, NetworkAssetParams> getNetworkAssetParamsMap(Context context) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static NetworkAssetParams getNetworkAssetParams(Context context, String str) {
        Map<String, NetworkAssetParams> map = networkAssetParamsMap;
