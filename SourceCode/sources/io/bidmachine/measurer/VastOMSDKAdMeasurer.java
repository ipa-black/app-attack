...
public class VastOMSDKAdMeasurer extends OMSDKAdMeasurer<View> implements VastAdMeasurer, VastPlaybackListener {
    ...
    public void addVerificationScriptResource(String str, String str2, String str3) {
        ...
        try {
            ...
            this.resourceList.add(createVerificationScriptResourceWithoutParameters);
        } catch (Throwable th) {
            Logger.log(th);
        }
    }
            ...
            public void run() {
                try {
                    if (VastOMSDKAdMeasurer.this.mediaEvents != null) {
                        VastOMSDKAdMeasurer.this.mediaEvents.adUserInteraction(InteractionType.CLICK);
                    }
    ...
    protected void onAdLoaded(AdEvents adEvents) throws Throwable {
        ...
        if (f2 == -1.0f) {
            createVastPropertiesForSkippableMedia = VastProperties.createVastPropertiesForNonSkippableMedia(true, Position.STANDALONE);
        } else {
            createVastPropertiesForSkippableMedia = VastProperties.createVastPropertiesForSkippableMedia(f2, true, Position.STANDALONE);
        }
    ...
    public void onVideoStarted(final float f2, final float f3) {
        Utils.onUiThread(new Runnable() { // from class: io.bidmachine.measurer.VastOMSDKAdMeasurer.4
            @Override // java.lang.Runnable
            public void run() {
                try {
                    if (VastOMSDKAdMeasurer.this.mediaEvents != null) {
                        VastOMSDKAdMeasurer.this.mediaEvents.start(f2, f3);
                    }
    ...
    public void onVideoFirstQuartile() {
        Utils.onUiThread(new Runnable() { // from class: io.bidmachine.measurer.VastOMSDKAdMeasurer.5
            @Override // java.lang.Runnable
            public void run() {
                try {
                    if (VastOMSDKAdMeasurer.this.mediaEvents != null) {
                        VastOMSDKAdMeasurer.this.mediaEvents.firstQuartile();
                    }
    ...
    public void onVideoMidpoint() {
        Utils.onUiThread(new Runnable() { // from class: io.bidmachine.measurer.VastOMSDKAdMeasurer.6
            @Override // java.lang.Runnable
            public void run() {
                try {
                    if (VastOMSDKAdMeasurer.this.mediaEvents != null) {
                        VastOMSDKAdMeasurer.this.mediaEvents.midpoint();
                    }
    ...
    public void onVideoThirdQuartile() {
        Utils.onUiThread(new Runnable() { // from class: io.bidmachine.measurer.VastOMSDKAdMeasurer.7
            @Override // java.lang.Runnable
            public void run() {
                try {
                    if (VastOMSDKAdMeasurer.this.mediaEvents != null) {
                        VastOMSDKAdMeasurer.this.mediaEvents.thirdQuartile();
                    }
    ...
    public void onVideoCompleted() {
        Utils.onUiThread(new Runnable() { // from class: io.bidmachine.measurer.VastOMSDKAdMeasurer.8
            @Override // java.lang.Runnable
            public void run() {
                try {
                    if (VastOMSDKAdMeasurer.this.mediaEvents != null) {
                        VastOMSDKAdMeasurer.this.mediaEvents.complete();
                    }
    ...
    public void onVideoPaused() {
        Utils.onUiThread(new Runnable() { // from class: io.bidmachine.measurer.VastOMSDKAdMeasurer.9
            @Override // java.lang.Runnable
            public void run() {
                try {
                    if (VastOMSDKAdMeasurer.this.mediaEvents != null) {
                        VastOMSDKAdMeasurer.this.mediaEvents.pause();
                    }
    ...
    public void onVideoResumed() {
        Utils.onUiThread(new Runnable() { // from class: io.bidmachine.measurer.VastOMSDKAdMeasurer.10
            @Override // java.lang.Runnable
            public void run() {
                try {
                    if (VastOMSDKAdMeasurer.this.mediaEvents != null) {
                        VastOMSDKAdMeasurer.this.mediaEvents.resume();
                    }
    ...
    @Override // com.explorestack.iab.vast.VastPlaybackListener
    public void onVideoVolumeChanged(final float f2) {
        Utils.onUiThread(new Runnable() { // from class: io.bidmachine.measurer.VastOMSDKAdMeasurer.11
            @Override // java.lang.Runnable
            public void run() {
                try {
                    if (VastOMSDKAdMeasurer.this.mediaEvents != null) {
                        VastOMSDKAdMeasurer.this.mediaEvents.volumeChange(f2);
                    }
    ...
    public void onVideoSkipped() {
        Utils.onUiThread(new Runnable() { // from class: io.bidmachine.measurer.VastOMSDKAdMeasurer.12
            @Override // java.lang.Runnable
            public void run() {
                try {
                    if (VastOMSDKAdMeasurer.this.mediaEvents != null) {
                        VastOMSDKAdMeasurer.this.mediaEvents.skipped();
                    }
    ...
    @Override // io.bidmachine.measurer.OMSDKAdMeasurer
    public void destroy() {
        Utils.onUiThread(new Runnable() { // from class: io.bidmachine.measurer.VastOMSDKAdMeasurer.13
            @Override // java.lang.Runnable
            public void run() {
