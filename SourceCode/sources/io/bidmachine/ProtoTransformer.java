...
public class ProtoTransformer {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* loaded from: classes5.dex */
    public interface Listener<AdResponse> {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static void toAdResponse(AdRequestParameters adRequestParameters, List<NetworkAdUnit> list, Response response, Listener<AdResponse> listener) {
