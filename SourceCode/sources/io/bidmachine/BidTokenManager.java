...
class BidTokenManager {
    ...
    private static void sendSuccessEvent() {
        BidMachineEvents.eventFinish(new SimpleTrackingObject(), TrackEventType.GetBidToken, null, null);
    }

    private static void sendFailEvent() {
        BidMachineEvents.eventFinish(new SimpleTrackingObject(), TrackEventType.GetBidToken, null, BMError.notFound("BidToken"));
    }
}
