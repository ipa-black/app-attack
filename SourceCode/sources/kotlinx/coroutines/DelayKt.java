...
public final class DelayKt {
    ...
    */
    ...
    public static final Object delay(long j, Continuation<? super Unit> continuation) {
        ...
        if (j < Long.MAX_VALUE) {
            getDelay(cancellableContinuationImpl2.getContext()).mo2008scheduleResumeAfterDelay(j, cancellableContinuationImpl2);
        }
    ...
    public static final Object m1944delayVtjQ1oo(long j, Continuation<? super Unit> continuation) {
        Object delay = delay(m1945toDelayMillisLRDsOJo(j), continuation);
    ...
    public static final long m1945toDelayMillisLRDsOJo(long j) {
        if (Duration.m1807compareToLRDsOJo(j, Duration.Companion.m1910getZEROUwyO8pc()) > 0) {
            return RangesKt.coerceAtLeast(Duration.m1826getInWholeMillisecondsimpl(j), 1L);
        }
        return 0L;
    }
}
