...
public final /* synthetic */ class FlowKt__DelayKt {
    ...
    public static final <T> Flow<T> debounce(Flow<? extends T> flow, final long j) {
        ...
        if (i >= 0) {
            return i == 0 ? flow : debounceInternal$FlowKt__DelayKt(flow, new Function1<T, Long>() { // from class: kotlinx.coroutines.flow.FlowKt__DelayKt$debounce$2
    ...
    public static final <T> Flow<T> m1987debounceHG0u8IE(Flow<? extends T> flow, long j) {
        return FlowKt.debounce(flow, DelayKt.m1945toDelayMillisLRDsOJo(j));
    }
    ...
    public static final <T> Flow<T> debounceDuration(Flow<? extends T> flow, final Function1<? super T, Duration> function1) {
        return debounceInternal$FlowKt__DelayKt(flow, new Function1<T, Long>() { // from class: kotlinx.coroutines.flow.FlowKt__DelayKt$debounce$3
            ...
            @Override // kotlin.jvm.functions.Function1
            public final Long invoke(T t) {
                return Long.valueOf(DelayKt.m1945toDelayMillisLRDsOJo(function1.invoke(t).m1862unboximpl()));
            }
        });
    }
    ...
    public static final <T> Flow<T> m1988sampleHG0u8IE(Flow<? extends T> flow, long j) {
        return FlowKt.sample(flow, DelayKt.m1945toDelayMillisLRDsOJo(j));
    }
}
