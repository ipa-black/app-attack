    ...
    public final Object invokeSuspend(Object obj) {
        ...
        while (objectRef.element != NullSurrogateKt.DONE) {
            ...
            try {
                ...
                selectBuilderImpl2.invoke(receiveChannel.getOnReceiveCatching(), new FlowKt__DelayKt$sample$2$1$1(objectRef, receiveChannel2, null));
                selectBuilderImpl2.invoke(receiveChannel2.getOnReceive(), new FlowKt__DelayKt$sample$2$1$2(objectRef, flowCollector, null));
            } catch (Throwable th) {
