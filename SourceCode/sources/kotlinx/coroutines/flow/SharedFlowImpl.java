    ...
    */
    ...
    public boolean tryEmit(T t) {
        ...
        while (i < length) {
            ...
            if (continuation != null) {
                ...
                continuation.resumeWith(Result.m501constructorimpl(Unit.INSTANCE));
            }
        }
        return z;
    }
    ...
    public final Continuation<Unit>[] updateCollectorIndexLocked$kotlinx_coroutines_core(long j) {
        ...
        if (!DebugKt.getASSERTIONS_ENABLED() || j >= this.minCollectorIndex) {
            ...
            if (!DebugKt.getASSERTIONS_ENABLED() || j2 >= this.minCollectorIndex) {
                ...
                if (getNCollectors() > 0) {
                    i = Math.min(this.queueSize, this.bufferCapacity - ((int) (bufferEndIndex - j2)));
                } else {
                    i = this.queueSize;
                }
                Continuation<Unit>[] continuationArr = AbstractSharedFlowKt.EMPTY_RESUMES;
                ...
                updateBufferLocked(max, j9, bufferEndIndex, j4);
                cleanupTailLocked();
    ...
    public final Object emitSuspend(T t, Continuation<? super Unit> continuation) {
        ...
        synchronized (this) {
            if (tryEmitLocked(t)) {
                Result.Companion companion = Result.Companion;
                cancellableContinuationImpl2.resumeWith(Result.m501constructorimpl(Unit.INSTANCE));
        ...
        while (i < length) {
            ...
            if (continuation2 != null) {
                ...
                continuation2.resumeWith(Result.m501constructorimpl(Unit.INSTANCE));
            }
        }
