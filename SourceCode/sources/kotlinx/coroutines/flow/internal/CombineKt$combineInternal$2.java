...
final class CombineKt$combineInternal$2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    /* JADX WARN: Removed duplicated region for block: B:28:0x00d1 A[LOOP:0: B:28:0x00d1->B:35:0x00f5, LOOP_START, PHI: r6 r10 
      PHI: (r6v9 int) = (r6v8 int), (r6v10 int) binds: [B:25:0x00cc, B:35:0x00f5] A[DONT_GENERATE, DONT_INLINE]
      PHI: (r10v5 kotlin.collections.IndexedValue) = (r10v4 kotlin.collections.IndexedValue), (r10v18 kotlin.collections.IndexedValue) binds: [B:25:0x00cc, B:35:0x00f5] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:45:0x013d -> B:46:0x013f). Please submit an issue!!! */
    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    /*
    ...
    */
    ...
    public static final class AnonymousClass1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            try {
                if (i == 0) {
                    ...
                    this.label = 1;
                    if (this.$flows[this.$i].collect(new C03701(this.$resultChannel, this.$i), this) == coroutine_suspended) {
        ...
        /* loaded from: classes5.dex */
        public static final class C03701<T> implements FlowCollector, SuspendFunction {
            final /* synthetic */ int $i;
            final /* synthetic */ Channel<IndexedValue<Object>> $resultChannel;

            C03701(Channel<IndexedValue<Object>> channel, int i) {
                this.$resultChannel = channel;
                this.$i = i;
            }
            ...
            */
            public final java.lang.Object emit(T r7, kotlin.coroutines.Continuation<? super kotlin.Unit> r8) {
                ...
                L57:
                    ...
                    return r7
                */
                throw new UnsupportedOperationException("Method not decompiled: kotlinx.coroutines.flow.internal.CombineKt$combineInternal$2.AnonymousClass1.C03701.emit(java.lang.Object, kotlin.coroutines.Continuation):java.lang.Object");
            }
        }
    }
}
