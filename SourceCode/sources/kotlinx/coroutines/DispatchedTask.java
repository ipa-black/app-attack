        ...
        try {
            ...
            if (job != null && !job.isActive()) {
                ...
                if (DebugKt.getRECOVER_STACK_TRACES() && (continuation instanceof CoroutineStackFrame)) {
                    ...
                    continuation.resumeWith(Result.m501constructorimpl(ResultKt.createFailure(cancellationException)));
                }
                cancellationException = cancellationException2;
                continuation.resumeWith(Result.m501constructorimpl(ResultKt.createFailure(cancellationException)));
            } else if (exceptionalResult$kotlinx_coroutines_core != null) {
                Result.Companion companion2 = Result.Companion;
                continuation.resumeWith(Result.m501constructorimpl(ResultKt.createFailure(exceptionalResult$kotlinx_coroutines_core)));
            } else {
                T successfulResult$kotlinx_coroutines_core = getSuccessfulResult$kotlinx_coroutines_core(takeState$kotlinx_coroutines_core);
                Result.Companion companion3 = Result.Companion;
                continuation.resumeWith(Result.m501constructorimpl(successfulResult$kotlinx_coroutines_core));
            }
            ...
            try {
                ...
                m501constructorimpl2 = Result.m501constructorimpl(Unit.INSTANCE);
            } catch (Throwable th) {
                Result.Companion companion5 = Result.Companion;
                m501constructorimpl2 = Result.m501constructorimpl(ResultKt.createFailure(th));
            }
            handleFatalException(null, Result.m504exceptionOrNullimpl(m501constructorimpl2));
        } catch (Throwable th2) {
            try {
                ...
                m501constructorimpl = Result.m501constructorimpl(ResultKt.createFailure(th3));
            }
            handleFatalException(th2, Result.m504exceptionOrNullimpl(m501constructorimpl));
        }
    }
