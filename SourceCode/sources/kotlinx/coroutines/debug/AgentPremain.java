...
public final class AgentPremain {
    ...
    static {
        ...
        try {
            ...
            m501constructorimpl = Result.m501constructorimpl(property == null ? null : Boolean.valueOf(Boolean.parseBoolean(property)));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.Companion;
            m501constructorimpl = Result.m501constructorimpl(ResultKt.createFailure(th));
        }
        Boolean bool = Result.m507isFailureimpl(m501constructorimpl) ? null : m501constructorimpl;
        ...
        try {
            Signal.handle(new Signal("TRAP"), new SignalHandler() { // from class: kotlinx.coroutines.debug.AgentPremain$$ExternalSyntheticLambda0
                public final void handle(Signal signal) {
                    AgentPremain.m1983installSignalHandler$lambda1(signal);
                }
            });
    ...
    public static final void m1983installSignalHandler$lambda1(Signal signal) {
