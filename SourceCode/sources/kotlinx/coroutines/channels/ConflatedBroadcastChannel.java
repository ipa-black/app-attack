...
public final class ConflatedBroadcastChannel<E> implements BroadcastChannel<E> {
    ...
    private final Subscriber<E>[] addSubscriber(Subscriber<E>[] subscriberArr, Subscriber<E> subscriber) {
        return subscriberArr == null ? new Subscriber[]{subscriber} : (Subscriber[]) ArraysKt.plus(subscriberArr, subscriber);
    }
    ...
    public Object mo1960trySendJP2dKIU(E e2) {
        Closed offerInternal = offerInternal(e2);
        if (offerInternal != null) {
            return ChannelResult.Companion.m1978closedJP2dKIU(offerInternal.getSendException());
        }
    ...
    private final Closed offerInternal(E e2) {
        ...
        if (_updating$FU.compareAndSet(this, 0, 1)) {
            ...
            } while (!AbstractResolvableFuture$SafeAtomicHelper$$ExternalSyntheticBackportWithForwarding0.m(_state$FU, this, obj, new State(e2, ((State) obj).subscribers)));
