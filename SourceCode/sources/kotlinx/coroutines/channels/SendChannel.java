...
public interface SendChannel<E> {
    ...
    Object mo1960trySendJP2dKIU(E e2);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e2) {
            ...
            if (ChannelResult.m1975isSuccessimpl(mo1960trySendJP2dKIU)) {
                return true;
            }
            Throwable m1969exceptionOrNullimpl = ChannelResult.m1969exceptionOrNullimpl(mo1960trySendJP2dKIU);
