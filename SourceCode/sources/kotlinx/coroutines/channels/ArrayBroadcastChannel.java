    ...
    public Object offerInternal(E e2) {
        ...
        try {
            ...
            if (closedForSend == null) {
                ...
                long tail = getTail();
                this.buffer[(int) (tail % getCapacity())] = e2;
                setSize(size + 1);
                setTail(tail + 1);
    ...
    */
    private final void updateHead(kotlinx.coroutines.channels.ArrayBroadcastChannel.Subscriber<E> r13, kotlinx.coroutines.channels.ArrayBroadcastChannel.Subscriber<E> r14) {
        ...
        L57:
            ...
            int r7 = r12.getCapacity()     // Catch: java.lang.Throwable -> L21
            long r7 = (long) r7     // Catch: java.lang.Throwable -> L21
            long r7 = r3 % r7
            int r7 = (int) r7     // Catch: java.lang.Throwable -> L21
            r8 = 0
            r6[r7] = r8     // Catch: java.lang.Throwable -> L21
            int r6 = r12.getCapacity()     // Catch: java.lang.Throwable -> L21
            if (r5 < r6) goto L70
            r6 = 1
            goto L71
        L70:
        ...
        L71:
            ...
            int r7 = r5 + (-1)
            r12.setSize(r7)     // Catch: java.lang.Throwable -> L21
            if (r6 == 0) goto Lc7
        L7e:
        ...
        L85:
            ...
            goto Lc7
        L8a:
            kotlinx.coroutines.internal.Symbol r11 = r6.tryResumeSend(r8)     // Catch: java.lang.Throwable -> L21
            if (r11 == 0) goto L7e
        ...
        La1:
            ...
            int r14 = r12.getCapacity()     // Catch: java.lang.Throwable -> L21
