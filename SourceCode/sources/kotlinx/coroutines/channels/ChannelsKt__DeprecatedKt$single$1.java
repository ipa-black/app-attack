...
@DebugMetadata(c = "kotlinx.coroutines.channels.ChannelsKt__DeprecatedKt", f = "Deprecated.kt", i = {0, 0, 1, 1}, l = {136, 139}, m = AdColonyUserMetadata.USER_SINGLE, n = {"$this$consume$iv", "iterator", "$this$consume$iv", AdColonyUserMetadata.USER_SINGLE}, s = {"L$0", "L$1", "L$0", "L$1"})
