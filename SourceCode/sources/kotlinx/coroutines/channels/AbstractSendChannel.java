...
public abstract class AbstractSendChannel<E> implements SendChannel<E> {
    ...
    */
    ...
    public final Object send(E e2, Continuation<? super Unit> continuation) {
        Object sendSuspend;
        return (offerInternal(e2) != AbstractChannelKt.OFFER_SUCCESS && (sendSuspend = sendSuspend(e2, continuation)) == IntrinsicsKt.getCOROUTINE_SUSPENDED()) ? sendSuspend : Unit.INSTANCE;
    }
    ...
    public final Object mo1960trySendJP2dKIU(E e2) {
        Object offerInternal = offerInternal(e2);
        if (offerInternal == AbstractChannelKt.OFFER_SUCCESS) {
            return ChannelResult.Companion.m1980successJP2dKIU(Unit.INSTANCE);
        }
        if (offerInternal == AbstractChannelKt.OFFER_FAILED) {
            Closed<?> closedForSend = getClosedForSend();
            return closedForSend == null ? ChannelResult.Companion.m1979failurePtdJZtk() : ChannelResult.Companion.m1978closedJP2dKIU(helpCloseAndGetSendException(closedForSend));
        } else if (offerInternal instanceof Closed) {
            return ChannelResult.Companion.m1978closedJP2dKIU(helpCloseAndGetSendException((Closed) offerInternal));
        } else {
    ...
    public final void helpCloseAndResumeWithSendException(Continuation<?> continuation, E e2, Closed<?> closed) {
        ...
        if (function1 != null && (callUndeliveredElementCatchingException$default = OnUndeliveredElementKt.callUndeliveredElementCatchingException$default(function1, e2, null, 2, null)) != null) {
            ...
            continuation.resumeWith(Result.m501constructorimpl(ResultKt.createFailure(undeliveredElementException)));
            return;
        }
        Result.Companion companion2 = Result.Companion;
        continuation.resumeWith(Result.m501constructorimpl(ResultKt.createFailure(sendException)));
    }
    ...
    public Object enqueueSend(Send send) {
        ...
        do {
            ...
            tryCondAddNext = prevNode2.tryCondAddNext(send2, lockFreeLinkedListHead2, condAddOp);
            if (tryCondAddNext == 1) {
                return null;
            }
    ...
    private final void helpClose(Closed<?> closed) {
        ...
        while (true) {
            ...
            if (receive == null) {
                break;
            } else if (!receive.mo2006remove()) {
                receive.helpRemove();
            } else {
                m1998constructorimpl$default = InlineList.m2003plusFjFbRPM(m1998constructorimpl$default, receive);
            }
        }
        if (m1998constructorimpl$default != null) {
            if (!(m1998constructorimpl$default instanceof ArrayList)) {
                ((Receive) m1998constructorimpl$default).resumeReceiveClosed(closed);
            } else if (m1998constructorimpl$default != null) {
                ArrayList arrayList = (ArrayList) m1998constructorimpl$default;
    ...
    */
    ...
    public final SelectClause2<E, SendChannel<E>> getOnSend() {
        return (SelectClause2) ((SelectClause2<E, SendChannel<? super E>>) new SelectClause2<E, SendChannel<? super E>>(this) { // from class: kotlinx.coroutines.channels.AbstractSendChannel$onSend$1
            ...
            public <R> void registerSelectClause2(SelectInstance<? super R> selectInstance, E e2, Function2<? super SendChannel<? super E>, ? super Continuation<? super R>, ? extends Object> function2) {
                this.this$0.registerSelectSend(selectInstance, e2, function2);
            }
        });
    }
        ...
        while (!selectInstance.isSelected()) {
            if (isFullImpl()) {
                ...
                if (enqueueSend == null) {
                    ...
                    throw StackTraceRecoveryKt.recoverStackTrace(helpCloseAndGetSendException(e2, (Closed) enqueueSend));
                } else {
            ...
            if (offerSelectInternal != AbstractChannelKt.OFFER_FAILED && offerSelectInternal != AtomicKt.RETRY_ATOMIC) {
                if (offerSelectInternal == AbstractChannelKt.OFFER_SUCCESS) {
                    ...
                    throw StackTraceRecoveryKt.recoverStackTrace(helpCloseAndGetSendException(e2, (Closed) offerSelectInternal));
                }
            }
        }
    }
    ...
    public static final class SendSelect<E, R> extends Send implements DisposableHandle {
        ...
        /* JADX WARN: Multi-variable type inference failed */
        public SendSelect(E e2, AbstractSendChannel<E> abstractSendChannel, SelectInstance<? super R> selectInstance, Function2<? super SendChannel<? super E>, ? super Continuation<? super R>, ? extends Object> function2) {
            this.pollResult = e2;
        ...
        while (true) {
            if (isFullImpl()) {
                if (this.onUndeliveredElement == null) {
                    sendElementWithUndeliveredHandler = new SendElement(e2, cancellableContinuationImpl);
                } else {
                    sendElementWithUndeliveredHandler = new SendElementWithUndeliveredHandler(e2, cancellableContinuationImpl, this.onUndeliveredElement);
                }
                ...
                if (enqueueSend == null) {
                    ...
                    helpCloseAndResumeWithSendException(cancellableContinuationImpl, e2, (Closed) enqueueSend);
                    break;
            ...
            if (offerInternal == AbstractChannelKt.OFFER_SUCCESS) {
                Result.Companion companion = Result.Companion;
                cancellableContinuationImpl.resumeWith(Result.m501constructorimpl(Unit.INSTANCE));
                break;
            } else if (offerInternal != AbstractChannelKt.OFFER_FAILED) {
                if (offerInternal instanceof Closed) {
                    helpCloseAndResumeWithSendException(cancellableContinuationImpl, e2, (Closed) offerInternal);
                } else {
