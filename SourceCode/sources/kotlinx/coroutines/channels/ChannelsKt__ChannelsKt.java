...
final /* synthetic */ class ChannelsKt__ChannelsKt {
    ...
    public static final <E> Object trySendBlocking(SendChannel<? super E> sendChannel, E e2) {
        ...
        Object mo1960trySendJP2dKIU = sendChannel.mo1960trySendJP2dKIU(e2);
        if (mo1960trySendJP2dKIU instanceof ChannelResult.Failed) {
            ...
            return ((ChannelResult) runBlocking$default).m1977unboximpl();
        }
        Unit unit = (Unit) mo1960trySendJP2dKIU;
    ...
    public static final <E> void sendBlocking(SendChannel<? super E> sendChannel, E e2) {
        if (ChannelResult.m1975isSuccessimpl(sendChannel.mo1960trySendJP2dKIU(e2))) {
            return;
        }
