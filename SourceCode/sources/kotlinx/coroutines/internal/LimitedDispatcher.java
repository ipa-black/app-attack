...
public final class LimitedDispatcher extends CoroutineDispatcher implements Runnable, Delay {
    ...
    public void mo2008scheduleResumeAfterDelay(long j, CancellableContinuation<? super Unit> cancellableContinuation) {
        this.$$delegate_0.mo2008scheduleResumeAfterDelay(j, cancellableContinuation);
    }
    ...
    */
    public void run() {
        ...
        L18:
            ...
            r0.mo2007dispatch(r3, r1)
            return
        L32:
            r1 = r4
            java.lang.Object r1 = (java.lang.Object) r1
            monitor-enter(r1)
            int r2 = r4.runningWorkers     // Catch: java.lang.Throwable -> L50
            int r2 = r2 + (-1)
            r4.runningWorkers = r2     // Catch: java.lang.Throwable -> L50
            kotlinx.coroutines.internal.LockFreeTaskQueue<java.lang.Runnable> r2 = r4.queue     // Catch: java.lang.Throwable -> L50
            int r2 = r2.getSize()     // Catch: java.lang.Throwable -> L50
            if (r2 != 0) goto L46
            monitor-exit(r1)
            return
        L46:
    ...
    public void mo2007dispatch(CoroutineContext coroutineContext, Runnable runnable) {
        if (!addAndTryDispatching(runnable) && tryAllocateWorker()) {
            this.dispatcher.mo2007dispatch(this, this);
        }
    }
