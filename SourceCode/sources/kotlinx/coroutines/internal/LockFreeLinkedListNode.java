...
public class LockFreeLinkedListNode {
    ...
    public final LockFreeLinkedListNode removeFirstOrNull() {
        while (true) {
            ...
            if (lockFreeLinkedListNode.mo2006remove()) {
                return lockFreeLinkedListNode;
            }
    ...
    public static final class PrepareOp extends OpDescriptor {
        ...
        public Object perform(Object obj) {
            Object consensus;
            Object obj2;
            if (!DebugKt.getASSERTIONS_ENABLED() || obj == this.affected) {
                if (obj != null) {
        ...
        */
        public final java.lang.Object prepare(kotlinx.coroutines.internal.AtomicOp<?> r7) {
            ...
            L3a:
                ...
                java.lang.Object r5 = kotlinx.coroutines.internal.LockFreeLinkedList_commonKt.REMOVE_PREPARED     // Catch: java.lang.Throwable -> L63
                if (r4 != r5) goto L53
                goto L0
            L53:
                boolean r7 = kotlinx.coroutines.DebugKt.getASSERTIONS_ENABLED()     // Catch: java.lang.Throwable -> L63
                if (r7 == 0) goto L62
                if (r4 != 0) goto L5c
                goto L62
            L5c:
    ...
    */
    ...
    public final void validateNode$kotlinx_coroutines_core(LockFreeLinkedListNode lockFreeLinkedListNode, LockFreeLinkedListNode lockFreeLinkedListNode2) {
        if (DebugKt.getASSERTIONS_ENABLED() && lockFreeLinkedListNode != this._prev) {
            throw new AssertionError();
        }
        if (DebugKt.getASSERTIONS_ENABLED() && lockFreeLinkedListNode2 != this._next) {
            throw new AssertionError();
        }
    }
