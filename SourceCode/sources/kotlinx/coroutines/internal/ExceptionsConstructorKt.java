...
public final class ExceptionsConstructorKt {
    ...
    public static final <E extends Throwable> E tryCopyException(E e2) {
        ...
        if (e2 instanceof CopyableThrowable) {
            try {
                ...
                m501constructorimpl = Result.m501constructorimpl(((CopyableThrowable) e2).createCopy());
            } catch (Throwable th) {
                    ...
                    return new Function1<Throwable, Throwable>() { // from class: kotlinx.coroutines.internal.ExceptionsConstructorKt$createSafeConstructor$$inlined$safeCtor$1
                        ...
                        public final Throwable invoke(Throwable th) {
                            ...
                            try {
                                ...
                                Result.Companion companion2 = Result.Companion;
                                m501constructorimpl = Result.m501constructorimpl(ResultKt.createFailure(th2));
                            }
                            if (newInstance != null) {
                                m501constructorimpl = Result.m501constructorimpl((Throwable) newInstance);
                                if (Result.m507isFailureimpl(m501constructorimpl)) {
                                    m501constructorimpl = null;
                                }
                                return (Throwable) m501constructorimpl;
                            }
                    ...
                    return new Function1<Throwable, Throwable>() { // from class: kotlinx.coroutines.internal.ExceptionsConstructorKt$createSafeConstructor$$inlined$safeCtor$3
                        ...
                        public final Throwable invoke(Throwable th) {
                            ...
                            if (newInstance != null) {
                                ...
                                th3.initCause(th);
                                m501constructorimpl = Result.m501constructorimpl(th3);
                                if (Result.m507isFailureimpl(m501constructorimpl)) {
                                    m501constructorimpl = null;
                                }
                                return (Throwable) m501constructorimpl;
    ...
    private static final Function1<Throwable, Throwable> safeCtor(final Function1<? super Throwable, ? extends Throwable> function1) {
        return new Function1<Throwable, Throwable>() { // from class: kotlinx.coroutines.internal.ExceptionsConstructorKt$safeCtor$1
            ...
            public final Throwable invoke(Throwable th) {
                ...
                try {
                    Result.Companion companion = Result.Companion;
                    m501constructorimpl = Result.m501constructorimpl(function12.invoke(th));
                } catch (Throwable th2) {
                    Result.Companion companion2 = Result.Companion;
                    m501constructorimpl = Result.m501constructorimpl(ResultKt.createFailure(th2));
                }
    ...
    private static final int fieldsCountOrDefault(Class<?> cls, int i) {
        Integer m501constructorimpl;
        JvmClassMappingKt.getKotlinClass(cls);
        try {
            Result.Companion companion = Result.Companion;
            m501constructorimpl = Result.m501constructorimpl(Integer.valueOf(fieldsCount$default(cls, 0, 1, null)));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.Companion;
            m501constructorimpl = Result.m501constructorimpl(ResultKt.createFailure(th));
        }
        ...
        if (Result.m507isFailureimpl(m501constructorimpl)) {
            m501constructorimpl = valueOf;
        }
        return ((Number) m501constructorimpl).intValue();
    }
