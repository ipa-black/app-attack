...
public final class Buffer implements BufferedSource, BufferedSink, Cloneable, ByteChannel {
    ...
    public long readLong() {
        ...
        int i2 = segment.limit;
        if (i2 - i < 8) {
            return ((readInt() & ArrayUnsignedIntList.MAX_VALUE) << 32) | (ArrayUnsignedIntList.MAX_VALUE & readInt());
        }
        byte[] bArr = segment.data;
        long j = ((bArr[i + 1] & 255) << 48) | ((bArr[i] & 255) << 56) | ((bArr[i + 2] & 255) << 40) | ((bArr[i + 3] & 255) << 32) | ((bArr[i + 4] & 255) << 24);
        int i3 = i + 7;
        int i4 = i + 8;
        long j2 = j | ((bArr[i + 5] & 255) << 16) | ((bArr[i + 6] & 255) << 8) | (bArr[i3] & 255);
        this.size -= 8;
        if (i4 == i2) {
            this.head = segment.pop();
            SegmentPool.recycle(segment);
    ...
    /* JADX WARN: Removed duplicated region for block: B:45:0x00a8 A[EDGE_INSN: B:45:0x00a8->B:38:0x00a8 ?: BREAK  , SYNTHETIC] */
    @Override // okio.BufferedSource
    /*
    ...
    */
    ...
    /* JADX WARN: Removed duplicated region for block: B:41:0x009e A[EDGE_INSN: B:41:0x009e->B:37:0x009e ?: BREAK  , SYNTHETIC] */
    @Override // okio.BufferedSource
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct add '--show-bad-code' argument
