...
class AnimationManager {
    ...
    public void startFlingAnimation(int i, int i2, int i3, int i4, int i5, int i6, int i7, int i8) {
        ...
        this.flingAnimation.setDuration(this.scroller.getDuration());
    ...
    /* loaded from: classes3.dex */
    class FlingAnimation implements ValueAnimator.AnimatorUpdateListener, Animator.AnimatorListener {
        @Override // android.animation.Animator.AnimatorListener
        public void onAnimationCancel(Animator animator) {
        }
