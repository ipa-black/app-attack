...
public class DtbAdRequestParamsBuilder {
    ...
    HashMap<String, Object> getCommonParams(Context context) {
        ...
        hashMap.put(MessengerIpcClient.KEY_PACKAGE, DtbPackageNativeData.getPackageNativeDataInstance(context).getParamsJson());
    ...
    HashMap<String, Object> getCustomAttributeParams(boolean z) {
        HashMap<String, Object> hashMap = new HashMap<>();
