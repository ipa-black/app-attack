...
public enum EnumC1399a1 {
    ...
    static final HashMap<Integer, EnumC1399a1> e0 = new HashMap<>();
    ...
    static {
        EnumC1399a1[] values = values();
        for (int i = 0; i < 54; i++) {
            EnumC1399a1 enumC1399a1 = values[i];
            e0.put(Integer.valueOf(enumC1399a1.f14386a), enumC1399a1);
        }
    }

    EnumC1399a1(int i, String str) {
        this.f14386a = i;
        this.f14387b = str;
    }
    ...
    public static EnumC1399a1 a(int i) {
        EnumC1399a1 enumC1399a1 = e0.get(Integer.valueOf(i));
        return enumC1399a1 == null ? EVENT_TYPE_UNDEFINED : enumC1399a1;
    }
}
