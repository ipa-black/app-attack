...
public class Uj implements Yj<List<Tj>> {
    ...
    private final Ij f14122a;

    /* renamed from: b  reason: collision with root package name */
    private final C2000yd f14123b;

    /* JADX INFO: Access modifiers changed from: package-private */
    public Uj(Ij ij, C2000yd c2000yd) {
        this.f14122a = ij;
        this.f14123b = c2000yd;
    }
    ...
    */
    private com.yandex.metrica.impl.ob.Tj a() {
        /*
            ...
            com.yandex.metrica.impl.ob.Ij r1 = r8.f14122a
        ...
        L2d:
            r1 = r3
        L2e:
            com.yandex.metrica.impl.ob.Ij r4 = r8.f14122a
        ...
        L81:
            ...
            com.yandex.metrica.impl.ob.Ij r5 = r8.f14122a
    ...
    public Object b() {
        ...
        if (this.f14122a.d()) {
            if (A2.a(23)) {
                if (this.f14123b.b(this.f14122a.e())) {
                    arrayList.addAll(Vj.a(this.f14122a.e()));
                }
                if (arrayList.size() == 0) {
                    arrayList.add(a());
                }
