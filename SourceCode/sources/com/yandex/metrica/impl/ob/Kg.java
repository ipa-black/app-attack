...
public class Kg {
    ...
    private final Map<String, String> f13371a;
    ...
    public Kg() {
        ...
        hashMap.put("diagnostics", com.ironsource.sdk.c.d.f11571a);
    ...
    public String a(String str) {
        return this.f13371a.containsKey(str) ? this.f13371a.get(str) : str;
    }
}
