...
public class FileCache implements Cache {
    ...
    public synchronized void append(byte[] bArr, int i) throws ProxyCacheException {
        try {
            ...
            throw new ProxyCacheException(String.format("Error writing %d bytes to %s from buffer with size %d", Integer.valueOf(i), this.dataFile, Integer.valueOf(bArr.length)), e2);
        }
    }
