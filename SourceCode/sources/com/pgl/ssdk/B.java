    ...
    */
    public static synchronized java.lang.String a(android.content.Context r11) {
        /*
            ...
            r2.<init>(r1)     // Catch: java.lang.Throwable -> Le3
            boolean r2 = r2.exists()     // Catch: java.lang.Throwable -> Le3
            if (r2 == 0) goto L51
            java.lang.String r2 = "chmod 777 "
            java.lang.String r3 = java.lang.String.valueOf(r1)     // Catch: java.lang.Throwable -> Le3
            java.lang.String r2 = r2.concat(r3)     // Catch: java.lang.Throwable -> Le3
            a(r2)     // Catch: java.lang.Throwable -> Le3
            java.lang.String r2 = a(r1)     // Catch: java.lang.Throwable -> Le3
            java.lang.String r3 = "chmod 600 "
            java.lang.String r4 = java.lang.String.valueOf(r1)     // Catch: java.lang.Throwable -> Le3
            java.lang.String r3 = r3.concat(r4)     // Catch: java.lang.Throwable -> Le3
            a(r3)     // Catch: java.lang.Throwable -> Le3
            if (r2 == 0) goto L51
            int r3 = r2.length()     // Catch: java.lang.Throwable -> Le3
            if (r3 <= 0) goto L51
            monitor-exit(r0)
            return r2
        L51:
            android.content.res.Resources r11 = r11.getResources()     // Catch: java.lang.Throwable -> Le3
            android.content.res.AssetManager r11 = r11.getAssets()     // Catch: java.lang.Throwable -> Le3
            java.lang.String r2 = "dic"
            java.io.InputStream r11 = r11.open(r2)     // Catch: java.lang.Throwable -> Le3
            java.io.ByteArrayOutputStream r2 = new java.io.ByteArrayOutputStream     // Catch: java.lang.Throwable -> Le3
            r2.<init>()     // Catch: java.lang.Throwable -> Le3
            r3 = 4096(0x1000, float:5.74E-42)
            byte[] r4 = new byte[r3]     // Catch: java.lang.Throwable -> Le3
        L68:
            r5 = 0
            int r6 = r11.read(r4, r5, r3)     // Catch: java.lang.Throwable -> Le3
            r7 = -1
            if (r6 == r7) goto L91
            java.lang.String r7 = "dic"
            java.lang.String r8 = "UTF-8"
            java.nio.charset.Charset r8 = java.nio.charset.Charset.forName(r8)     // Catch: java.lang.Throwable -> Le3
            byte[] r7 = r7.getBytes(r8)     // Catch: java.lang.Throwable -> Le3
            r8 = r5
        L7d:
            if (r8 >= r6) goto L8d
            r9 = r4[r8]     // Catch: java.lang.Throwable -> Le3
            int r10 = r7.length     // Catch: java.lang.Throwable -> Le3
            int r10 = r8 % r10
            r10 = r7[r10]     // Catch: java.lang.Throwable -> Le3
            r9 = r9 ^ r10
            byte r9 = (byte) r9     // Catch: java.lang.Throwable -> Le3
            r4[r8] = r9     // Catch: java.lang.Throwable -> Le3
            int r8 = r8 + 1
            goto L7d
        L8d:
            r2.write(r4, r5, r6)     // Catch: java.lang.Throwable -> Le3
            goto L68
        L91:
            java.io.FileOutputStream r11 = new java.io.FileOutputStream     // Catch: java.lang.Throwable -> Le3
            r11.<init>(r1)     // Catch: java.lang.Throwable -> Le3
            byte[] r2 = r2.toByteArray()     // Catch: java.lang.Throwable -> Le3
            r11.write(r2)     // Catch: java.lang.Throwable -> Le3
            ...
            java.lang.String r11 = r11.concat(r2)     // Catch: java.lang.Throwable -> Le3
            a(r11)     // Catch: java.lang.Throwable -> Le3
            java.lang.String r11 = a(r1)     // Catch: java.lang.Throwable -> Le3
            if (r11 == 0) goto Lb9
            int r2 = r11.length()     // Catch: java.lang.Throwable -> Le3
            if (r2 != 0) goto Ld5
        Lb9:
            java.io.RandomAccessFile r11 = new java.io.RandomAccessFile     // Catch: java.lang.Throwable -> Le3
            java.lang.String r2 = "rw"
            r11.<init>(r1, r2)     // Catch: java.lang.Throwable -> Le3
            r2 = 1
            byte[] r2 = new byte[r2]     // Catch: java.lang.Throwable -> Le3
            r3 = 2
            r2[r5] = r3     // Catch: java.lang.Throwable -> Le3
            r3 = 16
            r11.seek(r3)     // Catch: java.lang.Throwable -> Le3
            r11.write(r2)     // Catch: java.lang.Throwable -> Le3
            r11.close()     // Catch: java.lang.Throwable -> Le3
            java.lang.String r11 = a(r1)     // Catch: java.lang.Throwable -> Le3
        Ld5:
            java.lang.String r2 = "chmod 600 "
            java.lang.String r1 = java.lang.String.valueOf(r1)     // Catch: java.lang.Throwable -> Le3
            java.lang.String r1 = r2.concat(r1)     // Catch: java.lang.Throwable -> Le3
            a(r1)     // Catch: java.lang.Throwable -> Le3
            goto Le5
        Le3:
            java.lang.String r11 = "0[<!>]EXCEPTION[<!>]"
        Le5:
            if (r11 == 0) goto Led
            int r1 = r11.length()     // Catch: java.lang.Throwable -> Lf1
            if (r1 != 0) goto Lef
        Led:
