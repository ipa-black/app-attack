...
public abstract class MediationAdapterRouter {
    ...
    protected MediationAdapterRouter() {
        ...
        if (AppLovinMediationProvider.MAX.equalsIgnoreCase(n.f5853a.u())) {
            this.mSdk = n.f5853a;
        } else {
            v.i(simpleName, "Invalid mediation provider detected. Please set AppLovin SDK mediation provider to MAX via AppLovinSdk.getInstance(context).setMediationProvider( AppLovinMediationProvider.MAX )");
        }
    }
    ...
    protected void log(String str, Throwable th) {
        ...
        if (nVar != null) {
            nVar.D();
            if (v.a()) {
                this.mSdk.D().b(this.mTag, str, th);
            }
        }
    }
