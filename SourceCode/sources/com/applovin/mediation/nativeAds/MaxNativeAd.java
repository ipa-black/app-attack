...
public class MaxNativeAd extends MaxNativeAdImpl {
    ...
    public static class Builder {
        ...
        private MaxNativeAdImage f6277f;
    ...
    public MaxNativeAd(Builder builder) {
        this.format = builder.f6272a;
        this.title = builder.f6273b;
        this.advertiser = builder.f6274c;
        this.body = builder.f6275d;
        this.callToAction = builder.f6276e;
        this.icon = builder.f6277f;
        this.iconView = builder.f6278g;
        this.optionsView = builder.f6279h;
