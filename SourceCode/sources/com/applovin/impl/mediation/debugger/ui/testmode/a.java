...
public class a extends com.applovin.impl.mediation.debugger.ui.a implements a.InterfaceC0069a, AdControlButton.a, MaxAdRevenueListener, MaxAdViewAdListener, MaxRewardedAdListener {
    ...
    private com.applovin.impl.mediation.debugger.b.c.b f5166a;

    /* renamed from: b  reason: collision with root package name */
    private n f5167b;

    /* renamed from: c  reason: collision with root package name */
    private MaxAdView f5168c;

    /* renamed from: d  reason: collision with root package name */
    private MaxAdView f5169d;

    /* renamed from: e  reason: collision with root package name */
    private MaxInterstitialAd f5170e;

    /* renamed from: f  reason: collision with root package name */
    private MaxAppOpenAd f5171f;

    /* renamed from: g  reason: collision with root package name */
    private MaxRewardedInterstitialAd f5172g;

    /* renamed from: h  reason: collision with root package name */
    private MaxRewardedAd f5173h;
    private MaxAd i;
    ...
    private void a() {
        ...
        if (!this.f5166a.p().contains(maxAdFormat)) {
            findViewById(R.id.banner_control_view).setVisibility(8);
            frameLayout.setVisibility(8);
            return;
        }
        MaxAdView maxAdView = new MaxAdView(str, maxAdFormat, this.f5167b.ab(), this);
        this.f5168c = maxAdView;
        maxAdView.setExtraParameter(AppLovinSdkExtraParameterKey.IS_ADAPTIVE_BANNER, "false");
        this.f5168c.setListener(this);
        frameLayout.addView(this.f5168c, new FrameLayout.LayoutParams(AppLovinSdkUtils.dpToPx(this, maxAdFormat.getSize().getWidth()), AppLovinSdkUtils.dpToPx(this, maxAdFormat.getSize().getHeight())));
    ...
    private void a(MaxAdFormat maxAdFormat) {
        MaxAdView maxAdView;
        this.f5167b.N().a(getTestModeNetwork(maxAdFormat));
        if (MaxAdFormat.BANNER == maxAdFormat || MaxAdFormat.LEADER == maxAdFormat) {
            maxAdView = this.f5168c;
    ...
    private void b() {
        ...
        if (!this.f5166a.p().contains(MaxAdFormat.MREC)) {
            findViewById(R.id.mrec_control_view).setVisibility(8);
            this.u.setVisibility(8);
            return;
        }
        MaxAdView maxAdView = new MaxAdView("test_mode_mrec", MaxAdFormat.MREC, this.f5167b.ab(), this);
        this.f5169d = maxAdView;
        maxAdView.setListener(this);
        this.u.addView(this.f5169d, new FrameLayout.LayoutParams(-1, -1));
    ...
    private void c() {
        if (!this.f5166a.p().contains(MaxAdFormat.INTERSTITIAL)) {
            findViewById(R.id.interstitial_control_view).setVisibility(8);
            return;
        }
        MaxInterstitialAd maxInterstitialAd = new MaxInterstitialAd("test_mode_interstitial", this.f5167b.ab(), this);
        this.f5170e = maxInterstitialAd;
    ...
    private void d() {
        if (!this.f5166a.p().contains(MaxAdFormat.REWARDED)) {
            findViewById(R.id.rewarded_control_view).setVisibility(8);
            return;
        }
        String str = "test_mode_rewarded_" + this.f5166a.h();
        this.k = str;
        MaxRewardedAd maxRewardedAd = MaxRewardedAd.getInstance(str, this.f5167b.ab(), this);
        this.f5173h = maxRewardedAd;
    ...
    private void e() {
        ...
        MaxNativeAdLoader maxNativeAdLoader = new MaxNativeAdLoader("test_mode_native", this.f5167b.ab(), this);
    ...
    public String getTestModeNetwork(MaxAdFormat maxAdFormat) {
        return (this.f5166a.v() == null || !this.f5166a.v().containsKey(maxAdFormat)) ? this.f5166a.h() : this.f5166a.v().get(maxAdFormat);
    }
    ...
    public void onAdLoadFailed(AdError adError, MaxAdFormat maxAdFormat) {
        ...
        if (MaxAdFormat.BANNER == maxAdFormat || MaxAdFormat.LEADER == maxAdFormat) {
            ...
            if (MaxAdFormat.INTERSTITIAL == maxAdFormat) {
                this.f5170e.setLocalExtraParameter("amazon_ad_error", adError);
            } else if (MaxAdFormat.APP_OPEN == maxAdFormat) {
                this.f5171f.setLocalExtraParameter("amazon_ad_error", adError);
            } else if (MaxAdFormat.REWARDED_INTERSTITIAL == maxAdFormat) {
                this.f5172g.setLocalExtraParameter("amazon_ad_error", adError);
            } else if (MaxAdFormat.REWARDED == maxAdFormat) {
                this.f5173h.setLocalExtraParameter("amazon_ad_error", adError);
            } else if (MaxAdFormat.NATIVE == maxAdFormat) {
    ...
    public void onAdLoadFailed(String str, MaxError maxError) {
        ...
        Utils.showAlert(maxError, a2.getFormat().getLabel(), this);
    }
    ...
    public void onAdResponseLoaded(DTBAdResponse dTBAdResponse, MaxAdFormat maxAdFormat) {
        ...
        if (MaxAdFormat.BANNER == maxAdFormat || MaxAdFormat.LEADER == maxAdFormat) {
            ...
            if (MaxAdFormat.INTERSTITIAL == maxAdFormat) {
                this.f5170e.setLocalExtraParameter("amazon_ad_response", dTBAdResponse);
            } else if (MaxAdFormat.APP_OPEN == maxAdFormat) {
                this.f5171f.setLocalExtraParameter("amazon_ad_response", dTBAdResponse);
            } else if (MaxAdFormat.REWARDED_INTERSTITIAL == maxAdFormat) {
                this.f5172g.setLocalExtraParameter("amazon_ad_response", dTBAdResponse);
            } else if (MaxAdFormat.REWARDED == maxAdFormat) {
                this.f5173h.setLocalExtraParameter("amazon_ad_response", dTBAdResponse);
            } else if (MaxAdFormat.NATIVE == maxAdFormat) {
    ...
    public void onCreate(Bundle bundle) {
        ...
        setTitle(this.f5166a.i() + " Test Ads");
        a();
        b();
        c();
        d();
        ...
        if (this.f5166a.q() && this.f5166a.p().contains(MaxAdFormat.MREC)) {
            this.v.setVisibility(8);
        ...
        if (StringUtils.isValidString(this.f5166a.B()) && this.f5166a.C() != null && this.f5166a.C().size() > 0) {
            AdRegistration.getInstance(this.f5166a.B(), this);
            AdRegistration.enableTesting(true);
            AdRegistration.enableLogging(true);
            Map<MaxAdFormat, com.applovin.impl.mediation.debugger.a.a> map = CollectionUtils.map(this.f5166a.C().size());
            for (MaxAdFormat maxAdFormat : this.f5166a.C().keySet()) {
                map.put(maxAdFormat, new com.applovin.impl.mediation.debugger.a.a(this.f5166a.C().get(maxAdFormat), maxAdFormat, this));
            }
            this.w = map;
        }
        try {
    ...
    public void onDestroy() {
        MaxAd maxAd;
        super.onDestroy();
        this.f5167b.N().a((String) null);
        MaxAdView maxAdView = this.f5168c;
        if (maxAdView != null) {
            maxAdView.destroy();
        }
        MaxAdView maxAdView2 = this.f5169d;
        if (maxAdView2 != null) {
            maxAdView2.destroy();
        }
        MaxInterstitialAd maxInterstitialAd = this.f5170e;
        if (maxInterstitialAd != null) {
            maxInterstitialAd.destroy();
        }
        MaxRewardedAd maxRewardedAd = this.f5173h;
