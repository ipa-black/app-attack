...
public class b<T> implements Comparable {
    ...
    private static final List<?> f5599a = Arrays.asList(Boolean.class, Float.class, Integer.class, Long.class, String.class);

    /* renamed from: b  reason: collision with root package name */
    private static final Map<String, b<?>> f5600b = CollectionUtils.map(512);
    ...
    public static final b<String> aS = a("text_alert_consent_no_option", "Cancel");
    ...
    public static final b<Integer> dd = a("response_buffer_size", Integer.valueOf((int) AacUtil.AAC_HE_V1_MAX_RATE_BYTES_PER_SECOND));
    ...
    public static final b<Long> f0do = a("communicator_request_timeout_ms", Long.valueOf(TimeUnit.SECONDS.toMillis(10)));
    ...
    public static final b<Integer> ea = a("device_sensor_period_ms", 250);
    ...
    public static final b<Long> fc = a("anr_touch_millis", Long.valueOf((long) C.DEFAULT_MAX_SEEK_TO_PREVIOUS_POSITION_MS));
    public static final b<Long> fd = a("anr_check_millis", Long.valueOf((long) C.DEFAULT_MAX_SEEK_TO_PREVIOUS_POSITION_MS));
    ...
    public static final b<String> fs = a("config_consent_dialog_state", "unknown");
    ...
    public static <T> b<T> a(String str, T t) {
        if (t != null) {
            if (f5599a.contains(t.getClass())) {
                b<T> bVar = new b<>(str, t);
                Map<String, b<?>> map = f5600b;
    ...
    public static Collection<b<?>> c() {
        return Collections.synchronizedCollection(f5600b.values());
    }

    public T a(Object obj) {
        return (T) this.f5602d.getClass().cast(obj);
    }
    ...
    public int compareTo(Object obj) {
        if (obj instanceof b) {
            return this.f5601c.compareTo(((b) obj).a());
        }
        return 0;
    }
}
