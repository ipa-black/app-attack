...
public class d<T> {
    ...
    public static final d<String> f5608a = new d<>("com.applovin.sdk.impl.isFirstRun", String.class);

    /* renamed from: b  reason: collision with root package name */
    public static final d<Boolean> f5609b = new d<>("com.applovin.sdk.launched_before", Boolean.class);

    /* renamed from: c  reason: collision with root package name */
    public static final d<String> f5610c = new d<>("com.applovin.sdk.latest_installed_version", String.class);

    /* renamed from: d  reason: collision with root package name */
    public static final d<Long> f5611d = new d<>("com.applovin.sdk.install_date", Long.class);

    /* renamed from: e  reason: collision with root package name */
    public static final d<String> f5612e = new d<>("com.applovin.sdk.user_id", String.class);

    /* renamed from: f  reason: collision with root package name */
    public static final d<String> f5613f = new d<>("com.applovin.sdk.compass_id", String.class);

    /* renamed from: g  reason: collision with root package name */
    public static final d<String> f5614g = new d<>("com.applovin.sdk.compass_random_token", String.class);

    /* renamed from: h  reason: collision with root package name */
    public static final d<String> f5615h = new d<>("com.applovin.sdk.applovin_random_token", String.class);
