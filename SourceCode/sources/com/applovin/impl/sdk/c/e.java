...
public final class e {
    ...
    private static n f5616a;

    /* renamed from: b  reason: collision with root package name */
    private static SharedPreferences f5617b;

    /* renamed from: c  reason: collision with root package name */
    private final SharedPreferences f5618c;

    public e(n nVar) {
        this.f5618c = nVar.P().getSharedPreferences("com.applovin.sdk.preferences." + nVar.C(), 0);
        if (nVar.e()) {
            return;
        }
        f5616a = nVar;
    ...
    private static SharedPreferences a(Context context) {
        if (f5617b == null) {
            f5617b = context.getSharedPreferences("com.applovin.sdk.shared", 0);
        }
        return f5617b;
    }
        ...
        try {
            ...
            try {
                ...
                if (nVar != null) {
                    nVar.D();
                    if (v.a()) {
                        f5616a.D().b("SharedPreferencesManager", "Error getting value for key: " + str, th);
                    }
                }
                return t;
            } finally {
    ...
    private static void a(final SharedPreferences.Editor editor) {
        try {
            n nVar = f5616a;
            if (nVar != null && ((Boolean) nVar.a(b.eU)).booleanValue()) {
                if (!Utils.isMainThread()) {
                    editor.commit();
                } else if (f5616a.V() != null) {
                    f5616a.V().a(new z(f5616a, new Runnable() { // from class: com.applovin.impl.sdk.c.e.1
    ...
    public <T> void a(d<T> dVar) {
        a(this.f5618c.edit().remove(dVar.a()));
    }

    public <T> void a(d<T> dVar, T t) {
        a((d<d<T>>) dVar, (d<T>) t, this.f5618c);
    }
    ...
    public <T> T b(d<T> dVar, T t) {
        return (T) b((d<d<T>>) dVar, (d<T>) t, this.f5618c);
    }
