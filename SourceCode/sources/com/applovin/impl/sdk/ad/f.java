...
public final class f extends AppLovinAdImpl {
    ...
    private AppLovinAd c() {
        return (AppLovinAd) this.sdk.ac().c(this.f5544b);
    }
    ...
    public void a(AppLovinAd appLovinAd) {
        this.f5543a = appLovinAd;
    }

    public AppLovinAd b() {
        AppLovinAd appLovinAd = this.f5543a;
    ...
    public d getAdZone() {
        ...
        return appLovinAdImpl != null ? appLovinAdImpl.getAdZone() : this.f5544b;
    }
