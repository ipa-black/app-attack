        ...
        return new Iterable<T>() { // from class: com.applovin.exoplayer2.common.base.Optional.1
            ...
            public Iterator<T> iterator() {
                return new b<T>() { // from class: com.applovin.exoplayer2.common.base.Optional.1.1
                    ...
                    private final Iterator<? extends Optional<? extends T>> f1927b;

                    {
                        this.f1927b = (Iterator) Preconditions.checkNotNull(iterable.iterator());
                    }

                    @Override // com.applovin.exoplayer2.common.base.b
                    protected T a() {
                        while (this.f1927b.hasNext()) {
                            Optional<? extends T> next = this.f1927b.next();
                            if (next.isPresent()) {
                                return next.get();
                            }
                        }
