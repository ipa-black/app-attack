...
public final class MoreObjects {
    ...
    public static final class ToStringHelper {
        ...
        private ToStringHelper addHolder(String str, @NullableDecl Object obj) {
            ...
            addHolder.f1923b = obj;
            addHolder.f1922a = (String) Preconditions.checkNotNull(str);
            return this;
        }
        ...
        public String toString() {
            ...
            String str = "";
            for (a aVar = this.holderHead.f1924c; aVar != null; aVar = aVar.f1924c) {
                Object obj = aVar.f1923b;
                if (!z || obj != null) {
                    append.append(str);
                    if (aVar.f1922a != null) {
                        append.append(aVar.f1922a).append('=');
                    }
