...
public final class o {
    ...
    private static final int[] f1564a = {1, 2, 2, 2, 2, 3, 3, 4, 4, 5, 6, 6, 6, 7, 8, 8};

    /* renamed from: b  reason: collision with root package name */
    private static final int[] f1565b = {-1, 8000, AacUtil.AAC_HE_V1_MAX_RATE_BYTES_PER_SECOND, 32000, -1, -1, 11025, 22050, 44100, -1, -1, 12000, 24000, OpusUtil.SAMPLE_RATE, -1, -1};

    /* renamed from: c  reason: collision with root package name */
    private static final int[] f1566c = {64, 112, 128, 192, 224, 256, 384, 448, 512, 640, 768, 896, 1024, 1152, 1280, 1536, 1920, 2048, 2304, 2560, 2688, 2816, 2823, 2944, 3072, 3840, 4096, 6144, 7680};
    ...
    public static com.applovin.exoplayer2.v a(byte[] bArr, String str, String str2, com.applovin.exoplayer2.d.e eVar) {
        com.applovin.exoplayer2.l.x c2 = c(bArr);
        c2.b(60);
        int i = f1564a[c2.c(6)];
        int i2 = f1565b[c2.c(4)];
        int c3 = c2.c(5);
        int[] iArr = f1566c;
        int i3 = c3 >= iArr.length ? -1 : (iArr[c3] * 1000) / 2;
        c2.b(10);
        return new v.a().a(str).f(MimeTypes.AUDIO_DTS).d(i3).k(i + (c2.c(2) > 0 ? 1 : 0)).l(i2).a(eVar).c(str2).a();
    }
