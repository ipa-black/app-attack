...
public class n {
    ...
    private static File f1014b;

    /* renamed from: c  reason: collision with root package name */
    private static File f1015c;

    /* renamed from: d  reason: collision with root package name */
    private static File f1016d;
    ...
    public static File d(Context context) {
        if (f1015c == null) {
            ...
            f1015c = new File(j(context), "apminsight/CrashLogNative");
        }
        return f1015c;
    }
    ...
    public static File e(Context context) {
        if (f1016d == null) {
            f1016d = new File(j(context) + "/apminsight/CrashCommonLog/" + com.apm.insight.i.f());
        }
        return f1016d;
    }
    ...
    public static String j(Context context) {
        if (TextUtils.isEmpty(f1013a)) {
            try {
                f1013a = context.getFilesDir().getAbsolutePath();
            } catch (Exception e2) {
                f1013a = "/sdcard/";
                e2.printStackTrace();
            }
