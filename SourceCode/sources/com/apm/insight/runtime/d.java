...
public class d {
    ...
    private ICommonParams f1102b;

    /* renamed from: c  reason: collision with root package name */
    private ICommonParams f1103c;
    ...
    public d(Context context, ICommonParams iCommonParams, d dVar) {
        this.f1101a = context;
        this.f1102b = iCommonParams;
        this.f1103c = dVar == null ? null : dVar.f1102b;
    }
    ...
    */
    public java.util.Map<java.lang.String, java.lang.Object> b() {
        /*
            ...
            r3 = 0
            com.apm.insight.ICommonParams r4 = r9.f1103c     // Catch: java.lang.Throwable -> L25
            if (r4 == 0) goto L10
        ...
        L15:
            com.apm.insight.ICommonParams r5 = r9.f1102b     // Catch: java.lang.Throwable -> L20
        ...
        L2a:
            ...
            java.lang.String r5 = com.apm.insight.l.u.a(r5)     // Catch: java.lang.Throwable -> L3d
            r4.put(r6, r5)     // Catch: java.lang.Throwable -> L3d
        L3d:
            boolean r5 = a(r4)
            r6 = 128(0x80, float:1.794E-43)
            if (r5 == 0) goto La7
            android.content.Context r5 = r9.f1101a     // Catch: java.lang.Throwable -> L83
            android.content.pm.PackageManager r5 = r5.getPackageManager()     // Catch: java.lang.Throwable -> L83
            android.content.Context r7 = r9.f1101a     // Catch: java.lang.Throwable -> L83
        ...
        L7f:
            ...
            goto Lef
        L83:
            android.content.Context r3 = r9.f1101a
            java.lang.String r3 = com.apm.insight.l.a.d(r3)
            r4.put(r0, r3)
            android.content.Context r0 = r9.f1101a
            ...
            goto Lef
        La7:
            android.content.Context r0 = r9.f1101a     // Catch: java.lang.Throwable -> Lef
            android.content.pm.PackageManager r0 = r0.getPackageManager()     // Catch: java.lang.Throwable -> Lef
            android.content.Context r1 = r9.f1101a     // Catch: java.lang.Throwable -> Lef
            java.lang.String r1 = r1.getPackageName()     // Catch: java.lang.Throwable -> Lef
            android.content.pm.PackageInfo r0 = r0.getPackageInfo(r1, r6)     // Catch: java.lang.Throwable -> Lef
            java.lang.String r0 = r0.versionName     // Catch: java.lang.Throwable -> Lef
            ...
            android.content.Context r2 = r9.f1101a     // Catch: java.lang.Throwable -> Lef
            java.lang.String r2 = r2.getPackageName()     // Catch: java.lang.Throwable -> Lef
            ...
            java.lang.Object r1 = r1.get(r3)     // Catch: java.lang.Throwable -> Lef
            java.lang.String r1 = (java.lang.String) r1     // Catch: java.lang.Throwable -> Lef
            if (r0 == 0) goto Lef
            boolean r1 = r0.equals(r1)     // Catch: java.lang.Throwable -> Lef
            if (r1 != 0) goto Lef
            java.lang.String r1 = "manifest_version"
            r4.put(r1, r0)     // Catch: java.lang.Throwable -> Lef
        Lef:
            return r4
        */
    ...
    public String d() {
        try {
            return this.f1102b.getDeviceId();
    ...
    public String e() {
        try {
            return String.valueOf(this.f1102b.getCommonParams().get("aid"));
        } catch (Throwable unused) {
            return "4444";
        }
    }
