            ...
            p.b().a(new Runnable() { // from class: com.apm.insight.d.a.1
                ...
                public void run() {
                    ...
                    try {
                        ...
                        if (map != null) {
                            JSONObject optJSONObject = a2.h().optJSONObject(OSNotificationFormatHelper.PAYLOAD_OS_ROOT_CUSTOM);
                            if (optJSONObject == null) {
                                optJSONObject = new JSONObject();
                            }
                            com.apm.insight.entity.a.a(optJSONObject, map);
                            a2.a(OSNotificationFormatHelper.PAYLOAD_OS_ROOT_CUSTOM, optJSONObject);
                        }
                        if (map2 != null) {
