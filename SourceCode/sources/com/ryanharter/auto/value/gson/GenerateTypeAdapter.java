            ...
            if (rawType.isAnnotationPresent(GenerateTypeAdapter.class)) {
                ...
                try {
                    if (findConstructorForClass.getParameterTypes().length == 1) {
                        return findConstructorForClass.newInstance(gson);
                    }
                    return findConstructorForClass.newInstance(gson, ((ParameterizedType) typeToken.getType()).getActualTypeArguments());
