...
@Metadata(bv = {}, d1 = {"\u0000\u001a\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\u0010\u000e\n\u0002\b\n\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\b6\u0018\u00002\u00020\u0001:\u0002\u000b\fR\u0017\u0010\u0007\u001a\u00020\u00028\u0006¢\u0006\f\n\u0004\b\u0003\u0010\u0004\u001a\u0004\b\u0005\u0010\u0006R\u0017\u0010\n\u001a\u00020\u00028\u0006¢\u0006\f\n\u0004\b\b\u0010\u0004\u001a\u0004\b\t\u0010\u0006\u0082\u0001\u0002\r\u000e¨\u0006\u000f"}, d2 = {"Lcom/appodeal/consent/ConsentManagerError;", "", "", NotificationBundleProcessor.PUSH_ADDITIONAL_DATA_KEY, "Ljava/lang/String;", "getEvent", "()Ljava/lang/String;", "event", "b", "getMessage", "message", "LoadingError", "ShowingError", "Lcom/appodeal/consent/ConsentManagerError$LoadingError;", "Lcom/appodeal/consent/ConsentManagerError$ShowingError;", "apd_consent"}, k = 1, mv = {1, 6, 0})
...
public abstract class ConsentManagerError {
    ...
    public static final class LoadingError extends ConsentManagerError {
        ...
        public LoadingError(String message) {
            super("LoadingError", message, null);
    ...
    public static final class ShowingError extends ConsentManagerError {
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public ShowingError(String message) {
            super("ShowingError", message, null);
            Intrinsics.checkNotNullParameter(message, "message");
        }
    }
