...
public class UnifiedMraidUtils {
    ...
    public static class UnifiedMraidFullscreenAd<UnifiedAdParamsType extends UnifiedFullscreenAdParams, UnifiedAdCallbackType extends UnifiedFullscreenAdCallback, NetworkRequestParams> extends UnifiedFullscreenAd<UnifiedAdParamsType, UnifiedAdCallbackType, NetworkRequestParams> implements UnifiedMraidAd<UnifiedAdParamsType, UnifiedAdCallbackType> {
        ...
        public /* bridge */ /* synthetic */ void loadMraid(Context context, UnifiedAdParams unifiedAdParams, UnifiedMraidNetworkParams unifiedMraidNetworkParams, UnifiedAdCallback unifiedAdCallback) {
            loadMraid(context, (Context) ((UnifiedFullscreenAdParams) unifiedAdParams), unifiedMraidNetworkParams, (UnifiedMraidNetworkParams) ((UnifiedFullscreenAdCallback) unifiedAdCallback));
        }
        ...
        /* JADX WARN: Multi-variable type inference failed */
        @Override // com.appodeal.ads.unified.mraid.UnifiedMraidUtils.UnifiedMraidAd
        public /* bridge */ /* synthetic */ void performMraidRequest(Context context, UnifiedAdParams unifiedAdParams, UnifiedMraidNetworkParams unifiedMraidNetworkParams, UnifiedAdCallback unifiedAdCallback, String str) {
            performMraidRequest(context, (Context) ((UnifiedFullscreenAdParams) unifiedAdParams), unifiedMraidNetworkParams, (UnifiedMraidNetworkParams) ((UnifiedFullscreenAdCallback) unifiedAdCallback), str);
        }
    ...
    public static class UnifiedMraidViewAd<UnifiedAdParamsType extends UnifiedViewAdParams, UnifiedAdCallbackType extends UnifiedViewAdCallback, NetworkRequestParams> extends UnifiedViewAd<UnifiedAdParamsType, UnifiedAdCallbackType, NetworkRequestParams> implements UnifiedMraidAd<UnifiedAdParamsType, UnifiedAdCallbackType> {
        ...
        @Override // com.appodeal.ads.unified.UnifiedAd
        public /* bridge */ /* synthetic */ void load(ContextProvider contextProvider, UnifiedAdParams unifiedAdParams, Object obj, UnifiedAdCallback unifiedAdCallback) {
            load(contextProvider, (ContextProvider) ((UnifiedViewAdParams) unifiedAdParams), (UnifiedViewAdParams) obj, (Object) ((UnifiedViewAdCallback) unifiedAdCallback));
        }
        ...
        /* JADX WARN: Multi-variable type inference failed */
        public /* bridge */ /* synthetic */ void loadMraid(Context context, UnifiedAdParams unifiedAdParams, UnifiedMraidNetworkParams unifiedMraidNetworkParams, UnifiedAdCallback unifiedAdCallback) {
            loadMraid(context, (Context) ((UnifiedViewAdParams) unifiedAdParams), unifiedMraidNetworkParams, (UnifiedMraidNetworkParams) ((UnifiedViewAdCallback) unifiedAdCallback));
        }
        ...
        /* JADX WARN: Multi-variable type inference failed */
        @Override // com.appodeal.ads.unified.UnifiedAd
        public /* bridge */ /* synthetic */ void onPrepareToShow(Activity activity, UnifiedAdParams unifiedAdParams) {
            onPrepareToShow(activity, (Activity) ((UnifiedViewAdParams) unifiedAdParams));
        }

        public void onPrepareToShow(Activity activity, UnifiedAdParamsType unifiedadparamstype) {
            super.onPrepareToShow(activity, (Activity) unifiedadparamstype);
            MraidView mraidView = this.mraidView;
            if (mraidView != null) {
                mraidView.show(activity);
            }
        }

        /* JADX WARN: Multi-variable type inference failed */
        public /* bridge */ /* synthetic */ void performMraidRequest(Context context, UnifiedAdParams unifiedAdParams, UnifiedMraidNetworkParams unifiedMraidNetworkParams, UnifiedAdCallback unifiedAdCallback, String str) {
            performMraidRequest(context, (Context) ((UnifiedViewAdParams) unifiedAdParams), unifiedMraidNetworkParams, (UnifiedMraidNetworkParams) ((UnifiedViewAdCallback) unifiedAdCallback), str);
        }
