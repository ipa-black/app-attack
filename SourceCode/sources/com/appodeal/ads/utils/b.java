...
public final class b extends ArrayAdapter<String> {
    ...
    public final int getCount() {
        return com.appodeal.ads.m.b(6).length;
    }
    ...
    public final View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if (Appodeal.isInitialized(a.a(com.appodeal.ads.m.b(6)[i]))) {
            textView2.setText(a.b(com.appodeal.ads.m.b(6)[i]));
        } else {
            textView2.setText(a.b(com.appodeal.ads.m.b(6)[i]) + " (Isn't Initialized)");
