    ...
    public static void log(String str, String str2, String str3, LogLevel logLevel) {
        ...
        if (TextUtils.isEmpty(str3)) {
            ...
            if (format.length() > 1000) {
                int length = (format.length() + 999) / 1000;
                int i2 = 0;
                while (i < length) {
                    int i3 = i2 + 1000;
                    android.util.Log.d("Appodeal", format.substring(i2, Math.min(format.length(), i3)));
                    i++;
                    i2 = i3;
                }
                return;
            ...
            if (format.length() > 1000) {
                int length2 = (format.length() + 999) / 1000;
                int i4 = 0;
                while (i < length2) {
                    int i5 = i4 + 1000;
                    android.util.Log.d("Appodeal", format.substring(i4, Math.min(format.length(), i5)));
                    i++;
                    i4 = i5;
                }
                return;
