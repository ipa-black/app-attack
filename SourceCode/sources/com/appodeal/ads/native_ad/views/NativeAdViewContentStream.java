...
public class NativeAdViewContentStream extends NativeAdView {
    ...
    public final void a() {
        if (!this.q) {
            ...
            relativeLayout.addView(this.f6394h);
            ...
            this.f6390d.setLayoutParams(layoutParams7);
            this.f6390d.setPadding(round4, round4, round4, round4);
            ...
            layoutParams8.addRule(0, this.f6390d.getId());
            layoutParams8.addRule(3, this.i.getId());
            this.f6392f.setLayoutParams(layoutParams8);
        ...
        if (this.o != null) {
            this.f6394h.measure(getWidth(), getHeight());
            ((TextView) this.f6389c).setText(this.o.getTitle());
            this.f6389c.measure(getWidth(), getHeight());
            ((TextView) this.f6392f).setText(this.o.getDescription());
            this.f6392f.measure(getWidth(), getHeight());
            ...
            this.f6391e.measure(getWidth(), getHeight());
            ...
            this.f6390d.measure(getWidth(), getHeight());
            if (Math.max(this.f6392f.getMeasuredHeight(), this.f6390d.getMeasuredHeight()) + this.i.getMeasuredHeight() + Math.max(this.f6394h.getMeasuredHeight(), this.f6391e.getMeasuredHeight() + this.f6389c.getMeasuredHeight()) > getHeight() && getLayoutParams() != null && getLayoutParams().height != -2 && getLayoutParams().height != -1) {
