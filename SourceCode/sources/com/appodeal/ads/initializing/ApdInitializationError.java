...
public abstract class ApdInitializationError extends Throwable {
    ...
    public static abstract class Critical extends ApdInitializationError {
        ...
        public static final class ActivityIsNull extends Critical {
            ...
            private ActivityIsNull() {
                super("The Activity instance passed to Appodeal initialization method is null. Appodeal SDK is disabled", null);
            }
        }
    ...
    @Metadata(d1 = {"\u0000\u001c\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0003\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\b6\u0018\u00002\u00020\u0001:\u0002\u0005\u0006B\u000f\b\u0004\u0012\u0006\u0010\u0002\u001a\u00020\u0003¢\u0006\u0002\u0010\u0004\u0082\u0001\u0002\u0007\b¨\u0006\t"}, d2 = {"Lcom/appodeal/ads/initializing/ApdInitializationError$InternalError;", "Lcom/appodeal/ads/initializing/ApdInitializationError;", Constants.IPC_BUNDLE_KEY_SEND_ERROR, "", "(Ljava/lang/Throwable;)V", "PreparingSdkError", "SdkConfigurationError", "Lcom/appodeal/ads/initializing/ApdInitializationError$InternalError$SdkConfigurationError;", "Lcom/appodeal/ads/initializing/ApdInitializationError$InternalError$PreparingSdkError;", "apd_public"}, k = 1, mv = {1, 6, 0}, xi = 48)
    /* loaded from: classes2.dex */
    public static abstract class InternalError extends ApdInitializationError {

        @Metadata(d1 = {"\u0000\u0012\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0003\n\u0002\b\u0002\u0018\u00002\u00020\u0001B\r\u0012\u0006\u0010\u0002\u001a\u00020\u0003¢\u0006\u0002\u0010\u0004¨\u0006\u0005"}, d2 = {"Lcom/appodeal/ads/initializing/ApdInitializationError$InternalError$PreparingSdkError;", "Lcom/appodeal/ads/initializing/ApdInitializationError$InternalError;", Constants.IPC_BUNDLE_KEY_SEND_ERROR, "", "(Ljava/lang/Throwable;)V", "apd_public"}, k = 1, mv = {1, 6, 0}, xi = 48)
        /* loaded from: classes2.dex */
        public static final class PreparingSdkError extends InternalError {
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            public PreparingSdkError(Throwable error) {
                super(error, null);
                Intrinsics.checkNotNullParameter(error, "error");
            }
        }

        @Metadata(d1 = {"\u0000\u0012\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0003\n\u0002\b\u0002\u0018\u00002\u00020\u0001B\r\u0012\u0006\u0010\u0002\u001a\u00020\u0003¢\u0006\u0002\u0010\u0004¨\u0006\u0005"}, d2 = {"Lcom/appodeal/ads/initializing/ApdInitializationError$InternalError$SdkConfigurationError;", "Lcom/appodeal/ads/initializing/ApdInitializationError$InternalError;", Constants.IPC_BUNDLE_KEY_SEND_ERROR, "", "(Ljava/lang/Throwable;)V", "apd_public"}, k = 1, mv = {1, 6, 0}, xi = 48)
        /* loaded from: classes2.dex */
        public static final class SdkConfigurationError extends InternalError {
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            public SdkConfigurationError(Throwable error) {
                super(error, null);
                Intrinsics.checkNotNullParameter(error, "error");
            }
        }
