...
public final class f1 {
    ...
    public static final HashMap f6654a = new HashMap();

    /* renamed from: b  reason: collision with root package name */
    public static final HashMap f6655b = new HashMap();

    /* renamed from: c  reason: collision with root package name */
    public static long f6656c = 0;

    /* renamed from: d  reason: collision with root package name */
    public static long f6657d = 0;

    /* renamed from: e  reason: collision with root package name */
    public static long f6658e = 0;

    /* renamed from: f  reason: collision with root package name */
    public static int f6659f = 0;

    /* renamed from: g  reason: collision with root package name */
    public static WeakReference<ActivityManager> f6660g = null;

    /* renamed from: h  reason: collision with root package name */
    public static WeakReference<WindowManager> f6661h = null;
    ...
    */
    public static com.appodeal.ads.modules.common.internal.data.ConnectionData c(android.content.Context r6) {
        /*
            java.lang.ref.WeakReference<android.net.ConnectivityManager> r0 = com.appodeal.ads.f1.j
            if (r0 == 0) goto L13
            java.lang.Object r0 = r0.get()
            if (r0 == 0) goto L13
            java.lang.ref.WeakReference<android.net.ConnectivityManager> r6 = com.appodeal.ads.f1.j
    ...
    public static int d() {
        if (f6659f == 0) {
            try {
                ...
                f6659f = listFiles != null ? listFiles.length : Runtime.getRuntime().availableProcessors();
            } catch (Throwable th) {
                f6659f = Runtime.getRuntime().availableProcessors();
                Log.log(th);
            }
        }
        return f6659f;
    ...
    public static JSONObject f(Context context) {
        ...
        try {
            jSONObject.put("battery", b(context));
    ...
    public static long g() {
        try {
            if (f6656c == 0) {
                StatFs statFs = new StatFs(Environment.getDataDirectory().getAbsolutePath());
                f6656c = statFs.getBlockCountLong() * statFs.getBlockSizeLong();
            }
        } catch (Throwable th) {
            Log.log(th);
        }
    ...
    public static long j(Context context) {
        ...
        try {
            if (f6658e == 0) {
                WeakReference<ActivityManager> weakReference = f6660g;
                if (weakReference == null || weakReference.get() == null) {
                    activityManager = (ActivityManager) context.getSystemService("activity");
                    f6660g = new WeakReference<>(activityManager);
                } else {
                    activityManager = f6660g.get();
                }
                f6658e = activityManager.getLargeMemoryClass() * 1048576;
            }
            return f6658e - e();
        }
    }
    ...
    */
    ...
    public static WindowManager q(Context context) {
        WeakReference<WindowManager> weakReference = f6661h;
        if (weakReference == null || weakReference.get() == null) {
            WindowManager windowManager = (WindowManager) context.getSystemService("window");
            f6661h = new WeakReference<>(windowManager);
