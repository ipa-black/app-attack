...
public final class n5 {
    ...
    public static Boolean f7094a = null;

    /* renamed from: b  reason: collision with root package name */
    public static final /* synthetic */ boolean f7095b = true;
    ...
    */
    public static java.lang.String a(java.io.InputStream r4) {
        /*
            ...
            int r2 = r4.available()     // Catch: java.lang.Throwable -> L44 java.lang.Exception -> L46
        ...
        L14:
            ...
            if (r4 == 0) goto L24
            java.lang.StringBuilder r4 = r1.append(r4)     // Catch: java.lang.Throwable -> L40 java.lang.Exception -> L42
            r3 = 10
        ...
        L24:
            ...
            int r4 = r1.length()     // Catch: java.lang.Throwable -> L40 java.lang.Exception -> L42
            int r4 = r4 + (-1)
            r1.setLength(r4)     // Catch: java.lang.Throwable -> L40 java.lang.Exception -> L42
        L33:
        ...
        L46:
            ...
            r2 = r0
        L48:
            com.appodeal.ads.utils.Log.log(r4)     // Catch: java.lang.Throwable -> L56
            if (r2 == 0) goto L55
    ...
    public static JSONObject a() {
        ...
        try {
            ...
            JSONObject jSONObject2 = i0.f6731d;
            if (jSONObject2 != null) {
                Iterator<String> keys = jSONObject2.keys();
                while (keys.hasNext()) {
                    String next = keys.next();
                    jSONObject.put(next, i0.f6731d.get(next));
                }
            }
    ...
    /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:26:0x005f -> B:36:0x0062). Please submit an issue!!! */
    ...
    public static Activity b() {
        return com.appodeal.ads.context.b.f6583b.getTopActivityFlow().getValue();
    }
            ...
            try {
                ...
                switch (httpURLConnection.getResponseCode()) {
                    ...
                    case 307:
                        ...
                        String b3 = b(httpURLConnection.getHeaderField("Location"));
                        try {
                            httpURLConnection.getInputStream().close();
                            httpURLConnection.disconnect();
                        } catch (Exception e9) {
    ...
    */
    public static /* synthetic */ void c(java.lang.String r3) {
        /*
            ...
            java.net.URLConnection r3 = r1.openConnection()     // Catch: java.lang.Throwable -> L31 java.lang.Exception -> L36
            java.net.HttpURLConnection r3 = (java.net.HttpURLConnection) r3     // Catch: java.lang.Throwable -> L31 java.lang.Exception -> L36
            r0 = 5000(0x1388, float:7.006E-42)
            r3.setConnectTimeout(r0)     // Catch: java.lang.Exception -> L2f java.lang.Throwable -> L4f
            r0 = 1
            r3.setInstanceFollowRedirects(r0)     // Catch: java.lang.Exception -> L2f java.lang.Throwable -> L4f
            java.lang.String r0 = "Connection"
            java.lang.String r1 = "close"
            r3.setRequestProperty(r0, r1)     // Catch: java.lang.Exception -> L2f java.lang.Throwable -> L4f
            java.lang.String r0 = "GET"
            r3.setRequestMethod(r0)     // Catch: java.lang.Exception -> L2f java.lang.Throwable -> L4f
            r3.getResponseCode()     // Catch: java.lang.Exception -> L2f java.lang.Throwable -> L4f
            java.io.InputStream r0 = r3.getInputStream()     // Catch: java.lang.Exception -> L4a
            r0.close()     // Catch: java.lang.Exception -> L4a
            r3.disconnect()     // Catch: java.lang.Exception -> L4a
            goto L4e
        L2f:
            r0 = move-exception
            goto L3a
        ...
        L36:
            ...
            r3 = r2
        L3a:
            com.appodeal.ads.utils.Log.log(r0)     // Catch: java.lang.Throwable -> L4f
            if (r3 == 0) goto L4e
            java.io.InputStream r0 = r3.getInputStream()     // Catch: java.lang.Exception -> L4a
            r0.close()     // Catch: java.lang.Exception -> L4a
            r3.disconnect()     // Catch: java.lang.Exception -> L4a
        ...
        L50:
            if (r3 == 0) goto L61
            java.io.InputStream r1 = r3.getInputStream()     // Catch: java.lang.Exception -> L5d
            r1.close()     // Catch: java.lang.Exception -> L5d
            r3.disconnect()     // Catch: java.lang.Exception -> L5d
            goto L61
        L5d:
            r3 = move-exception
            com.appodeal.ads.utils.Log.log(r3)
    ...
    /* JADX WARN: Removed duplicated region for block: B:13:0x0034 A[Catch: all -> 0x004f, TryCatch #1 {all -> 0x004f, blocks: (B:3:0x0003, B:5:0x0006, B:6:0x0010, B:8:0x0024, B:10:0x002a, B:13:0x0034, B:14:0x004a), top: B:22:0x0003 }] */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct add '--show-bad-code' argument
    */
    public static java.lang.String e(android.content.Context r5) {
        /*
            ...
            r2 = -1
            java.lang.Class<com.appodeal.ads.q4> r3 = com.appodeal.ads.q4.class
            java.lang.ClassLoader r3 = r3.getClassLoader()     // Catch: java.lang.Throwable -> L31 java.lang.Throwable -> L4f
            r4 = 0
            java.lang.Class.forName(r0, r4, r3)     // Catch: java.lang.Throwable -> L31 java.lang.Throwable -> L4f
            java.lang.Class r0 = java.lang.Class.forName(r0)     // Catch: java.lang.Throwable -> L4f
            java.lang.String r3 = "GOOGLE_PLAY_SERVICES_VERSION_CODE"
            java.lang.reflect.Field r0 = r0.getDeclaredField(r3)     // Catch: java.lang.Throwable -> L4f
            r0.setAccessible(r1)     // Catch: java.lang.Throwable -> L4f
            boolean r1 = r0.isAccessible()     // Catch: java.lang.Throwable -> L4f
            r3 = 0
            if (r1 == 0) goto L28
            java.lang.Object r3 = r0.get(r3)     // Catch: java.lang.Throwable -> L4f
        L28:
            if (r3 == 0) goto L31
            java.lang.Integer r3 = (java.lang.Integer) r3     // Catch: java.lang.Throwable -> L4f
            int r0 = r3.intValue()     // Catch: java.lang.Throwable -> L4f
            goto L32
        L31:
            r0 = r2
        L32:
            if (r0 != r2) goto L4a
            android.content.pm.PackageManager r0 = r5.getPackageManager()     // Catch: java.lang.Throwable -> L4f
            java.lang.String r5 = r5.getPackageName()     // Catch: java.lang.Throwable -> L4f
            r1 = 128(0x80, float:1.794E-43)
            android.content.pm.ApplicationInfo r5 = r0.getApplicationInfo(r5, r1)     // Catch: java.lang.Throwable -> L4f
            android.os.Bundle r5 = r5.metaData     // Catch: java.lang.Throwable -> L4f
            java.lang.String r0 = "com.google.android.gms.version"
            int r0 = r5.getInt(r0)     // Catch: java.lang.Throwable -> L4f
        L4a:
            java.lang.String r5 = java.lang.String.valueOf(r0)     // Catch: java.lang.Throwable -> L4f
            return r5
        L4f:
            r5 = move-exception
    ...
    public static void a(final String str, com.appodeal.ads.utils.s sVar) {
        if (TextUtils.isEmpty(str) || sVar == null) {
            return;
        }
        sVar.f7825a.execute(new Runnable() { // from class: com.appodeal.ads.n5$$ExternalSyntheticLambda2
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public static boolean b(final android.content.Context r2, final java.lang.String r3, final java.lang.Runnable r4) {
        /*
            boolean r0 = android.text.TextUtils.isEmpty(r3)
            if (r0 == 0) goto Lf
            if (r4 == 0) goto Ld
            android.os.Handler r2 = com.appodeal.ads.h5.f6714a
            r2.post(r4)
        Ld:
            r2 = 0
            return r2
        Lf:
            boolean r0 = com.appodeal.ads.n5.f7095b
            if (r0 != 0) goto L1c
            if (r3 == 0) goto L16
            goto L1c
        L16:
        ...
        L22:
            ...
            java.lang.String r3 = java.net.URLDecoder.decode(r3, r0)     // Catch: java.lang.Throwable -> L28
        L28:
            boolean r0 = com.appodeal.ads.i0.f6733f
            if (r0 == 0) goto L4a
            ...
            if (r0 == 0) goto L4a
        L3c:
            com.appodeal.ads.utils.s r0 = com.appodeal.ads.utils.s.f7824e
            com.appodeal.ads.n5$$ExternalSyntheticLambda1 r1 = new com.appodeal.ads.n5$$ExternalSyntheticLambda1
            r1.<init>()
            java.util.concurrent.ThreadPoolExecutor r2 = r0.f7825a
            r2.execute(r1)
            r2 = 1
            return r2
        L4a:
            if (r4 == 0) goto L51
            android.os.Handler r0 = com.appodeal.ads.h5.f6714a
            r0.post(r4)
        L51:
            boolean r2 = b(r2, r3)
            return r2
        */
        throw new UnsupportedOperationException("Method not decompiled: com.appodeal.ads.n5.b(android.content.Context, java.lang.String, java.lang.Runnable):boolean");
    }

    public static void a(final String str, com.appodeal.ads.utils.s sVar, final Runnable runnable) {
        if (TextUtils.isEmpty(str) || sVar == null) {
            return;
        }
        sVar.f7825a.execute(new Runnable() { // from class: com.appodeal.ads.n5$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
                n5.a(str, runnable);
            }
    ...
    public static void a(AdType adType, com.appodeal.ads.waterfall_filter.a aVar) {
        ...
        StringBuilder sb = new StringBuilder();
        sb.append(String.format("%s waterfall:", a(displayName)));
        if (b2 != null && !b2.isEmpty()) {
            ...
            while (it.hasNext()) {
                ...
                sb.append(jSONObject.has("name") ? String.format(Locale.ENGLISH, "%s (%s), eCPM: %.2f; ", a(jSONObject.optString("name")), a(jSONObject.optString("status")), Double.valueOf(jSONObject.optDouble("ecpm", 0.0d))) : String.format(Locale.ENGLISH, "%s, eCPM: %.2f; ", a(jSONObject.optString("status")), Double.valueOf(jSONObject.optDouble("ecpm", 0.0d))));
            }
        }
        if (c2 == null || c2.isEmpty()) {
            ...
            while (it2.hasNext()) {
                ...
                String format = jSONObject2.has("name") ? String.format(Locale.ENGLISH, "%s (%s), eCPM: %.2f; ", a(jSONObject2.optString("name")), a(jSONObject2.optString("status")), Double.valueOf(jSONObject2.optDouble("ecpm", 0.0d))) : String.format(Locale.ENGLISH, "%s, eCPM: %.2f; ", a(jSONObject2.optString("status")), Double.valueOf(jSONObject2.optDouble("ecpm", 0.0d)));
                sb.append(format);
                i += format.length();
            }
        }
    ...
    public static String a(Uri uri) {
        ...
        com.appodeal.ads.context.b bVar = com.appodeal.ads.context.b.f6583b;
        mediaMetadataRetriever.setDataSource(bVar.f6584a.getApplicationContext(), uri);
        Bitmap frameAtTime = mediaMetadataRetriever.getFrameAtTime(Long.parseLong(mediaMetadataRetriever.extractMetadata(9)), 2);
        ?? r2 = 0;
        try {
            if (frameAtTime != null) {
                try {
                    File file = new File(c(bVar.f6584a.getApplicationContext()), new BigInteger(a(uri.toString().getBytes())).abs().toString(36));
