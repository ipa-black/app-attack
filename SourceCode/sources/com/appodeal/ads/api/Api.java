...
public final class Api {
    ...
    static {
        ...
        internal_static_com_appodeal_ads_Device_fieldAccessorTable = new GeneratedMessageV3.FieldAccessorTable(descriptor3, new String[]{"Ua", "Osv", "Os", ExifInterface.LONGITUDE_WEST, "H", "Pxratio", "Devicetype", ExifInterface.TAG_MAKE, ExifInterface.TAG_MODEL, "Rooted", "WebviewVersion", "Battery", "Mccmnc", "Locale", "Connectiontype", "Ifa", "Lmt", "Adidg", "TrackingStatus", "Idfv", "StorageSize", "StorageFree", "StorageUsed", "RamSize", "RamFree", "RamUsed", "CpuUsage", "SecureAndroidId"});
        ...
        internal_static_com_appodeal_ads_UserSettings_fieldAccessorTable = new GeneratedMessageV3.FieldAccessorTable(descriptor7, new String[]{"UserId", "Gender", HttpHeaders.AGE});
        ...
        internal_static_com_appodeal_ads_Request_fieldAccessorTable = new GeneratedMessageV3.FieldAccessorTable(descriptor12, new String[]{"App", RtspHeaders.SESSION, "Device", "User", "Regs", "Geo", "Ext", "Impid", "MainId", LogConstants.EVENT_GET, "Stats", "Event", RtspHeaders.TIMESTAMP, "CustomState", "ServicesData"});
        ...
        internal_static_com_appodeal_ads_Get_fieldAccessorTable = new GeneratedMessageV3.FieldAccessorTable(descriptor16, new String[]{"Type", "LargeBanners", LogConstants.KEY_REWARDED_VIDEO, FilterDialog.DEBUG_MODE, "ShowArray", "CheckSdkVersion"});
