...
public class BidMachineNetwork extends AdNetwork<RequestParams> {
    ...
    public class a implements b.a {
        ...
        public final /* synthetic */ TargetingParams f6474a;

        /* renamed from: b  reason: collision with root package name */
        public final /* synthetic */ PriceFloorParams f6475b;

        /* renamed from: c  reason: collision with root package name */
        public final /* synthetic */ CustomParams f6476c;

        /* renamed from: d  reason: collision with root package name */
        public final /* synthetic */ JSONArray f6477d;

        /* renamed from: e  reason: collision with root package name */
        public final /* synthetic */ NetworkInitializationListener f6478e;
        ...
        public a(TargetingParams targetingParams, PriceFloorParams priceFloorParams, CustomParams customParams, JSONArray jSONArray, NetworkInitializationListener networkInitializationListener) {
            this.f6474a = targetingParams;
            this.f6475b = priceFloorParams;
            this.f6476c = customParams;
            this.f6477d = jSONArray;
            this.f6478e = networkInitializationListener;
        }

        @Override // com.appodeal.ads.adapters.bidmachine.b.a
        public final void onInitializationFailed(LoadingError loadingError) {
            this.f6478e.onInitializationFailed(loadingError);
        }

        @Override // com.appodeal.ads.adapters.bidmachine.b.a
        public final void onInitializationFinished() {
            TargetingParams targetingParams = this.f6474a;
            PriceFloorParams priceFloorParams = this.f6475b;
            CustomParams customParams = this.f6476c;
            JSONArray jSONArray = this.f6477d;
            try {
                this.f6478e.onInitializationFinished(new RequestParams(targetingParams, priceFloorParams, customParams, jSONArray != null ? jSONArray.toString() : null));
            } catch (Exception e2) {
                e2.printStackTrace();
                this.f6478e.onInitializationFailed(LoadingError.InternalError);
            }
        }
    }
