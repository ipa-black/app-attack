...
public class IronSourceNetwork extends AdNetwork<RequestParams> {
    ...
    protected void initialize(Activity activity, AdUnit adUnit, AdNetworkMediationParams adNetworkMediationParams, NetworkInitializationListener<RequestParams> networkInitializationListener) throws Exception {
        ...
        if (!isInitialized) {
            isInitialized = true;
            IronSource.setLogListener(new LogListener() { // from class: com.appodeal.ads.adapters.ironsource.IronSourceNetwork.2
