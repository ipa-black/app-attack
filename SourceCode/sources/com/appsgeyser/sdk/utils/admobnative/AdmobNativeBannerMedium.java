...
public class AdmobNativeBannerMedium extends FrameLayout {
    ...
    public AdmobNativeBannerMedium(Context context) {
        super(context);
    }
    ...
    public AdmobNativeBannerMedium(Context context, AttributeSet attributeSet, int i) {
        super(context, attributeSet, i);
        initView(context, attributeSet);
    }

    public AdmobNativeBannerMedium(Context context, AttributeSet attributeSet, int i, int i2) {
