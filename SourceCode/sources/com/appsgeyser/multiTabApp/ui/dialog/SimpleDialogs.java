...
public class SimpleDialogs {
    public static AlertDialog createConfirmDialog(String str, String str2, Context context, final DialogInterface.OnClickListener onClickListener, final DialogInterface.OnClickListener onClickListener2) {
        ...
        textView2.setOnClickListener(new View.OnClickListener() { // from class: com.appsgeyser.multiTabApp.ui.dialog.SimpleDialogs.1
        ...
        textView3.setOnClickListener(new View.OnClickListener() { // from class: com.appsgeyser.multiTabApp.ui.dialog.SimpleDialogs.2
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                create.dismiss();
        ...
        create.setOnCancelListener(new DialogInterface.OnCancelListener() { // from class: com.appsgeyser.multiTabApp.ui.dialog.SimpleDialogs.3
    ...
    public static void showOpenOrSaveDialog(Context context, final DialogInterface.OnClickListener onClickListener, final DialogInterface.OnClickListener onClickListener2) {
        ...
        textView2.setOnClickListener(new View.OnClickListener() { // from class: com.appsgeyser.multiTabApp.ui.dialog.SimpleDialogs.4
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
        ...
        textView3.setOnClickListener(new View.OnClickListener() { // from class: com.appsgeyser.multiTabApp.ui.dialog.SimpleDialogs.5
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
        ...
        textView4.setOnClickListener(new View.OnClickListener() { // from class: com.appsgeyser.multiTabApp.ui.dialog.SimpleDialogs.6
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                create.cancel();
            }
    ...
    public static AlertDialog showNoticeDialog(String str, String str2, Context context, final DialogInterface.OnClickListener onClickListener, final DialogInterface.OnClickListener onClickListener2, final DialogInterface.OnClickListener onClickListener3) {
        final AlertDialog create = new AlertDialog.Builder(context).create();
        LinearLayout linearLayout = (LinearLayout) Factory.getInstance().getMainNavigationActivity().getLayoutInflater().inflate(R.layout.dialog_3_buttons, (ViewGroup) null);
        TextView textView = (TextView) linearLayout.findViewById(R.id.dialog_positive_button);
        TextView textView2 = (TextView) linearLayout.findViewById(R.id.dialog_negative_button);
        TextView textView3 = (TextView) linearLayout.findViewById(R.id.dialog_neutral_button);
        create.setView(linearLayout);
        ...
        textView.setOnClickListener(new View.OnClickListener() { // from class: com.appsgeyser.multiTabApp.ui.dialog.SimpleDialogs.7
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                onClickListener3.onClick(create, 0);
            }
        });
        textView2.setOnClickListener(new View.OnClickListener() { // from class: com.appsgeyser.multiTabApp.ui.dialog.SimpleDialogs.8
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                onClickListener2.onClick(create, 0);
            }
        });
        textView3.setOnClickListener(new View.OnClickListener() { // from class: com.appsgeyser.multiTabApp.ui.dialog.SimpleDialogs.9
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                onClickListener.onClick(create, 0);
            }
