...
import com.appsgeyser.multiTabApp.SettingsActivity;
...
public abstract class NavigationWidget implements INavigationWidget, SuggestionsListener {
        ...
        try {
            if (loadWeeklyHistory.moveToFirst()) {
                do {
                    ...
                    String string2 = loadWeeklyHistory.getString(loadWeeklyHistory.getColumnIndex("title"));
                    String string3 = loadWeeklyHistory.getString(loadWeeklyHistory.getColumnIndex("url"));
                    String string4 = loadWeeklyHistory.getString(loadWeeklyHistory.getColumnIndex(DatabaseOpenHelper.HISTORY_ROW_VISIT_TIME));
    ...
    @Override // com.appsgeyser.multiTabApp.ui.navigationwidget.INavigationWidget
    public void setAdsKeyboard(boolean z) {
        this.adsKeyboard = z;
    }
    ...
    public void onPageFinished(WebView webView, String str) {
        ...
        if (PreferenceManager.getDefaultSharedPreferences(mainNavigationActivity).getBoolean(SettingsActivity.KEY_QUICK_SEARCH, true) && Factory.getInstance().getNavigationWidget() != null && mainNavigationActivity.getIntent().getBooleanExtra("focus", false)) {
