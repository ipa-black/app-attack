...
public class WebViewJsAudioPlayer {
    ...
    private void _setPlayerEvenets() {
        this._player.setOnPreparedListener(new MediaPlayer.OnPreparedListener() { // from class: com.appsgeyser.multiTabApp.media.WebViewJsAudioPlayer.1
        ...
        this._player.setOnCompletionListener(new MediaPlayer.OnCompletionListener() { // from class: com.appsgeyser.multiTabApp.media.WebViewJsAudioPlayer.2
        ...
        this._player.setOnErrorListener(new MediaPlayer.OnErrorListener() { // from class: com.appsgeyser.multiTabApp.media.WebViewJsAudioPlayer.3
    ...
    public void _callFunction(String str, String[] strArr) {
        ...
        this._parentWebView.post(new Runnable() { // from class: com.appsgeyser.multiTabApp.media.WebViewJsAudioPlayer.4
