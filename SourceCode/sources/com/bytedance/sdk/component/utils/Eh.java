...
public class Eh {
    public static List<File> Qhi(String str, String str2) throws IOException {
        return Qhi(str, str2, (String) null);
    }

    public static List<File> Qhi(String str, String str2, String str3) throws IOException {
        return Qhi(Qhi(str), Qhi(str2), str3);
    }

    public static List<File> Qhi(File file, File file2, String str) throws IOException {
        ...
        try {
            if (cJ(str)) {
                while (entries.hasMoreElements()) {
                    ...
                    } else if (!Qhi(file2, arrayList, zipFile, nextElement, name)) {
                        return arrayList;
                    }
                }
            } else {
                while (entries.hasMoreElements()) {
                    ...
                    } else if (name2.contains(str) && !Qhi(file2, arrayList, zipFile, nextElement2, name2)) {
                        return arrayList;
                    }
                }
            }
    ...
    */
    private static boolean Qhi(java.io.File r2, java.util.List<java.io.File> r3, java.util.zip.ZipFile r4, java.util.zip.ZipEntry r5, java.lang.String r6) throws java.io.IOException {
        /*
