...
public class Tgh {
    ...
    public Tgh(Context context, boolean z, int i) {
        this.Qhi = context;
        this.ac = z;
        this.fl = i;
    }
    ...
    */
    ...
    public void Qhi() {
        if (this.ac) {
            String string = this.Qhi.getSharedPreferences(hm.Qhi().Qhi(this.fl).Qhi(), 0).getString("tnc_config_str", null);
    ...
    public void cJ() {
        try {
            String Qhi = com.bytedance.sdk.component.ROR.CJ.hm.Qhi(this.Qhi, 1, this.fl);
    ...
    private fl cJ(JSONObject jSONObject) {
        try {
            ...
            flVar.fl = jSONObject.optInt("req_to_cnt", flVar.fl);
            ...
            flVar.hm = jSONObject.optInt("req_err_api_cnt", flVar.hm);
            flVar.WAv = jSONObject.optInt("req_err_ip_cnt", flVar.WAv);
            flVar.Gm = jSONObject.optInt("update_interval", flVar.Gm);
            flVar.zc = jSONObject.optInt("update_random_range", flVar.zc);
