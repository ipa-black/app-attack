...
public class HzH extends fl {
    ...
    List<ObjectAnimator> Qhi() {
        ObjectAnimator duration = ObjectAnimator.ofFloat(this.ac, "translationX", 0.0f, CQU.Qhi(com.bytedance.sdk.component.adexpress.fl.Qhi(), 20.0f), 0.0f, -CQU.Qhi(com.bytedance.sdk.component.adexpress.fl.Qhi(), 20.0f), 0.0f).setDuration((int) (this.cJ.WAv() * 1000.0d));
