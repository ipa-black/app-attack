...
public class zc implements hm<ViewGroup> {
    ...
    public zc(Context context, DynamicBaseWidget dynamicBaseWidget, com.bytedance.sdk.component.adexpress.dynamic.ac.Sf sf, String str, String str2) {
        int i;
        ...
        if ("22".equals(str2)) {
            ...
            layoutParams2.bottomMargin = (int) CQU.Qhi(context, i);
            frameLayout.setLayoutParams(layoutParams2);
            frameLayout.setClipChildren(false);
        } else {
            FrameLayout.LayoutParams layoutParams3 = new FrameLayout.LayoutParams((int) (dynamicBaseWidget.getDynamicWidth() * 0.32d * oU), (int) (dynamicBaseWidget.getDynamicWidth() * 0.32d * d2));
            layoutParams3.gravity = 17;
            frameLayout.setLayoutParams(layoutParams3);
        }
    }

    private void Qhi(Context context, FrameLayout frameLayout, com.bytedance.sdk.component.adexpress.dynamic.ac.Sf sf) {
        ...
        if (sf != null && !TextUtils.isEmpty(sf.Dq())) {
            textView2.setText(sf.Dq());
        }
