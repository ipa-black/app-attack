...
public class DynamicTimeOuter extends DynamicButton implements com.bytedance.sdk.component.adexpress.dynamic.ac {
    ...
    public boolean hm() {
        ...
        if ("timedown".equals(this.ABk.WAv().cJ())) {
            ((TextView) this.pA).setText(String.valueOf((int) Double.parseDouble(this.zc.WAv())));
            return true;
        }
        ((TextView) this.pA).setText(((int) Double.parseDouble(this.zc.WAv())) + "s");
        return true;
    }
    ...
    public void Qhi(CharSequence charSequence, boolean z, int i, boolean z2) {
        ...
        setVisibility(0);
        if (!z && this.iMK.getRenderRequest().Qhi() && Dww.cJ(this.iMK.getRenderRequest().CJ())) {
            if (com.bytedance.sdk.component.adexpress.fl.cJ()) {
                ((TextView) this.pA).setText(i + "s");
            } else {
                ((TextView) this.pA).setText(String.format(MQ.Qhi(com.bytedance.sdk.component.adexpress.fl.Qhi(), "tt_reward_full_skip"), Integer.valueOf(i)));
            }
            this.Qhi = true;
            ...
            if (this.Qhi) {
                ...
                FrameLayout.LayoutParams layoutParams = new FrameLayout.LayoutParams((int) (ABk.cJ(str, this.zc.fl(), true)[0] + CQU.Qhi(com.bytedance.sdk.component.adexpress.fl.Qhi(), this.zc.ac() + this.zc.CJ())), this.Sf);
