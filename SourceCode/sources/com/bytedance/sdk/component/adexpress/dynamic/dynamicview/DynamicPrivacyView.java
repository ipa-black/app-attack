...
public class DynamicPrivacyView extends DynamicBaseWidgetImp {
    ...
    public boolean hm() {
        ...
        if (this.zc != null) {
            this.MQ.setTextColor(this.zc.ROR());
            this.MQ.setTextSize(this.zc.fl());
            this.cJ.setTextColor(this.zc.ROR());
            this.cJ.setTextSize(this.zc.fl());
            this.qMt.setTextColor(this.zc.ROR());
            this.EBS.setTextColor(this.zc.ROR());
            this.Qhi.setTextColor(this.zc.ROR());
            this.Qhi.setTextSize(this.zc.fl());
            return false;
        }
