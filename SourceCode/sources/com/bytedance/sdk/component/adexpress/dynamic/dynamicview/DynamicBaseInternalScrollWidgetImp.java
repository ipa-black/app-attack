...
public class DynamicBaseInternalScrollWidgetImp extends DynamicBaseWidgetImp implements Tgh {
    ...
    public void Qhi() {
        ...
        if (i + 1 >= getChildCount() || ((ViewGroup) getChildAt(this.MQ + 1)).getChildCount() <= 0) {
            this.qMt = true;
            childAt = getChildAt(this.MQ - 1);
            this.Qhi = ObjectAnimator.ofFloat(childAt2, "translationX", 0.0f, (this.ROR + getChildAt(this.MQ).getWidth()) / 2);
        } else {
            childAt = getChildAt(this.MQ + 1);
            this.Qhi = ObjectAnimator.ofFloat(childAt2, "translationX", 0.0f, (-(this.ROR + getChildAt(this.MQ).getWidth())) / 2);
        }
        ...
        if (this.qMt) {
            this.cJ = ObjectAnimator.ofFloat(childAt, "translationX", (-(this.ROR + childAt.getWidth())) / 2, 0.0f);
        } else {
            this.cJ = ObjectAnimator.ofFloat(childAt, "translationX", (this.ROR + childAt.getWidth()) / 2, 0.0f);
        }
        ...
        postDelayed(this.EBS, ExoPlayer.DEFAULT_DETACH_SURFACE_TIMEOUT_MS);
    }
