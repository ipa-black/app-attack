    ...
    public PressButtonInteractView(Context context) {
        ...
        post(new Runnable() { // from class: com.bytedance.sdk.component.adexpress.widget.PressButtonInteractView.1
            ...
            public void run() {
                ...
                layoutParams.topMargin = (int) ((PressButtonInteractView.this.ac.getMeasuredHeight() / 2.0f) - CQU.Qhi(PressButtonInteractView.this.getContext(), 5.0f));
                layoutParams.leftMargin = (int) ((PressButtonInteractView.this.ac.getMeasuredWidth() / 2.0f) - CQU.Qhi(PressButtonInteractView.this.getContext(), 5.0f));
                layoutParams.bottomMargin = (int) (((-PressButtonInteractView.this.ac.getMeasuredHeight()) / 2.0f) + CQU.Qhi(PressButtonInteractView.this.getContext(), 5.0f));
                layoutParams.rightMargin = (int) (((-PressButtonInteractView.this.ac.getMeasuredWidth()) / 2.0f) + CQU.Qhi(PressButtonInteractView.this.getContext(), 5.0f));
    ...
    private void CJ() {
        ...
        ofFloat.addListener(new Animator.AnimatorListener() { // from class: com.bytedance.sdk.component.adexpress.widget.PressButtonInteractView.2
            ...
            public void onAnimationRepeat(Animator animator) {
                if (PressButtonInteractView.this.fl) {
                    PressButtonInteractView.this.ac.Qhi();
                }
                PressButtonInteractView pressButtonInteractView = PressButtonInteractView.this;
                pressButtonInteractView.fl = !pressButtonInteractView.fl;
            }
        });
