...
public class SlideUpView extends RelativeLayout {
    ...
    protected void Qhi(Context context) {
        ...
        this.ac = (ImageView) findViewById(2097610733);
        this.fl = (TextView) findViewById(2097610731);
    }
    ...
    public void ac() {
        ...
        ofInt.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.bytedance.sdk.component.adexpress.widget.SlideUpView.2
            ...
            public void onAnimationUpdate(ValueAnimator valueAnimator) {
                if (SlideUpView.this.ac != null) {
                    RelativeLayout.LayoutParams layoutParams = (RelativeLayout.LayoutParams) SlideUpView.this.ac.getLayoutParams();
                    layoutParams.height = ((Integer) valueAnimator.getAnimatedValue()).intValue();
                    SlideUpView.this.ac.setLayoutParams(layoutParams);
                }
            }
        });
        ofInt.setInterpolator(new PathInterpolator(0.2f, 0.0f, 0.3f, 1.0f));
        ObjectAnimator ofFloat4 = ObjectAnimator.ofFloat(this.ac, "alpha", 0.0f, 1.0f);
        ObjectAnimator ofFloat5 = ObjectAnimator.ofFloat(this.ac, "alpha", 1.0f, 0.0f);
        ...
        this.hm.playTogether(ofFloat3, ofInt, ofFloat10);
    ...
    public void cJ() {
        try {
            ...
            AnimatorSet animatorSet4 = this.hm;
