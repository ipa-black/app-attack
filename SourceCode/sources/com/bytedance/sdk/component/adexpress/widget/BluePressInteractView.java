...
public class BluePressInteractView extends FrameLayout {
    ...
    private void ac() {
        ...
        FrameLayout.LayoutParams layoutParams = new FrameLayout.LayoutParams((int) (this.Sf * 0.45d), (int) (this.hm * 0.45d));
        ...
        FrameLayout.LayoutParams layoutParams2 = new FrameLayout.LayoutParams((int) (this.Sf * 0.25d), (int) (this.hm * 0.25d));
        ...
        FrameLayout.LayoutParams layoutParams4 = new FrameLayout.LayoutParams((int) (this.Sf * 0.62d), (int) (this.hm * 0.53d));
    ...
    private void CJ() {
        ...
        ObjectAnimator ofFloat3 = ObjectAnimator.ofFloat(this.fl, "scaleX", 1.0f, 2.5f, 1.0f);
        ObjectAnimator ofFloat4 = ObjectAnimator.ofFloat(this.fl, "scaleY", 1.0f, 2.5f, 1.0f);
        ...
        ObjectAnimator ofFloat7 = ObjectAnimator.ofFloat(this.ROR, Key.ROTATION, 0.0f, -20.0f, 0.0f);
        this.cJ = ofFloat7;
        ...
        this.Qhi.addListener(new Animator.AnimatorListener() { // from class: com.bytedance.sdk.component.adexpress.widget.BluePressInteractView.1
            ...
            public void onAnimationEnd(Animator animator) {
                if (BluePressInteractView.this.ac) {
                    return;
                }
            ...
            public void onAnimationCancel(Animator animator) {
                BluePressInteractView.this.ac = true;
            }
        });
    }
