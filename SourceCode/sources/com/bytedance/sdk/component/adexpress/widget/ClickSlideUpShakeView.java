...
public class ClickSlideUpShakeView extends SlideUpView {
    ...
    public ClickSlideUpShakeView(Context context, int i, int i2, int i3, JSONObject jSONObject) {
        super(context);
        Qhi(context, i, i2, i3, jSONObject);
    }

    private void Qhi(Context context, int i, int i2, int i3, JSONObject jSONObject) {
        ShakeClickView shakeClickView = new ShakeClickView(context, Qhi.ac(context), i, i2, i3, jSONObject);
