...
public class Sf {
    ...
    private JSONObject ac(String str) {
        ...
        com.bytedance.sdk.component.ROR.cJ.cJ ROR = ac.ROR();
        ROR.cJ(str);
    ...
    public void Qhi(com.bytedance.sdk.component.adexpress.Qhi.ac.fl flVar, String str) {
        ...
        final String str3 = flVar.Qhi;
        final String str4 = flVar.ac;
        final String str5 = flVar.cJ;
        final String str6 = flVar.CJ;
        final String str7 = flVar.fl;
        if (com.bytedance.sdk.component.adexpress.Qhi.Qhi.Qhi.Qhi().ac() == null) {
            str2 = "";
        } else {
            str2 = com.bytedance.sdk.component.adexpress.Qhi.Qhi.Qhi.Qhi().ac().Sf();
        }
        ...
        if (TextUtils.isEmpty(str3)) {
            ...
            qMt.Qhi(new com.bytedance.sdk.component.Sf.hm("saveTemplate") { // from class: com.bytedance.sdk.component.adexpress.Qhi.cJ.Sf.1
                ...
                public void run() {
                    Sf.this.Qhi(str3, str4, str5, str6, str7, str8);
                }
            }, 10);
        }
    }
    ...
    private void Qhi(String str, String str2, String str3) {
        JSONObject ac;
        if (TextUtils.isEmpty(str) || (ac = ac(str)) == null) {
            return;
        }
        String optString = ac.optString("md5");
        String optString2 = ac.optString(MediationMetaData.KEY_VERSION);
        String optString3 = ac.optString("data");
