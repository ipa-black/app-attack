...
public class cJ implements com.bytedance.sdk.component.ROR.ac.cJ {
    ...
    public String[] Tgh() {
        ...
        if (!TextUtils.isEmpty(PAe)) {
            return ("SG".equals(PAe) || "CN".equals(PAe)) ? new String[]{"tnc16-alisg.isnssdk.com", "tnc16-alisg.byteoversea.com", "tnc16-useast1a.isnssdk.com", "tnc16-useast1a.byteoversea.com"} : strArr;
        }
        int hpZ = js.hpZ();
        return (hpZ == 2 || hpZ == 1) ? new String[]{"tnc16-alisg.isnssdk.com", "tnc16-alisg.byteoversea.com", "tnc16-useast1a.isnssdk.com", "tnc16-useast1a.byteoversea.com"} : strArr;
    }
}
