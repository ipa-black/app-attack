...
public class ac {
    ...
    public static SharedPreferences Qhi(Context context, String str) {
        ...
        try {
            ...
            ABk.Qhi("SPMultiHelperImpl", "getSharedPreferences error ", th.getMessage());
            return null;
        }
    }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static synchronized <T> void Qhi(Context context, String str, String str2, T t) {
        synchronized (ac.class) {
            String Qhi2 = cJ.Qhi(str, str2);
            if (hm.ROR(Qhi2)) {
                com.bytedance.sdk.component.cJ Qhi3 = com.bytedance.sdk.component.cJ.Qhi(context, Qhi2);
                if (t.equals(Qhi(Qhi2, str2))) {
                    return;
                }
                cJ.ac cJ = Qhi3.cJ();
                Qhi(cJ, str2, (Object) t);
                cJ.apply();
                Qhi(Qhi2, str2, t);
                return;
            }
    ...
    public static <T> void Qhi(SharedPreferences.Editor editor, String str, T t) {
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    public static <T> void Qhi(cJ.ac acVar, String str, T t) {
        if (t instanceof Integer) {
            acVar.putInt(str, ((Integer) t).intValue());
        }
        if (t instanceof Long) {
            acVar.putLong(str, ((Long) t).longValue());
        }
        if (t instanceof Float) {
            acVar.putFloat(str, ((Float) t).floatValue());
        }
        if (t instanceof Boolean) {
            acVar.putBoolean(str, ((Boolean) t).booleanValue());
        }
        if (t instanceof String) {
            acVar.putString(str, (String) t);
        }
    }
