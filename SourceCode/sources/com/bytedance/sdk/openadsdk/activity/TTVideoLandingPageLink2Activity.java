...
public class TTVideoLandingPageLink2Activity extends TTVideoLandingPageActivity implements com.bytedance.sdk.openadsdk.Sf.fl {
    ...
    protected void onCreate(Bundle bundle) {
        ...
        if (!iMK.fl() || this.hpZ == null || this.Qhi == null) {
            finish();
            return;
        }
        com.bytedance.sdk.openadsdk.common.cJ Qhi = js.Qhi(this.hpZ, this.Qhi, this.fl, this.lB);
        this.EGK = Qhi;
        if (Qhi != null) {
        ...
        if (this.Qhi.getWebView() != null) {
            this.Qhi.getWebView().setOnScrollChangeListener(new View.OnScrollChangeListener() { // from class: com.bytedance.sdk.openadsdk.activity.TTVideoLandingPageLink2Activity.1
                ...
                public void onScrollChange(View view, int i, int i2, int i3, int i4) {
                    if (TTVideoLandingPageLink2Activity.this.FQ != null) {
                        TTVideoLandingPageLink2Activity.this.FQ.cJ(i2);
                    }
                }
            });
        }
        this.Qhi.setWebViewClient(new com.bytedance.sdk.openadsdk.core.widget.Qhi.Tgh(this.fl, this.WAv, this.Sf, this.EGK, this.FQ, true) { // from class: com.bytedance.sdk.openadsdk.activity.TTVideoLandingPageLink2Activity.7
            ...
            public void onPageFinished(WebView webView, String str) {
                ...
                try {
                    ...
                    com.bytedance.sdk.openadsdk.cJ.ac.Qhi(TTVideoLandingPageLink2Activity.this.hpZ, TTVideoLandingPageLink2Activity.this.lB, System.currentTimeMillis() - TTVideoLandingPageLink2Activity.this.ots, true);
        ...
        this.Qhi.setWebChromeClient(new com.bytedance.sdk.openadsdk.core.widget.Qhi.fl(this.WAv, this.FQ, this.EGK) { // from class: com.bytedance.sdk.openadsdk.activity.TTVideoLandingPageLink2Activity.8
            ...
            public void onProgressChanged(WebView webView, int i) {
                ...
                if (TTVideoLandingPageLink2Activity.this.oU && TTVideoLandingPageLink2Activity.this.pv != null && i == 100) {
                ...
                if (TTVideoLandingPageLink2Activity.this.Dq != null) {
                    TTVideoLandingPageLink2Activity.this.Dq.Qhi(i);
                }
            }
        });
        ...
        iMK.ac().postDelayed(new Runnable() { // from class: com.bytedance.sdk.openadsdk.activity.TTVideoLandingPageLink2Activity.9
            ...
            public void run() {
                try {
                    ...
                    com.bytedance.sdk.openadsdk.cJ.ac.Qhi(TTVideoLandingPageLink2Activity.this.hpZ, TTVideoLandingPageLink2Activity.this.lB, System.currentTimeMillis() - TTVideoLandingPageLink2Activity.this.ots, false);
                } catch (Exception unused) {
                }
            }
        }, (this.hpZ == null || this.hpZ.hm() == null) ? 10000L : this.hpZ.hm().Qhi() * 1000);
    }
    ...
    protected View Qhi() {
        ...
        pAGTextView.setId(com.bytedance.sdk.openadsdk.utils.iMK.ip);
        ...
        layoutParams7.addRule(1, com.bytedance.sdk.openadsdk.utils.iMK.ip);
        ...
        pAGLinearLayout3.setId(com.bytedance.sdk.openadsdk.utils.iMK.zn);
        ...
        PangleViewStub pangleViewStub = new PangleViewStub(this, new PangleViewStub.Qhi() { // from class: com.bytedance.sdk.openadsdk.activity.TTVideoLandingPageLink2Activity.10
        ...
        PangleViewStub pangleViewStub2 = new PangleViewStub(this, new PangleViewStub.Qhi() { // from class: com.bytedance.sdk.openadsdk.activity.TTVideoLandingPageLink2Activity.11
            @Override // com.bytedance.sdk.openadsdk.common.PangleViewStub.Qhi
            public View Qhi(Context context) {
    ...
    protected void ac() {
        ...
        this.NBs = findViewById(com.bytedance.sdk.openadsdk.utils.iMK.zn);
        ...
        findViewById(com.bytedance.sdk.openadsdk.utils.iMK.NBs).setOnClickListener(new View.OnClickListener() { // from class: com.bytedance.sdk.openadsdk.activity.TTVideoLandingPageLink2Activity.13
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                TTWebsiteActivity.Qhi(TTVideoLandingPageLink2Activity.this.fl, TTVideoLandingPageLink2Activity.this.hpZ, TTVideoLandingPageLink2Activity.this.lB);
            }
        });
        if (this.Qhi != null && this.Qhi.getWebView() != null) {
            ...
            if (this.Qhi.getWebView() != null) {
                this.Qhi.getWebView().setOnTouchListener(new View.OnTouchListener() { // from class: com.bytedance.sdk.openadsdk.activity.TTVideoLandingPageLink2Activity.14
                    ...
                    public boolean onTouch(View view, MotionEvent motionEvent) {
                        ...
                        if (TTVideoLandingPageLink2Activity.this.FQ != null) {
                            TTVideoLandingPageLink2Activity.this.FQ.Qhi(motionEvent);
                        }
                        ...
                        if (motionEvent.getAction() == 2) {
                            ...
                            if (y - f2 > 8.0f) {
                                ...
                                return false;
                            } else if (y - f2 < -8.0f && TTVideoLandingPageLink2Activity.this.pv != null) {
        ...
        if (fl()) {
            ...
            if (this.iMK != null) {
                if (this.iMK.getNativeVideoController() != null) {
                    ...
                    this.zc.setOnTouchListener(new View.OnTouchListener() { // from class: com.bytedance.sdk.openadsdk.activity.TTVideoLandingPageLink2Activity.3
                        @Override // android.view.View.OnTouchListener
                        public boolean onTouch(View view, MotionEvent motionEvent) {
                            if (motionEvent.getAction() == 0) {
    ...
    protected boolean fl() {
        return this.ABk == 5 || this.ABk == 15 || this.ABk == 50;
    }
    ...
    private void hpZ() {
        try {
            if (this.dIT == null) {
                TTAdDislikeDialog tTAdDislikeDialog = new TTAdDislikeDialog(this.fl, this.hpZ);
            ...
            if (this.Qe == null) {
                TTAdDislikeToast tTAdDislikeToast = new TTAdDislikeToast(this.fl);
