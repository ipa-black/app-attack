    ...
    protected void onCreate(Bundle bundle) {
        ...
        try {
            ...
            try {
                ...
                pAGLinearLayout.addView(this.ac, new ViewGroup.LayoutParams(-1, -1));
                pAGImageView.setOnClickListener(new View.OnClickListener() { // from class: com.bytedance.sdk.openadsdk.activity.TTWebsiteActivity.1
                    ...
                    public void onClick(View view2) {
                        if (TTWebsiteActivity.this.ac.canGoBack()) {
                            TTWebsiteActivity.this.ac.goBack();
                        } else {
                ...
                pAGImageView3.setOnClickListener(new View.OnClickListener() { // from class: com.bytedance.sdk.openadsdk.activity.TTWebsiteActivity.3
                    ...
                    public void onClick(View view2) {
                        ...
                        String url = TTWebsiteActivity.this.ac.getUrl();
                ...
                if (HzH.CJ() != null) {
                    ...
                    if (!TextUtils.isEmpty(stringExtra2)) {
                        ...
                        if (this.Qhi.contains("?")) {
                            this.Qhi += "&gdid_encrypted=" + encode;
                        } else {
                            this.Qhi += "?gdid_encrypted=" + encode;
                        }
                    }
                ...
                if (this.Qhi != null) {
                    ...
                    try {
                        this.ac.loadUrl(this.Qhi, hashMap);
                    } catch (Throwable unused2) {
                        this.ac.loadUrl(this.Qhi);
                    }
                    this.ac.setWebChromeClient(new WebChromeClient() { // from class: com.bytedance.sdk.openadsdk.activity.TTWebsiteActivity.5
                    ...
                    this.ac.setWebViewClient(new SSWebView.Qhi() { // from class: com.bytedance.sdk.openadsdk.activity.TTWebsiteActivity.6
                    ...
                    com.bytedance.sdk.openadsdk.core.widget.Qhi.ac.cJ(this.ac);
                    return;
                }
                finish();
            } catch (Exception e2) {
                ABk.Qhi("TTAD.TTWebsiteActivity", "onCreate: ", e2);
                finish();
            }
