...
public abstract class TTVideoLandingPageActivity extends TTBaseActivity implements com.bytedance.sdk.openadsdk.Sf.fl {
    ...
    private final fl.cJ NBs = new fl.cJ() { // from class: com.bytedance.sdk.openadsdk.activity.TTVideoLandingPageActivity.11
        ...
        public void Qhi(boolean z) {
            TTVideoLandingPageActivity.this.sDy = z;
            if (TTVideoLandingPageActivity.this.isFinishing()) {
                return;
            }
            if (z) {
                zn.Qhi((View) TTVideoLandingPageActivity.this.Qhi, 8);
                ViewGroup.MarginLayoutParams marginLayoutParams = (ViewGroup.MarginLayoutParams) TTVideoLandingPageActivity.this.zc.getLayoutParams();
                TTVideoLandingPageActivity.this.kYc = marginLayoutParams.leftMargin;
                TTVideoLandingPageActivity.this.HzH = marginLayoutParams.topMargin;
                TTVideoLandingPageActivity.this.tP = marginLayoutParams.width;
                TTVideoLandingPageActivity.this.MQ = marginLayoutParams.height;
                marginLayoutParams.width = -1;
                marginLayoutParams.height = -1;
                marginLayoutParams.topMargin = 0;
                marginLayoutParams.leftMargin = 0;
                TTVideoLandingPageActivity.this.zc.setLayoutParams(marginLayoutParams);
                return;
            }
            zn.Qhi((View) TTVideoLandingPageActivity.this.Qhi, 0);
            ViewGroup.MarginLayoutParams marginLayoutParams2 = (ViewGroup.MarginLayoutParams) TTVideoLandingPageActivity.this.zc.getLayoutParams();
            marginLayoutParams2.width = TTVideoLandingPageActivity.this.tP;
            marginLayoutParams2.height = TTVideoLandingPageActivity.this.MQ;
            marginLayoutParams2.leftMargin = TTVideoLandingPageActivity.this.kYc;
            marginLayoutParams2.topMargin = TTVideoLandingPageActivity.this.HzH;
            TTVideoLandingPageActivity.this.zc.setLayoutParams(marginLayoutParams2);
        }
    };
    private final bxS.Qhi dI = new bxS.Qhi() { // from class: com.bytedance.sdk.openadsdk.activity.TTVideoLandingPageActivity.2
        ...
        public void Qhi(Context context, Intent intent, boolean z, final int i) {
        ...
        public void Qhi(int i) {
            if (TTVideoLandingPageActivity.this.es == 0 && i != 0 && TTVideoLandingPageActivity.this.Qhi != null && TTVideoLandingPageActivity.this.zn != null) {
                TTVideoLandingPageActivity.this.Qhi.a_(TTVideoLandingPageActivity.this.zn);
            }
            if (TTVideoLandingPageActivity.this.iMK != null && TTVideoLandingPageActivity.this.iMK.getNativeVideoController() != null && !TTVideoLandingPageActivity.this.lG && TTVideoLandingPageActivity.this.es != i) {
                ((com.bytedance.sdk.openadsdk.core.video.nativevideo.ac) TTVideoLandingPageActivity.this.iMK.getNativeVideoController()).ac(i);
            }
            TTVideoLandingPageActivity.this.es = i;
        }
    };

    protected abstract View Qhi();
    ...
    public void onCreate(Bundle bundle) {
        ...
        try {
            ...
            this.hm = intent.getStringExtra("log_extra");
            this.Gm = intent.getIntExtra("source", -1);
            this.zn = intent.getStringExtra("url");
            ...
            Qhi(4);
            if (this.Qhi != null) {
                com.bytedance.sdk.openadsdk.core.widget.Qhi.ac.Qhi(this.fl).Qhi(true).cJ(false).Qhi(this.Qhi.getWebView());
                zc Qhi3 = new zc(this.hpZ, this.Qhi.getWebView(), new Gm() { // from class: com.bytedance.sdk.openadsdk.activity.TTVideoLandingPageActivity.1
                    ...
                    public void Qhi(int i) {
                        ac.Qhi.Qhi(TTVideoLandingPageActivity.this.Dq, TTVideoLandingPageActivity.this.cjC.get(), TTVideoLandingPageActivity.this.YB.get(), TTVideoLandingPageActivity.this.Qe.get() - TTVideoLandingPageActivity.this.YB.get(), TTVideoLandingPageActivity.this.hpZ, "landingpage_split_screen", i);
                    }
                }, this.Hf).Qhi(true);
                this.FQ = Qhi3;
                this.jPH = Qhi3.Qhi;
                this.FQ.Qhi("landingpage_split_screen");
            }
            ...
            if (sSWebView != null) {
                ...
                this.Qhi.setWebViewClient(new com.bytedance.sdk.openadsdk.core.widget.Qhi.Tgh(this.fl, this.WAv, this.Sf, this.FQ, true) { // from class: com.bytedance.sdk.openadsdk.activity.TTVideoLandingPageActivity.4
                    ...
                    public WebResourceResponse shouldInterceptRequest(WebView webView, String str) {
                        try {
                            ...
                            ABk.Qhi("TTVideoLandingPage", "shouldInterceptRequest url error", th);
                            return super.shouldInterceptRequest(webView, str);
                        }
                    }
                });
            ...
            com.bytedance.sdk.openadsdk.utils.tP.Qhi(this.Qhi, this.zn);
            ...
            this.Qhi.setDownloadListener(new DownloadListener() { // from class: com.bytedance.sdk.openadsdk.activity.TTVideoLandingPageActivity.6
                ...
                public void onDownloadStart(String str, String str2, String str3, String str4, long j2) {
                    if (TTVideoLandingPageActivity.this.NFd != null) {
                        TTVideoLandingPageActivity.this.NFd.CJ();
                    }
                }
            });
    ...
    private void Qhi(final String str) {
        ...
        button.post(new Runnable() { // from class: com.bytedance.sdk.openadsdk.activity.TTVideoLandingPageActivity.7
            @Override // java.lang.Runnable
            public void run() {
                if (TTVideoLandingPageActivity.this.aP == null || TTVideoLandingPageActivity.this.isFinishing()) {
                    return;
                }
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    public void ac() {
        this.Eh = (PangleViewStub) findViewById(com.bytedance.sdk.openadsdk.utils.iMK.dI);
        this.Qhi = (SSWebView) findViewById(com.bytedance.sdk.openadsdk.utils.iMK.MND);
        ...
        if (imageView != null) {
            imageView.setOnClickListener(new View.OnClickListener() { // from class: com.bytedance.sdk.openadsdk.activity.TTVideoLandingPageActivity.8
                ...
                public void onClick(View view) {
                    if (TTVideoLandingPageActivity.this.Qhi != null) {
                        if (TTVideoLandingPageActivity.this.jPH != null) {
                            TTVideoLandingPageActivity.this.jPH.Qhi();
                        }
                        if (!TTVideoLandingPageActivity.this.Qhi.fl()) {
                            if (TTVideoLandingPageActivity.this.HzH()) {
                                TTVideoLandingPageActivity.this.onBackPressed();
                                return;
                            }
                            com.bytedance.sdk.openadsdk.cJ.ac.Qhi(TTVideoLandingPageActivity.this.hpZ, "embeded_ad", "detail_back", TTVideoLandingPageActivity.this.Tgh(), TTVideoLandingPageActivity.this.ROR(), (TTVideoLandingPageActivity.this.iMK == null || TTVideoLandingPageActivity.this.iMK.getNativeVideoController() == null) ? null : js.Qhi(TTVideoLandingPageActivity.this.hpZ, TTVideoLandingPageActivity.this.iMK.getNativeVideoController().Tgh(), TTVideoLandingPageActivity.this.iMK.getNativeVideoController().zc()), (Sf) null);
        ...
        ImageView imageView2 = (ImageView) findViewById(com.bytedance.sdk.openadsdk.utils.iMK.yN);
        this.ac = imageView2;
        if (imageView2 != null) {
            imageView2.setOnClickListener(new View.OnClickListener() { // from class: com.bytedance.sdk.openadsdk.activity.TTVideoLandingPageActivity.9
                @Override // android.view.View.OnClickListener
                public void onClick(View view) {
                    if (TTVideoLandingPageActivity.this.iMK != null) {
                        com.bytedance.sdk.openadsdk.cJ.ac.Qhi(TTVideoLandingPageActivity.this.hpZ, "embeded_ad", "detail_skip", TTVideoLandingPageActivity.this.Tgh(), TTVideoLandingPageActivity.this.ROR(), TTVideoLandingPageActivity.this.iMK.getNativeVideoController() != null ? js.Qhi(TTVideoLandingPageActivity.this.hpZ, TTVideoLandingPageActivity.this.iMK.getNativeVideoController().Tgh(), TTVideoLandingPageActivity.this.iMK.getNativeVideoController().zc()) : null, (Sf) null);
                    }
                    TTVideoLandingPageActivity.this.finish();
                }
            });
        }
        this.CJ = (TextView) findViewById(com.bytedance.sdk.openadsdk.utils.iMK.DaO);
        this.zc = (FrameLayout) findViewById(com.bytedance.sdk.openadsdk.utils.iMK.es);
        this.EBS = (RelativeLayout) findViewById(com.bytedance.sdk.openadsdk.utils.iMK.FQ);
        this.bxS = (TextView) findViewById(com.bytedance.sdk.openadsdk.utils.iMK.ip);
        this.CQU = (TextView) findViewById(com.bytedance.sdk.openadsdk.utils.iMK.xyz);
        this.pM = (TextView) findViewById(com.bytedance.sdk.openadsdk.utils.iMK.jPH);
        this.Dww = (CornerIV) findViewById(com.bytedance.sdk.openadsdk.utils.iMK.PAe);
        Sf();
    }
    ...
    public void CJ() {
        if (fl()) {
            try {
                NativeVideoTsView nativeVideoTsView = new NativeVideoTsView(this.fl, this.hpZ, true, null);
                ...
                if (this.lG) {
                    ...
                    if (this.yN != null && this.iMK.getNativeVideoController() != null) {
                        ...
                        this.iMK.getNativeVideoController().ac(this.yN.fl);
                ...
                ABk.Qhi("TTVideoLandingPage", e2.getMessage());
                if (this.iMK == null) {
    ...
    private void ABk() {
        ...
        this.WAv = nFd;
        nFd.cJ(this.Qhi).ac(this.Sf).CJ(this.hm).cJ(this.Gm).Qhi(this.hpZ).Qhi(this.hpZ.zn()).Qhi(this.Qhi).cJ("landingpage_split_screen").fl(this.hpZ.bIO());
    }
    ...
    protected void onSaveInstanceState(Bundle bundle) {
        ...
        NativeVideoTsView nativeVideoTsView = this.iMK;
        if (nativeVideoTsView != null && nativeVideoTsView.getNativeVideoController() != null) {
            j = this.iMK.getNativeVideoController().fl();
        }
    ...
    private void Qhi(com.bykv.vk.openvk.component.video.api.CJ.fl flVar) {
        ...
        com.bytedance.sdk.openadsdk.multipro.CJ.cJ.Qhi("sp_multi_native_video_data", "key_video_is_update_flag", Boolean.TRUE);
        com.bytedance.sdk.openadsdk.multipro.CJ.cJ.Qhi("sp_multi_native_video_data", "key_video_isfromvideodetailpage", Boolean.TRUE);
        ...
        com.bytedance.sdk.openadsdk.multipro.CJ.cJ.Qhi("sp_multi_native_video_data", "key_video_total_play_duration", Long.valueOf(flVar.Sf() + flVar.Tgh()));
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public boolean HzH() {
        return !TextUtils.isEmpty(this.zn) && this.zn.contains("__luban_sdk");
    }
    ...
    private void Qhi(final int i) {
        ...
        lG.Qhi(new Runnable() { // from class: com.bytedance.sdk.openadsdk.activity.TTVideoLandingPageActivity.3
            @Override // java.lang.Runnable
            public void run() {
                zn.Qhi((View) TTVideoLandingPageActivity.this.ac, i);
            }
        });
    }
    ...
    /* loaded from: classes2.dex */
    private static class Qhi extends AsyncTask<Void, Void, Drawable> {
        ...
        public Drawable doInBackground(Void... voidArr) {
            try {
                ...
                ABk.Qhi("TTVideoLandingPage", th.getMessage());
                return null;
            }
        }
