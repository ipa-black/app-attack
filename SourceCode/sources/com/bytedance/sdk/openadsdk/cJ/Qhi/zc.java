...
public class zc implements com.bytedance.sdk.component.Tgh.Qhi.Tgh {
    ...
    @Override // com.bytedance.sdk.component.Tgh.Qhi.Tgh
    public void Qhi(boolean z, int i, long j, com.bytedance.sdk.component.Tgh.Qhi.Tgh.fl flVar) {
        Runnable Qhi;
        if (flVar == null) {
            return;
        }
        Qhi.Qhi(Qhi.ac, z, i, j);
        if (z) {
        ...
        } else if (!HUk.Qhi() || (Qhi = flVar.Qhi(com.bytedance.sdk.openadsdk.core.zc.Qhi(HzH.Qhi()), null)) == null) {
        } else {
