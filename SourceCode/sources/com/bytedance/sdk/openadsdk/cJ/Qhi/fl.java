...
public class fl {
    ...
    public static void Qhi(final List<String> list, final int i, final String str) {
        if (list == null) {
            return;
        }
        com.bytedance.sdk.openadsdk.cJ.ac.Qhi(new com.bytedance.sdk.component.Sf.hm("track") { // from class: com.bytedance.sdk.openadsdk.cJ.Qhi.fl.1
            ...
            public void run() {
                ...
                com.bytedance.sdk.component.Tgh.Qhi.cJ.Qhi(com.bytedance.sdk.openadsdk.core.zc.Qhi(HzH.Qhi()), list, true, i, str);
            }
        });
    }
    ...
    public static void Qhi(String str, boolean z) {
        ...
        com.bytedance.sdk.component.Tgh.Qhi.cJ.Qhi(str, z);
    }
    ...
    public static void ac() {
        try {
            ...
            com.bytedance.sdk.component.utils.ABk.Qhi("AdLogSwitchUtils", th.getMessage());
        }
    }
}
