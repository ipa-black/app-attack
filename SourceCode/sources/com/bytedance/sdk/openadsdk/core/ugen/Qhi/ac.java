...
public class ac {
    ...
    public Qhi Qhi(String str, String str2) {
        ...
        try {
            if (acVar.moveToFirst()) {
                do {
                    int columnIndex = acVar.getColumnIndex("id");
                    int columnIndex2 = acVar.getColumnIndex("md5");
                    int columnIndex3 = acVar.getColumnIndex("url");
    ...
    public void Qhi(Qhi qhi) {
        ...
        contentValues.put("id", qhi.Qhi());
        contentValues.put("md5", qhi.cJ());
        contentValues.put("url", qhi.ac());
                            ...
                            if (qhi != null) {
                                ...
                                if (columnIndex2 != -1) {
                                    ...
                                    if (!TextUtils.isEmpty(string2)) {
                                        ...
                                        int columnIndex4 = acVar.getColumnIndex("url");
                                        int columnIndex5 = acVar.getColumnIndex("update_time");
                                        if (columnIndex3 != -1) {
