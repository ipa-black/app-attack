...
public class Qhi extends PAGBannerAd implements CQU.Qhi {
    ...
    protected final View.OnAttachStateChangeListener Tgh = new View.OnAttachStateChangeListener() { // from class: com.bytedance.sdk.openadsdk.core.bannerexpress.Qhi.1
        ...
        public void onViewAttachedToWindow(View view) {
            ...
            Qhi qhi = Qhi.this;
            qhi.Qhi(qhi.Qhi.getCurView(), Qhi.this.ac);
        }
    ...
    /* loaded from: classes2.dex */
    public interface InterfaceC0223Qhi {
        void Qhi();
    }
    ...
    public Object getExtraInfo(String str) {
        ...
        try {
            return this.ac.Gy().get(str);
        } catch (Throwable th) {
            ABk.Qhi("PAGBannerAdImpl", th.getMessage());
            return null;
        }
    }
    ...
    public View getBannerView() {
        com.bytedance.sdk.openadsdk.utils.cJ.Qhi(this.ac);
        IPMiBroadcastReceiver.Qhi(this.cJ, this.ac);
        return this.Qhi;
    }
    ...
    protected void Qhi(final NativeExpressView nativeExpressView, final tP tPVar) {
        ...
        final InterfaceC0223Qhi Qhi2 = Qhi();
            ...
            public boolean Qhi(ViewGroup viewGroup, int i) {
                try {
                    ...
                    if (Qhi.this.ac.IC()) {
                        ...
                        vastBannerBackupView.Qhi(Qhi.this.ac, nativeExpressView, Qhi.this.zc);
                        vastBannerBackupView.setDislikeInner(Qhi.this.Gm);
                        vastBannerBackupView.setDislikeOuter(Qhi.this.fl);
                    ...
                    bannerExpressBackupView.Qhi(Qhi.this.ac, nativeExpressView, Qhi.this.zc);
                    bannerExpressBackupView.setDislikeInner(Qhi.this.Gm);
                    bannerExpressBackupView.setDislikeOuter(Qhi.this.fl);
        ...
        if (!this.ROR) {
            ...
            es.Qhi(nativeExpressView, true, 1, new es.cJ() { // from class: com.bytedance.sdk.openadsdk.core.bannerexpress.Qhi.4
                ...
                public void Qhi(View view, boolean z) {
                    if (z && Qhi.this.MQ.compareAndSet(false, true)) {
                        Qhi.this.Qhi(view, nativeExpressView, tPVar, Qhi, Qhi2);
                    }
                }
            }, null);
        ...
        Context Qhi4 = nativeExpressView != null ? com.bytedance.sdk.component.utils.cJ.Qhi(nativeExpressView) : null;
        if (Qhi4 == null) {
            Qhi4 = this.cJ;
        }
        Sf sf = new Sf(Qhi4, tPVar, this.kYc, 2);
        sf.Qhi(nativeExpressView);
        sf.Qhi(this);
        sf.Qhi(this.zc);
        sf.Qhi(new cJ.Qhi() { // from class: com.bytedance.sdk.openadsdk.core.bannerexpress.Qhi.5
        ...
        nativeExpressView.setClickListener(sf);
    ...
    public void Qhi(boolean z, tP tPVar) {
        if (z) {
            if (this.ac.qb() && !this.ac.ZRq()) {
                this.ac.ROR(true);
                tP tPVar2 = this.ac;
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void Qhi(EmptyView emptyView, boolean z, tP tPVar) {
        BannerExpressView bannerExpressView = this.Qhi;
        if (bannerExpressView != null) {
            if (!z && emptyView != null && emptyView == Qhi(bannerExpressView.getCurView())) {
                fl();
            } else if (z) {
                fl();
            }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void Qhi(View view, NativeExpressView nativeExpressView, tP tPVar, String str, InterfaceC0223Qhi interfaceC0223Qhi) {
        ...
        try {
            ...
            if (view != null) {
                ...
                try {
                    jSONObject2.put(IabUtils.KEY_WIDTH, view.getWidth());
                    jSONObject2.put(IabUtils.KEY_HEIGHT, view.getHeight());
    ...
    private fl Qhi(tP tPVar) {
        if (tPVar.ip() == 4) {
            return Tgh.Qhi(this.cJ, tPVar, this.kYc);
        }
        return null;
    }
    ...
    public static class cJ extends com.bytedance.sdk.component.Sf.hm {
        boolean Qhi;
        WeakReference<Qhi> ac;
        tP cJ;

        cJ(boolean z, tP tPVar, Qhi qhi) {
            super("ReportWindowFocusChangedAdShow");
            this.Qhi = z;
            this.cJ = tPVar;
            this.ac = new WeakReference<>(qhi);
        }

        @Override // java.lang.Runnable
        public void run() {
            WeakReference<Qhi> weakReference = this.ac;
            if (weakReference == null || weakReference.get() == null) {
                return;
            }
            this.ac.get().cJ(this.Qhi, this.cJ);
        }
    }

    /* JADX INFO: Access modifiers changed from: private */
    public void cJ(boolean z, tP tPVar) {
        Long poll;
        try {
            if (z) {
            ...
            ABk.Qhi("PAGBannerAdImpl", e2.getMessage());
        }
    }
    ...
    public InterfaceC0223Qhi Qhi() {
        return new InterfaceC0223Qhi() { // from class: com.bytedance.sdk.openadsdk.core.bannerexpress.Qhi.7
            @Override // com.bytedance.sdk.openadsdk.core.bannerexpress.Qhi.InterfaceC0223Qhi
            public void Qhi() {
                EmptyView emptyView;
                ...
                if (HzH.CJ().lB() == 1) {
                    Qhi.this.fl();
                } else if (Qhi.this.hm != 0 && !Qhi.this.ROR && emptyView != null) {
            ...
            private View Qhi(boolean z) {
                ...
                View.OnClickListener onClickListener = new View.OnClickListener() { // from class: com.bytedance.sdk.openadsdk.core.bannerexpress.Qhi.7.1
                    ...
                    public void onClick(View view2) {
                        TTWebsiteActivity.Qhi(Qhi.this.cJ, Qhi.this.ac, Qhi.this.kYc);
                    }
                };
    ...
    private void CJ() {
        com.bytedance.sdk.openadsdk.core.nativeexpress.Tgh.Qhi(this.cJ).Qhi(this.CJ, 1, null, new Tgh.Qhi() { // from class: com.bytedance.sdk.openadsdk.core.bannerexpress.Qhi.8
            ...
            public void Qhi(List<tP> list) {
                ...
                tP tPVar = list.get(0);
                Qhi.this.Qhi.Qhi(tPVar, Qhi.this.CJ);
                Qhi.this.ac(tPVar);
                Qhi.this.Qhi.CJ();
            }
    ...
    private void cJ(NativeExpressView nativeExpressView, tP tPVar) {
        ...
        if (tTDislikeDialogAbstract != null) {
            ...
            nativeExpressView.setOuterDislike(this.fl);
        }
    }
    ...
    public void cJ() {
        this.ac.Qhi(SystemClock.elapsedRealtime());
        this.Qhi.cJ();
    }
}
