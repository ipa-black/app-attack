...
public class BannerExpressBackupView extends BackupView {
    public static iMK[] Qhi = {new iMK(1, 6.4f, 320, 50), new iMK(4, 1.2f, VastError.ERROR_CODE_GENERAL_WRAPPER, 250)};
    private Qhi ABk;
    ...
    public void Qhi(tP tPVar, NativeExpressView nativeExpressView, fl flVar) {
        ...
        this.Tgh = "banner_ad";
        this.iMK.addView(this, new ViewGroup.LayoutParams(-2, -2));
        cJ();
    }
    ...
    private void ac() {
        ...
        if ((this.Sf * 1.0f) / this.ROR > 0.21875f) {
            cJ = (this.ROR * 1.0f) / zn.cJ(this.cJ, 320.0f);
        }
        Qhi fl = fl();
        this.ABk = fl;
        ImageView imageView = fl.ac;
        TextView textView = this.ABk.cJ;
        TTRatingBar2 tTRatingBar2 = this.ABk.CJ;
        TextView textView2 = this.ABk.ROR;
        ...
        if (view != null) {
            view.setOnClickListener(new View.OnClickListener() { // from class: com.bytedance.sdk.openadsdk.core.bannerexpress.BannerExpressBackupView.1
                ...
                public void onClick(View view2) {
                    TTWebsiteActivity.Qhi(BannerExpressBackupView.this.cJ, BannerExpressBackupView.this.ac, BannerExpressBackupView.this.Tgh);
                }
            });
        }
        ...
        if (this.ac.dIT() != null && !TextUtils.isEmpty(this.ac.dIT().Qhi())) {
            com.bytedance.sdk.openadsdk.iMK.ac.Qhi().Qhi(this.ac.dIT().Qhi(), this.ac.dIT().cJ(), this.ac.dIT().ac(), imageView, this.ac);
        }
        textView.setText(this.ac.dVA());
        if (!TextUtils.isEmpty(this.ac.ots())) {
            textView2.setText(this.ac.ots());
        } else {
            textView2.setVisibility(8);
        }
        zn.Qhi((TextView) null, tTRatingBar2, this.ac);
    ...
    private void CJ() {
        ...
        if (this.ac != null) {
            ...
            if (this.ac.FQ() == null) {
                ...
                ImageView imageView = this.ABk.ac;
                TextView textView2 = this.ABk.cJ;
                TextView textView3 = this.ABk.ROR;
                ViewGroup.LayoutParams layoutParams = imageView.getLayoutParams();
                if (layoutParams != null) {
                ...
                List<hpZ> cjC = this.ac.cjC();
                if (cjC != null && !cjC.isEmpty()) {
                    com.bytedance.sdk.openadsdk.iMK.ac.Qhi().Qhi(cjC.get(0), ratioImageView, this.ac);
                    com.bytedance.sdk.openadsdk.iMK.ac.Qhi().Qhi(cjC.get(0).Qhi(), this.ABk.fl);
                }
                if (this.ac.dIT() == null || TextUtils.isEmpty(this.ac.dIT().Qhi())) {
                    textView = textView3;
                } else {
                ...
                textView2.setText(this.ac.dVA());
                if (!TextUtils.isEmpty(this.ac.ots())) {
                    textView.setText(this.ac.ots());
                } else {
                    textView.setVisibility(8);
                }
                zn.Qhi((TextView) null, this.ABk.CJ, this.ac);
                Qhi((View) ratioImageView, true);
                ratioImageView.setTag(520093762, Boolean.TRUE);
                Qhi((View) this, true);
                Qhi((View) textView, true);
                return;
            }
            Qhi ROR = ROR();
            this.ABk = ROR;
            TextView textView4 = ROR.cJ;
            TextView textView5 = this.ABk.ROR;
            RatioFrameLayout ratioFrameLayout = this.ABk.Sf;
            ...
            com.bytedance.sdk.openadsdk.iMK.ac.Qhi().Qhi(this.ac.FQ().WAv(), this.ABk.fl);
            ...
            if (videoView != null) {
                ...
                videoView.setAdCreativeClickListener(new NativeVideoTsView.Qhi() { // from class: com.bytedance.sdk.openadsdk.core.bannerexpress.BannerExpressBackupView.4
                    ...
                    public void Qhi(View view3, int i) {
            ...
            if (this.ac.dIT() != null && !TextUtils.isEmpty(this.ac.dIT().Qhi())) {
                com.bytedance.sdk.openadsdk.iMK.ac.Qhi().Qhi(this.ac.dIT().Qhi(), this.ac.dIT().cJ(), this.ac.dIT().ac(), this.ABk.ac, this.ac);
            }
            textView4.setText(this.ac.dVA());
            zn.Qhi((TextView) null, this.ABk.CJ, this.ac);
            if (!TextUtils.isEmpty(this.ac.ots())) {
                textView5.setText(this.ac.ots());
            } else {
    ...
    public static iMK Qhi(int i, int i2) {
        try {
            return ((double) i2) >= Math.floor((((double) i) * 450.0d) / 600.0d) ? Qhi[1] : Qhi[0];
    ...
    public void Qhi() {
        if (this.fl != null) {
            ...
            TTDelegateActivity.Qhi(this.ac, this.pA);
        }
    }
    ...
    public static class Qhi {
        ...
        Qhi(ImageView imageView, TextView textView, TTRatingBar2 tTRatingBar2, View view, TextView textView2) {
            this.ac = imageView;
            this.cJ = textView;
