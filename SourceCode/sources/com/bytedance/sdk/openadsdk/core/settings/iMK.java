...
public class iMK extends hpZ {
    static final ArrayList<String> CJ = new ArrayList<>(Arrays.asList("ja", "en", "ko", "zh", "th", "vi", "id", "ru", "ar", "fr", "de", "it", "es", "hi", "pt", "zh-Hant", "ms", "pl", "tr"));
    public boolean ac;
    private Set<String> fl;

    public iMK(hpZ.Qhi qhi) {
        super("tt_sdk_settings.prop", qhi);
        this.fl = Collections.synchronizedSet(new HashSet());
    }
    ...
    public void Qhi(JSONObject jSONObject) {
        int optInt;
        Tgh.Qhi Qhi = Qhi();
        JSONObject fl = HzH.YD().fl();
        JSONObject optJSONObject = jSONObject.optJSONObject("digest");
        this.ac = (optJSONObject == null || fl == null || !optJSONObject.toString().equals(fl.toString())) ? false : true;
        ...
        if (jSONObject.has("req_inter_min")) {
            ...
            if (optLong < 0 || optLong > Constants.MILLIS_IN_DAY) {
                optLong = TTAdConstant.AD_MAX_EVENT_TIME;
            }
            Qhi.Qhi("req_inter_min", optLong);
        }
        if (jSONObject.has("lp_new_style")) {
            Qhi.Qhi("landingpage_new_style", jSONObject.optInt("lp_new_style", Integer.MAX_VALUE));
        }
        ...
        if (optJSONObject2 != null) {
            ...
            if (optJSONObject2.has(AppLovinMediationProvider.MAX)) {
                Qhi.Qhi(AppLovinMediationProvider.MAX, optJSONObject2.optInt(AppLovinMediationProvider.MAX));
            }
        }
        ...
        if (optJSONObject3 != null) {
            if (optJSONObject3.has(MediationMetaData.KEY_VERSION)) {
                Qhi.Qhi("ab_test_version", optJSONObject3.optString(MediationMetaData.KEY_VERSION));
            }
        ...
        if (optJSONObject5 != null) {
            ...
            if (optJSONObject5.has("disable_rotate_banner_on_dislike")) {
                Qhi.Qhi("disable_rotate_banner_on_dislike", optJSONObject5.optInt("disable_rotate_banner_on_dislike", Integer.MAX_VALUE));
            }
                ...
                try {
                    ...
                    if (optJSONArray != null && optJSONArray.length() != 0) {
                        for (int i = 0; i < optJSONArray.length(); i++) {
                            this.fl.add(optJSONArray.getString(i));
                        }
                    }
                    this.fl = Qhi(this.fl);
                    Qhi.Qhi("gecko_hosts", optJSONArray.toString());
                } catch (Throwable th) {
                    com.bytedance.sdk.component.utils.ABk.cJ("GeckoLog: settings json error ".concat(String.valueOf(th)));
                }
            }
        }
        ...
        if (optJSONObject6 != null) {
            if (optJSONObject6.has("ad_enable")) {
                Qhi.Qhi("privacy_ad_enable", optJSONObject6.optInt("ad_enable", Integer.MAX_VALUE));
            }
            if (optJSONObject6.has("personalized_ad")) {
                Qhi.Qhi("privacy_personalized_ad", optJSONObject6.optInt("personalized_ad", Integer.MAX_VALUE));
            }
            if (optJSONObject6.has("sladar_enable")) {
                Qhi.Qhi("privacy_sladar_enable", optJSONObject6.optInt("sladar_enable", Integer.MAX_VALUE));
            }
            if (optJSONObject6.has("app_log_enable")) {
                Qhi.Qhi("privacy_app_log_enable", optJSONObject6.optInt("app_log_enable", Integer.MAX_VALUE));
            }
            if (optJSONObject6.has("debug_unlock")) {
                Qhi.Qhi("privacy_debug_unlock", optJSONObject6.optInt("debug_unlock", Integer.MAX_VALUE));
            }
        ...
        if (optJSONObject7 != null) {
            ...
            if (optJSONObject7.has("bus_con_sec_type")) {
                Qhi.Qhi("bus_con_sec_type", optJSONObject7.optInt("bus_con_sec_type", Integer.MAX_VALUE));
            }
            ...
            if (optJSONObject7.has("bus_con_behavior_count")) {
                Qhi.Qhi("bus_con_behavior_count", optJSONObject7.optInt("bus_con_behavior_count", VastError.ERROR_CODE_GENERAL_WRAPPER));
            }
            ...
            if (optJSONObject7.has("bus_con_arbitrage_loading_timeout")) {
                Qhi.Qhi("bus_con_arbitrage_loading_timeout", optJSONObject7.optInt("bus_con_arbitrage_loading_timeout", 10000));
            }
        ...
        if (jSONObject.has("perf_con")) {
            try {
                ...
                com.bytedance.sdk.component.utils.ABk.Qhi("SettingsDefaultRepository", th2.getMessage());
            }
        }
        ...
        try {
            ...
            com.bytedance.sdk.component.utils.ABk.Qhi("SettingsDefaultRepository", "coreSettingJson", e2.getMessage());
        }
