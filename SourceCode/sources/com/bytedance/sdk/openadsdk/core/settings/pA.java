...
public class pA extends com.bytedance.sdk.component.Sf.hm {
            ...
            public void Qhi(com.bytedance.sdk.component.ROR.cJ.ac acVar, com.bytedance.sdk.component.ROR.cJ cJVar) {
                ...
                if (cJVar.Tgh() && !TextUtils.isEmpty(CJ)) {
                    ...
                    if (jSONObject2 != null && (optInt = jSONObject2.optInt("cypher", -1)) != -1) {
                        if (optInt == 3) {
                            str = com.bytedance.sdk.component.utils.Qhi.ac(jSONObject2.optString("message"));
    ...
    public static JSONObject Qhi(int i) {
        ...
        try {
            ...
            jSONObject.put("gdpr", com.bytedance.sdk.openadsdk.core.hm.cJ().hm());
            ...
            jSONObject.put("conn_type", js.ROR(i));
            int i2 = 1;
            jSONObject.put("os", 1);
            ...
            jSONObject.put(Constants.UUID, com.bytedance.sdk.openadsdk.core.zc.ac(Qhi2));
            String CJ2 = com.bytedance.sdk.openadsdk.core.hm.cJ().CJ();
            if (CJ2 != null) {
                jSONObject.put(OSOutcomeConstants.APP_ID, CJ2);
            }
            long currentTimeMillis = System.currentTimeMillis() / 1000;
            jSONObject.put("ts", currentTimeMillis);
            String str = "";
            if (CJ2 != null) {
                str = CJ2.concat(String.valueOf(currentTimeMillis)).concat(BuildConfig.VERSION_NAME);
            }
            jSONObject.put("req_sign", com.bytedance.sdk.component.utils.Tgh.Qhi(str));
            ...
            String fl2 = com.bytedance.sdk.openadsdk.core.hm.cJ().fl();
            if (!TextUtils.isEmpty(fl2)) {
                jSONObject.put("mediation", fl2);
            }
        } catch (Exception unused) {
        }
        return jSONObject;
