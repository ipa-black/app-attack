...
public class MQ extends tP {
    ...
    public Qhi.C0225Qhi Xw() {
        return this.Qhi.Sf();
    }

    public List<tP> Gf() {
        List<tP> ac = this.Qhi.ac();
        return ac != null ? ac : new ArrayList();
    }
