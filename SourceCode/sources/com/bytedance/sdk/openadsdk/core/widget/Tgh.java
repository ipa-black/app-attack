...
public class Tgh {
    ...
    private void Qhi(Context context, View view, boolean z) {
    ...
    private boolean Qhi(int i) {
        ...
        if (this.CJ != null && (cJVar = this.fl) != null) {
            if (cJVar.WAv()) {
    ...
    private void Qhi(com.bykv.vk.openvk.component.video.api.ac.cJ cJVar, boolean z) {
        View view;
        String str;
        View view2;
        if (cJVar == null || (view = this.Qhi) == null || this.ac == null || view.getVisibility() == 0) {
            return;
        }
        cJ cJVar2 = this.fl;
        if (cJVar2 != null) {
        ...
        if (z) {
            str = String.format(MQ.Qhi(this.ac, "tt_video_without_wifi_tips"), Float.valueOf(Double.valueOf(ceil).floatValue()));
        } else {
            str = MQ.Qhi(this.ac, "tt_video_without_wifi_tips") + MQ.Qhi(this.ac, "tt_video_bytesize");
        }
        zn.Qhi(this.Qhi, 0);
        zn.Qhi(this.cJ, str);
