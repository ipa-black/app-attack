...
public class cJ {
    ...
    public static void Qhi(tP tPVar, long j, long j2) {
        if (tPVar != null) {
            if (bxS.Gm(tPVar) || bxS.cJ(tPVar)) {
                ...
                try {
                    ...
                    ABk.Qhi("PlayableEvent", "onSuccess json error", e2);
                }
    ...
    public static void Qhi(tP tPVar, int i, String str) {
        if (tPVar != null) {
            if (bxS.Gm(tPVar) || bxS.cJ(tPVar)) {
                JSONObject jSONObject = new JSONObject();
                try {
                    ...
                    ABk.Qhi("PlayableEvent", "onFail json error", e2);
                }
