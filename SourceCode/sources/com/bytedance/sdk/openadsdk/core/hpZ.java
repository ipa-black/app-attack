...
public class hpZ {
    ...
    private List<View> fl = new ArrayList();
    private final com.bytedance.sdk.openadsdk.cJ.Sf hm = new com.bytedance.sdk.openadsdk.cJ.Sf();
    ...
    private void Qhi(ViewGroup viewGroup, List<View> list, List<View> list2, List<View> list3, com.bytedance.sdk.openadsdk.apiImpl.feed.ROR ror) {
        this.ROR = ror;
        viewGroup.addOnLayoutChangeListener(new Qhi(this.hm, viewGroup));
        this.fl = list;
        Qhi(list2, (com.bytedance.sdk.openadsdk.core.cJ.ac) null);
        if (list != null) {
            for (View view : this.fl) {
                if (view != null) {
    ...
    private EmptyView cJ(ViewGroup viewGroup, List<View> list, List<View> list2, List<View> list3, com.bytedance.sdk.openadsdk.apiImpl.feed.ROR ror) {
        ...
        if (CJ == null) {
            CJ = new EmptyView(this.ac, viewGroup);
    ...
    public static class Qhi implements View.OnLayoutChangeListener {
        ...
        public Qhi(com.bytedance.sdk.openadsdk.cJ.Sf sf, ViewGroup viewGroup) {
            this.Qhi = sf;
            this.cJ = viewGroup;
        }
    ...
    private void Qhi(ViewGroup viewGroup, View view) {
        ...
        this.ABk.Qhi(new cJ.Qhi() { // from class: com.bytedance.sdk.openadsdk.core.hpZ.1
            ...
            public void Qhi(View view2, int i) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void Qhi(boolean z, ViewGroup viewGroup) {
        if (z && this.Qhi.qb() && !this.Qhi.ZRq()) {
            this.Qhi.ROR(true);
            com.bytedance.sdk.openadsdk.core.model.tP tPVar = this.Qhi;
        ...
        if (!z && this.Sf > 0) {
            ...
            this.hm.Qhi(System.currentTimeMillis(), sDy.Qhi(viewGroup));
            com.bytedance.sdk.openadsdk.cJ.ac.Qhi(valueOf, this.Qhi, this.Tgh, this.hm);
            this.Sf = 0L;
            return;
        }
        this.hm.Qhi(System.currentTimeMillis(), sDy.Qhi(viewGroup));
    ...
    public void cJ() {
        if (this.Sf > 0) {
            com.bytedance.sdk.openadsdk.cJ.ac.Qhi(String.valueOf(SystemClock.elapsedRealtime() - this.Sf), this.Qhi, this.Tgh, this.hm);
            this.Sf = 0L;
        }
    }
    ...
    private void ac(ViewGroup viewGroup) {
        ...
        try {
            ...
            if (viewGroup != null) {
                ...
                try {
                    jSONObject3.put(IabUtils.KEY_WIDTH, viewGroup.getWidth());
                    jSONObject3.put(IabUtils.KEY_HEIGHT, viewGroup.getHeight());
            ...
            if (Sf != null) {
                ...
                try {
                    jSONObject4.put(IabUtils.KEY_WIDTH, zn.ac(this.ac, Sf.getWidth()) * 1.0f);
                    jSONObject4.put(IabUtils.KEY_HEIGHT, zn.ac(this.ac, Sf.getHeight()) * 1.0f);
            ...
            com.bytedance.sdk.component.utils.ABk.Qhi("InteractionManager", "onShowFun json error", e2);
        }
    }
