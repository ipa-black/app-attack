...
public class ROR extends com.bytedance.sdk.openadsdk.core.cJ.Qhi {
    public ROR(Context context, tP tPVar, String str, int i) {
    ...
    public com.bytedance.sdk.openadsdk.core.model.Gm Qhi(float f2, float f3, float f4, float f5, SparseArray<ac.Qhi> sparseArray, long j, long j2, View view, View view2, String str, float f6, int i, float f7, int i2, JSONObject jSONObject, JSONObject jSONObject2) {
        ...
        this.MQ = i8;
        return new Gm.Qhi().Tgh(f8).fl(f9).CJ(f10).ac(f11).cJ(j3).Qhi(j4).cJ(Qhi).Qhi(iArr).ac(zn.ac(view)).CJ(iArr2).CJ(this.Eh).fl(this.aP).Tgh(this.NFd).cJ(com.bytedance.sdk.openadsdk.core.hm.cJ().Qhi() ? i5 : 2).Qhi(sparseArray).Qhi(str).Qhi(f6).ac(i).cJ(f7).Qhi(i2).Qhi(jSONObject).cJ(jSONObject2).Qhi();
    }
