...
public class Gm {
    ...
    public static void Qhi() {
        ...
        com.bytedance.sdk.component.adexpress.Qhi.Qhi.Qhi.Qhi().Qhi(new com.bytedance.sdk.component.adexpress.Qhi.Qhi.fl() { // from class: com.bytedance.sdk.openadsdk.core.nativeexpress.Gm.3
            ...
            public void Qhi(int i) {
                com.bytedance.sdk.openadsdk.Gm.ac.Qhi().Qhi(com.bytedance.sdk.openadsdk.Gm.Qhi.fl.cJ().cJ(i).Tgh(com.bytedance.sdk.openadsdk.core.Sf.Qhi(i)));
            }
        });
        com.bytedance.sdk.component.widget.Qhi.Qhi.Qhi().Qhi(new com.bytedance.sdk.component.widget.Qhi.cJ() { // from class: com.bytedance.sdk.openadsdk.core.nativeexpress.Gm.4
            ...
            @Override // com.bytedance.sdk.component.widget.Qhi.cJ
            public void Qhi(com.bytedance.sdk.component.widget.cJ.Qhi qhi, String str, String str2, JSONObject jSONObject, long j) {
                tP ac = tP.ac();
                ac.HzH(qhi.Qhi());
                ac.MQ(qhi.cJ());
                ac.kYc(qhi.ac());
                com.bytedance.sdk.openadsdk.cJ.ac.cJ(ac, str, str2, jSONObject, j);
            }
        });
    }
    ...
    public static String cJ() {
        ...
        if (cJ2 != null && (ac = cJ2.ac()) != null && !ac.equals(Qhi)) {
            Qhi = ac;
            com.bytedance.sdk.openadsdk.multipro.CJ.Tgh.Qhi("tt_sp", "js_render_ver", ac);
        }
        return Qhi;
    }
    ...
    public static String ac() {
        ...
        com.bytedance.sdk.component.adexpress.Qhi.ac.Qhi cJ2 = com.bytedance.sdk.component.adexpress.Qhi.cJ.hm.cJ();
        if (cJ2 != null && (Qhi2 = cJ2.Qhi()) != null && (qhi = Qhi2.get("v3")) != null && (ac = qhi.ac()) != null && !ac.equals(cJ)) {
            cJ = ac;
            com.bytedance.sdk.openadsdk.multipro.CJ.Tgh.Qhi("tt_sp", "js_render_v3_ver", ac);
        }
        return cJ;
    }
}
