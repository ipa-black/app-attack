...
public class lB {
    ...
    private static com.bytedance.sdk.openadsdk.Gm.Qhi.cJ Qhi(int i, com.bytedance.sdk.openadsdk.core.model.tP tPVar) {
    ...
    public static boolean Qhi(Context context, com.bytedance.sdk.openadsdk.core.model.tP tPVar, int i, PAGNativeAd pAGNativeAd, PangleAd pangleAd, String str, com.bytedance.sdk.openadsdk.pA.Qhi.Qhi.fl flVar, boolean z, int i2) {
        String Qhi2;
        com.bytedance.sdk.openadsdk.cJ.ac.Qhi(Qhi(-1, tPVar));
        if (context == null || tPVar == null || i == -1) {
            com.bytedance.sdk.openadsdk.cJ.ac.Qhi(Qhi(1, tPVar));
            return false;
        }
        ...
        if (ReL != null && !TextUtils.isEmpty(ReL.Qhi())) {
            if (Qhi(context, tPVar, i, str, z, hashMap)) {
        ...
        return Qhi(context, tPVar, i, pAGNativeAd, pangleAd, str, z, str2);
    }
    ...
    public static boolean Qhi(Context context, com.bytedance.sdk.openadsdk.core.model.tP tPVar, int i, String str, boolean z, Map<String, Object> map) {
        if (tPVar == null) {
            return false;
        }
        com.bytedance.sdk.openadsdk.core.model.zc ReL = tPVar.ReL();
        ...
        if (js.Sf(context)) {
            ...
            if (cJ.cJ > 0) {
                ...
                try {
                    ...
                    if (!HzH.CJ().Sf()) {
                        Qhi(context, tPVar.YB(), tPVar, i, str, z);
                        com.bytedance.sdk.component.utils.ABk.Qhi("WebHelper", "openDetailPage() -> context.startActivity(intent) fail :", e2);
                    }
                    return false;
                }
            }
    ...
    public static boolean Qhi(Context context, com.bytedance.sdk.openadsdk.core.model.tP tPVar, int i, PAGNativeAd pAGNativeAd, PangleAd pangleAd, String str, boolean z, String str2) {
        if (!TextUtils.isEmpty(str2) || com.bytedance.sdk.openadsdk.core.model.bxS.cJ(tPVar)) {
            ...
            com.bytedance.sdk.component.utils.cJ.Qhi(context, Qhi(context, str2, tPVar, i, pAGNativeAd, pangleAd, str, z), null);
            Qhi = false;
            return true;
        }
    ...
    public static boolean Qhi(Context context, String str, com.bytedance.sdk.openadsdk.core.model.tP tPVar, int i, String str2, boolean z) {
        try {
            context.startActivity(Qhi(context, str, tPVar, i, (PAGNativeAd) null, (PangleAd) null, str2, z));
            return true;
    ...
    public static boolean cJ(Context context, String str, com.bytedance.sdk.openadsdk.core.model.tP tPVar, int i, String str2, boolean z) {
        try {
            Intent Qhi2 = Qhi(context, str, tPVar, i, (PAGNativeAd) null, (PangleAd) null, str2, z, true);
            if (!(context instanceof Activity)) {
    ...
    private static Intent Qhi(Context context, String str, com.bytedance.sdk.openadsdk.core.model.tP tPVar, int i, PAGNativeAd pAGNativeAd, PangleAd pangleAd, String str2, boolean z) {
        return Qhi(context, str, tPVar, i, pAGNativeAd, pangleAd, str2, z, false);
    }

    private static Intent Qhi(Context context, String str, com.bytedance.sdk.openadsdk.core.model.tP tPVar, int i, PAGNativeAd pAGNativeAd, PangleAd pangleAd, String str2, boolean z, boolean z2) {
        Intent intent;
        if (!z2 && com.bytedance.sdk.openadsdk.core.model.bxS.cJ(tPVar) && (pAGNativeAd != null || pangleAd != null)) {
            intent = new Intent(context, TTPlayableLandingPageActivity.class);
            intent.putExtra("ad_pending_download", Qhi(tPVar, z));
            String fl = com.bytedance.sdk.openadsdk.core.model.bxS.fl(tPVar);
            if (!TextUtils.isEmpty(fl)) {
                if (fl.contains("?")) {
                    str = fl + "&orientation=portrait";
                } else {
                    str = fl + "?orientation=portrait";
                }
            }
        } else {
            intent = (z2 || tPVar.ip() != 3 || !(tPVar.hpZ() == 2 || (tPVar.hpZ() == 1 && Qhi)) || tPVar.GN()) ? new Intent(context, TTLandingPageActivity.class) : new Intent(context, TTVideoLandingPageLink2Activity.class);
        }
        ...
        if (tPVar.gga() == 5 || tPVar.gga() == 15 || tPVar.gga() == 50) {
            if (pAGNativeAd != null) {
                if (pAGNativeAd instanceof Qhi.InterfaceC0239Qhi) {
                    qhi = ((Qhi.InterfaceC0239Qhi) pAGNativeAd).Tgh();
    ...
    private static boolean Qhi(com.bytedance.sdk.openadsdk.core.model.tP tPVar, boolean z) {
        if (z && tPVar != null && tPVar.ip() == 4) {
