...
public class aP implements pM {
    private static final Map<Integer, String> fl = new HashMap<Integer, String>(12) { // from class: com.bytedance.sdk.openadsdk.core.aP.1
        {
            put(1, "abtest");
            put(2, "user_data");
            put(3, "gaid");
    ...
    boolean Qhi = false;
    boolean cJ = false;
    String ac = "com.union_test.internationad";
    String CJ = "8025677";
    private int Tgh = 0;
    ...
    public String ac(String str) {
        ...
        try {
            ...
            if (WAv != null && qMt != null) {
                ...
                jSONObject2.put(MediationMetaData.KEY_VERSION, WAv);
            ...
            while (i > 0 && jSONObject.toString().getBytes().length > 2680) {
                jSONObject.remove(fl.get(Integer.valueOf(i)));
                i--;
            }
            ...
            JSONObject Qhi2 = Qhi(jSONObject, z);
            while (i > 0 && Qhi2.toString().getBytes().length > 4096) {
                jSONObject.remove(fl.get(Integer.valueOf(i)));
                Qhi2 = Qhi(jSONObject, z);
                i--;
            }
            if (com.bytedance.sdk.component.utils.ABk.CJ()) {
                new StringBuilder("bidding token: ").append(Qhi2).append("\nbidding token length: ");
                int length = Qhi2.toString().getBytes().length;
            }
            new StringBuilder("bidding token: ").append(Qhi2);
    ...
    private JSONObject Qhi(JSONObject jSONObject, boolean z) {
        JSONObject Qhi;
        if (z) {
    ...
    @Override // com.bytedance.sdk.openadsdk.core.pM
    public boolean Qhi(String str, int i, String str2, String str3, String str4) {
        if (this.ac.equals(HzH.Qhi().getPackageName()) && this.CJ.equals(hm.cJ().CJ()) && !TextUtils.isEmpty(str)) {
            try {
                ...
                if (Qhi != null) {
                    Qhi.invoke(null, str, Integer.valueOf(i), str2, str3, str4);
                }
            } catch (Throwable unused) {
            }
            return true;
