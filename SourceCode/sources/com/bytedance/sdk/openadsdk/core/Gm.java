...
public class Gm {
        ...
        com.bytedance.sdk.openadsdk.utils.lG.ac(new com.bytedance.sdk.component.Sf.hm("ipv6") { // from class: com.bytedance.sdk.openadsdk.core.Gm.1
            ...
            public void run() {
                ...
                try {
                    ...
                    com.bytedance.sdk.openadsdk.Gm.ac.Qhi(-1, SO, -2, e2.getMessage());
                    com.bytedance.sdk.component.utils.ABk.cJ("build ipv6 request failed:" + e2.getMessage());
                }
            }
        });
    }
    ...
    public static class Qhi implements bxS.Qhi {
        ...
        public void Qhi(Context context, Intent intent, boolean z, int i) {
            if (System.currentTimeMillis() - cJ >= ExoPlayer.DEFAULT_DETACH_SURFACE_TIMEOUT_MS && i != 0) {
                Gm.ac();
                Gm.ac(zc.Qhi(HzH.Qhi()));
                cJ();
            }
