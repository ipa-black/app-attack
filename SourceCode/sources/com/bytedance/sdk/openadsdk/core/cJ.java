...
public class cJ {
    ...
    public static Pair<com.bytedance.sdk.openadsdk.core.model.Qhi, ArrayList<Integer>> Qhi(JSONObject jSONObject, AdSlot adSlot, com.bytedance.sdk.openadsdk.core.model.qMt qmt, com.bytedance.sdk.openadsdk.core.model.cJ cJVar) {
        ...
        try {
            ...
            qhi.cJ(jSONObject.optString("message"));
            ...
            if (optJSONArray != null) {
                ...
                for (int i2 = 0; i2 < optJSONArray.length(); i2++) {
                    com.bytedance.sdk.openadsdk.core.model.tP Qhi2 = Qhi(optJSONArray.optJSONObject(i2), adSlot, qmt);
                    if (Qhi2 != null && qhi.Gm()) {
                        if (Qhi2.hpZ() == 30) {
                            Qhi2.hm(true);
                        } else {
            ...
            Qhi(i, qhi, arrayList, cJVar2);
            return new Pair<>(qhi, arrayList);
        } catch (Throwable th) {
            com.bytedance.sdk.component.utils.ABk.Qhi("TTAD.AdInfoFactory", th.getMessage());
            return null;
        }
    }

    private static void Qhi(int i, final com.bytedance.sdk.openadsdk.core.model.Qhi qhi, final ArrayList<Integer> arrayList, final com.bytedance.sdk.openadsdk.core.model.cJ cJVar) {
        if (qhi == null || i < 2 || !qhi.ROR()) {
            return;
        }
        final int size = i - (qhi.ac() != null ? qhi.ac().size() : 0);
        final boolean z = qhi.Sf() == null;
        if (size > 0 || z) {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:129:0x0592, code lost:
        if (r13.optBoolean("is_html", false) != false) goto L120;
     */
    /*
    ...
    */
    ...
    private static com.bytedance.sdk.openadsdk.core.ugen.fl.Qhi cJ(JSONObject jSONObject) {
        ...
        qhi.Qhi(jSONObject.optString("id"));
        qhi.cJ(jSONObject.optString("md5"));
        qhi.ac(jSONObject.optString("url"));
        return qhi;
    }
    ...
    private static void Qhi(final com.bytedance.sdk.openadsdk.core.model.tP tPVar, final String str, final com.bytedance.sdk.openadsdk.core.ROR.Qhi qhi, final long j, final cJ.Qhi qhi2) {
                    ...
                    if (qhi3 != null) {
                        if (!TextUtils.isEmpty(qhi3.hm()) && !TextUtils.isEmpty(qhi.Tgh()) && qhi.Sf() > 0.0d) {
                            ...
                            if (qhi4 != null) {
                                ...
                                jSONObject.put("impression_links_null", qhi2.ac);
                            }
    ...
    private static Pair<com.bytedance.sdk.openadsdk.core.ROR.Qhi, cJ.Qhi> Qhi(String str, int i, int i2) {
        int i3;
        int i4;
        ...
        com.bytedance.sdk.openadsdk.core.ROR.Qhi.Qhi.Tgh tgh = new com.bytedance.sdk.openadsdk.core.ROR.Qhi.Qhi.Tgh(HzH.Qhi(), i3, i4);
        ...
        try {
            ...
            if (optJSONArray != null && optJSONArray.length() > 0) {
                for (int i = 0; i < optJSONArray.length(); i++) {
                    FilterWord fl = fl(optJSONArray.optJSONObject(i));
                    if (fl != null && fl.isValid()) {
                        filterWord.addOption(fl);
                    }
                }
            }
            return filterWord;
    ...
    private static com.bytedance.sdk.openadsdk.core.model.ac Tgh(JSONObject jSONObject) {
        ...
        acVar.ac(jSONObject.optString("package_name"));
        acVar.Qhi(jSONObject.optString("download_url"));
        acVar.Qhi(jSONObject.optDouble(FirebaseAnalytics.Param.SCORE, -1.0d));
    ...
    private static com.bykv.vk.openvk.component.video.api.ac.cJ Qhi(JSONObject jSONObject, com.bytedance.sdk.openadsdk.core.model.tP tPVar, boolean z) {
        int optInt;
        if (jSONObject == null) {
            return null;
        }
    ...
    */
    ...
    private static int ac(com.bytedance.sdk.openadsdk.core.model.tP tPVar) {
        int i;
        String ac = js.ac(tPVar.eN());
        if (tPVar.nR() == 0) {
            i = Qhi(tPVar.ReL());
            if (i != 200) {
                com.bytedance.sdk.openadsdk.cJ.ac.ac(tPVar, ac, i);
                return i;
            }
        } else {
            i = 200;
        ...
        if (ip != 2 && ip != 3) {
            if (ip == 4) {
                ...
                if (Qhi2 != 200) {
                    com.bytedance.sdk.openadsdk.cJ.ac.ac(tPVar, ac, Qhi2);
                    return Qhi2;
                }
                return Qhi2;
            } else if (ip != 8) {
        ...
        if (CJ(tPVar) && TextUtils.isEmpty(tPVar.YB())) {
            com.bytedance.sdk.openadsdk.cJ.ac.ac(tPVar, ac, (int) TTAdConstant.LANDING_PAGE_TYPE_CODE);
    ...
    private static int Qhi(com.bytedance.sdk.openadsdk.core.model.zc zcVar) {
        ...
        return TextUtils.isEmpty(zcVar.cJ()) ? TTAdConstant.DEEPLINK_FALLBACK_CODE : (zcVar.ac() == 1 || zcVar.ac() == 2) ? 200 : 405;
    }

    private static int Qhi(com.bykv.vk.openvk.component.video.api.ac.cJ cJVar, boolean z) {
        if (cJVar == null) {
        ...
        if (z || !TextUtils.isEmpty(cJVar.WAv())) {
            return 200;
        }
    ...
    private static int Qhi(com.bytedance.sdk.openadsdk.core.model.ac acVar) {
        return acVar == null ? TTAdConstant.DOWNLOAD_APP_INFO_CODE : TextUtils.isEmpty(acVar.Qhi()) ? TTAdConstant.DOWNLOAD_URL_CODE : TextUtils.isEmpty(acVar.ac()) ? 416 : 200;
    }
