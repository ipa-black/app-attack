...
public class cJ {
    ...
    public ILoader cJ() {
        try {
            ...
            ABk.Qhi("GeckoHub", "getGeckoResLoader error", th);
            return null;
        }
    }
    ...
    private cJ() {
        try {
            ...
            ABk.Qhi("GeckoHub", "GeckoHubImp init error", th);
        }
    }
    ...
    public void Qhi(final Map<String, tP> map) {
        try {
            ...
            cJ(map, null, th.toString());
            ABk.Qhi("GeckoHub", "releaseGeckoResLoader error", th);
        }
    }
    ...
    public static void cJ(Map<String, tP> map, JSONObject jSONObject, String str) {
        try {
            ...
            for (tP tPVar : map.values()) {
                com.bytedance.sdk.openadsdk.Gm.ac.Qhi(tPVar, jSONObject);
            }
        } catch (Throwable th) {
            ABk.Qhi("GeckoHub", "upLoadStateEvent error", th);
        }
    }
    ...
    public WebResourceResponseModel Qhi(ILoader iLoader, String str, String str2) {
        if (iLoader != null) {
            try {
                ...
                ABk.Qhi("GeckoHub", "findRes error", th);
                return null;
            }
        }
        return null;
    ...
    public int Qhi(ILoader iLoader, String str) {
        try {
            ...
            ABk.Qhi("GeckoHub", "getResCount error", th);
            return 0;
        }
    }
    ...
    public static void ac() {
        try {
            ...
            ABk.Qhi("GeckoHub", "setThreadPoolExecutor error", th);
        }
    }
}
