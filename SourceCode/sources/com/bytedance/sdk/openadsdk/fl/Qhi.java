...
public class Qhi implements INetWork {
    protected zc Qhi = new zc.Qhi().Qhi(10, TimeUnit.SECONDS).cJ(10, TimeUnit.SECONDS).ac(10, TimeUnit.SECONDS).Qhi();
    protected zc cJ = new zc.Qhi().Qhi(10, TimeUnit.SECONDS).cJ(30, TimeUnit.SECONDS).ac(30, TimeUnit.SECONDS).Qhi();
        ...
        try {
            try {
                try {
                    ...
                    ac = Qhi.ac();
                    try {
                        bufferedInputStream = new BufferedInputStream(Qhi.Tgh().ac());
                    } catch (Exception e3) {
                        e2 = e3;
                    }
                } catch (Exception e4) {
