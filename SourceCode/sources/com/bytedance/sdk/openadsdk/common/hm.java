...
public class hm extends Dialog {
    ...
    public void Qhi(String str) {
        try {
            ...
            this.ac = com.bytedance.sdk.component.utils.Qhi.Qhi(new JSONObject(str)).toString();
        } catch (JSONException e2) {
            ABk.Qhi("TTPrivacyAdReportDialog", e2.getMessage());
        }
    }
    ...
    private void cJ() {
        final String fl = js.fl();
        final String ROR = js.ROR();
        final String str = "Android " + Build.VERSION.RELEASE;
        final String str2 = Build.BRAND + " " + Build.MODEL;
        this.fl.setOnClickListener(new View.OnClickListener() { // from class: com.bytedance.sdk.openadsdk.common.hm.1
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                ClipboardManager clipboardManager = (ClipboardManager) hm.this.getContext().getSystemService("clipboard");
                if (clipboardManager != null) {
                    StringBuilder sb = new StringBuilder();
                    String[] strArr = {BuildConfig.VERSION_NAME, fl, ROR, str, str2, hm.this.ac};
                    for (int i = 0; i < hm.cJ.length; i++) {
                        sb.append(hm.cJ[i]).append(": ").append(strArr[i]).append("\n");
                    }
                    try {
    ...
    private View Qhi(Context context) {
        ...
        PAGLinearLayout Qhi2 = Qhi(context, "App", fl);
        ...
        this.fl = new Button(context);
        LinearLayout.LayoutParams layoutParams8 = new LinearLayout.LayoutParams(-1, -1);
        int Qhi7 = Qhi(16.0f);
        layoutParams8.setMargins(Qhi7, Qhi7, Qhi7, Qhi7);
        this.fl.setBackground(com.bytedance.sdk.openadsdk.utils.hm.Qhi(context, "tt_ad_report_info_button_bg"));
        this.fl.setText("copy all");
        this.fl.setTextColor(Color.parseColor("#333333"));
        ...
        pAGLinearLayout3.addView(this.fl);
