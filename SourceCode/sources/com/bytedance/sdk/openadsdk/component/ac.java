...
public class ac {
    ...
    protected final com.bytedance.sdk.openadsdk.component.Qhi fl;
    protected final com.bytedance.sdk.openadsdk.component.Sf.Qhi hm;
    ...
    public ac(Activity activity, tP tPVar, FrameLayout frameLayout, com.bytedance.sdk.openadsdk.component.Qhi qhi, int i, boolean z, com.bytedance.sdk.openadsdk.component.Sf.Qhi qhi2) {
        this.Qhi = activity;
        this.cJ = tPVar;
        this.CJ = frameLayout;
        this.ROR = i;
    ...
    public void Qhi(ViewGroup viewGroup) {
        ...
        this.zc = pAGAppOpenDefaultNativeLayout.getAdLogo();
        ...
        if (!this.cJ.gT()) {
            this.MQ.Qhi(pAGAppOpenDefaultNativeLayout, this.cJ, this.tP, this.kYc, this.ac);
        }
    ...
    public void Qhi() {
        this.zc.setOnClickListener(new View.OnClickListener() { // from class: com.bytedance.sdk.openadsdk.component.ac.2
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                try {
                    TTWebsiteActivity.Qhi(ac.this.Qhi, ac.this.cJ, "open_ad");
                } catch (Throwable th) {
                    ABk.Qhi("AppOpenAdNativeManager", th.getMessage());
                }
            }
        });
        ...
        com.bytedance.sdk.openadsdk.component.Qhi.Qhi Qhi2 = com.bytedance.sdk.openadsdk.component.Qhi.cJ.Qhi(this.cJ, this.Qhi, this.hm);
    ...
    */
    private void Tgh() {
        ...
        L1c:
            ...
            if (r0 == 0) goto L37
            com.bytedance.sdk.openadsdk.component.Qhi r0 = r8.fl
            r0.ac()
            goto L3c
        L37:
            com.bytedance.sdk.openadsdk.component.Qhi r0 = r8.fl
    ...
    public boolean Qhi(FrameLayout frameLayout) {
        ...
        this.bxS.Qhi(this.fl);
        try {
            return this.bxS.Qhi();
        } catch (Throwable th) {
            ABk.Qhi("AppOpenAdNativeManager", "open_ad", "ttAppOpenAd playVideo error: " + th.getMessage());
            return false;
        }
    }

    private void cJ(int i) {
        zn.Qhi((View) this.Sf, i);
    }
    ...
    private void Sf() {
        ...
        pA.Qhi(new com.bytedance.sdk.openadsdk.iMK.Qhi(hpz.Qhi(), hpz.ROR()), hpz.cJ(), hpz.ac(), new cJ(this), com.bytedance.sdk.openadsdk.component.ROR.Qhi.cJ(TextUtils.isEmpty(hpz.ROR()) ? com.bytedance.sdk.component.utils.Tgh.Qhi(hpz.Qhi()) : hpz.ROR()).getParent(), 25);
    }
