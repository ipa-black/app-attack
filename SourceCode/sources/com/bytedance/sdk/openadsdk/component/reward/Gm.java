...
public class Gm {
    public static void Qhi(String str, int i, String str2, String str3, String str4) {
        try {
            ...
            if (Qhi != null) {
                ...
                if (Qhi.pv() != null) {
                    if (!TextUtils.isEmpty(str2)) {
                        Qhi.pv().Qhi(str2);
                        Qhi.pv().cJ("Test the downloaded app");
                    } else {
                        Qhi.pv().Qhi((String) null);
                        Qhi.pv().cJ("");
                    }
                    if (TextUtils.isEmpty(str2)) {
                        str2 = str4;
            ...
            arrayList.add(Qhi);
            qhi.Qhi(arrayList);
            new pA(HzH.Qhi(), qhi).Qhi(true);
        } catch (Exception e2) {
            com.bytedance.sdk.component.utils.ABk.Qhi("PlayableVerityHelper", e2.getMessage());
        }
    }
}
