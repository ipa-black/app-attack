...
public class cJ {
    ...
    public static tP Qhi(Intent intent, Bundle bundle, com.bytedance.sdk.openadsdk.core.video.ac.cJ cJVar) {
        if (!com.bytedance.sdk.openadsdk.multipro.cJ.ac()) {
            ...
            try {
                ...
                com.bytedance.sdk.component.utils.ABk.Qhi("TTAD.RFDM", "", e2);
            }
        }
        if (bundle != null) {
            try {
                ...
                com.bytedance.sdk.component.utils.ABk.Qhi("TTAD.RFDM", "", th);
            }
        }
        if (r3 != null) {
            r3.Qhi(r3.HzH(), 7);
    ...
    public static void Qhi(Qhi qhi, Bundle bundle) {
        ...
        try {
            ...
            com.bytedance.sdk.component.utils.ABk.Qhi("TTAD.RFDM", "onSaveInstanceState: ", th);
        }
    }
