...
public class ac extends TTDislikeDialogAbstract {
    ...
    public void onCreate(Bundle bundle) {
        try {
            ...
            Qhi(getContext());
            cJ();
            setMaterialMeta(this.hm, this.WAv);
    ...
    private void Qhi(Context context) {
        this.ac = (RelativeLayout) findViewById(iMK.Em);
        this.CJ = findViewById(iMK.wI);
        TextView textView = (TextView) findViewById(iMK.qb);
        ...
        tTDislikeListView.setOnItemClickListener(new AdapterView.OnItemClickListener() { // from class: com.bytedance.sdk.openadsdk.dislike.ac.5
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long j) {
                ...
                if (ac.this.ROR != null) {
                    try {
                        ac.this.ROR.Qhi(i, (FilterWord) ac.this.WAv.get(i));
        ...
        tTDislikeListView2.setOnItemClickListener(new AdapterView.OnItemClickListener() { // from class: com.bytedance.sdk.openadsdk.dislike.ac.6
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long j) {
                if (ac.this.ROR != null) {
                    try {
                        ac.this.ROR.Qhi(i, (FilterWord) adapterView.getAdapter().getItem(i));
                    } catch (Throwable unused) {
                    }
                }
                ac.this.dismiss();
    ...
    public static class cJ extends BaseAdapter {
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            ...
            FilterWord filterWord = this.cJ.get(i);
            qhi.Qhi.setText(filterWord.getName());
            if (HzH.YD().YB()) {
                qhi.Qhi.setBackground(hm.Qhi(this.ac.getContext(), "tt_dislike_middle_seletor"));
            } else if (i != this.cJ.size() - 1) {
                qhi.Qhi.setBackground(hm.Qhi(this.ac.getContext(), "tt_dislike_middle_seletor"));
            } else {
                qhi.Qhi.setBackground(hm.Qhi(this.ac.getContext(), "tt_dislike_bottom_seletor"));
            }
            if (this.Qhi && i == 0) {
                qhi.Qhi.setBackground(hm.Qhi(this.ac.getContext(), "tt_dislike_top_seletor"));
            }
            if (filterWord.hasSecondOptions()) {
