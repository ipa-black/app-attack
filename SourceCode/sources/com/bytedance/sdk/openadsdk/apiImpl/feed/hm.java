...
public class hm extends PAGNativeAd {
    ...
    public hm(Context context, tP tPVar, int i, boolean z) {
        if (tPVar == null) {
        ...
        this.ROR = js.ac(i);
        if (z) {
            this.CJ = new Qhi(context, tPVar, this.ROR);
            this.Qhi = new hpZ(context, this, tPVar, Qhi(i), this.CJ);
        }
    }
    ...
    public Object getExtraInfo(String str) {
        ...
        try {
            ...
            ABk.Qhi("TTNativeAdImpl", th.getMessage());
            return null;
        }
    }
    ...
    protected boolean ROR() {
        tP tPVar = this.cJ;
        return (tPVar == null || tPVar.ip() == 5 || HzH.CJ().ac(this.Tgh) != 1) ? false : true;
    }
            ...
            if (view != null && ror != null && ror.cJ()) {
                view.setOnClickListener(new View.OnClickListener() { // from class: com.bytedance.sdk.openadsdk.apiImpl.feed.hm.1
                    ...
                    public void onClick(View view2) {
                        ...
                        TTDelegateActivity.Qhi(hm.this.cJ, Qhi, new Qhi.InterfaceC0223Qhi() { // from class: com.bytedance.sdk.openadsdk.apiImpl.feed.hm.1.1
