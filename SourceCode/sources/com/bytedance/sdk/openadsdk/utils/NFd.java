...
public class NFd implements Thread.UncaughtExceptionHandler {
    ...
    */
    ...
    private void ac() {
        try {
            Method Qhi2 = com.bytedance.sdk.component.utils.Dww.Qhi("com.bytedance.sdk.openadsdk.TTC2Proxy", NotificationBundleProcessor.PUSH_ADDITIONAL_DATA_KEY, Context.class);
            if (Qhi2 != null) {
        ...
        try {
            Method Qhi3 = com.bytedance.sdk.component.utils.Dww.Qhi("com.bytedance.sdk.openadsdk.TTC3Proxy", NotificationBundleProcessor.PUSH_ADDITIONAL_DATA_KEY, Context.class);
            if (Qhi3 != null) {
