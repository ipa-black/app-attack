...
public class es {
    ...
    public static void Qhi(final ViewGroup viewGroup, boolean z, int i, cJ cJVar, List<ViewGroup> list) {
        ...
        if (list != null && list.size() > 0) {
            for (int i2 = 0; i2 < list.size(); i2++) {
                list.get(i2).setOnHierarchyChangeListener(new ViewGroup.OnHierarchyChangeListener() { // from class: com.bytedance.sdk.openadsdk.utils.es.1
    ...
    public class Qhi implements ViewTreeObserver.OnGlobalLayoutListener {
        ...
        public void onGlobalLayout() {
            try {
                ...
                ApmHelper.reportCustomError("onGlobalLayout exception " + this.cJ.getTag(520093765), "ViewUtils", e2);
            }
        }
    }
    ...
    private static boolean Qhi(View view, int i) {
        return com.bytedance.sdk.openadsdk.core.sDy.Qhi(view, 20, i);
    }
}
