...
public class lG {
    ...
    private static volatile com.bytedance.sdk.component.Sf.ac.ROR ac;
    private static volatile boolean cJ;
    private static volatile com.bytedance.sdk.component.Sf.ac.ROR fl;
    private static volatile com.bytedance.sdk.component.Sf.ac.ROR hm;
                        ...
                        if (value != null) {
                            ...
                            com.bytedance.sdk.openadsdk.Gm.ac.Qhi("pag_thread_pool_state", false, new com.bytedance.sdk.openadsdk.Gm.cJ() { // from class: com.bytedance.sdk.openadsdk.utils.lG.3.1
                                ...
                                public com.bytedance.sdk.openadsdk.Gm.Qhi.ac getLogStats() throws Exception {
                                    ...
                                    try {
                                        jSONObject.put("name", value.Qhi());
                                        jSONObject.put("times", value.cJ());
                                        jSONObject.put("runMaxTime", value.Tgh());
                                        jSONObject.put("waitMaxTime", value.fl());
                                        long cJ2 = value.cJ() == 0 ? 1 : value.cJ();
                                        jSONObject.put("avgRunTime", value.CJ() / cJ2);
                                        jSONObject.put("avgWaitTime", value.ac() / cJ2);
                                        jSONObject.put("poolType", ror.cJ());
                                    } catch (Exception e2) {
                                        com.bytedance.sdk.component.utils.ABk.Qhi("ThreadUtils", "run: ", e2);
                                    }
    ...
    public static void Qhi(final com.bytedance.sdk.component.Sf.hm hmVar, int i) {
        ...
        com.bytedance.sdk.component.Sf.ROR.Qhi(hmVar, 5, i);
    }
    ...
    public static void cJ(final com.bytedance.sdk.component.Sf.hm hmVar, int i) {
        if (hmVar == null || NFd.Qhi) {
            return;
        }
        if (Gm()) {
        ...
        com.bytedance.sdk.component.Sf.ROR.cJ(hmVar, i);
    }
    ...
    public static void ac(final com.bytedance.sdk.component.Sf.hm hmVar, int i) {
        if (hmVar == null || NFd.Qhi) {
            return;
        }
        if (Gm()) {
            ...
            com.bytedance.sdk.component.Sf.ROR.ac(hmVar, i);
        }
    }
    ...
    public static void fl(final com.bytedance.sdk.component.Sf.hm hmVar) {
        ...
        ThreadPoolExecutor zc = zc();
        zc.execute(hmVar);
        if (cJ || !com.bytedance.sdk.openadsdk.core.settings.HzH.Ug()) {
            return;
        }
        cJ = true;
        zc.setCorePoolSize(com.bytedance.sdk.openadsdk.core.settings.HzH.YD().Oy());
    }
            ...
            synchronized (lG.class) {
                if (Qhi == null) {
                    if (com.bytedance.sdk.openadsdk.core.settings.HzH.Ug()) {
                        i = com.bytedance.sdk.openadsdk.core.settings.HzH.YD().Oy();
                        cJ = true;
                    } else {
                        i = 4;
                    }
                    Qhi = new ThreadPoolExecutor(i, Integer.MAX_VALUE, 30L, TimeUnit.SECONDS, new LinkedBlockingQueue());
                    new Object[]{"token_thread_count=", Integer.valueOf(i)};
                }
            }
        }
        return Qhi;
    ...
    private static ThreadPoolExecutor ABk() {
        ...
        com.bytedance.sdk.component.Sf.ac.ROR ror2 = ac;
        if (Qhi(ror2)) {
            synchronized (lG.class) {
                if (Qhi(ac)) {
                    ac = Qhi("ad", ac);
    ...
    private static com.bytedance.sdk.component.Sf.ac.ROR hpZ() {
        com.bytedance.sdk.component.Sf.ac.ROR ror;
        com.bytedance.sdk.component.Sf.ac.ROR ror2 = fl;
        if (Qhi(ror2)) {
            synchronized (lG.class) {
                if (Qhi(fl)) {
                    fl = Qhi("aidl", fl);
    ...
    public static com.bytedance.sdk.component.Sf.ac.ROR Sf() {
        com.bytedance.sdk.component.Sf.ac.ROR ror;
        com.bytedance.sdk.component.Sf.ac.ROR ror2 = hm;
        if (Qhi(ror2)) {
            synchronized (lG.class) {
                if (Qhi(hm)) {
                    hm = Qhi("express", hm);
    ...
    private static ROR.Qhi cJ(String str) {
        ...
        switch (c2) {
            ...
            case 5:
                return qhi.Qhi(str).Qhi(2).cJ(4).ac(0).Qhi(10000L).Qhi(true).fl(-1).CJ(10).cJ(false);
            case 6:
                return qhi.Qhi(str).Qhi(0).cJ(0).ac(0).Qhi(5000L).Qhi(true).fl(-1).CJ(20).cJ(false);
            case 7:
