...
public class Qhi extends ac {
    ...
    public boolean Qhi() {
        ...
        if (this.cJ == null || this.cJ.nR() != 0) {
            hashMap = null;
        } else {
            hashMap = new HashMap();
            hashMap.put("dpl_probability_jump", Boolean.valueOf(this.ROR >= 11));
        }
        return Qhi(this.cJ, this.Qhi.ac(), ac(), this.ac, hashMap);
    }
    ...
    public boolean cJ() {
        ...
        if (this.cJ.ReL() != null) {
            ...
            if (Qhi(this.cJ.ReL().Qhi(), ac(), this.ac, this.cJ, hashMap)) {
                return true;
            }
            if (!this.CJ || this.Tgh.get()) {
                this.CJ = true;
                Qhi(this.cJ, hashMap);
                com.bytedance.sdk.openadsdk.cJ.ac.Qhi(this.cJ, this.ac, "open_fallback_url", hashMap);
            }
        } else {
            com.bytedance.sdk.openadsdk.core.fl.Qhi(this.cJ, this.ac, -1, null);
        }
