...
public class ac implements fl {
    ...
    public boolean Qhi(Context context, String str, String str2) {
        return Qhi(context, str, str2, this.ac, this.cJ);
    }
    ...
    public Context ac() {
        ...
        return (weakReference == null || weakReference.get() == null) ? HzH.Qhi() : this.Sf.get();
    }
    ...
    public void CJ() {
        ...
        if (cJ()) {
            ...
            if (fl()) {
                ...
                lB.Qhi(ac(), this.cJ.YB(), this.cJ, js.Qhi(this.ac), this.ac, true);
                this.cJ.ac(true);
            }
        }
    }
    ...
    public boolean cJ() {
        com.bytedance.sdk.openadsdk.core.fl.Qhi(this.cJ, this.ac, 1, null);
        if (this.cJ.ReL() != null) {
            ...
            if (!TextUtils.isEmpty(Qhi)) {
                ...
                if (cJ.cJ > 0) {
                    ...
                    try {
                        ...
                        com.bytedance.sdk.openadsdk.cJ.ac.Qhi(this.cJ, this.ac, "open_url_app", hashMap);
                        ac().startActivity(intent);
                        ABk.Qhi().Qhi(hashMap).Qhi(this.cJ, this.ac);
                        com.bytedance.sdk.openadsdk.cJ.ac.Qhi("dp_start_act_success", this.cJ, this.ac, hashMap);
                        return true;
                    } catch (Throwable th) {
                        ...
                        com.bytedance.sdk.openadsdk.core.fl.Qhi(this.cJ, this.ac, -4, jSONObject);
                    }
                } else {
                    ...
                    com.bytedance.sdk.openadsdk.core.fl.Qhi(this.cJ, this.ac, -3, jSONObject2);
                }
            } else {
                tP tPVar = this.cJ;
                com.bytedance.sdk.openadsdk.core.fl.Qhi(tPVar, this.ac, -2, tPVar.ReL().CJ());
            }
            if (!this.CJ || this.Tgh.get()) {
                this.CJ = true;
                Map<String, Object> hashMap2 = new HashMap<>();
                Qhi(hashMap2);
                com.bytedance.sdk.openadsdk.cJ.ac.Qhi(this.cJ, this.ac, "open_fallback_url", hashMap2);
                return false;
            }
            return false;
        }
    ...
    public boolean fl() {
        this.Tgh.set(true);
        return this.Qhi != null && Qhi(ac(), this.Qhi.Qhi(), this.Qhi.ac());
    }
    ...
    public boolean Qhi() {
        ...
        if (tPVar == null || tPVar.XH() != 0) {
            String ac = this.Qhi.ac();
            if (TextUtils.isEmpty(ac) || !js.cJ(ac(), ac) || (Qhi = js.Qhi(ac(), ac)) == null) {
                return false;
            }
            ...
            try {
                ...
                Qhi(hashMap);
                com.bytedance.sdk.openadsdk.cJ.ac.Qhi(this.cJ, this.ac, "click_open", hashMap);
                return true;
            } catch (Throwable th) {
                com.bytedance.sdk.component.utils.ABk.Qhi("GPDownLoader", th.getMessage());
                return false;
            }
        }
        return false;
    ...
    public boolean Tgh() {
        ...
        try {
            ...
            lG.cJ(new hm("task_oem_store") { // from class: com.bytedance.sdk.openadsdk.pA.Qhi.Qhi.ac.1
                ...
                public void run() {
                    if (Qhi2) {
                        com.bytedance.sdk.openadsdk.core.hm.Qhi("oem_store", IcyHeaders.REQUEST_HEADER_ENABLE_METADATA_VALUE);
                    } else {
