...
public class TTVideoAdCoverLayout extends PAGRelativeLayout {
    ...
    private void Qhi(Context context) {
        ...
        pAGTextView.setId(iMK.ip);
        RelativeLayout.LayoutParams layoutParams3 = new RelativeLayout.LayoutParams(cJ, cJ);
        layoutParams3.addRule(8, iMK.PAe);
        layoutParams3.addRule(19, iMK.PAe);
        layoutParams3.addRule(5, iMK.PAe);
        layoutParams3.addRule(7, iMK.PAe);
        layoutParams3.addRule(18, iMK.PAe);
        layoutParams3.addRule(6, iMK.PAe);
        ...
        pAGTextView2.setId(iMK.xyz);
        RelativeLayout.LayoutParams layoutParams4 = new RelativeLayout.LayoutParams(-2, -2);
        layoutParams4.addRule(3, iMK.PAe);
        ...
        layoutParams5.addRule(3, iMK.xyz);
