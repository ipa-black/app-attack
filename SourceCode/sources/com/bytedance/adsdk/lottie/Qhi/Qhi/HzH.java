...
public class HzH implements Gm, Tgh, iMK, zc, Qhi.InterfaceC0175Qhi {
    ...
    private final com.bytedance.adsdk.lottie.Qhi.cJ.HzH hm;
    ...
    public void Qhi(ListIterator<ac> listIterator) {
        ...
        this.WAv = new fl(this.ac, this.CJ, "Repeater", this.Tgh, arrayList, null);
    }
    ...
    public Path CJ() {
        ...
        for (int i = ((int) floatValue) - 1; i >= 0; i--) {
            this.Qhi.set(this.hm.cJ(i + floatValue2));
    ...
    public void Qhi(Canvas canvas, Matrix matrix, int i) {
        float floatValue = this.ROR.ROR().floatValue();
        float floatValue2 = this.Sf.ROR().floatValue();
        float floatValue3 = this.hm.cJ().ROR().floatValue() / 100.0f;
        float floatValue4 = this.hm.ac().ROR().floatValue() / 100.0f;
        for (int i2 = ((int) floatValue) - 1; i2 >= 0; i2--) {
            this.Qhi.set(matrix);
            float f2 = i2;
            this.Qhi.preConcat(this.hm.cJ(f2 + floatValue2));
            this.WAv.Qhi(canvas, this.Qhi, (int) (i * com.bytedance.adsdk.lottie.Tgh.Tgh.Qhi(floatValue3, floatValue4, f2 / floatValue)));
        }
    }

    @Override // com.bytedance.adsdk.lottie.Qhi.Qhi.Tgh
    public void Qhi(RectF rectF, Matrix matrix, boolean z) {
        this.WAv.Qhi(rectF, matrix, z);
    }
