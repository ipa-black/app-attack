...
public class Qhi extends cJ<UGProgressBar> {
    ...
    public void cJ() {
        super.cJ();
        ((UGProgressBar) this.fl).setBackgroundColor(this.dIT);
        ((UGProgressBar) this.fl).setText(this.Qe);
        ((UGProgressBar) this.fl).setProgressBgColor(this.dIT);
        ((UGProgressBar) this.fl).setProgressColor(this.Qhi);
        ((UGProgressBar) this.fl).setTextColor(this.YB);
    }
