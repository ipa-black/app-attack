...
public class Qhi extends com.bytedance.adsdk.ugeno.component.cJ<RichTextView> {
    ...
    public void cJ() {
        super.cJ();
        ((RichTextView) this.fl).setRichText(this.Qhi);
        ((RichTextView) this.fl).setTextSize(1, this.Qe);
        ((RichTextView) this.fl).setTextColor(this.dIT);
        ((RichTextView) this.fl).setLines(this.Dq);
        ((RichTextView) this.fl).setMaxLines(this.cjC);
        ((RichTextView) this.fl).setGravity(this.NBs);
    }
