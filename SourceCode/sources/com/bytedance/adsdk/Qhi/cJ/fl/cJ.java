...
public class cJ {
    public static com.bytedance.adsdk.Qhi.cJ.cJ.Qhi Qhi(List<com.bytedance.adsdk.Qhi.cJ.cJ.Qhi> list, String str, int i) {
        ac(list, str, i);
        Deque<com.bytedance.adsdk.Qhi.cJ.cJ.Qhi> Qhi = Qhi(cJ(list, str, i));
        if (Qhi.size() != 1) {
    ...
    private static Deque<com.bytedance.adsdk.Qhi.cJ.cJ.Qhi> cJ(List<com.bytedance.adsdk.Qhi.cJ.cJ.Qhi> list, String str, int i) {
        ...
        while (i2 > 0) {
            ...
            for (com.bytedance.adsdk.Qhi.cJ.cJ.Qhi qhi : linkedList) {
                if (!linkedList2.isEmpty() && Tgh.Qhi(((com.bytedance.adsdk.Qhi.cJ.cJ.Qhi) linkedList2.peekLast()).Qhi()) && ((Tgh) ((com.bytedance.adsdk.Qhi.cJ.cJ.Qhi) linkedList2.peekLast()).Qhi()).cJ() == i2) {
    ...
    private static void ac(List<com.bytedance.adsdk.Qhi.cJ.cJ.Qhi> list, String str, int i) {
