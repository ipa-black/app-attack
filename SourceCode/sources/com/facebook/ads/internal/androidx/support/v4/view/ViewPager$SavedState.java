...
public class ViewPager$SavedState extends AbsSavedState {
    ...
    public static void A02() {
        byte[] bArr = {26, 74, 85, 73, 83, 78, 83, 85, 84, 7, 104, 92, 79, 73, 67, 75, SignedBytes.MAX_POWER_OF_TWO, 90, 126, 79, 73, 75, 92, 0, 125, 79, 88, 75, 74, 125, 90, 79, 90, 75, 85, 110};
        if (A04[0].length() == 0) {
    ...
    static {
        A02();
        CREATOR = new Parcelable.ClassLoaderCreator<ViewPager$SavedState>() { // from class: com.facebook.ads.redexgen.X.3Q
