...
import com.facebook.ads.redexgen.X.C4Z;
@RestrictTo({RestrictTo.Scope.LIBRARY_GROUP})
/* loaded from: assets/audience_network.dex */
public class RecyclerView$SavedState extends AbsSavedState {
    public static final Parcelable.Creator<RecyclerView$SavedState> CREATOR = new Parcelable.ClassLoaderCreator<RecyclerView$SavedState>() { // from class: com.facebook.ads.redexgen.X.4j
    ...
    public RecyclerView$SavedState(Parcel parcel, ClassLoader classLoader) {
        ...
        this.A00 = parcel.readParcelable(classLoader == null ? C4Z.class.getClassLoader() : classLoader);
    }
