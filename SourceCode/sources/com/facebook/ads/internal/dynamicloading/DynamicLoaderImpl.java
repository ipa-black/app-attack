...
import com.facebook.ads.redexgen.X.C05215d;
import com.facebook.ads.redexgen.X.C05255h;
import com.facebook.ads.redexgen.X.C0845Iy;
import com.facebook.ads.redexgen.X.C0846Iz;
import com.facebook.ads.redexgen.X.C1115Tp;
...
public class DynamicLoaderImpl implements DynamicLoader {
        ...
        if (A00 == null) {
            A00 = new AdSettingsApi() { // from class: com.facebook.ads.redexgen.X.59
                ...
                public final boolean isTestMode(Context context) {
                    ...
                    if (string == null) {
                        SharedPreferences A003 = C0857Jm.A00(context);
    ...
    public AudienceNetworkActivityApi createAudienceNetworkActivity(final AudienceNetworkActivity audienceNetworkActivity, final AudienceNetworkActivityApi audienceNetworkActivityApi) {
        final C5F c5f = new C5F(audienceNetworkActivity, audienceNetworkActivityApi);
        return new AudienceNetworkActivityApi(audienceNetworkActivity, audienceNetworkActivityApi, c5f) { // from class: com.facebook.ads.redexgen.X.5G
            ...
            private void A02(Throwable th) {
                ...
                if (logContext != null) {
                    logContext.A07().A9C(A00(38, 11, 18), C05787s.A0C, new C05797t(th));
                    return;
                }
    ...
    @Override // com.facebook.ads.internal.dynamicloading.DynamicLoader
    @Nullable
    public C0846Iz createNativeAdRatingApi(JSONObject jSONObject) {
        return C0846Iz.A00(jSONObject);
    }
    ...
    public NativeAdViewApi createNativeAdViewApi() {
        if (A02 == null) {
            A02 = new NativeAdViewApi() { // from class: com.facebook.ads.redexgen.X.5U
                ...
                public static View A00(C1203Xc c1203Xc, NativeAd nativeAd, NativeAdView.Type type, @Nullable NativeAdViewAttributes nativeAdViewAttributes) {
                    if (nativeAdViewAttributes == null) {
                        nativeAdViewAttributes = new NativeAdViewAttributes();
                    }
                    J0 j0 = (J0) nativeAdViewAttributes.getInternalAttributes();
                    C1115Tp internalNativeAd = C1115Tp.A0L(nativeAd.getInternalNativeAd());
                    internalNativeAd.A1X(J1.A00(type.getEnumCode()));
                    internalNativeAd.A1W(j0);
                    C0719Dw c0719Dw = new C0719Dw();
                    NativeAdLayout mediumRectTemplateLayout = new NativeAdLayout(c1203Xc, c0719Dw);
                    c0719Dw.A04(mediumRectTemplateLayout, c1203Xc, nativeAd, j0);
                ...
                public static View A01(C1203Xc c1203Xc, NativeAd nativeAd, @Nullable NativeAdViewAttributes nativeAdViewAttributes) {
                    if (nativeAdViewAttributes == null) {
                        nativeAdViewAttributes = new NativeAdViewAttributes();
                    }
                    C1115Tp A0L = C1115Tp.A0L(nativeAd.getInternalNativeAd());
                    J0 j0 = (J0) nativeAdViewAttributes.getInternalAttributes();
                    A0L.A1X(J1.A0B);
                    A0L.A1W(j0);
                    C0719Dw c0719Dw = new C0719Dw();
                    NativeAdLayout nativeAdLayout = new NativeAdLayout(c1203Xc, c0719Dw);
                    c0719Dw.A04(nativeAdLayout, c1203Xc, nativeAd, j0);
    ...
    public NativeBannerAdApi createNativeBannerAdApi(NativeBannerAd nativeBannerAd, NativeAdBaseApi nativeAdBaseApi) {
        return new NativeBannerAdApi(nativeAdBaseApi) { // from class: com.facebook.ads.redexgen.X.5a
            ...
            {
                this.A00 = C1115Tp.A0L(nativeAdBaseApi);
                this.A00.A1Y(JF.A04);
            }

            private void A02(ImageView imageView, NativeAdBaseApi nativeAdBaseApi2) {
                C1115Tp A0L = C1115Tp.A0L(nativeAdBaseApi2);
                C1225Xy c1225Xy = new C1225Xy(this, imageView, A0L);
                C0845Iy adIcon = A0L.getAdIcon();
                if (adIcon != null) {
                    Bitmap preloadedBitmap = A0L.A10().A0M(adIcon.getUrl());
                    C1203Xc A022 = C5M.A02(imageView.getContext());
                    if (preloadedBitmap != null) {
                        Drawable A052 = C1115Tp.A05(A022, preloadedBitmap, A0L.A1d(), A0L.A1C());
                        C1115Tp.A0e(A052, imageView);
                        imageView.post(new C1224Xx(this, A0L, A052));
                        return;
                    }
                    C5X loadImageTask = new C5X(A022, c1225Xy, A0L.A1d(), null);
    ...
    public NativeBannerAdViewApi createNativeBannerAdViewApi() {
        if (A03 == null) {
            A03 = new NativeBannerAdViewApi() { // from class: com.facebook.ads.redexgen.X.5b
                public static View A00(C1203Xc c1203Xc, NativeBannerAd nativeBannerAd, NativeBannerAdView.Type type, @Nullable NativeAdViewAttributes nativeAdViewAttributes) {
                    if (nativeAdViewAttributes == null) {
                        nativeAdViewAttributes = new NativeAdViewAttributes();
                    }
                    C1115Tp.A0L(nativeBannerAd.getInternalNativeAd()).A1X(J1.A00(type.getEnumCode()));
                    E6 bannerTemplateLayoutApi = new E6();
                    NativeAdLayout nativeAdLayout = new NativeAdLayout(c1203Xc, bannerTemplateLayoutApi);
                    bannerTemplateLayoutApi.A04(c1203Xc, nativeBannerAd, (J0) nativeAdViewAttributes.getInternalAttributes(), nativeAdLayout);
        ...
        return new NativeComponentTagApi() { // from class: com.facebook.ads.redexgen.X.5c
            ...
            public final void tagView(View view, NativeAdBase.NativeComponentTag nativeComponentTag) {
                if (view != null && nativeComponentTag != null) {
                    EnumC0883Kp.A03(view, nativeComponentTag);
                }
            }
        };
    }
    ...
    public RewardedInterstitialAdApi createRewardedInterstitialAd(Context context, String str, RewardedInterstitialAd rewardedInterstitialAd) {
        return (RewardedInterstitialAdApi) AnonymousClass57.A00(new C05215d(context, str, rewardedInterstitialAd), RewardedInterstitialAdApi.class);
    }

    @Override // com.facebook.ads.internal.dynamicloading.DynamicLoader
    public RewardedVideoAdApi createRewardedVideoAd(Context context, String str, RewardedVideoAd rewardedVideoAd) {
        return (RewardedVideoAdApi) AnonymousClass57.A00(new C05255h(context, str, rewardedVideoAd), RewardedVideoAdApi.class);
    }
