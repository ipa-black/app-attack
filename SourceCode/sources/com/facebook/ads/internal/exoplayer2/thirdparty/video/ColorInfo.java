...
import com.facebook.ads.redexgen.X.C0818Hv;
...
public final class ColorInfo implements Parcelable {
    ...
    public static void A01() {
        A05 = new byte[]{30, 39, 43, 74, 102, 101, 102, 123, SignedBytes.MAX_POWER_OF_TWO, 103, 111, 102, 33};
    }
    ...
    public ColorInfo(Parcel parcel) {
        ...
        boolean hasHdrStaticInfo = C0815Hs.A0f(parcel);
    ...
    public final void writeToParcel(Parcel parcel, int i) {
        ...
        C0815Hs.A0V(parcel, this.A04 != null);
        byte[] bArr = this.A04;
        if (bArr != null) {
