...
public enum AdErrorType {
    ...
    AD_PRESENTATION_ERROR(AdError.AD_PRESENTATION_ERROR_CODE, A00(IronSourceConstants.REWARDED_VIDEO_DAILY_CAPPED, 25, 118), true),
    ...
    PARSER_FAILURE(IronSourceConstants.RV_INSTANCE_SHOW, A00(IronSourceError.ERROR_DO_RV_CALL_LOAD_BEFORE_SHOW, 50, 14), false),
    UNKNOWN_RESPONSE(IronSourceConstants.RV_INSTANCE_SHOW_FAILED, A00(2343, 47, 51), false),
    ERROR_MESSAGE(IronSourceConstants.RV_INSTANCE_CLOSED, A00(575, 48, 14), true),
    NO_AD_PLACEMENT(IronSourceConstants.RV_AUCTION_SUCCESS, A00(TypedValues.TransitionType.TYPE_AUTO_TRANSITION, 42, 45), false),
    MEDIATION_ERROR(3001, A00(1926, 15, 30), true),
    BID_IMPRESSION_MISMATCH(PlaybackException.ERROR_CODE_DECODER_INIT_FAILED, A00(465, 36, 10), true),
    BID_PAYLOAD_ERROR(PlaybackException.ERROR_CODE_DECODER_QUERY_FAILED, A00(1673, 19, 67), false),
    NO_ADAPTER_ON_LOAD(5001, A00(292, 25, 116), false),
    NO_ADAPTER_ON_START(5002, A00(TypedValues.AttributesType.TYPE_EASING, 26, 15), false),
