...
public final class C0895Lb implements SensorEventListener {
    ...
    public final Set<InterfaceC0894La> A09 = new CopyOnWriteArraySet();
    ...
    public static void A02() {
        A0A = new byte[]{119, 65, 74, 87, 75, 86, 87, 4, 74, 75, 80, 4, 87, 81, 84, 84, 75, 86, 80, 65, SignedBytes.MAX_POWER_OF_TWO, 17, 42, 35, 41, 43, 44, 37, 98, 44, 45, 54, 98, 49, 55, 50, 50, 45, 48, 54, 39, 38, 21, 3, 8, 21, 9, 20};
    }

    public C0895Lb(C1203Xc c1203Xc) {
        this.A08 = c1203Xc;
    }
    ...
    public final void A03(InterfaceC0894La interfaceC0894La) {
        if (this.A09.isEmpty()) {
            A01();
        } else if (this.A09.contains(interfaceC0894La)) {
            return;
        }
        this.A09.add(interfaceC0894La);
    }
        ...
        if (now - j > 100) {
            ...
            if (speed > 800.0f) {
                ...
                if (i >= 3 && now - this.A05 > 1000) {
                    this.A05 = now;
                    this.A03 = 0;
                    for (InterfaceC0894La interfaceC0894La : this.A09) {
                        interfaceC0894La.ACY();
                    }
                }
                this.A04 = now;
            }
