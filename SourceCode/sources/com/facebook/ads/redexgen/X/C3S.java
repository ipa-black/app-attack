...
public class C3S extends ViewGroup {
    ...
    private C3K A03() {
        ...
        while (i2 < this.A0t.size()) {
            ...
            f3 = c3k2.A00;
            float f5 = c3k2.A01 + f3 + f2;
            if (!z) {
                int i3 = (scrollX > f3 ? 1 : (scrollX == f3 ? 0 : -1));
                String[] strArr = A0v;
    ...
    private final void A0J(int i, int i2, int i3) {
        ...
        if (abs2 > 0) {
            ...
            strArr[4] = "";
            strArr[5] = "";
            abs = Math.round(Math.abs(A00 / f2) * 1000.0f) * 4;
        } else {
                ...
                for (int i6 = 0; i6 < childCount2; i6++) {
                    ...
                    if (childAt.getVisibility() != 8 && ((c3l = (C3L) childAt.getLayoutParams()) == null || !c3l.A05)) {
                        ...
                        if (strArr[4].length() == strArr[5].length()) {
                            ...
                            childAt.measure(View.MeasureSpec.makeMeasureSpec((int) (f2 * c3l.A00), 1073741824), this.A0A);
                        }
                    }
                }
                return;
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        AbstractC04672z abstractC04672z;
        if (this.A0h) {
            return true;
        }
        if ((motionEvent.getAction() == 0 && motionEvent.getEdgeFlags() != 0) || (abstractC04672z = this.A01) == null || abstractC04672z.A05() == 0) {
            return false;
        }
        if (this.A0U == null) {
                ...
                if (!this.A0k) {
                    ...
                    if (findPointerIndex == -1) {
                        ...
                        if (abs > this.A0R && abs > abs2) {
                            ...
                            A0T(true);
                            float f2 = this.A03;
                            this.A05 = x2 - f2 > 0.0f ? f2 + this.A0R : f2 - this.A0R;
                            this.A06 = y2;
                            setScrollState(1);
                            setScrollingCacheEnabled(true);
    ...
    private int A01(int i, float f2, int i2, int i3) {
    ...
    */
    ...
    private final void A0D() {
        ...
        C3E.A0B(this, new C1241Yp(this));
        if (C3E.A00(this) == 0) {
            C3E.A09(this, 1);
        }
        C3E.A0C(this, new C1242Yq(this));
    }
    ...
    private void A0H(int i, float f2, int i2) {
        C3N c3n = this.A0Z;
        List<C3N> list = this.A0f;
        if (list != null) {
            int i3 = list.size();
    ...
    @CallSuper
    private final void A0I(int childOffset, float f2, int i) {
        int i2;
        if (this.A0D > 0) {
    ...
    */
    ...
    private final boolean A0W() {
        AbstractC04672z abstractC04672z = this.A01;
        if (abstractC04672z != null && this.A00 < abstractC04672z.A05() - 1) {
            A0L(this.A00 + 1, true);
            return true;
    ...
    private boolean A0X(float f2) {
        ...
        boolean z = false;
        this.A05 = f2;
        float scrollX = getScrollX() + (this.A05 - f2);
        int clientWidth = getClientWidth();
        ...
        if (c3k.A02 != 0) {
            ...
            A0v[1] = NotificationBundleProcessor.PUSH_ADDITIONAL_DATA_KEY;
    ...
    private boolean A0Z(int i) {
        ...
        int i2 = this.A0M;
        int i3 = A03.A02;
        float f2 = ((i / currentPage) - A03.A00) / (A03.A01 + (i2 / currentPage));
        this.A0g = false;
        A0I(i3, f2, (int) ((currentPage + i2) * f2));
        if (this.A0g) {
            return true;
        }
        throw new IllegalStateException(A08);
    ...
    private final boolean A0a(int i) {
        ...
        if (findFocus == this) {
            ...
            if (!z) {
                ...
                Log.e(A08(VastError.ERROR_CODE_GENERAL_WRAPPER, 9, 47), A08(309, 72, 80) + sb.toString());
                findFocus = null;
            }
        }
        boolean z2 = false;
    ...
    */
    ...
    public AbstractC04672z getAdapter() {
        return this.A01;
    }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (this.A0M > 0 && this.A0S != null && this.A0t.size() > 0 && this.A01 != null) {
            ...
            loop0: for (int i2 = c3k.A02; i2 < i; i2++) {
                ...
                if (i2 == c3k.A02) {
                    f2 = (c3k.A00 + c3k.A01) * lastPos;
                    float marginOffset2 = c3k.A00;
                    marginOffset = marginOffset2 + c3k.A01 + f3;
                } else {
                    float A04 = this.A01.A04(i2);
                    f2 = (marginOffset + A04) * lastPos;
                    marginOffset += A04 + f3;
                }
                if (this.A0M + f2 > pos) {
                    Drawable drawable = this.A0S;
            ...
            if (action != 0) {
                if (action == 2) {
                    ...
                    if (i != -1) {
                        ...
                        if (f3 != 0.0f && !A0Y(this.A05, f3) && A0d(this, false, (int) f3, (int) y, (int) y2)) {
                            this.A05 = y;
                            this.A06 = y2;
                            this.A0m = true;
                            return false;
    ...
    */
    ...
    public final Parcelable onSaveInstanceState() {
        ...
        ss.A00 = this.A00;
        AbstractC04672z abstractC04672z = this.A01;
        if (abstractC04672z != null) {
            Parcelable superState2 = abstractC04672z.A07();
            ss.A01 = superState2;
        }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public void setAdapter(com.facebook.ads.redexgen.X.AbstractC04672z r7) {
        /*
            r6 = this;
    ...
    public void setOffscreenPageLimit(int i) {
        if (i < 1) {
            Log.w(A08(VastError.ERROR_CODE_GENERAL_WRAPPER, 9, 47), A08(127, 31, 60) + i + A08(51, 26, 90) + 1);
            i = 1;
        }
        if (i != this.A0L) {
            this.A0L = i;
