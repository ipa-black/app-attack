...
public final class N8 extends Drawable {
    ...
    public final Runnable A0F = new C1081Sg(this);
    ...
    public N8() {
        ...
        this.A0B.setColor(Color.argb((int) LossReason.LOSS_REASON_CREATIVE_FILTERED_NOT_ALLOWED_IN_DEAL_VALUE, 0, 0, 0));
    ...
    public void A03() {
        ...
        for (String str : split) {
            f2 = Math.max(f2, this.A0E.measureText(str, 0, str.length()));
        }
    ...
    public final void draw(Canvas canvas) {
        ...
        float canvasMiddleY = f2 - width2;
        float textMiddleX = f3 - height2;
        float textMiddleY = f2 + width2;
        canvas.drawRect(canvasMiddleY - 40.0f, textMiddleX - 40.0f, textMiddleY + 40.0f, f3 + height2 + 40.0f, this.A0B);
        canvas.save();
