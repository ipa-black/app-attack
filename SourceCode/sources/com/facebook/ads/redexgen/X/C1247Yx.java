...
public final class C1247Yx<K, V> extends C04552m<K, V> implements Map<K, V> {
    public AbstractC04522j<K, V> A00;
    ...
    private AbstractC04522j<K, V> A00() {
        if (this.A00 == null) {
            this.A00 = new C1248Yy(this);
        }
        return this.A00;
    }
