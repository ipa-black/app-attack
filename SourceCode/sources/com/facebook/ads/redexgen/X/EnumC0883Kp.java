...
public enum EnumC0883Kp {
    ...
    EnumC0883Kp(int i, NativeAdBase.NativeComponentTag nativeComponentTag) {
        this.A00 = i;
        this.A01 = nativeComponentTag;
    }

    public static EnumC0883Kp A00(NativeAdBase.NativeComponentTag nativeComponentTag) {
        EnumC0883Kp[] values;
        for (EnumC0883Kp enumC0883Kp : values()) {
            if (enumC0883Kp.A01 == nativeComponentTag) {
                return enumC0883Kp;
            }
        }
        return null;
    ...
    public static void A03(View view, NativeAdBase.NativeComponentTag nativeComponentTag) {
        EnumC0883Kp internalTag = A00(nativeComponentTag);
        if (view != null && internalTag != null && Build.VERSION.SDK_INT > 4) {
            view.setTag(A02, nativeComponentTag);
        }
    }

    public static void A04(View view, EnumC0883Kp enumC0883Kp) {
        if (view != null && enumC0883Kp != null && Build.VERSION.SDK_INT > 4) {
            view.setTag(A02, enumC0883Kp);
        }
    }
