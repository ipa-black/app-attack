...
public final class C05878b implements Closeable {
    ...
    public C05878b(File file) throws IOException {
        ...
        this.A00 = new C05888c(readInt, index);
    }
    ...
    public final C05888c A03() throws IOException {
        if (!this.A01) {
            return this.A00;
        }
    ...
    public final void A04(C05888c c05888c) throws IOException {
        if (!this.A01) {
            if (c05888c.A02() >= 0 && c05888c.A03() >= 0) {
                this.A00 = c05888c;
                A01();
                return;
            }
            throw new IOException(String.format(Locale.US, A00(28, 25, 96), Integer.valueOf(c05888c.A02()), Integer.valueOf(c05888c.A03())));
        }
        throw new IOException(A00(0, 28, 58));
    }
