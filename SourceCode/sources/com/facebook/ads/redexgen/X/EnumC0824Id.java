...
public enum EnumC0824Id {
    ...
    EnumC0824Id(String str) {
        this.A00 = str;
    }

    public static EnumC0824Id A00(String str) {
        EnumC0824Id[] values;
        for (EnumC0824Id enumC0824Id : values()) {
            if (enumC0824Id.A00.equalsIgnoreCase(str)) {
                return enumC0824Id;
            }
        }
        String[] strArr = A02;
