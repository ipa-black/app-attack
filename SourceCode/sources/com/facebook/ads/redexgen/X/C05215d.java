...
public final class C05215d implements RewardedInterstitialAdApi, Repairable {
    ...
    public C05215d(Context context, String str, RewardedInterstitialAd rewardedInterstitialAd) {
        this.A00 = new C05255h(context, str, rewardedInterstitialAd);
    }
    ...
    public final void loadAd(RewardedInterstitialAd.RewardedInterstitialLoadAdConfig rewardedInterstitialLoadAdConfig) {
        ((C05235f) rewardedInterstitialLoadAdConfig).A00();
    }
    ...
    public final boolean show() {
        ...
        return this.A00.A08(new C05275j().withAppOrientation(-1).build());
    }
    ...
    public final boolean show(RewardedInterstitialAd.RewardedInterstitialShowAdConfig rewardedInterstitialShowAdConfig) {
        ...
        return this.A00.A08(((C05245g) rewardedInterstitialShowAdConfig).A00());
    }
