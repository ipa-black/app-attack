...
public final class II {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void A07(int i, C05797t c05797t) {
        this.A03.A07().A9C(A05(PsExtractor.PRIVATE_STREAM_1, 14, 74), i, c05797t);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public void A08(int i, C05797t c05797t) {
        c05797t.A03(1);
        this.A03.A07().A9D(A05(PsExtractor.PRIVATE_STREAM_1, 14, 74), i, c05797t);
    }

    public final void A0C() {
        A08(C05787s.A1s, new C05797t(A05(101, 18, 66), this.A05));
        Intent intent = new Intent();
        intent.setClassName(A05(170, 19, 125), A05(119, 51, 26));
        try {
            if (!this.A03.bindService(intent, this.A02, 1)) {
                A08(C05787s.A1o, new C05797t(A05(51, 50, 11)));
                this.A03.unbindService(this.A02);
            }
        } catch (Exception e2) {
            A07(C05787s.A1n, new C05797t(e2));
        }
    }
}
