...
public final class C1315ad implements AnonymousClass03<Bitmap> {
    ...
    public final String A02 = C1315ad.class.getSimpleName();
    ...
    public C1315ad(int i, int i2, boolean z, boolean z2, boolean z3) {
        this.A01 = i;
        this.A00 = i2;
        this.A05 = z;
        this.A03 = z2;
    ...
    public final AnonymousClass02<Bitmap> A3B(File file, C0L c0l) {
        ...
        try {
            ...
            c0l.A96(new C1309aX(A01(4, 14, 77)));
            return A00(null);
        } catch (Throwable th) {
            if (A07[6].length() == 26) {
    ...
    @Override // com.facebook.ads.redexgen.X.AnonymousClass03
    @SuppressLint({"CatchGeneralException"})
    public final void A4E(File file, C0L c0l) throws C1309aX {
        if (this.A03) {
            try {
                ...
                c0l.A9G(th);
                Throwable t = new C1309aX(A01(18, 33, 49), th);
                throw t;
            }
        }
    }
