...
public final class C0695Ct {
    ...
    public C0695Ct(String str, @Nullable String str2, @Nullable MediaCodecInfo.CodecCapabilities codecCapabilities, boolean z, boolean z2, boolean z3) {
    ...
    public static int A00(String str, String str2, int i) {
        int i2;
        if (i > 1 || (C0815Hs.A02 >= 26 && i > 0)) {
            return i;
        }
        if (A03(226, 10, 45).equals(str2) || A03(121, 10, 96).equals(str2) || A03(IronSourceConstants.USING_CACHE_FOR_INIT_EVENT, 12, 97).equals(str2) || A03(LossReason.LOSS_REASON_CREATIVE_FILTERED_ANIMATION_TOO_LONG_VALUE, 15, 35).equals(str2) || A03(255, 12, 77).equals(str2) || A03(236, 10, 92).equals(str2) || A03(246, 9, 101).equals(str2) || A03(162, 10, 106).equals(str2) || A03(TsExtractor.TS_STREAM_TYPE_AC4, 15, 62).equals(str2) || A03(187, 15, 13).equals(str2) || A03(202, 9, 74).equals(str2)) {
            return i;
        }
    ...
    public static C0695Ct A01(String str) {
        return new C0695Ct(str, null, null, true, false, false);
    }

    public static C0695Ct A02(String str, String str2, MediaCodecInfo.CodecCapabilities codecCapabilities, boolean z, boolean z2) {
        return new C0695Ct(str, str2, codecCapabilities, false, z, z2);
    }
    ...
    public static boolean A07(MediaCodecInfo.CodecCapabilities codecCapabilities) {
        return C0815Hs.A02 >= 19 && A08(codecCapabilities);
    }
    ...
    public static boolean A09(MediaCodecInfo.CodecCapabilities codecCapabilities) {
        return C0815Hs.A02 >= 21 && A0A(codecCapabilities);
    }

    @TargetApi(21)
    public static boolean A0A(MediaCodecInfo.CodecCapabilities codecCapabilities) {
        return codecCapabilities.isFeatureSupported(A03(TTAdConstant.LANDING_PAGE_TYPE_CODE, 15, 40));
    }

    public static boolean A0B(MediaCodecInfo.CodecCapabilities codecCapabilities) {
        return C0815Hs.A02 >= 21 && A0C(codecCapabilities);
    }
    ...
    @TargetApi(21)
    public static boolean A0D(MediaCodecInfo.VideoCapabilities videoCapabilities, int i, int i2, double d2) {
        if (d2 == -1.0d || d2 <= 0.0d) {
    ...
    public final Point A0E(int i, int i2) {
        ...
        int heightAlignment2 = C0815Hs.A04(i, widthAlignment);
        return new Point(heightAlignment2 * widthAlignment, C0815Hs.A04(i2, heightAlignment) * heightAlignment);
    }
    ...
    @TargetApi(21)
    public final boolean A0H(int i, int i2, double d2) {
        MediaCodecInfo.CodecCapabilities codecCapabilities = this.A00;
        if (codecCapabilities == null) {
            A06(A03(TypedValues.CycleType.TYPE_WAVE_SHAPE, 16, 101));
            return false;
        }
        MediaCodecInfo.VideoCapabilities videoCapabilities = codecCapabilities.getVideoCapabilities();
        if (videoCapabilities == null) {
            A06(A03(479, 17, 60));
            return false;
        } else if (!A0D(videoCapabilities, i, i2, d2)) {
            String A03 = A03(InputDeviceCompat.SOURCE_DPAD, 1, 73);
            if (i >= i2 || !A0D(videoCapabilities, i2, i, d2)) {
                A06(A03(458, 21, 100) + i + A03 + i2 + A03 + d2);
                return false;
            }
            A05(A03(437, 21, 29) + i + A03 + i2 + A03 + d2);
            return true;
        } else {
            return true;
        }
