...
public final class C05476g extends PR {
    ...
    public C05476g(C1203Xc c1203Xc) {
        super(c1203Xc);
        this.A03 = new C0856Jk(this);
        this.A02 = new C0854Ji(this);
        this.A01 = c1203Xc;
    ...
    public void setImage(@Nullable String str, @Nullable N9 n9) {
        ...
        setVisibility(0);
        AsyncTaskC1080Sf downloadImageTask = new AsyncTaskC1080Sf(this.A00, this.A01).A04();
        if (n9 != null) {
