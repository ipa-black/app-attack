...
public class C04552m<K, V> {
    ...
    public int[] A01 = C04452c.A00;
    public Object[] A02 = C04452c.A02;
    public int A00 = 0;
    ...
    public final V A0A(int i) {
        ...
        if (i3 <= 1) {
            ...
            this.A01 = C04452c.A00;
            this.A02 = C04452c.A02;
            i2 = 0;
        } else {
            i2 = i3 - 1;
            int[] iArr = this.A01;
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof C04552m) {
            C04552m c04552m = (C04552m) obj;
            if (size() != c04552m.size()) {
                return false;
            }
            for (int i = 0; i < this.A00; i++) {
                try {
                    K A09 = A09(i);
                    V A0B = A0B(i);
                    Object obj2 = c04552m.get(A09);
                    if (A0B == null) {
                        if (obj2 == null && c04552m.containsKey(A09)) {
                        }
                        return false;
