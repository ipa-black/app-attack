...
public final class C05536o extends PR {
    ...
    public final PO A01;
    public final NY A02;
    public final AbstractC0939Mt A03;
    ...
    public static void A05() {
        A04 = new byte[]{69, 81, SignedBytes.MAX_POWER_OF_TWO, 77, 75};
    }
    ...
    public C05536o(C1203Xc c1203Xc) {
        super(c1203Xc);
        this.A00 = null;
        this.A01 = new PO() { // from class: com.facebook.ads.redexgen.X.6s
            ...
            public final void A03(AnonymousClass72 anonymousClass72) {
                ...
                AudioManager audioManager = (AudioManager) C05536o.this.getContext().getApplicationContext().getSystemService(A00(0, 5, 67));
                weakReference = C05536o.this.A00;
                if (weakReference == null) {
                    onAudioFocusChangeListener = null;
                } else {
                    weakReference2 = C05536o.this.A00;
        ...
        this.A02 = new NY() { // from class: com.facebook.ads.redexgen.X.6r
            ...
            public final void A03(C05626z c05626z) {
                ...
                WeakReference weakReference2;
                AudioManager.OnAudioFocusChangeListener onAudioFocusChangeListener;
                AudioManager audioManager = (AudioManager) C05536o.this.getContext().getApplicationContext().getSystemService(A00(0, 5, 113));
                weakReference = C05536o.this.A00;
                if (weakReference == null) {
                    onAudioFocusChangeListener = null;
                } else {
