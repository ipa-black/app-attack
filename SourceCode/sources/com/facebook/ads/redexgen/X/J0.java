...
public final class J0 implements NativeAdViewAttributesApi {
    ...
    public final int A04(float f2) {
        int i = this.A01;
        return C04432a.A02(((-16777216) & i) | ((i ^ (-1)) & ViewCompat.MEASURED_SIZE_MASK), i, f2);
    }
    ...
    public final void A05(TextView textView) {
        ...
        ColorStateList textColors = new ColorStateList(new int[][]{new int[]{16842919}, new int[0]}, new int[]{this.A01, this.A03});
