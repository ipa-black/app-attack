...
public final class C5R implements MediaViewVideoRendererApi {
    ...
    public final AbstractC0939Mt A0C = new E4(this);
    public final NY A0B = new E3(this);
    public final AbstractC0919Lz A0E = new E2(this);
    public final PO A09 = new E1(this);
    public final AbstractC0885Kr A0F = new E0(this);
    public final AbstractC0980Oj A0A = new C0722Dz(this);
    ...
    public final void A03() {
        ...
        if (nativeAd != null) {
            C1115Tp.A0L(nativeAd.getInternalNativeAd()).A1c(false, false);
        }
        this.A08 = null;
        InterfaceC0840It interfaceC0840It = this.A04;
        if (interfaceC0840It != null) {
            interfaceC0840It.AFh();
        }
    }

    public final void A04(NativeAd nativeAd) {
        this.A08 = nativeAd;
        C1203Xc A11 = ((C1115Tp) nativeAd.getInternalNativeAd()).A11();
        C1203Xc adObjectContext = this.A03;
        adObjectContext.A0G(A11);
        C5S c5s = (C5S) nativeAd.getNativeAdApi();
        this.A05.setClientToken(C1115Tp.A0L(nativeAd.getInternalNativeAd()).A1B());
        this.A05.setVideoMPD(c5s.A01());
        this.A05.setVideoURI(c5s.A02());
        C1283a7 A0y = C1115Tp.A0L(nativeAd.getInternalNativeAd()).A0y();
        if (A0y != null) {
        ...
        InterfaceC0840It interfaceC0840It = this.A04;
        if (interfaceC0840It != null) {
            interfaceC0840It.AF2(nativeAd);
        }
    }

    public final void A05(InterfaceC0821Ia interfaceC0821Ia) {
        this.A05.setAdEventManager(interfaceC0821Ia);
    }

    public final void A06(@Nullable InterfaceC0840It interfaceC0840It) {
        this.A04 = interfaceC0840It;
    }

    public final void A07(@Nullable InterfaceC0912Ls interfaceC0912Ls) {
        this.A05.setListener(interfaceC0912Ls);
    }
