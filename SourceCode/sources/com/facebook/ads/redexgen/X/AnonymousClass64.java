...
public final class AnonymousClass64 {
    ...
    static {
        A05();
        A03 = C05405w.class.getSimpleName();
        A00 = A04(173, 52, 75);
    }
    ...
    */
    public static com.facebook.ads.redexgen.X.C05405w A00(com.facebook.ads.redexgen.X.C7N r5) {
        /*
    ...
    @Nullable
    @VisibleForTesting
    public static C05405w A01(C7N c7n) {
        C7R adId = c7n.A04().A7W();
        if (adId != null) {
            return new C05405w(adId.getId(), adId.A8n(), EnumC05395v.A03);
        }
        return null;
    }
    ...
    @Nullable
    @VisibleForTesting
    public static C05405w A02(C7N c7n) {
        Object A002;
        Method A022;
        Object A003;
        boolean z = true;
        ...
        if (str != null) {
            return new C05405w(str, (bool == null || !bool.booleanValue()) ? false : false, EnumC05395v.A07);
        }
        return null;
    }
    ...
    @VisibleForTesting
    public static C05405w A03(C7N c7n) {
        ...
        if (c7n.bindService(intent, anonymousClass63, 1)) {
            try {
                final IBinder A022 = anonymousClass63.A02();
                ...
                return new C05405w(r0.A02(), r0.A03(), EnumC05395v.A08);
            } catch (Throwable th) {
                try {
                    c7n.A07().A9C(A04(225, 7, 30), C05787s.A1Q, new C05797t(th));
                } finally {
