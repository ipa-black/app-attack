...
public final class C05888c {
    ...
    public final int A04(C05888c c05888c) {
        int i = this.A00;
        int i2 = c05888c.A00;
        if (i != i2) {
            return i - i2;
        }
        return this.A01 - c05888c.A01;
    }

    public final C05888c A05(int i) {
        int i2 = this.A01;
        if (i + i2 >= 0) {
            return new C05888c(this.A00, i2 + i);
        }
        throw new IllegalArgumentException(String.format(Locale.US, A00(0, 35, 63), Integer.valueOf(i), Integer.valueOf(this.A01)));
    }

    public final boolean equals(Object obj) {
        if (obj instanceof C05888c) {
            C05888c c05888c = (C05888c) obj;
            int i = c05888c.A00;
            int i2 = this.A00;
            if (A03[4].charAt(2) != 'U') {
            ...
            return i == i2 && c05888c.A01 == this.A01;
        }
        return false;
    }
