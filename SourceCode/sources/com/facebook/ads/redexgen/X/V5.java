...
public class V5 implements FT {
    ...
    public static void A01() {
        byte[] bArr = {74, Byte.MAX_VALUE, Byte.MAX_VALUE, 110, 102, 123, Byte.MAX_VALUE, 110, 111, 43, Byte.MAX_VALUE, 100, 43, 104, 121, 110, 106, Byte.MAX_VALUE, 110, 43, 111, 110, 104, 100, 111, 110, 121, 43, 109, 100, 121, 43, 126, 101, 120, 126, 123, 123, 100, 121, Byte.MAX_VALUE, 110, 111, 43, 109, 100, 121, 102, 106, Byte.MAX_VALUE, 77, 92, 92, SignedBytes.MAX_POWER_OF_TWO, 69, 79, 77, 88, 69, 67, 66, 3, 79, 73, 77, 1, 26, 28, 20, 15, 30, 30, 2, 7, 13, 15, 26, 7, 1, 0, 65, 13, 11, 15, 67, 89, 94, 86, 89, 72, 72, 84, 81, 91, 89, 76, 81, 87, 86, 23, 92, 78, 90, 75, 77, 90, 75, 20, 5, 5, 25, 28, 22, 20, 1, 28, 26, 27, 90, 5, 18, 6, 56, 41, 41, 53, 48, 58, 56, 45, 48, 54, 55, 118, 45, 45, 52, 53, 114, 33, 52, 53, 86, 71, 71, 91, 94, 84, 86, 67, 94, 88, 89, 24, 79, 26, 90, 71, 3, 26, 84, 82, 86, 26, 1, 7, 15, 107, 122, 122, 102, 99, 105, 107, 126, 99, 101, 100, 37, 114, 39, 103, 122, 62, 39, 124, 126, 126, 119, 102, 102, 122, Byte.MAX_VALUE, 117, 119, 98, Byte.MAX_VALUE, 121, 120, 57, 110, 59, 103, 99, Byte.MAX_VALUE, 117, 125, 98, Byte.MAX_VALUE, 123, 115, 59, 98, 110, 37, 113, 49, 32, 32, 60, 57, 51, 49, 36, 57, 63, 62, Byte.MAX_VALUE, 40, 125, 35, 37, 50, 34, 57, 32, 26, 11, 22, 26, 65, 24, 26, 26, 110, Byte.MAX_VALUE, 98, 110, 53, 98, 55, 105, 105, 123};
        String[] strArr = A01;
                ...
                if (!mimeType3.equals(str)) {
                    ...
                    if (!mimeType4.equals(str)) {
                        ...
                        if (!mimeType5.equals(str)) {
                            String mimeType6 = A00(TsExtractor.TS_PACKET_SIZE, 28, 77);
