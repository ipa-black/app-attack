...
public final class UI implements InterfaceC0833Im {
    ...
    public UJ A00;
    @Nullable
    public C1337b9<IQ, IV> A01;
    public final C1202Xb A02;
    public final C1331b3 A03 = C1331b3.A01();
    ...
    public UI(C1202Xb c1202Xb) {
        this.A02 = c1202Xb;
    }

    private void A01() {
        this.A02.A07().A9C(A00(89, 14, 40), 3600, new C05797t(A00(67, 22, 71)));
    }

    @Override // com.facebook.ads.redexgen.X.InterfaceC0833Im
    public final void AAg() {
        C1337b9<IQ, IV> c1337b9 = this.A01;
        if (c1337b9 != null) {
            c1337b9.A03.A00();
        } else {
            A01();
    ...
    public final void AFe(@Nullable View view) {
        if (this.A01 == null) {
            this.A02.A07().A9C(A00(89, 14, 40), 3600, new C05797t(A00(32, 35, 9)));
            return;
        }
        this.A03.A04(view);
    }
    ...
    public final void AFr(@Nullable View view, String str, boolean z, boolean z2, boolean z3) {
        if (view != null) {
            ...
            this.A01 = C1337b9.A00(new IQ(this.A02, view, str, z, z3), new IV(), A06).A05(new UK(new UH())).A06();
            this.A03.A05(view, this.A01);
            return;
        }
        this.A02.A07().A9C(A00(89, 14, 40), 3600, new C05797t(A00(0, 32, 38)));
    }
}
