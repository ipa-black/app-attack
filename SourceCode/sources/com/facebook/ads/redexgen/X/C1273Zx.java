...
public final class C1273Zx extends AbstractC04060p {
    ...
    public C1273Zx(C1203Xc c1203Xc, AbstractC04070q abstractC04070q, QA qa, C1283a7 c1283a7) {
        super(c1203Xc, abstractC04070q, qa);
        this.A02 = EnumC04160z.A03;
        this.A03 = null;
        this.A0D = c1283a7;
    }
    ...
    */
    private org.json.JSONObject A04(android.view.View r10) throws org.json.JSONException {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.X.C1273Zx.A04(android.view.View):org.json.JSONObject");
    }
    ...
    public final void A06(Map<String, String> map) {
        ...
        EnumC04160z enumC04160z = this.A02;
        if (enumC04160z != null) {
            map.put(A01(106, 14, 33), enumC04160z.toString());
        }
        if (this.A09) {
    ...
    public final void A09(EnumC04160z enumC04160z) {
        this.A02 = enumC04160z;
    }
