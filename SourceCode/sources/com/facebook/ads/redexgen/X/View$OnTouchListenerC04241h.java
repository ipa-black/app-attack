...
public class View$OnTouchListenerC04241h extends E9 implements View.OnTouchListener {
    ...
    public View$OnTouchListenerC04241h(C1203Xc c1203Xc) {
        super(c1203Xc);
        this.A05 = 0;
        this.A00 = 0;
        this.A03 = true;
    ...
    public View$OnTouchListenerC04241h(C1203Xc c1203Xc, AttributeSet attributeSet) {
    ...
    public View$OnTouchListenerC04241h(C1203Xc c1203Xc, AttributeSet attributeSet, int i) {
    ...
    public void setLayoutManager(C4Z c4z) {
        if (c4z instanceof C1231Ye) {
            super.setLayoutManager(c4z);
            this.A01 = (C1231Ye) c4z;
            return;
        }
        throw new IllegalArgumentException(A09(0, 50, 58));
    }

    public void setSnapDelegate(InterfaceC0981Ok interfaceC0981Ok) {
        this.A02 = interfaceC0981Ok;
    }
}
