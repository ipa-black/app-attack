...
public final class JW extends RelativeLayout implements PL {
    ...
    public JW(C1203Xc c1203Xc) {
        this(c1203Xc, A09, -12549889, 0);
    }

    public JW(C1203Xc c1203Xc, int i, int i2, int i3) {
        super(c1203Xc);
        this.A00 = -1;
        ...
        this.A05 = new AbstractC0939Mt() { // from class: com.facebook.ads.redexgen.X.4n
            /* JADX INFO: Access modifiers changed from: private */
            @Override // com.facebook.ads.redexgen.X.C8V
            /* renamed from: A00 */
        ...
        this.A02 = new ProgressBar(c1203Xc, null, 16842872);
        A06(i2, i3);
