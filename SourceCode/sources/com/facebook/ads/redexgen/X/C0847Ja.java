...
public final class C0847Ja {
    ...
    public C0847Ja(C7N c7n, String str, @Nullable C0891Kx c0891Kx, JF jf, @Nullable String str2, int i, boolean z, boolean z2, JK jk, @Nullable String str3, @Nullable String str4, @Nullable String str5) {
        this.A01 = c7n;
        this.A06 = str;
        this.A03 = c0891Kx;
        this.A02 = jf;
    ...
    private long A00() {
        SharedPreferences A00 = C0857Jm.A00(this.A01);
    ...
    public final Map<String, String> A08(Map<String, String> map) {
        ...
        A03(hashMap, A01(125, 4, 91), C05425y.A00().A03());
        if (C05425y.A00().A04()) {
            A01 = A01(0, 1, 52);
        } else {
            A01 = A01(1, 1, 52);
        }
        A03(hashMap, A01(TsExtractor.TS_STREAM_TYPE_AC3, 9, 31), A01);
        A03(hashMap, A01(93, 5, 29), String.valueOf(this.A08));
        A03(hashMap, A01(LossReason.LOSS_REASON_CREATIVE_FILTERED_LANGUAGE_EXCLUSIONS_VALUE, 12, 3), this.A06);
        if (this.A0B != AdPlacementType.UNKNOWN) {
            A03(hashMap, A01(219, 14, 30), this.A0B.toString().toLowerCase());
        }
        C0891Kx c0891Kx = this.A03;
        if (c0891Kx != null) {
            A03(hashMap, A01(276, 5, 52), String.valueOf(c0891Kx.A01()));
        ...
        if (idfaFlag.charAt(22) == strArr[3].charAt(22)) {
            ...
            boolean z2 = this.A09;
            if (z2) {
                A03(hashMap, A01(TsExtractor.TS_STREAM_TYPE_DTS, 22, 92), String.valueOf(z2));
            }
