...
public final class C04994h {
    ...
    public C4g A01;
    public AbstractC05074p A04;
    public final /* synthetic */ E9 A08;
    public final ArrayList<AbstractC05094r> A05 = new ArrayList<>();
    public ArrayList<AbstractC05094r> A02 = null;
    public final ArrayList<AbstractC05094r> A06 = new ArrayList<>();
    public final List<AbstractC05094r> A07 = Collections.unmodifiableList(this.A05);
    public int A03 = 2;
    public int A00 = 2;
    ...
    private final AbstractC05094r A01(int i) {
        int size;
        int A0D;
        ArrayList<AbstractC05094r> arrayList = this.A02;
        if (arrayList == null || (size = arrayList.size()) == 0) {
            return null;
        }
        for (int i2 = 0; i2 < size; i2++) {
            AbstractC05094r abstractC05094r = this.A02.get(i2);
            if (!abstractC05094r.A0i()) {
                int i3 = abstractC05094r.A0I();
                if (i3 == i) {
                    abstractC05094r.A0T(32);
        ...
        if (this.A08.A04.A0A() && (A0D = this.A08.A00.A0D(i)) > 0) {
            ...
            if (A0D < offsetPosition) {
                ...
                for (int i4 = 0; i4 < size; i4++) {
                    AbstractC05094r abstractC05094r2 = this.A02.get(i4);
                    if (!abstractC05094r2.A0i()) {
                        int offsetPosition2 = (abstractC05094r2.A0K() > A04 ? 1 : (abstractC05094r2.A0K() == A04 ? 0 : -1));
                        if (offsetPosition2 == 0) {
                            abstractC05094r2.A0T(32);
                            return abstractC05094r2;
                        }
                    }
                }
            }
    ...
    private final AbstractC05094r A02(int i, boolean z) {
        View A08;
        int size = this.A05.size();
        for (int i2 = 0; i2 < size; i2++) {
            AbstractC05094r abstractC05094r = this.A05.get(i2);
            if (!abstractC05094r.A0i()) {
                int scrapCount = abstractC05094r.A0I();
                if (scrapCount == i && !abstractC05094r.A0b() && (this.A08.A0s.A09 || !abstractC05094r.A0c())) {
                    abstractC05094r.A0T(32);
                    return abstractC05094r;
                }
            }
        ...
        if (!z && (A08 = this.A08.A01.A08(i)) != null) {
            AbstractC05094r A0F = E9.A0F(A08);
        ...
        for (int i3 = 0; i3 < size2; i3++) {
            AbstractC05094r abstractC05094r2 = this.A06.get(i3);
            if (!abstractC05094r2.A0b()) {
                int scrapCount2 = abstractC05094r2.A0I();
                if (scrapCount2 == i) {
                    if (!z) {
                        this.A06.remove(i3);
                    }
    ...
    */
    private final com.facebook.ads.redexgen.X.AbstractC05094r A03(long r8, int r10, boolean r11) {
        /*
            Method dump skipped, instructions count: 313
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.X.C04994h.A03(long, int, boolean):com.facebook.ads.redexgen.X.4r");
    }
    ...
    private void A09(AbstractC05094r abstractC05094r) {
        if (this.A08.A1t()) {
            ...
            if (!C3E.A0F(view)) {
                abstractC05094r.A0T(16384);
                C3E.A0B(view, this.A08.A09.A0A());
            }
        }
    }

    private void A0A(AbstractC05094r abstractC05094r) {
        if (abstractC05094r.A0H instanceof ViewGroup) {
            A08((ViewGroup) abstractC05094r.A0H, false);
        }
    }

    private final void A0B(AbstractC05094r abstractC05094r) {
        if (this.A08.A07 != null) {
            throw new NullPointerException(A04(779, 14, 62));
        }
        C4N c4n = this.A08.A04;
        if (this.A08.A0s != null) {
            this.A08.A0t.A0B(abstractC05094r);
        }
    }

    private final boolean A0C(AbstractC05094r abstractC05094r) {
        if (abstractC05094r.A0c()) {
            return this.A08.A0s.A07();
        }
        if (abstractC05094r.A03 >= 0 && abstractC05094r.A03 < this.A08.A04.A0D()) {
            if (!this.A08.A0s.A07()) {
                int A03 = this.A08.A04.A03(abstractC05094r.A03);
                int type = abstractC05094r.A0H();
                if (A03 != type) {
                    return false;
                }
            }
            return !this.A08.A04.A0A() || abstractC05094r.A0K() == this.A08.A04.A04(abstractC05094r.A03);
        }
        throw new IndexOutOfBoundsException(A04(LossReason.LOSS_REASON_CREATIVE_FILTERED_ANIMATION_TOO_LONG_VALUE, 60, 112) + abstractC05094r + this.A08.A1I());
    }

    private boolean A0D(AbstractC05094r abstractC05094r, int i, int i2, long startBindNs) {
        abstractC05094r.A08 = this.A08;
        ...
        this.A08.A04.A09(abstractC05094r, i);
        this.A01.A05(abstractC05094r.A0H(), this.A08.getNanoTime() - nanoTime);
        A09(abstractC05094r);
        if (this.A08.A0s.A07()) {
            abstractC05094r.A04 = i2;
            return true;
        }
        return true;
    }
    ...
    @Nullable
    public final AbstractC05094r A0I(int i, boolean z, long j) {
        C04934a c04934a;
        boolean fromScrapOrHiddenOrCache;
        E9 A0H;
        AbstractC05074p abstractC05074p;
        View A00;
        if (i >= 0 && i < this.A08.A0s.A03()) {
            ...
            if (fromScrapOrHiddenOrCache2) {
                abstractC05094r = A01(i);
                z2 = abstractC05094r != null;
            }
            if (abstractC05094r == null && (abstractC05094r = A02(i, z)) != null) {
                boolean fromScrapOrHiddenOrCache3 = A0C(abstractC05094r);
                if (!fromScrapOrHiddenOrCache3) {
                    if (!z) {
                        abstractC05094r.A0T(4);
                        boolean fromScrapOrHiddenOrCache4 = abstractC05094r.A0d();
                        if (fromScrapOrHiddenOrCache4) {
                            this.A08.removeDetachedView(abstractC05094r.A0H, false);
                            abstractC05094r.A0S();
                        } else {
                            boolean fromScrapOrHiddenOrCache5 = abstractC05094r.A0i();
                    ...
                    abstractC05094r = null;
                } else {
                    z2 = true;
                }
            }
            if (abstractC05094r == null) {
                ...
                if (A0D >= 0 && A0D < this.A08.A04.A0D()) {
                    ...
                    if (fromScrapOrHiddenOrCache6 && (abstractC05094r = A03(this.A08.A04.A04(A0D), A03, z)) != null) {
                        abstractC05094r.A03 = A0D;
                        z2 = true;
                    }
                    if (abstractC05094r == null && (abstractC05074p = this.A04) != null && (A00 = abstractC05074p.A00(this, i, A03)) != null) {
                        abstractC05094r = this.A08.A1H(A00);
                        if (abstractC05094r != null) {
                            boolean fromScrapOrHiddenOrCache7 = abstractC05094r.A0h();
                    ...
                    if (abstractC05094r == null) {
                        ...
                        abstractC05094r = c4n.A05(e9, A03);
                        fromScrapOrHiddenOrCache = E9.A1E;
                        if (fromScrapOrHiddenOrCache && (A0H = E9.A0H(abstractC05094r.A0H)) != null) {
                            abstractC05094r.A09 = new WeakReference<>(A0H);
                        }
            ...
            if (z2 && !this.A08.A0s.A07() && abstractC05094r.A0k(8192)) {
                abstractC05094r.A0U(0, 8192);
                if (this.A08.A0s.A0C) {
                    int changeFlags = C4V.A00(abstractC05094r);
                    C4U info = this.A08.A05.A09(this.A08.A0s, abstractC05094r, changeFlags | 4096, abstractC05094r.A0L());
                    this.A08.A1n(abstractC05094r, info);
                }
            }
            boolean z4 = false;
            if (this.A08.A0s.A07() && abstractC05094r.A0a()) {
                abstractC05094r.A04 = i;
            } else if (!abstractC05094r.A0a() || abstractC05094r.A0g() || abstractC05094r.A0b()) {
                z4 = A0D(abstractC05094r, this.A08.A00.A0D(i), i, j);
            }
            ViewGroup.LayoutParams layoutParams = abstractC05094r.A0H.getLayoutParams();
            if (layoutParams == null) {
                c04934a = (C04934a) this.A08.generateDefaultLayoutParams();
                abstractC05094r.A0H.setLayoutParams(c04934a);
            } else if (!this.A08.checkLayoutParams(layoutParams)) {
                c04934a = (C04934a) this.A08.generateLayoutParams(layoutParams);
                abstractC05094r.A0H.setLayoutParams(c04934a);
            } else {
                if (A0A[0].length() == 16) {
                    A0A[4] = "WeHbAL2DpvJL4iRMn0O7hIhaGbvumhB7";
                    c04934a = (C04934a) layoutParams;
                }
                throw new RuntimeException();
            }
            c04934a.A00 = abstractC05094r;
            c04934a.A02 = (z2 && z4) ? false : false;
            return abstractC05094r;
        }
        throw new IndexOutOfBoundsException(A04(271, 22, 0) + i + A04(12, 1, 99) + i + A04(21, 14, 104) + this.A08.A0s.A03() + this.A08.A1I());
    }

    public final List<AbstractC05094r> A0J() {
        return this.A07;
    }
    ...
    public final void A0M() {
        int size = this.A06.size();
        for (int i = 0; i < size; i++) {
            C04934a c04934a = (C04934a) this.A06.get(i).A0H.getLayoutParams();
            if (c04934a != null) {
                c04934a.A01 = true;
            }
        }
    ...
    public final void A0N() {
        if (this.A08.A04 != null && this.A08.A04.A0A()) {
            int size = this.A06.size();
            for (int i = 0; i < size; i++) {
                AbstractC05094r abstractC05094r = this.A06.get(i);
                int i2 = A0A[0].length();
                if (i2 != 16) {
                    throw new RuntimeException();
                }
                ...
                if (abstractC05094r != null) {
                    abstractC05094r.A0T(6);
                    abstractC05094r.A0Y(null);
                }
            }
            return;
        }
    ...
    public final void A0R(int i, int i2) {
        ...
        for (int i3 = 0; i3 < size; i3++) {
            AbstractC05094r abstractC05094r = this.A06.get(i3);
            if (abstractC05094r != null) {
                int cachedCount = abstractC05094r.A03;
                if (cachedCount >= i) {
                    abstractC05094r.A0W(i2, true);
                }
            }
        }
    }
    ...
    public final void A0S(int i, int i2) {
        ...
        for (int i6 = 0; i6 < size; i6++) {
            AbstractC05094r abstractC05094r = this.A06.get(i6);
            if (abstractC05094r != null) {
                int start = abstractC05094r.A03;
                if (start >= i3) {
                    int start2 = abstractC05094r.A03;
                    if (start2 > i4) {
                        continue;
                    } else {
                        int i7 = abstractC05094r.A03;
                        String[] strArr = A0A;
                        String str = strArr[5];
                        String str2 = strArr[3];
                        ...
                        if (i7 == i) {
                            int start4 = i2 - i;
                            abstractC05094r.A0W(start4, false);
                        } else {
                            abstractC05094r.A0W(i5, false);
                        }
                    }
                } else {
                    continue;
    ...
    public final void A0T(int i, int i2) {
        ...
        for (int i4 = this.A06.size() - 1; i4 >= 0; i4--) {
            AbstractC05094r abstractC05094r = this.A06.get(i4);
            if (abstractC05094r != null && (positionEnd = abstractC05094r.A03) >= i && positionEnd < i3) {
                abstractC05094r.A0T(2);
                A07(i4);
            }
        }
    }
    ...
    public final void A0U(int i, int i2, boolean z) {
        ...
        for (int i4 = removedEnd - 1; i4 >= 0; i4--) {
            AbstractC05094r abstractC05094r = this.A06.get(i4);
            if (abstractC05094r != null) {
                int removedEnd2 = abstractC05094r.A03;
                if (removedEnd2 >= i3) {
                    int removedEnd3 = -i2;
                    abstractC05094r.A0W(removedEnd3, z);
                } else {
                    int removedEnd4 = abstractC05094r.A03;
                    if (removedEnd4 >= i) {
                        abstractC05094r.A0T(8);
                        A07(i4);
                    }
                }
            }
    ...
    public final void A0a(AbstractC05074p abstractC05074p) {
        this.A04 = abstractC05074p;
    }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public final void A0b(com.facebook.ads.redexgen.X.AbstractC05094r r10) {
        /*
            Method dump skipped, instructions count: 384
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.X.C04994h.A0b(com.facebook.ads.redexgen.X.4r):void");
    }

    public final void A0c(AbstractC05094r abstractC05094r) {
        boolean z;
        z = abstractC05094r.A0G;
        if (z) {
            this.A02.remove(abstractC05094r);
        } else {
            this.A05.remove(abstractC05094r);
        }
        abstractC05094r.A0F = null;
        abstractC05094r.A0G = false;
        abstractC05094r.A0O();
    }

    public final void A0d(AbstractC05094r abstractC05094r, boolean z) {
        E9.A0s(abstractC05094r);
        if (abstractC05094r.A0k(16384)) {
            abstractC05094r.A0U(0, 16384);
            C3E.A0B(abstractC05094r.A0H, null);
        }
        if (z) {
            A0B(abstractC05094r);
        }
        abstractC05094r.A08 = null;
        A0H().A09(abstractC05094r);
    }
}
