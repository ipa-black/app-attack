...
public enum OV {
    ...
    public static OV A00(String str) {
        OV[] values;
        for (OV ov : values()) {
            if (ov.A00.equalsIgnoreCase(str)) {
                return ov;
            }
        }
        return A0O;
