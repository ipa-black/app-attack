...
public enum EnumC1038Qp {
    ...
    EnumC1038Qp(String str) {
        this.A00 = str;
    }

    public static EnumC1038Qp A00(String str) {
        EnumC1038Qp[] valuesCustom;
        for (EnumC1038Qp enumC1038Qp : valuesCustom()) {
            if (enumC1038Qp.A00.equals(str)) {
                return enumC1038Qp;
            }
        }
    ...
    public static EnumC1038Qp[] valuesCustom() {
        EnumC1038Qp[] enumC1038QpArr = (EnumC1038Qp[]) values().clone();
        String[] strArr = A02;
