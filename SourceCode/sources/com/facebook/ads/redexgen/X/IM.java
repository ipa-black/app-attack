...
public final class IM {
    ...
    public static int A07(Context context) {
        return IK.A0P(context).A2I(A0L(TTAdConstant.STYLE_SIZE_RADIO_2_3, 36, 33), 10485760);
    }
    ...
    public static long A0I(Context context) {
        return IK.A0P(context).A2J(A0L(320, 46, 122), ExoPlayer.DEFAULT_DETACH_SURFACE_TIMEOUT_MS);
    }

    public static long A0J(Context context) {
        return IK.A0P(context).A2I(A0L(IronSourceError.ERROR_IS_ALL_SMASHES_SESSION_CAPPED, 41, 66), VastError.ERROR_CODE_GENERAL_WRAPPER) * 1000;
    }

    public static long A0K(Context context) {
        return IK.A0P(context).A2J(A0L(IronSourceConstants.RV_CALLBACK_AVAILABILITY_TRUE, 34, 102), 500L);
    }
