...
public class N5 extends WebViewClient {
    ...
    public final WeakReference<C1082Sh> A03;
    ...
    public N5(C1203Xc c1203Xc, WeakReference<N3> weakReference, WeakReference<QA> weakReference2, WeakReference<LD> weakReference3, WeakReference<AtomicBoolean> checkAssetsByJavascriptBridge, WeakReference<C1082Sh> weakReference4, AtomicInteger atomicInteger, AtomicReference<String> requestId, boolean z) {
        this.A02 = c1203Xc;
    ...
    private void A03(int i, CharSequence charSequence, long j) {
        ...
        InterfaceC05777r A07 = this.A02.A07();
        int i2 = C05787s.A2c;
        String defaultErrorMessage = AdErrorType.WEB_VIEW_FAILED_TO_LOAD.getDefaultErrorMessage();
        A07.A9C(A01(306, 8, 32), i2, new C05797t(defaultErrorMessage, A01(55, 12, 72) + jSONObject.toString()));
    }
    ...
    private final void A05(WebResourceRequest webResourceRequest, WebResourceResponse webResourceResponse) {
        ...
        this.A02.A0E().AG4(webResourceResponse.getStatusCode(), C0882Ko.A01(statusCode, A01(67, 10, 55), A01(0, 0, 49) + webResourceRequest.getUrl()));
    }
    ...
    private void A07(String str, String str2) {
        ...
        if (c1203Xc != null) {
            ...
            A07.A9C(A01(306, 8, 32), i, new C05797t(defaultErrorMessage, A01(55, 12, 72) + jSONObject.toString()));
        }
    }
    ...
    public final void onPageStarted(WebView webView, String str, Bitmap bitmap) {
        ...
        this.A02.A0E().AG2();
        this.A00 = new Date();
        new Handler().postDelayed(new C1083Si(this), this.A08.get());
    }
    ...
    public final void onReceivedError(WebView webView, WebResourceRequest webResourceRequest, WebResourceError webResourceError) {
        ...
        this.A02.A0E().AG3(C0882Ko.A01(webResourceError.getErrorCode(), A01 + ((Object) webResourceError.getDescription()), A01 + webResourceRequest.getUrl()));
    }
