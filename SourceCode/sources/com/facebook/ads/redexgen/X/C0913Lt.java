...
public final class C0913Lt extends RelativeLayout {
    @Nullable
    public TextView A00;
    ...
    public C0913Lt(C1203Xc c1203Xc, int i, int i2, String str, @Nullable String str2, String str3, String str4, Bitmap bitmap) {
        super(c1203Xc);
        this.A05 = new TextView(c1203Xc);
        this.A02 = new Button(c1203Xc);
        this.A01 = new Button(c1203Xc);
        this.A03 = new ImageView(c1203Xc);
        this.A04 = new LinearLayout(c1203Xc);
