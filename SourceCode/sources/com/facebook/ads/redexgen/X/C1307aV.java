...
public final class C1307aV implements C0K {
    ...
    public static String A01(int i, int i2, int i3) {
        ...
        for (int i4 = 0; i4 < copyOfRange.length; i4++) {
            byte b2 = (byte) ((copyOfRange[i4] - i3) - 93);
    ...
    private HttpURLConnection A02(int i, int i2) throws IOException, C1309aX {
        String A01;
        ...
        do {
            ...
            if (i3 > 5) {
                ...
                throw new C1309aX(url2);
            }
        } while (code != 0);
        return httpURLConnection;
    }

    private void A03() throws C1309aX {
        ...
        try {
            try {
                ...
                Log.e(A07, A01(TsExtractor.TS_STREAM_TYPE_AC3, 25, 77) + this.A03, e2);
                C0I.A05(inputStream);
    ...
    private final void A05(int i, int i2) throws C1309aX {
        try {
            this.A02 = A02(i, i2);
            ...
            throw new C1309aX(A01(154, 29, 63) + this.A03 + A01(19, 13, 86) + i, e2);
        }
    }
    ...
    public final void close() throws C1309aX {
        ...
        if (httpURLConnection != null) {
            try {
                ...
                throw new C1309aX(A01(92, 37, 93), e2);
            }
        }
    }

    @Override // com.facebook.ads.redexgen.X.C0K
    public final synchronized int length() throws C1309aX {
    ...
    public final int read(byte[] bArr) throws C1309aX {
        ...
        if (inputStream != null) {
            try {
                ...
                throw new FP(A01(278, 15, 96) + this.A03 + A01(0, 15, 66), e2);
            } catch (IOException e3) {
                throw new C1309aX(A01 + this.A03, e3);
            }
        }
        throw new C1309aX(A01 + this.A03 + A01(51, 23, 21));
    }

    public final String toString() {
        return A01(LossReason.LOSS_REASON_CREATIVE_FILTERED_LANGUAGE_EXCLUSIONS_VALUE, 19, 41) + this.A03 + A01(328, 1, 87);
    }
}
