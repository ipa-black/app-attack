...
public final class C2D {
    ...
    private String A01() {
        return A03(A02(643, 27, 68), A02(TsExtractor.TS_STREAM_TYPE_AC3, 64, 34));
    }
    ...
    public static Map<String, String> A05(@Nullable String str) {
        ...
        try {
            ...
            if (A04(jSONObject.getString(A02(670, 17, 53))).size() == 0) {
                A08(C05787s.A27, new C05797t(A02(239, 20, 101)));
                return null;
            } else if (A04(jSONObject.getString(A02(503, 15, 30))).size() == 0) {
                A08(C05787s.A24, new C05797t(A02(221, 18, 10)));
                return null;
            } else {
                return hashMap;
            }
        } catch (JSONException e2) {
            A08(C05787s.A26, new C05797t(e2));
            return null;
        }
    }
    ...
    public static void A08(int i, C05797t c05797t) {
        C1202Xb sdkContext = C7M.A00();
        if (sdkContext != null) {
            sdkContext.A07().A9C(A02(687, 9, 5), i, c05797t);
        }
    }
    ...
    public final C2H A0A() {
        C2H c2h = new C2H(A00());
        try {
            for (C2H hideAdParent : A04(A03(A02(503, 15, 30), A02(0, 0, 94)))) {
                c2h.A06(hideAdParent);
            }
        } catch (JSONException e2) {
            A07();
            A08(C05787s.A25, new C05797t(e2));
        }
        return c2h;
    }
    ...
    public final C2H A0B() {
        ...
        try {
            ...
            A07();
            A08(C05787s.A28, new C05797t(e2));
        }
        return c2h;
    }
