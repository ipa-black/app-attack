...
public class C0696Cv extends Exception {
    ...
    public C0696Cv(Format format, Throwable th, boolean z, int i) {
    ...
    public C0696Cv(Format format, Throwable th, boolean z, String str) {
        super(A01(2, 21, 67) + str + A01(0, 2, 104) + format, th);
        this.A02 = format.A0O;
        this.A03 = z;
        this.A00 = str;
        this.A01 = C0815Hs.A02 >= 21 ? A02(th) : null;
    }
