...
public final class C0734El {
     ...
     */
    public final synchronized int A09(C9S c9s, C1181Wg c1181Wg, boolean z, boolean z2, Format format, C0733Ek c0733Ek) {
        if (!A0I()) {
            if (z2) {
                c1181Wg.A02(4);
                return -4;
        ...
        if (z || this.A0G[A00] != format) {
            ...
            c1181Wg.A00 = this.A0F[A00];
            c1181Wg.A02(this.A0B[A00]);
            c0733Ek.A00 = this.A0C[A00];
            c0733Ek.A01 = this.A0E[A00];
            c0733Ek.A02 = this.A0H[A00];
            this.A03++;
            return -4;
        }
    }
    ...
    java.lang.ArrayIndexOutOfBoundsException
     */
    public final synchronized void A0G(long j, int i, long j2, int i2, C0666Bg c0666Bg) {
        if (this.A0A) {
            if ((i & 1) == 0) {
                return;
            }
        ...
        if (this.A02 == this.A01) {
            ...
            C0666Bg[] c0666BgArr = new C0666Bg[i3];
            ...
            System.arraycopy(this.A0H, this.A04, c0666BgArr, 0, i4);
            ...
            System.arraycopy(this.A0H, 0, c0666BgArr, i4, i5);
    ...
    */
    private int A01(int r6, int r7, long r8, boolean r10) {
        ...
        L21:
            return r4
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.X.C0734El.A01(int, int, long, boolean):int");
    }
    ...
    */
    public final long A0C(int r6) {
        ...
        L2f:
            ...
            return r2
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.X.C0734El.A0C(int):long");
    }
    ...
    public final synchronized boolean A0K(Format format) {
        ...
        this.A09 = false;
        if (C0815Hs.A0g(format, this.A08)) {
            return false;
        }
        this.A08 = format;
        return true;
