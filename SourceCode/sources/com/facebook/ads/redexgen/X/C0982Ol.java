...
public final class C0982Ol extends RelativeLayout {
    public final Paint A00;
    public final RectF A01;

    public C0982Ol(C1203Xc c1203Xc, String str) {
        super(c1203Xc);
        float f2 = c1203Xc.getResources().getDisplayMetrics().density;
        TextView textView = new TextView(c1203Xc);
