    ...
    public final void onReceive(Context context, Intent intent) {
        ...
        if (str3.equals(action5)) {
            ...
            if (serializableExtra instanceof M0) {
                ...
                return;
            } else if (serializableExtra instanceof C0971Nz) {
                if (this.A01.getListener() == null) {
                    return;
                }
                InterfaceC0912Ls listener = this.A01.getListener();
                String[] split3 = A04;
                ...
                if (this.A01.getListener() != null) {
                    InterfaceC0912Ls listener2 = this.A01.getListener();
                    String[] split4 = A04;
                ...
                this.A02 = false;
                return;
            } else if (!(serializableExtra instanceof C05626z) || this.A01.getListener() == null) {
                return;
            } else {
