...
public final class WS implements BV {
    ...
    public static void A05() {
        byte[] bArr = {-89, -19, -7, -24, -12, -20, -89, -5, 0, -9, -20, -89, -65, -67, -35, -23, -18, -90, -17, -19, 13, 25, 30, -7, 35, 14, -42, 14, 58, SignedBytes.MAX_POWER_OF_TWO, 55, 47, -21, 57, 58, 63, -21, 49, 52, 57, 47, -21, 12, 24, 29, -21, 51, 48, 44, 47, 48, 61, -7, 37, 72, 72, 65, 67, 61, 72, -4, 29, 41, 46, -4, 36, 73, 81, 60, 71, 68, 63, -5, 75, 60, 63, 63, 68, 73, 66, -5, 61, 68, 79, 78, -5, 65, 74, 77, -5, 65, 77, 60, 72, SignedBytes.MAX_POWER_OF_TWO, -5, 67, SignedBytes.MAX_POWER_OF_TWO, 60, 63, SignedBytes.MAX_POWER_OF_TWO, 77, -5, -53, -65, -34, -55, 67, 87, 70, 75, 81, 17, 21, 73, 82, 82, -3, 17, 0, 5, 11, -53, -3, 9, 14, -55, 19, -2};
        if (A08[6].length() != 31) {
            throw new RuntimeException();
        }
        String[] strArr = A08;
    ...
    static {
        ...
        A0B = C0815Hs.A0i(A03(12, 6, 52));
        A0C = C0815Hs.A0i(A03(18, 9, 100));
        A0A = A0E[8];
    }
    ...
    private int A01(BW bw) throws IOException, InterruptedException {
        ...
        throw new C9Y(A03(65, 38, 115) + ((int) b2));
    }
    ...
    private void A04() {
        if (!this.A04) {
            this.A04 = true;
            this.A03.A5X(Format.A06(null, this.A05 ? A03(117, 12, 52) : A03(107, 10, 122), null, -1, A0A, 1, this.A05 ? AacUtil.AAC_HE_V1_MAX_RATE_BYTES_PER_SECOND : 8000, -1, null, null, 0, null));
        }
    }
