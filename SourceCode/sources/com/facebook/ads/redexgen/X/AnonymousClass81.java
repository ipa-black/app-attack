...
public final class AnonymousClass81 {
    ...
    public static void A0A(C7N c7n) {
        try {
            ...
            int status = c7n.getIntExtra(A01(TsExtractor.TS_STREAM_TYPE_SPLICE_INFO, 6, 71), -1);
            boolean z = status == 2 || status == 5;
            float f2 = 0.0f;
            if (scale > 0) {
                f2 = (intExtra / scale) * 100.0f;
            }
            A05.put(A01(77, 7, 113), String.valueOf(f2));
            A05.put(A01(84, 8, 75), z ? A01(1, 1, 117) : A01(0, 1, 33));
        } catch (IllegalArgumentException e2) {
            c7n.A07().A9C(A01(102, 7, 57), C05787s.A1T, new C05797t(e2));
        }
    }
