...
public final class JK {
    ...
    public JK(C7N c7n, @Nullable String str, @Nullable String str2, @Nullable JF jf) throws JB {
        ...
        try {
            ...
            if (JI.A00[JJ.valueOf(jSONObject.getString(A014).toUpperCase()).ordinal()] != 1) {
                ...
                throw new JB(adErrorType, A01(LossReason.LOSS_REASON_CREATIVE_FILTERED_AD_TYPE_EXCLUSIONS_VALUE, 28, 16) + jSONObject.getString(A014));
            }
            this.A00 = JJ.A02;
            ...
            c7n.A07().A9C(A01(238, 3, 37), C05787s.A0P, new C05797t(e2));
            throw new JB(AdErrorType.BID_PAYLOAD_ERROR, A01(152, 18, 27), e2);
        }
    }
    ...
    public static JF A00(String str) throws JB {
        try {
            return JF.A00(new JSONObject(str).getInt(A01(302, 8, 85)));
        } catch (JSONException e2) {
            throw new JB(AdErrorType.BID_PAYLOAD_ERROR, A01(152, 18, 27), e2);
        }
    }
