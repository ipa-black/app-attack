...
public final class C7W {
    ...
    public final C1201Xa A02 = new C1201Xa(this);
    ...
    public static void A07() {
        A04 = new byte[]{-31, -2, -31, -81, -51, -81, -50, -11, 22, 40, 24, -67, -29, -17, -20, -22, -67, -44, -2, 3, -3, 2, -44, -108, -64, -67, -63, -67, -56, -108, -106, -59, -60, -106, -35, 12, 15, 1, 2, 15, -35, -1, 22, -35, -42, 9, -5, 10, -42, -98, -43, -58, -61, -48, -61, -98, -49, -43, -46, -58, 11, 3, -54, -52, 22, 52, 65, 65, 66, 71, -13, 54, 52, 63, 63, -13, 58, 56, 71, 23, 52, 71, 52, 53, 52, 70, 56, -13, 57, 69, 66, SignedBytes.MAX_POWER_OF_TWO, -13, 71, 59, 56, -13, 40, 28, -13, 71, 59, 69, 56, 52, 55, -12, 33, 19, 26, 19, 17, 34, -18, 66, 61, 57, 51, 60, 65, -4, 39, 34, 22, 19, 38, 23, -14, 43, 40, 59, 40, 41, 40, 58, 44, 71, 88, 71, 80, 86, 85, -9, -14, -18, -24, -15, -10};
    }
    ...
    static {
        ...
        sb.append(A055);
        sb.append(A054);
        sb.append(C1201Xa.A04.A01);
        sb.append(A052);
        sb.append(A055);
        sb.append(A054);
        sb.append(C1201Xa.A05.A01);
        sb.append(A052);
        sb.append(A055);
        sb.append(A054);
        sb.append(C1201Xa.A0A.A01);
        sb.append(A052);
        sb.append(A055);
        sb.append(A054);
        sb.append(C1201Xa.A08.A01);
        sb.append(A052);
        sb.append(A055);
        sb.append(A054);
        sb.append(C1201Xa.A07.A01);
        sb.append(A052);
        sb.append(A055);
        sb.append(A054);
        sb.append(C1201Xa.A06.A01);
        sb.append(A052);
        sb.append(A055);
        sb.append(A054);
        sb.append(C1201Xa.A03.A01);
        sb.append(A052);
        sb.append(A055);
        sb.append(A054);
        sb.append(C1201Xa.A02.A01);
    ...
    public C7W(C1202Xb c1202Xb) {
        this.A01 = c1202Xb;
    }

    private synchronized SQLiteDatabase A00() {
        if (this.A00 == null) {
            final C1202Xb c1202Xb = this.A01;
            this.A00 = new SQLiteOpenHelper(c1202Xb, this) { // from class: com.facebook.ads.redexgen.X.7X
                ...
                {
                    super(c1202Xb, A01(c1202Xb), (SQLiteDatabase.CursorFactory) null, 4);
                    if (this != null) {
                        this.A00 = this;
                        return;
                    }
                ...
                public static String A01(C1202Xb c1202Xb2) {
                    ...
                    String defaultDbName = c1202Xb2.getPackageName();
                    String processName2 = ProcessUtils.getProcessName(c1202Xb2);
    ...
    private synchronized SQLiteDatabase A01() {
        ...
        this.A01.A07().A9C(A05(128, 8, 84), C05787s.A0v, new C05797t(e2));
        throw e2;
        return A00();
    }
    ...
    public final int A08(int i) {
        ...
        try {
            ...
            return A0E.delete(A052, C1201Xa.A02.A01 + A05(3, 4, 28), new String[]{String.valueOf(i - 1)});
        } finally {
            A08.unlock();
        }
    }
    ...
    public final <T> AsyncTask A0F(final C7Z<T> c7z, final C8W<T> c8w) {
        ...
        final C1202Xb c1202Xb = this.A01;
        return LN.A00(executor, new AsyncTask<Void, Void, T>(c1202Xb, c7z, c8w) { // from class: com.facebook.ads.redexgen.X.7V
            public static byte[] A04;
                ...
                if (A05[6].length() != 11) {
                    ...
                    try {
                        try {
                            ...
                            this.A01.A07().A9C(A01(0, 8, 71), C05787s.A0w, new C05797t(e2));
                            this.A00 = C7Y.A09;
                            return t;
                        }
                    } catch (Throwable th) {
    ...
    public final AsyncTask A0G(String str, int i, String str2, double d2, double d3, String str3, Map<String, String> data, C8W<String> c8w) {
        return A0F(new C0717Du(this, str2, str, i, d2, d3, str3, data), c8w);
    }
    ...
    public final boolean A0L(String str) {
        ...
        A08.lock();
        try {
            A0E().execSQL(A05(121, 7, 95) + A05(136, 6, 111) + A05(44, 5, 67) + C1201Xa.A02.A01 + A05(61, 1, 83) + C1201Xa.A02.A01 + A05(56, 2, 49) + A05(49, 7, 11) + C1201Xa.A04.A01 + A05(62, 2, 26), new String[]{str});
            z = true;
