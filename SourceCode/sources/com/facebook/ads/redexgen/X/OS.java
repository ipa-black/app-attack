...
public final class OS extends InputStream {
    ...
    public OS(C1202Xb c1202Xb, FileInputStream fileInputStream, OR or) {
        ...
        if (messageDigest != null) {
            ...
            try {
                if (read > 0) {
                    ...
                    String hash = C0881Kn.A05(messageDigest.digest());
                    this.A02.A8K(hash);
                    this.A00 = null;
                }
            } catch (Exception e2) {
                this.A00 = null;
                this.A01.A07().A9V(A00(3, 3, 122), C05787s.A13, new C05797t(e2));
            }
        }
        return read;
    }
