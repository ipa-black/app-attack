...
public final class AnonymousClass60 {
    ...
    public static C05435z A00(ContentResolver contentResolver) {
        ...
        try {
            ...
            if (query == null || !query.moveToFirst()) {
                C05435z c05435z = new C05435z(null, null, false);
                if (query != null) {
                    query.close();
                }
                return c05435z;
            ...
            C05435z c05435z2 = new C05435z(string, attributionId, Boolean.valueOf(query.getString(query.getColumnIndex(A012))).booleanValue());
            query.close();
            return c05435z2;
        } catch (Throwable th) {
            if (0 != 0) {
