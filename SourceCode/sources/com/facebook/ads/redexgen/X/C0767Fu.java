...
public final class C0767Fu {
    ...
    private C0767Fu A00(C0767Fu c0767Fu, boolean z) {
        if (c0767Fu != null) {
            if (!this.A0C && c0767Fu.A0C) {
                A0B(c0767Fu.A03);
            }
            if (this.A02 == -1) {
                this.A02 = c0767Fu.A02;
            }
            if (this.A05 == -1) {
                this.A05 = c0767Fu.A05;
            }
            if (this.A09 == null) {
                this.A09 = c0767Fu.A09;
            }
            if (this.A06 == -1) {
                this.A06 = c0767Fu.A06;
            }
            if (this.A07 == -1) {
                this.A07 = c0767Fu.A07;
            }
            if (this.A08 == null) {
                this.A08 = c0767Fu.A08;
            }
            if (this.A04 == -1) {
                int i = c0767Fu.A04;
                String[] strArr = A0F;
                ...
                this.A04 = i;
                this.A00 = c0767Fu.A00;
            }
            if (z && !this.A0B && c0767Fu.A0B) {
                A0A(c0767Fu.A01);
            }
        }
        return this;
    ...
    public final C0767Fu A09(float f2) {
        this.A00 = f2;
        return this;
    }

    public final C0767Fu A0A(int i) {
        this.A01 = i;
        this.A0B = true;
        return this;
    }

    public final C0767Fu A0B(int i) {
    ...
    public final C0767Fu A0C(int i) {
        this.A04 = i;
        return this;
    }

    public final C0767Fu A0D(Layout.Alignment alignment) {
        this.A08 = alignment;
        return this;
    }

    public final C0767Fu A0E(C0767Fu c0767Fu) {
        return A00(c0767Fu, true);
    }

    public final C0767Fu A0F(String str) {
        HD.A04(this.A0D == null);
        this.A09 = str;
        return this;
    }

    public final C0767Fu A0G(String str) {
        this.A0A = str;
        return this;
    }

    public final C0767Fu A0H(boolean z) {
        HD.A04(this.A0D == null);
        this.A02 = z ? 1 : 0;
        return this;
    }

    public final C0767Fu A0I(boolean z) {
        HD.A04(this.A0D == null);
        this.A05 = z ? 1 : 0;
        return this;
    }

    public final C0767Fu A0J(boolean z) {
        HD.A04(this.A0D == null);
        this.A06 = z ? 1 : 0;
        return this;
    }

    public final C0767Fu A0K(boolean z) {
        HD.A04(this.A0D == null);
        this.A07 = z ? 1 : 0;
        return this;
    }
