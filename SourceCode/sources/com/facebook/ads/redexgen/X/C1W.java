...
public final class C1W {
    ...
    public static C04181b A01(JSONObject jSONObject) {
        return new C04171a().A06(A0A(jSONObject)).A07(A0B(jSONObject)).A05(A05(jSONObject)).A04(A04(jSONObject)).A08();
    }

    public static String A03(JSONObject jSONObject) {
        JSONObject optJSONObject = jSONObject.optJSONObject(A02(279, 12, 72));
        String A02 = A02(TsExtractor.TS_STREAM_TYPE_AC4, 9, 91);
    ...
    public static String A05(JSONObject jSONObject) {
        JSONObject optJSONObject = jSONObject.optJSONObject(A02(279, 12, 72));
        String A02 = A02(TsExtractor.TS_STREAM_TYPE_DTS, 13, 77);
    ...
    public static String A06(JSONObject jSONObject) {
        ...
        return optJSONObject == null ? A02 : optJSONObject.optString(A02(LossReason.LOSS_REASON_CREATIVE_FILTERED_NOT_ALLOWED_IN_DEAL_VALUE, 8, 62), A02);
    }
