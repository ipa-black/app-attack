...
public final class QU implements Map<String, String> {
    ...
    public QU(Map<String, String> map) {
        this.A00 = map;
    }
    ...
    public final QU A04(String str, String str2) {
        this.A00.put(str, str2);
        return this;
    }

    public final QU A05(Map<? extends String, ? extends String> arg) {
        putAll(arg);
        return this;
    }
    ...
    public final String A06() {
        ...
        for (String str : this.A00.keySet()) {
            ...
            if (value != null) {
                ...
                try {
                    sb.append(URLEncoder.encode(value, A00(2, 5, 74)));
