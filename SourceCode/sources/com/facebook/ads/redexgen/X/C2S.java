...
public final class C2S extends Drawable {
    ...
    public C2S(ColorStateList colorStateList, float f2) {
        this.A01 = f2;
        A01(colorStateList);
        this.A0A = new RectF();
        this.A09 = new Rect();
    ...
    private void A02(Rect rect) {
        ...
        this.A09.set(rect);
        if (this.A06) {
            float A01 = C2U.A01(this.A00, this.A01, this.A07);
            float vInset = C2U.A00(this.A00, this.A01, this.A07);
    ...
    public final void A07(float f2, boolean z, boolean z2) {
        if (f2 == this.A00) {
            boolean z3 = this.A06;
