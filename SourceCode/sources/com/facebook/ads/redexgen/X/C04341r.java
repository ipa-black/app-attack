...
public final class C04341r {
    ...
    public static AdSettings.IntegrationErrorMode A00(C1203Xc c1203Xc) {
        ...
        if (integrationErrorMode == integrationErrorMode2 && !A03(c1203Xc)) {
    ...
    public static boolean A03(C1203Xc c1203Xc) {
        return (c1203Xc.getApplicationInfo().flags & 2) != 0;
    }
}
