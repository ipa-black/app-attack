...
public final class C0829Ii {
    ...
    public final InterfaceC0821Ia A00;
    ...
    public C0829Ii(String str, InterfaceC0821Ia interfaceC0821Ia) {
        this.A01 = str;
        this.A00 = interfaceC0821Ia;
    }

    public static void A02(EnumC0828Ih enumC0828Ih, @Nullable Map<String, String> map, String str, InterfaceC0821Ia interfaceC0821Ia) {
        A03(enumC0828Ih.A02(), map, str, interfaceC0821Ia);
    }

    public static void A03(String str, @Nullable Map<String, String> map, String str2, InterfaceC0821Ia interfaceC0821Ia) {
        if (!C0831Ik.A0B(str2, str)) {
            return;
        }
        if (map == null) {
            map = new HashMap<>();
        ...
        interfaceC0821Ia.A9F(str2, map);
    }

    public final void A04(EnumC0828Ih enumC0828Ih, @Nullable Map<String, String> data) {
        A05(enumC0828Ih.A02(), data);
    }
