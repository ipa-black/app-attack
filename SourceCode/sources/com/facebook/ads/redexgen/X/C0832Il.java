...
public final class C0832Il {
    ...
    public static void A06(C7N c7n, QG qg, Map<String, ?> map) throws JSONException {
        ...
        hashMap2.put(A01(TsExtractor.TS_PACKET_SIZE, 7, 10), A01(157, 14, 92));
        hashMap2.put(A01(195, 12, 97), String.valueOf((int) IronSourceConstants.BN_AUCTION_FAILED));
        ...
        A09(c7n, hashMap2);
        C8I A08 = c7n.A08();
        JSONObject A05 = C05807u.A05(new C05827w(A08.A01(), A08.A02(), hashMap2));
    ...
    static {
        A04();
        A02 = C0832Il.class.getSimpleName();
    ...
    @VisibleForTesting
    public static boolean A0A(double d2, int i) {
