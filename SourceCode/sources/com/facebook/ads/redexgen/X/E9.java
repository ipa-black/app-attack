...
public class E9 extends ViewGroup implements Yt {
    ...
    @VisibleForTesting
    public C4Z A06;
    public InterfaceC05004i A07;
    public RunnableC05084q A08;
    public YR A09;
    public boolean A0A;
    public boolean A0B;
    public boolean A0C;
    ...
    public C4Q A0e;
    public C4T A0f;
    public AbstractC04954c A0g;
    public InterfaceC04964d A0h;
    public AbstractC04974e A0i;
    public RecyclerView$SavedState A0j;
    public Runnable A0k;
    public List<RecyclerView.OnChildAttachStateChangeListener> A0l;
    public List<AbstractC04974e> A0m;
    public boolean A0n;
    public boolean A0o;
    public final Rect A0p;
    public final RectF A0q;
    public final C04994h A0r;
    public final C05064o A0s;
    public final C05174z A0t;
    public final Runnable A0u;
    public final ArrayList<C4W> A0v;
    @VisibleForTesting
    public final List<AbstractC05094r> A0w;
    public final int A0x;
    public final int A0y;
    public final Rect A0z;
    public final AccessibilityManager A10;
    public final YU A11;
    public final InterfaceC05164y A12;
    public final ArrayList<InterfaceC04964d> A13;
    ...
    private void A0N() {
        ...
        C05064o c05064o2 = this.A0s;
        c05064o2.A05 = c05064o2.A03;
        this.A0C = false;
        C05064o c05064o3 = this.A0s;
        c05064o3.A0C = false;
        c05064o3.A0B = false;
        this.A06.A09 = false;
        if (this.A0r.A02 != null) {
            ArrayList<AbstractC05094r> arrayList = this.A0r.A02;
            String[] strArr = A19;
    ...
    public E9(Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        this.A0r = new C04994h(this);
        this.A0t = new C05174z();
        ...
        this.A0o = true;
        this.A08 = new RunnableC05084q(this);
        this.A02 = A1E ? new C1232Yf() : null;
        this.A0s = new C05064o();
        this.A0G = false;
        this.A0H = false;
    ...
    private final long A0C(AbstractC05094r abstractC05094r) {
        return this.A04.A0A() ? abstractC05094r.A0K() : abstractC05094r.A03;
    }

    @Nullable
    private View A0D() {
        AbstractC05094r A1F2;
        int i = this.A0s.A01 != -1 ? this.A0s.A01 : 0;
        int A03 = this.A0s.A03();
        for (int i2 = i; i2 < A03; i2++) {
            AbstractC05094r A1F3 = A1F(i2);
            if (A1F3 == null) {
                break;
    ...
    private final AbstractC05094r A0E(long j) {
        C4N c4n = this.A04;
        if (c4n == null || !c4n.A0A()) {
            return null;
        }
        int A06 = this.A01.A06();
        AbstractC05094r abstractC05094r = null;
        for (int i = 0; i < A06; i++) {
            AbstractC05094r holder = A0F(this.A01.A0A(i));
            if (holder != null && !holder.A0c()) {
                ...
                if (childCount2 != 0) {
                    ...
                    abstractC05094r = holder;
                } else {
                    return holder;
                }
            }
        }
        return abstractC05094r;
    }

    public static AbstractC05094r A0F(View view) {
        if (view == null) {
            return null;
        }
        ...
        return ((C04934a) layoutParams).A00;
    }

    @Nullable
    private final AbstractC05094r A0G(View view) {
    ...
    */
    ...
    private void A0O() {
        this.A01 = new C04903x(new YZ(this));
    }
    ...
    */
    ...
    private void A0Q() {
        ...
        if (this.A0o && this.A04 != null && hasFocus() && getDescendantFocusability() != 393216) {
            ...
            if (this.A0s.A08 != -1 && this.A04.A0A()) {
                abstractC05094r = A0E(this.A0s.A08);
            }
            View view = null;
            if (abstractC05094r == null || this.A01.A0K(abstractC05094r.A0H) || !abstractC05094r.A0H.hasFocusable()) {
                if (this.A01.A05() > 0) {
                    view = A0D();
                }
            } else {
                view = abstractC05094r.A0H;
            }
            if (view != null) {
    ...
    private void A0U() {
        ...
        AbstractC05094r A0G2 = view == null ? null : A0G(view);
        if (A0G2 == null) {
            A0S();
            return;
        }
    ...
    private final void A0X() {
        ...
        for (int i = 0; i < A06; i++) {
            ...
            AbstractC05094r A0F = A0F(c04903x.A0A(i));
            if (!A0F.A0h()) {
                A0F.A0M();
            }
        }
    ...
    private final void A0Z() {
        ...
        for (int size = this.A0w.size() - 1; size >= 0; size--) {
            AbstractC05094r abstractC05094r = this.A0w.get(size);
            if (abstractC05094r.A0H.getParent() == this && !abstractC05094r.A0h() && (state = abstractC05094r.A02) != -1) {
                C3E.A09(abstractC05094r.A0H, state);
                abstractC05094r.A02 = -1;
            }
        }
        this.A0w.clear();
    }
    ...
    private final void A0e() {
        this.A00 = new C1233Yg(new YY(this));
    }
    ...
    private final void A0g() {
        int A06 = this.A01.A06();
        for (int i = 0; i < A06; i++) {
            ((C04934a) this.A01.A0A(i).getLayoutParams()).A01 = true;
        }
        this.A0r.A0M();
    }
    ...
    private final void A0h() {
        int A06 = this.A01.A06();
        for (int i = 0; i < A06; i++) {
            AbstractC05094r A0F = A0F(this.A01.A0A(i));
            if (A0F != null && !A0F.A0h()) {
                A0F.A0T(6);
            }
        }
    ...
    private void A0j(float f2, float f3, float f4, float f5) {
        boolean z = false;
        if (f3 < 0.0f) {
            A0b();
            C04813o.A00(this.A0a, (-f3) / getWidth(), 1.0f - (f4 / getHeight()));
            z = true;
        } else if (f3 > 0.0f) {
            A0c();
            C04813o.A00(this.A0b, f3 / getWidth(), f4 / getHeight());
            z = true;
        }
        if (f5 < 0.0f) {
            A0d();
            C04813o.A00(this.A0c, (-f5) / getHeight(), f2 / getWidth());
            z = true;
        } else if (f5 > 0.0f) {
            A0a();
            C04813o.A00(this.A0Z, f5 / getHeight(), 1.0f - (f2 / getWidth()));
            z = true;
        }
    ...
    private final void A0k(int i) {
        C4Z c4z = this.A06;
        AbstractC04974e abstractC04974e = this.A0i;
        if (abstractC04974e != null) {
            abstractC04974e.A0L(this, i);
        }
        List<AbstractC04974e> list = this.A0m;
        String[] strArr = A19;
        if (strArr[2].length() == strArr[7].length()) {
            throw new RuntimeException();
        }
    ...
    private void A0m(long j, AbstractC05094r abstractC05094r, AbstractC05094r abstractC05094r2) {
        int A05 = this.A01.A05();
        for (int i = 0; i < A05; i++) {
            AbstractC05094r A0F = A0F(this.A01.A09(i));
            if (A0F != abstractC05094r) {
                int childCount = (A0C(A0F) > j ? 1 : (A0C(A0F) == j ? 0 : -1));
                if (childCount == 0) {
                    C4N c4n = this.A04;
                    String A0I = A0I(1, 17, 65);
                    if (c4n != null && c4n.A0A()) {
                        throw new IllegalStateException(A0I(1696, TsExtractor.TS_STREAM_TYPE_HDMV_DTS, 77) + A0F + A0I + abstractC05094r + A1I());
                    }
                    throw new IllegalStateException(A0I(1508, TsExtractor.TS_PACKET_SIZE, 116) + A0F + A0I + abstractC05094r + A1I());
                }
            }
        }
        Log.e(A0I(1370, 12, 79), A0I(IronSourceConstants.RV_INSTANCE_SHOW_FAILED, 111, 90) + abstractC05094r2 + A0I(18, 41, 39) + abstractC05094r + A1I());
    }
    ...
    public static void A0o(View view, Rect rect) {
        ...
        Rect rect2 = c04934a.A03;
        rect.set((view.getLeft() - rect2.left) - c04934a.leftMargin, (view.getTop() - rect2.top) - c04934a.topMargin, view.getRight() + rect2.right + c04934a.rightMargin, view.getBottom() + rect2.bottom + c04934a.bottomMargin);
    }
    ...
    private void A0p(@NonNull View view, @Nullable View view2) {
        ...
        if (focusedLayoutParams instanceof C04934a) {
            C04934a c04934a = (C04934a) focusedLayoutParams;
            if (!c04934a.A01) {
                Rect insets = c04934a.A03;
    ...
    private void A0q(C4N c4n, boolean z, boolean z2) {
        ...
        C4Z c4z = this.A06;
        C04994h c04994h = this.A0r;
        C4N oldAdapter = this.A04;
        c04994h.A0Y(c4n3, oldAdapter, z);
        this.A0s.A0D = true;
        A1Q();
    }

    private void A0r(AbstractC05094r abstractC05094r) {
        View view = abstractC05094r.A0H;
        boolean z = view.getParent() == this;
        this.A0r.A0c(A1H(view));
        if (abstractC05094r.A0e()) {
            C04903x c04903x = this.A01;
            String[] strArr = A19;
            if (strArr[3].length() == strArr[0].length()) {
                throw new RuntimeException();
            ...
            c04903x.A0H(view, -1, view.getLayoutParams(), true);
        } else if (!z) {
    ...
    public static void A0s(@NonNull AbstractC05094r abstractC05094r) {
        if (abstractC05094r.A09 != null) {
            WeakReference<E9> weakReference = abstractC05094r.A09;
            if (A19[1].length() != 32) {
                throw new RuntimeException();
            }
            String[] strArr = A19;
            ...
            abstractC05094r.A09 = null;
        }
    }

    private void A0t(@NonNull AbstractC05094r abstractC05094r, @NonNull AbstractC05094r abstractC05094r2, @NonNull C4U c4u, @NonNull C4U c4u2, boolean z, boolean z2) {
        ...
        if (abstractC05094r != abstractC05094r2) {
            if (z2) {
                A0r(abstractC05094r2);
            }
            abstractC05094r.A06 = abstractC05094r2;
            A0r(abstractC05094r);
            this.A0r.A0c(abstractC05094r);
            abstractC05094r2.A0Z(false);
            abstractC05094r2.A07 = abstractC05094r;
        }
        if (this.A05.A0H(abstractC05094r, abstractC05094r2, c4u, c4u2)) {
            A1N();
        }
    }
    ...
    private final boolean A12(int i, int i2) {
        ...
        if (c4z == null) {
            ...
            if (!canScrollHorizontal) {
                ...
                AbstractC04954c abstractC04954c = this.A0g;
                if (abstractC04954c != null) {
                    boolean canScrollHorizontal2 = abstractC04954c.A0B(i, i2);
    ...
    private final boolean A13(int i, int i2, MotionEvent motionEvent) {
        ...
        if (A1y(i3, unconsumedX, unconsumedY, consumedX, this.A17, 0)) {
            ...
            if (motionEvent != null && !C04622u.A00(motionEvent, 8194)) {
                float x = motionEvent.getX();
                float f2 = unconsumedY;
    ...
    private boolean A14(MotionEvent motionEvent) {
        ...
        if (action != 0) {
            ...
            for (int i2 = 0; i2 < i; i2++) {
                InterfaceC04964d interfaceC04964d = this.A13.get(i2);
                if (interfaceC04964d.onInterceptTouchEvent(this, motionEvent)) {
                    this.A0h = interfaceC04964d;
                    return true;
                }
            }
            return false;
    ...
    private boolean A15(MotionEvent motionEvent) {
        ...
        for (int listenerCount = 0; listenerCount < i; listenerCount++) {
            InterfaceC04964d interfaceC04964d = this.A13.get(listenerCount);
            if (interfaceC04964d.onInterceptTouchEvent(this, motionEvent) && action != 3) {
                this.A0h = interfaceC04964d;
                return true;
            }
        }
    ...
    private boolean A16(View view, View view2, int i) {
        ...
        if (i == 2 || i == 1) {
            ...
            if (i == 2) {
                return A17(view, view2, TsExtractor.TS_STREAM_TYPE_HDMV_DTS);
            }
    ...
    public final int A1B(View view) {
        AbstractC05094r holder = A0F(view);
        if (holder != null) {
            return holder.A0I();
        }
        return -1;
    ...
    public final int A1C(AbstractC05094r abstractC05094r) {
        if (abstractC05094r.A0k(IronSourceError.ERROR_REACHED_CAP_LIMIT_PER_PLACEMENT) || !abstractC05094r.A0a()) {
            if (A19[5].charAt(2) != 'Y') {
                throw new RuntimeException();
            }
            String[] strArr = A19;
        ...
        return this.A00.A0E(abstractC05094r.A03);
    }
    ...
    */
    public final android.graphics.Rect A1D(android.view.View r9) {
        /*
            ...
            com.facebook.ads.redexgen.X.4a r6 = (com.facebook.ads.redexgen.X.C04934a) r6
            boolean r0 = r6.A01
            if (r0 != 0) goto Ld
    ...
    */
    ...
    public final AbstractC05094r A1F(int i) {
        if (this.A0C) {
            return null;
        }
        int A06 = this.A01.A06();
        AbstractC05094r hidden = null;
        for (int i2 = 0; i2 < A06; i2++) {
            AbstractC05094r A0F = A0F(this.A01.A0A(i2));
            if (A0F != null && !A0F.A0c()) {
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public final com.facebook.ads.redexgen.X.AbstractC05094r A1G(int r9, boolean r10) {
        /*
            r8 = this;
    ...
    public final AbstractC05094r A1H(View view) {
    ...
    public final String A1I() {
        return A0I(0, 1, 65) + super.toString() + A0I(169, 10, 82) + this.A04 + A0I(PsExtractor.PRIVATE_STREAM_1, 9, 71) + this.A06 + A0I(179, 10, 10) + getContext();
    }
    ...
    public final void A1d(int i, int i2) {
        ...
        for (int i3 = 0; i3 < A06; i3++) {
            AbstractC05094r A0F = A0F(this.A01.A0A(i3));
            if (A0F != null && !A0F.A0h()) {
                int i4 = A0F.A03;
    ...
    */
            ...
            if (A0F != null && !A0F.A0h()) {
                ...
                if (i5 >= i) {
                    ...
                    if (childCount < i3) {
                        A0F.A0T(2);
                        A0F.A0Y(obj);
                        ((C04934a) A0A.getLayoutParams()).A01 = true;
                    }
                }
            }
        }
    ...
    public final void A1h(int i, int i2, boolean z) {
        ...
        int A06 = this.A01.A06();
        for (int i4 = 0; i4 < A06; i4++) {
            AbstractC05094r A0F = A0F(this.A01.A0A(i4));
            if (A0F != null && !A0F.A0h()) {
    ...
    public final void A1k(AbstractC04974e abstractC04974e) {
        if (this.A0m == null) {
            this.A0m = new ArrayList();
        }
        this.A0m.add(abstractC04974e);
    }

    public final void A1l(AbstractC04974e abstractC04974e) {
        List<AbstractC04974e> list = this.A0m;
        if (list != null) {
            list.remove(abstractC04974e);
        }
    }

    public final void A1m(C05064o c05064o) {
        if (getScrollState() == 2) {
            OverScroller overScroller = this.A08.A01;
            c05064o.A06 = overScroller.getFinalX() - overScroller.getCurrX();
            c05064o.A07 = overScroller.getFinalY() - overScroller.getCurrY();
            return;
        }
        c05064o.A06 = 0;
        c05064o.A07 = 0;
    ...
    public final void A1n(AbstractC05094r abstractC05094r, C4U c4u) {
        abstractC05094r.A0U(0, 8192);
        if (this.A0s.A0E && abstractC05094r.A0f() && !abstractC05094r.A0c() && !abstractC05094r.A0h()) {
            this.A0t.A08(A0C(abstractC05094r), abstractC05094r);
        }
        this.A0t.A0F(abstractC05094r, c4u);
    }

    public final void A1o(@NonNull AbstractC05094r abstractC05094r, @Nullable C4U c4u, @NonNull C4U c4u2) {
        abstractC05094r.A0Z(false);
        if (this.A05.A0E(abstractC05094r, c4u, c4u2)) {
            A1N();
        }
    }

    public final void A1p(@NonNull AbstractC05094r abstractC05094r, @NonNull C4U c4u, @Nullable C4U c4u2) {
        A0r(abstractC05094r);
        abstractC05094r.A0Z(false);
        if (this.A05.A0F(abstractC05094r, c4u, c4u2)) {
            A1N();
        }
    }
    ...
    public final boolean A20(View view) {
        ...
        if (A0L) {
            AbstractC05094r viewHolder = A0F(view);
    ...
    public final boolean A21(AbstractC05094r abstractC05094r) {
        C4V c4v = this.A05;
        return c4v == null || c4v.A0M(abstractC05094r, abstractC05094r.A0L());
    }

    @VisibleForTesting
    public final boolean A22(AbstractC05094r abstractC05094r, int i) {
        if (A1v()) {
            abstractC05094r.A02 = i;
            this.A0w.add(abstractC05094r);
            return false;
        }
        C3E.A09(abstractC05094r.A0H, i);
        return true;
    }
    ...
    public final boolean checkLayoutParams(ViewGroup.LayoutParams layoutParams) {
        return (layoutParams instanceof C04934a) && this.A06.A1c((C04934a) layoutParams);
    }
    ...
    */
    ...
    public final ViewGroup.LayoutParams generateLayoutParams(ViewGroup.LayoutParams layoutParams) {
        C4Z c4z = this.A06;
        if (c4z != null) {
            C04934a A0w = c4z.A0w(layoutParams);
            if (A19[1].length() != 32) {
                throw new RuntimeException();
            }
            String[] strArr = A19;
    ...
    @Nullable
    public AbstractC04954c getOnFlingListener() {
        return this.A0g;
    }
    ...
    private C04642w getScrollingChildHelper() {
        if (this.A0d == null) {
            this.A0d = new C04642w(this);
        }
        return this.A0d;
    }
    ...
    */
    ...
    public void setOnFlingListener(@Nullable AbstractC04954c abstractC04954c) {
        this.A0g = abstractC04954c;
    }

    @Deprecated
    public void setOnScrollListener(AbstractC04974e abstractC04974e) {
        this.A0i = abstractC04974e;
    }
    ...
    public void setRecyclerListener(InterfaceC05004i interfaceC05004i) {
        this.A07 = interfaceC05004i;
    }
    ...
    public void setViewCacheExtension(AbstractC05074p abstractC05074p) {
        this.A0r.A0a(abstractC05074p);
    }
    ...
    @Override // android.view.View, com.facebook.ads.redexgen.X.InterfaceC04632v
