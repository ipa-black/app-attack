...
public enum EnumC05385u {
    ...
    EnumC05385u(String str) {
        this.A00 = str;
    }

    @Nullable
    public static EnumC05385u A00(@Nullable String str) {
        EnumC05385u[] values;
        for (EnumC05385u enumC05385u : values()) {
            if (enumC05385u.A00.equals(str)) {
                return enumC05385u;
            }
        }
        return null;
