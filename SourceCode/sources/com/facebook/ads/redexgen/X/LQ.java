...
public final class LQ implements Executor {
    ...
    public static void A04() {
        A04 = new byte[]{32, 50, 56, 47, 34, 125, 123, 124, 119, 102, 101, 125, 96, 121, 112, 74, 89, 70, 3, 30, 3, SignedBytes.MAX_POWER_OF_TWO, 117, 103, Byte.MAX_VALUE, 103, 52, 101, 97, 113, 97, 113, 52, 96, 123, 123, 52, 120, 123, 122, 115, 58, 70, 68, 79, 68, 83, 72, 66};
    }
    ...
    public final void execute(Runnable runnable) {
        ...
        synchronized (LQ.class) {
            ...
            if (size == reservedExecutorQueueSize) {
                ...
                C1202Xb A00 = C7M.A00();
                if (A00 != null) {
                    InterfaceC05777r A072 = A00.A07();
                    String A002 = A00(42, 7, 27);
                    int i2 = C05787s.A1c;
                    String A003 = A00(21, 21, 46);
                    A072.A9C(A002, i2, new C05797t(A003, A00(14, 7, 25) + i));
                }
            }
        }
