...
public final class C0846Iz implements NativeAdRatingApi {
    ...
    public C0846Iz(double d2, double d3) {
        this.A01 = d2;
        this.A00 = d3;
    }

    @Nullable
    public static C0846Iz A00(@Nullable JSONObject jSONObject) {
        if (jSONObject == null) {
            return null;
        }
        if (A03[1].length() == 15) {
            ...
            if (optDouble != 0.0d) {
                ...
                if (A03[5].charAt(0) == 'R') {
                    ...
                    if (i != 0) {
                        return new C0846Iz(optDouble, optDouble2);
                    }
                }
            }
            return null;
