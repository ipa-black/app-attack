...
public final class JP implements InterfaceC1004Ph {
    ...
    private ValueAnimator A00(View view, int i, int i2) {
        ...
        ofInt.addUpdateListener(new C1013Pq(this, view));
        return ofInt;
    }
    ...
    public void A08(boolean z) {
        if (z) {
            ...
            this.A00.addListener(new C1012Pp(this));
            this.A00.start();
            return;
        }
    ...
    public void A09(boolean z) {
        ...
        if (z) {
            ...
            this.A00.addListener(new C1011Po(this));
            this.A00.start();
            return;
        }
        View view = this.A05;
