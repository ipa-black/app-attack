...
public abstract class GenericBridge {
    ...
    public Class<?> classForName() {
        try {
            ...
            DeviceLog.debug("ERROR: Could not find Class %s %s", this._className, e2.getLocalizedMessage());
            return null;
        }
    }
    ...
    private Method getReflectiveMethod(Class<?> cls, String str, Class<?>... clsArr) {
        try {
            ...
            DeviceLog.debug("ERROR: Could not find method %s in %s", str, cls.getName() + " " + e2.getLocalizedMessage());
    ...
    public void callVoidMethod(String str, Object obj, Object... objArr) {
        ...
        try {
            ...
            DeviceLog.debug("ERROR: Could not invoke method %s : %s", str, e2.getLocalizedMessage());
        }
    }
