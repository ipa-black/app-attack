...
public class InitializeThread extends Thread {
            ...
            try {
                privacyConfigurationLoader.loadConfiguration(new IConfigurationLoaderListener() { // from class: com.unity3d.services.core.configuration.InitializeThread.InitializeStateConfig.1
                    ...
                    public void onSuccess(Configuration configuration2) {
                        ...
                        InitializeStateConfig.this._nextState = isNativeWebViewCacheEnabled ? new InitializeStateCreateWithRemote(InitializeStateConfig.this._configuration) : new InitializeStateLoadCache(InitializeStateConfig.this._configuration);
                    }
        ...
        public InitializeState execute() {
            ...
            try {
                ...
                if (Sha256 != null && Sha256.equals(this._configuration.getWebViewHash())) {
                    try {
                        String str = new String(readFileBytes, C.UTF8_NAME);
    ...
    public static class InitializeStateLoadWeb extends InitializeState {
        ...
        public InitializeState execute() {
            ...
            try {
                try {
                    String makeRequest = new WebRequest(this._configuration.getWebViewUrl(), ShareTarget.METHOD_GET, null).makeRequest();
        ...
        public InitializeState execute() {
            try {
                ...
                if (Utilities.Sha256(loadCachedFileToByteArray).equals(this._configuration.getWebViewHash())) {
                    return new InitializeStateUpdateCache(this._configuration, new String(loadCachedFileToByteArray, C.UTF8_NAME));
                }
            } catch (Exception unused) {
            }
