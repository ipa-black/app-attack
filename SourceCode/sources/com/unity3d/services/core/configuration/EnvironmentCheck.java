...
public class EnvironmentCheck {
    ...
    public static boolean testProGuard() {
        try {
            ...
            DeviceLog.exception("Unity Ads ProGuard check fail: Unity Ads web bridge class not found", e2);
            return false;
        } catch (NoSuchMethodException e3) {
            DeviceLog.exception("Unity Ads ProGuard check fail: Unity Ads web bridge methods not found", e3);
            return false;
        } catch (Exception e4) {
