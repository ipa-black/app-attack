...
public class ScarMetric {
    ...
    public static Metric hbSignalsFetchStart() {
        ...
        return new Metric(HB_SIGNALS_FETCH_START, null, null);
    }

    public static Metric hbSignalsFetchSuccess() {
        return new Metric(HB_SIGNALS_FETCH_SUCCESS, Long.valueOf(getTotalFetchTime()), null);
    }
    ...
    public static Metric hbSignalsUploadStart() {
        ...
        return new Metric(HB_SIGNALS_UPLOAD_START, null, null);
    }

    public static Metric hbSignalsUploadSuccess() {
        return new Metric(HB_SIGNALS_UPLOAD_SUCCESS, Long.valueOf(getTotalUploadTime()), null);
    }
