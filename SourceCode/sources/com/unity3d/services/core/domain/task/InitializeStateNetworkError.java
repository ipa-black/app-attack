...
public final class InitializeStateNetworkError extends MetricTask<Params, Result<? extends Unit>> implements IConnectivityListener {
    ...
    public Object doWork(Params params, Continuation<? super Result<Unit>> continuation) {
        return BuildersKt.withContext(this.dispatchers.getDefault(), new InitializeStateNetworkError$doWork$2(this, params, null), continuation);
    }
    ...
    public void onConnected() {
        ...
        if (shouldHandleConnectedEvent()) {
            ...
            if (continuation != null) {
                ...
                continuation.resumeWith(Result.m501constructorimpl(unit));
            }
