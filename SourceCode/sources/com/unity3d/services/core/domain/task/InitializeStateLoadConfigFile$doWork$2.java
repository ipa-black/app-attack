...
@DebugMetadata(c = "com.unity3d.services.core.domain.task.InitializeStateLoadConfigFile$doWork$2", f = "InitializeStateLoadConfigFile.kt", i = {}, l = {}, m = "invokeSuspend", n = {}, s = {})
/* loaded from: classes3.dex */
public final class InitializeStateLoadConfigFile$doWork$2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Result<? extends Configuration>>, Object> {
    ...
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Result<? extends Configuration>> continuation) {
        return ((InitializeStateLoadConfigFile$doWork$2) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
        ...
        try {
            try {
                ...
                try {
                    ...
                    config = new Configuration(new JSONObject(new String(readFileBytes, Charsets.UTF_8)));
