    ...
    private class WebPlayerClient extends WebViewClient {
        ...
        public boolean shouldOverrideUrlLoading(WebView webView, WebResourceRequest webResourceRequest) {
            ...
            if (WebPlayerView.this.hasReturnValue("shouldOverrideUrlLoading")) {
                bool = (Boolean) WebPlayerView.this.getReturnValue("shouldOverrideUrlLoading", Boolean.class, true);
            }
        ...
        public boolean shouldOverrideKeyEvent(WebView webView, KeyEvent keyEvent) {
            ...
            if (WebPlayerView.this.hasReturnValue("shouldOverrideKeyEvent")) {
                bool = (Boolean) WebPlayerView.this.getReturnValue("shouldOverrideKeyEvent", Boolean.class, true);
            }
            return bool.booleanValue();
        }
    ...
    private class WebPlayerChromeClient extends WebChromeClient {
        ...
        public boolean onCreateWindow(WebView webView, boolean z, boolean z2, Message message) {
            ...
            if (WebPlayerView.this.hasReturnValue("onCreateWindow")) {
                bool = (Boolean) WebPlayerView.this.getReturnValue("onCreateWindow", Boolean.class, false);
            }
            return bool.booleanValue();
        }
        ...
        public boolean onJsAlert(WebView webView, String str, String str2, JsResult jsResult) {
            ...
            if (WebPlayerView.this.hasReturnValue("onJsAlert")) {
                bool = (Boolean) WebPlayerView.this.getReturnValue("onJsAlert", Boolean.class, true);
            }
            return bool.booleanValue();
        }
        ...
        public boolean onJsConfirm(WebView webView, String str, String str2, JsResult jsResult) {
            ...
            if (WebPlayerView.this.hasReturnValue("onJsConfirm")) {
                bool = (Boolean) WebPlayerView.this.getReturnValue("onJsConfirm", Boolean.class, true);
            }
            return bool.booleanValue();
        }
        ...
        public boolean onJsPrompt(WebView webView, String str, String str2, String str3, JsPromptResult jsPromptResult) {
            ...
            if (WebPlayerView.this.hasReturnValue("onJsPrompt")) {
                bool = (Boolean) WebPlayerView.this.getReturnValue("onJsPrompt", Boolean.class, true);
            }
            return bool.booleanValue();
        }
        ...
        public boolean onConsoleMessage(ConsoleMessage consoleMessage) {
            ...
            if (WebPlayerView.this.hasReturnValue("onConsoleMessage")) {
                bool = (Boolean) WebPlayerView.this.getReturnValue("onConsoleMessage", Boolean.class, true);
            }
            return bool.booleanValue();
        }
        ...
        public boolean onShowFileChooser(WebView webView, ValueCallback<Uri[]> valueCallback, WebChromeClient.FileChooserParams fileChooserParams) {
            ...
            if (WebPlayerView.this.hasReturnValue("onShowFileChooser")) {
                bool = (Boolean) WebPlayerView.this.getReturnValue("onShowFileChooser", Boolean.class, true);
