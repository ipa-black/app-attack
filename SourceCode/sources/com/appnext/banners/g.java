...
public class g extends com.appnext.banners.a {
    ...
    public JSONObject getConfigParams() throws JSONException {
        ...
        jSONObject.put("mute", new StringBuilder().append(getAdRequest().isMute()).toString());
        jSONObject.put("auto_play", new StringBuilder().append(getAdRequest().isAutoPlay()).toString());
            ...
            g.this.handler.post(new Runnable() { // from class: com.appnext.banners.g.a.1
                ...
                public final void run() {
                    ...
                    if (!g.this.getSelectedAd().getWebview().equals("0")) {
                        g.this.click();
                    } else if (g.this.getSelectedAd().getRevenueType().equals("cpi")) {
                        String lowerCase = d.S().get(g.this.getBannerSize().toString() + "_cpiActiveFlow").toLowerCase();
                        g.this.getBannerSize().toString();
                        ...
                        } else if (lowerCase2.equals(NotificationBundleProcessor.PUSH_ADDITIONAL_DATA_KEY)) {
                            g.this.clicked = true;
                        }
                        g.this.click();
                    }
    ...
    public void pageFinished() {
        ...
        new Thread(new Runnable() { // from class: com.appnext.banners.g.4
            @Override // java.lang.Runnable
            public final void run() {
                g gVar = g.this;
