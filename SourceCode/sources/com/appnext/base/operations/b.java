...
public class b {
    ...
    public final void a(String str, com.appnext.base.a.b.c cVar, Bundle bundle, Object obj, a.InterfaceC0092a interfaceC0092a) {
        if (cVar == null) {
            return;
        }
        try {
            ...
            if (a2 != null) {
                ...
                a2.a(interfaceC0092a);
                i.aR().putLong(cVar.getKey() + i.fy, System.currentTimeMillis());
                a2.aC();
            }
        } catch (Throwable unused) {
        }
