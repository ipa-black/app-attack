...
public class Circle extends View {
    ...
    private static int a(Context context, float f2) {
        return com.appnext.core.f.a(context, f2);
    }

    private void init(Context context) {
        float a2 = com.appnext.core.f.a(context, 5.0f);
        ...
        this.aw = new RectF(a2, a2, com.appnext.core.f.a(context, 20.0f) + a2, com.appnext.core.f.a(context, 20.0f) + a2);
        this.ax = 360.0f;
    }
}
