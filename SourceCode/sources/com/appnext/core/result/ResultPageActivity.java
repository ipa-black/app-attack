...
public class ResultPageActivity extends Activity {
    ...
    private boolean cd;
    private String fJ;
    private AppnextAd ic;
    private String id;
    private com.appnext.core.result.a ie;
    ...
    protected void onCreate(Bundle bundle) {
        ...
        try {
            c bs = d.br().bs();
            this.f2if = bs;
            this.placementID = bs.getPlacementId();
            this.id = this.f2if.z();
            this.cd = getIntent().getExtras().getBoolean("shouldClose");
            this.ic = this.f2if.getSelectedAd();
            this.fJ = this.f2if.A();
            this.ca = this.f2if.B();
            this.userAction = new q(this, new q.a() { // from class: com.appnext.core.result.ResultPageActivity.1
                ...
                @Override // com.appnext.core.q.a
                public final Ad e() {
                    return ResultPageActivity.this.f2if.D();
                }
                ...
                @Override // com.appnext.core.q.a
                public final p g() {
                    return ResultPageActivity.this.f2if.C();
                }
            });
            this.ie = this.f2if.E();
            ...
            com.appnext.core.result.a aVar = this.ie;
            if (aVar != null) {
                aVar.getJSurl();
                str = this.ie.getJSurl();
            } else {
                str = "https://cdn.appnext.com/tools/sdk/banner/2.4.3/result.min.js";
            }
            AppnextWebView.u(this).a(str, new AppnextWebView.c() { // from class: com.appnext.core.result.ResultPageActivity.3
                ...
                public final void f(String str2) {
                    new Handler(Looper.getMainLooper()).post(new Runnable() { // from class: com.appnext.core.result.ResultPageActivity.3.1
                        ...
                        public final void run() {
                            ResultPageActivity.this.loadWebview(str, AppnextWebView.u(ResultPageActivity.this).aj(str));
                        }
                    });
                }
                ...
                public final void error(String str2) {
                    new Handler(Looper.getMainLooper()).post(new Runnable() { // from class: com.appnext.core.result.ResultPageActivity.3.2
                        @Override // java.lang.Runnable
                        public final void run() {
                            ResultPageActivity.this.loadWebview(str, ResultPageActivity.c(ResultPageActivity.this));
                        }
                    });
                }
            });
    ...
    public class b {
        ...
        public final void adClicked(String str, int i) {
            ...
            qVar.a(appnextAd, sb.append(resultPageActivity2.h(resultPageActivity2.aE).getAppURL()).append("&tem_id=").append(ResultPageActivity.this.id).append(IcyHeaders.REQUEST_HEADER_ENABLE_METADATA_VALUE).toString(), ResultPageActivity.this.placementID, new e.a() { // from class: com.appnext.core.result.ResultPageActivity.b.1
        ...
        public final void postView(String str) {
            ...
            ResultPageActivity.this.userAction.a(appnextAd, ResultPageActivity.this.h(appnextAd).getImpressionURL() + "&tem_id=" + ResultPageActivity.this.id + IcyHeaders.REQUEST_HEADER_ENABLE_METADATA_VALUE, null);
        }
    ...
    public class a extends WebViewClient {
        ...
        public final void onPageFinished(WebView webView, String str) {
            ...
            new Thread(new Runnable() { // from class: com.appnext.core.result.ResultPageActivity.a.1
                @Override // java.lang.Runnable
                public final void run() {
                    final String b2 = f.b((Context) ResultPageActivity.this, false);
                    new Handler(Looper.getMainLooper()).post(new Runnable() { // from class: com.appnext.core.result.ResultPageActivity.a.1.1
                        @Override // java.lang.Runnable
                        public final void run() {
                            try {
                                ResultPageActivity.this.loadJS("Appnext.setParams(" + d.br().bs().getConfigParams().put("did", b2).toString() + ");");
                            } catch (Throwable unused) {
                            }
                            ResultPageActivity.this.loadJS("Appnext.load(" + ResultPageActivity.this.h(ResultPageActivity.this.ic).getAdJSON() + "," + ResultPageActivity.this.ca + "," + ResultPageActivity.this.fJ + ");");
                        }
                    });
                }
            }).start();
