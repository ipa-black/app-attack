...
public final class UnsafeUtil {
    ...
    static void putFloat(float[] fArr, long j, float f2) {
        MEMORY_ACCESSOR.putFloat(fArr, FLOAT_ARRAY_BASE_OFFSET + (j * FLOAT_ARRAY_INDEX_SCALE), f2);
    }
    ...
    public static Unsafe getUnsafe() {
        try {
            return (Unsafe) AccessController.doPrivileged(new PrivilegedExceptionAction<Unsafe>() { // from class: com.explorestack.protobuf.UnsafeUtil.1
