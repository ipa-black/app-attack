...
public final class Utf8 {
        ...
        */
        final int partialIsValidUtf8Default(int r7, java.nio.ByteBuffer r8, int r9, int r10) {
            ...
            L6a:
                ...
                byte r7 = r8.get(r7)
                if (r9 < r10) goto L79
                int r7 = com.explorestack.protobuf.Utf8.access$100(r0, r1, r7)
                return r7
            L79:
                r5 = r9
                r9 = r7
        ...
        final String decodeUtf8Default(ByteBuffer byteBuffer, int i, int i2) throws InvalidProtocolBufferException {
            ...
            while (i < i3) {
                ...
                if (DecodeUtil.isOneByte(b3)) {
                    ...
                    int i9 = i + 3;
                    i += 4;
                    DecodeUtil.handleFourBytes(b3, b5, byteBuffer.get(i + 2), byteBuffer.get(i9), cArr, i5);
                    i5 += 2;
                }
            }
    ...
    static final class SafeProcessor extends Processor {
        ...
        String decodeUtf8(byte[] bArr, int i, int i2) throws InvalidProtocolBufferException {
            ...
            while (i < i3) {
                ...
                if (DecodeUtil.isOneByte(b3)) {
                    ...
                    int i9 = i + 3;
                    i += 4;
                    DecodeUtil.handleFourBytes(b3, b5, bArr[i + 2], bArr[i9], cArr, i5);
                    i5 += 2;
                }
            }
            return new String(cArr, 0, i5);
        ...
        */
        int encodeUtf8(java.lang.CharSequence r8, byte[] r9, int r10, int r11) {
            ...
            */
            throw new UnsupportedOperationException("Method not decompiled: com.explorestack.protobuf.Utf8.SafeProcessor.encodeUtf8(java.lang.CharSequence, byte[], int, int):int");
        }
    ...
    static final class UnsafeProcessor extends Processor {
        ...
        /* JADX WARN: Code restructure failed: missing block: B:35:0x0058, code lost:
            if (com.explorestack.protobuf.UnsafeUtil.getByte(r12, r0) > (-65)) goto L36;
         */
        /* JADX WARN: Code restructure failed: missing block: B:58:0x009e, code lost:
            if (com.explorestack.protobuf.UnsafeUtil.getByte(r12, r0) > (-65)) goto L56;
         */
        @Override // com.explorestack.protobuf.Utf8.Processor
        /*
            Code decompiled incorrectly, please refer to instructions dump.
        ...
        */
        ...
        /* JADX WARN: Code restructure failed: missing block: B:14:0x002d, code lost:
            if (com.explorestack.protobuf.UnsafeUtil.getByte(r0) > (-65)) goto L16;
         */
        /* JADX WARN: Code restructure failed: missing block: B:35:0x0061, code lost:
            if (com.explorestack.protobuf.UnsafeUtil.getByte(r0) > (-65)) goto L35;
         */
        /* JADX WARN: Code restructure failed: missing block: B:56:0x00a3, code lost:
            if (com.explorestack.protobuf.UnsafeUtil.getByte(r0) > (-65)) goto L55;
         */
        @Override // com.explorestack.protobuf.Utf8.Processor
        /*
            Code decompiled incorrectly, please refer to instructions dump.
        ...
        String decodeUtf8(byte[] bArr, int i, int i2) throws InvalidProtocolBufferException {
            ...
            while (i < i3) {
                ...
                if (DecodeUtil.isOneByte(b3)) {
                    ...
                    int i9 = i + 3;
                    i += 4;
                    DecodeUtil.handleFourBytes(b3, UnsafeUtil.getByte(bArr, i6), UnsafeUtil.getByte(bArr, i + 2), UnsafeUtil.getByte(bArr, i9), cArr, i5);
                    i5 += 2;
                }
            }
            return new String(cArr, 0, i5);
        ...
        String decodeUtf8Direct(ByteBuffer byteBuffer, int i, int i2) throws InvalidProtocolBufferException {
            ...
            while (addressOffset < j) {
                ...
                if (DecodeUtil.isOneByte(b3)) {
                    ...
                    addressOffset += 2;
                    DecodeUtil.handleTwoBytes(b3, UnsafeUtil.getByte(j2), cArr, i4);
                    i4++;
                } else if (DecodeUtil.isThreeBytes(b3)) {
                    if (j2 >= j - 1) {
                        throw InvalidProtocolBufferException.invalidUtf8();
                    ...
                    addressOffset += 3;
                    DecodeUtil.handleThreeBytes(b3, UnsafeUtil.getByte(j2), UnsafeUtil.getByte(j3), cArr, i4);
                    i4++;
                } else if (j2 >= j - 2) {
                    throw InvalidProtocolBufferException.invalidUtf8();
                } else {
                    ...
                    addressOffset += 4;
                    DecodeUtil.handleFourBytes(b3, UnsafeUtil.getByte(j2), UnsafeUtil.getByte(2 + addressOffset), UnsafeUtil.getByte(j4), cArr, i4);
                    i4 += 2;
                }
            }
        ...
        */
        private static int partialIsValidUtf8(byte[] r10, long r11, int r13) {
            ...
            L9:
                ...
                if (r13 <= 0) goto L1a
                long r4 = r11 + r2
                byte r1 = com.explorestack.protobuf.UnsafeUtil.getByte(r10, r11)
                if (r1 < 0) goto L19
                int r13 = r13 + (-1)
                r11 = r4
                goto L9
            ...
            L29:
                ...
                if (r1 < r0) goto L39
                long r2 = r2 + r11
                byte r11 = com.explorestack.protobuf.UnsafeUtil.getByte(r10, r11)
                if (r11 <= r6) goto L37
                goto L39
            L37:
                r11 = r2
            ...
            L48:
                int r13 = r13 + (-3)
                long r2 = r2 + r11
                byte r0 = com.explorestack.protobuf.UnsafeUtil.getByte(r10, r11)
                if (r0 > r6) goto L64
                r7 = -96
                if (r1 != r4) goto L57
                if (r0 < r7) goto L64
            ...
            L5d:
                long r11 = r11 + r8
                byte r0 = com.explorestack.protobuf.UnsafeUtil.getByte(r10, r2)
                if (r0 <= r6) goto L7
            L64:
                return r5
            L65:
            ...
            L6d:
                ...
                r0 = 3
                long r11 = r11 + r0
                byte r0 = com.explorestack.protobuf.UnsafeUtil.getByte(r10, r8)
                if (r0 <= r6) goto L7
            L8f:
                return r5
            */
        ...
        */
        private static int partialIsValidUtf8(long r10, int r12) {
            ...
            L9:
                ...
                if (r12 <= 0) goto L1a
                long r4 = r10 + r2
                byte r1 = com.explorestack.protobuf.UnsafeUtil.getByte(r10)
                if (r1 < 0) goto L19
                int r12 = r12 + (-1)
                r10 = r4
                goto L9
            ...
            L29:
                ...
                if (r1 < r0) goto L39
                long r2 = r2 + r10
                byte r10 = com.explorestack.protobuf.UnsafeUtil.getByte(r10)
                if (r10 <= r6) goto L37
                goto L39
            L37:
                r10 = r2
            ...
            L48:
                int r12 = r12 + (-3)
                long r2 = r2 + r10
                byte r0 = com.explorestack.protobuf.UnsafeUtil.getByte(r10)
                if (r0 > r6) goto L64
                r7 = -96
                if (r1 != r4) goto L57
                if (r0 < r7) goto L64
            ...
            L5d:
                long r10 = r10 + r8
                byte r0 = com.explorestack.protobuf.UnsafeUtil.getByte(r2)
                if (r0 <= r6) goto L7
            L64:
                return r5
            L65:
            ...
            L6d:
                ...
                r0 = 3
                long r10 = r10 + r0
                byte r0 = com.explorestack.protobuf.UnsafeUtil.getByte(r8)
                if (r0 <= r6) goto L7
            L8f:
                return r5
            */
