...
public final class MessageSchema<T> implements Schema<T> {
    ...
    */
    static <T> com.explorestack.protobuf.MessageSchema<T> newSchemaForRawMessageInfo(com.explorestack.protobuf.RawMessageInfo r33, com.explorestack.protobuf.NewInstanceSchema r34, com.explorestack.protobuf.ListFieldSchema r35, com.explorestack.protobuf.UnknownFieldSchema<?, ?> r36, com.explorestack.protobuf.ExtensionSchema<?> r37, com.explorestack.protobuf.MapFieldSchema r38) {
        /*
    ...
    */
    private static void storeFieldData(com.explorestack.protobuf.FieldInfo r8, int[] r9, int r10, java.lang.Object[] r11) {
        /*
            ...
            long r4 = com.explorestack.protobuf.UnsafeUtil.objectFieldOffset(r0)
        L22:
            int r0 = (int) r4
            r4 = r1
            goto L6c
    ...
    */
    ...
    private <K, V> int decodeMapEntry(byte[] bArr, int i, int i2, MapEntryLite.Metadata<K, V> metadata, Map<K, V> map, ArrayDecoders.Registers registers) throws IOException {
        ...
        while (decodeVarint32 < i5) {
            ...
            if (b2 < 0) {
                i3 = ArrayDecoders.decodeVarint32(b2, bArr, i6, registers);
                b2 = registers.int1;
            } else {
                i3 = i6;
            }
            ...
            if (i7 == 1) {
                if (i8 == metadata.keyType.getWireType()) {
                    ...
                    decodeVarint32 = ArrayDecoders.skipField(b2, bArr, i3, i2, registers);
                }
            } else {
    ...
    public int parseProto2Message(T t, byte[] bArr, int i, int i2, int i3, ArrayDecoders.Registers registers) throws IOException {
        ...
        while (true) {
            if (i19 < i17) {
                ...
                byte b3 = bArr2[i19];
                if (b3 < 0) {
                    int decodeVarint32 = ArrayDecoders.decodeVarint32(b3, bArr2, i25, registers2);
                    b2 = registers2.int1;
                    i25 = decodeVarint32;
                } else {
                    b2 = b3;
