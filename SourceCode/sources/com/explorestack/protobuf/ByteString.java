...
public abstract class ByteString implements Iterable<Byte>, Serializable {
    ...
    static {
        ...
        UNSIGNED_LEXICOGRAPHICAL_COMPARATOR = new Comparator<ByteString>() { // from class: com.explorestack.protobuf.ByteString.2
            /* JADX WARN: Type inference failed for: r0v0, types: [com.explorestack.protobuf.ByteString$ByteIterator] */
            /* JADX WARN: Type inference failed for: r1v0, types: [com.explorestack.protobuf.ByteString$ByteIterator] */
    ...
    private String truncateAndEscapeForDisplay() {
        return size() <= 50 ? TextFormatEscaper.escapeBytes(this) : TextFormatEscaper.escapeBytes(substring(0, 47)) + APSSharedUtil.TRUNCATE_SEPARATOR;
    }
