        ...
        public static FileDescriptor internalBuildGeneratedFileFrom(String[] strArr, FileDescriptor[] fileDescriptorArr) {
            ...
            try {
                try {
                    ...
                    throw new IllegalArgumentException("Invalid embedded descriptor for \"" + fileDescriptorProtoOrBuilder.getName() + "\".", e2);
                }
        ...
        public void crossLink() throws DescriptorValidationException {
            ...
            if (this.proto.hasDefaultValue()) {
                ...
                try {
                    switch (AnonymousClass1.$SwitchMap$com$google$protobuf$Descriptors$FieldDescriptor$Type[getType().ordinal()]) {
                        ...
                        case 16:
                            ...
                            if (findValueByName == null) {
                                throw new DescriptorValidationException(this, "Unknown enum default value: \"" + this.proto.getDefaultValue() + Typography.quote, (AnonymousClass1) null);
                            }
                            break;
                        case 17:
                        case 18:
                    ...
                    throw new DescriptorValidationException(this, "Could not parse default value: \"" + this.proto.getDefaultValue() + Typography.quote, e3, null);
                }
            } else if (isRepeated()) {
