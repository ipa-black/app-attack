...
public class j extends g<View> {
    ...
    public void a(float f2, int i, int i2) {
        IabElementStyle iabElementStyle = this.f9436c;
        if (iabElementStyle == null) {
            return;
        }
        boolean z = iabElementStyle.getStyle() != null && this.f9436c.getStyle().endsWith("reverse");
        T t = this.f9435b;
        if (t instanceof TextCountdownView) {
            ...
            if (z) {
                circleCountdownView.changePercentage(f2, i2 != 0 ? Math.max(1, i2 - i) : 0);
            } else {
