...
public final class b {
    ...
    static final Type[] f8252a = new Type[0];
    ...
    public static Type a(Type type) {
        if (type instanceof Class) {
            ...
            return new C0168b(parameterizedType.getOwnerType(), parameterizedType.getRawType(), parameterizedType.getActualTypeArguments());
        ...
        do {
            ...
            if (type2 instanceof TypeVariable) {
                ...
                if (type2 instanceof GenericArrayType) {
                    ...
                    return z ? new C0168b(a5, parameterizedType.getRawType(), actualTypeArguments) : parameterizedType;
                } else {
                    ...
                    if (z2) {
                        ...
                        if (lowerBounds.length == 1) {
                            ...
                            if (upperBounds.length == 1) {
                                ...
                                wildcardType = wildcardType2;
                                if (a8 != upperBounds[0]) {
                                    return new c(a8 instanceof WildcardType ? ((WildcardType) a8).getUpperBounds() : new Type[]{a8}, f8252a);
                                }
                            }
                        }
                    }
    ...
    /* loaded from: classes2.dex */
    public static final class C0168b implements Serializable, ParameterizedType {

        /* renamed from: a  reason: collision with root package name */
        private final Type f8255a;

        /* renamed from: b  reason: collision with root package name */
        private final Type f8256b;

        /* renamed from: c  reason: collision with root package name */
        private final Type[] f8257c;

        public C0168b(Type type, Type type2, Type... typeArr) {
            if (type2 instanceof Class) {
            ...
            this.f8255a = type == null ? null : b.a(type);
            this.f8256b = b.a(type2);
            Type[] typeArr2 = (Type[]) typeArr.clone();
            this.f8257c = typeArr2;
            int length = typeArr2.length;
            for (int i = 0; i < length; i++) {
                com.bykv.vk.openvk.preload.a.b.a.a(this.f8257c[i]);
                b.e(this.f8257c[i]);
                Type[] typeArr3 = this.f8257c;
        ...
        public final int hashCode() {
            return (Arrays.hashCode(this.f8257c) ^ this.f8256b.hashCode()) ^ b.a((Object) this.f8255a);
        }

        public final String toString() {
            int length = this.f8257c.length;
            if (length == 0) {
                return b.c(this.f8256b);
            }
            StringBuilder sb = new StringBuilder((length + 1) * 30);
            sb.append(b.c(this.f8256b)).append("<").append(b.c(this.f8257c[0]));
            for (int i = 1; i < length; i++) {
                sb.append(", ").append(b.c(this.f8257c[i]));
            }
    ...
    public static final class a implements Serializable, GenericArrayType {
        ...
        /* renamed from: a  reason: collision with root package name */
        private final Type f8253a;

        public a(Type type) {
            this.f8253a = b.a(type);
        }
    ...
    public static final class c implements Serializable, WildcardType {
        ...
        /* renamed from: a  reason: collision with root package name */
        private final Type f8261a;

        /* renamed from: b  reason: collision with root package name */
        private final Type f8262b;
        ...
        public c(Type[] typeArr, Type[] typeArr2) {
            ...
            if (typeArr2.length == 1) {
                ...
                this.f8262b = b.a(typeArr2[0]);
                this.f8261a = Object.class;
                return;
            }
            com.bykv.vk.openvk.preload.a.b.a.a(typeArr[0]);
            b.e(typeArr[0]);
            this.f8262b = null;
            this.f8261a = b.a(typeArr[0]);
        }

        @Override // java.lang.reflect.WildcardType
        public final Type[] getUpperBounds() {
            return new Type[]{this.f8261a};
        }

        @Override // java.lang.reflect.WildcardType
        public final Type[] getLowerBounds() {
            Type type = this.f8262b;
            return type != null ? new Type[]{type} : b.f8252a;
        }
        ...
        public final int hashCode() {
            Type type = this.f8262b;
            return (type != null ? type.hashCode() + 31 : 1) ^ (this.f8261a.hashCode() + 31);
        }

        public final String toString() {
            if (this.f8262b != null) {
                return "? super " + b.c(this.f8262b);
            }
            if (this.f8261a == Object.class) {
                return "?";
            }
            return "? extends " + b.c(this.f8261a);
        }
    }
}
