...
public final class a<E> extends t<Object> {
    ...
    public static final u f8165a = new u() { // from class: com.bykv.vk.openvk.preload.a.b.a.a.1
    ...
    private final Class<E> f8166b;

    /* renamed from: c  reason: collision with root package name */
    private final t<E> f8167c;

    public a(com.bykv.vk.openvk.preload.a.f fVar, t<E> tVar, Class<E> cls) {
        this.f8167c = new m(fVar, tVar, cls);
        this.f8166b = cls;
    }
    ...
    public final Object a(com.bykv.vk.openvk.preload.a.d.a aVar) throws IOException {
        ...
        aVar.a();
        while (aVar.e()) {
            arrayList.add(this.f8167c.a(aVar));
        }
        aVar.b();
        int size = arrayList.size();
        Object newInstance = Array.newInstance((Class<?>) this.f8166b, size);
    ...
    public final void a(com.bykv.vk.openvk.preload.a.d.c cVar, Object obj) throws IOException {
        ...
        for (int i = 0; i < length; i++) {
            this.f8167c.a(cVar, Array.get(obj, i));
        }
        cVar.b();
    }
}
