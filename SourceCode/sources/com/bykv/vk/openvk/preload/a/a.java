...
public final class a extends t<Date> {
    ...
    private final Class<? extends Date> f8163a;

    /* renamed from: b  reason: collision with root package name */
    private final List<DateFormat> f8164b;
    ...
    public final /* synthetic */ void a(com.bykv.vk.openvk.preload.a.d.c cVar, Date date) throws IOException {
        ...
        synchronized (this.f8164b) {
            cVar.b(this.f8164b.get(0).format(date2));
        }
    }
    ...
    private Date a(String str) {
        synchronized (this.f8164b) {
            for (DateFormat dateFormat : this.f8164b) {
                try {
    ...
    public final String toString() {
        DateFormat dateFormat = this.f8164b.get(0);
    ...
    public final /* synthetic */ Date a(com.bykv.vk.openvk.preload.a.d.a aVar) throws IOException {
        ...
        Date a2 = a(aVar.i());
        Class<? extends Date> cls = this.f8163a;
        if (cls == Date.class) {
            return a2;
        }
