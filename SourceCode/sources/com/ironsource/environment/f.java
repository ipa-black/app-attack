...
public final class f extends SQLiteOpenHelper {
    ...
    public static Cursor a(int i) {
        ...
        try {
            readableDatabase = new f(e.a().f10566a).getReadableDatabase();
        } catch (Throwable th) {
            th = th;
        }
        try {
    ...
    */
    public static java.util.List<com.ironsource.environment.c> a() {
        /*
            ...
            android.content.Context r1 = r1.f10566a
            r0.<init>(r1)
    ...
    public static void a(c cVar) {
        SQLiteDatabase sQLiteDatabase = null;
        try {
            SQLiteDatabase writableDatabase = new f(e.a().f10566a).getWritableDatabase();
            try {
    ...
    public static void c() {
        ...
        try {
            sQLiteDatabase = new f(e.a().f10566a).getWritableDatabase();
            try {
