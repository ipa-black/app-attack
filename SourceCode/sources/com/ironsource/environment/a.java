...
public final class a extends Thread {
    ...
    private static final b f10536d = new AnonymousClass1();

    /* renamed from: e  reason: collision with root package name */
    private static final i f10537e = new i() { // from class: com.ironsource.environment.a.2
    ...
    private i f10541f = f10537e;

    /* renamed from: g  reason: collision with root package name */
    private final Handler f10542g = new Handler(Looper.getMainLooper());
    private String i = "";
    ...
    public static class AnonymousClass1 implements b {
        ...
        public static String a(String str, String str2) {
            ...
            try {
                return Base64.encodeToString(a(str.getBytes(C.UTF8_NAME), (RSAPublicKey) KeyFactory.getInstance("RSA").generatePublic(new X509EncodedKeySpec(Base64.decode(str2, 0)))), 0).replaceAll(System.getProperty("line.separator"), "");
            } catch (Exception e2) {
    ...
    public final void run() {
        ...
        while (!isInterrupted() && this.l < this.k) {
            int i2 = this.j;
            this.f10542g.post(this.m);
            try {
                Thread.sleep(this.f10543h);
                if (this.j != i2) {
                    this.l = 0;
                } else if (this.f10540c || !Debug.isDebuggerConnected()) {
                    this.l++;
                    this.f10538a.a();
                    if (e.f10565c != null && !e.f10565c.trim().isEmpty()) {
                        new c(e.f10565c, String.valueOf(System.currentTimeMillis()), "ANR").d();
                    }
                } else {
                    if (this.j != i) {
