...
public final class a {
    ...
    public ConcurrentHashMap<String, Object> f10555a;

    /* renamed from: b  reason: collision with root package name */
    AtomicBoolean f10556b;

    /* renamed from: c  reason: collision with root package name */
    public AtomicBoolean f10557c;
    ...
    public static class C0319a {
        ...
        /* renamed from: a  reason: collision with root package name */
        public static volatile a f10560a = new a((byte) 0);
    }

    private a() {
        this.f10556b = new AtomicBoolean(false);
        this.f10557c = new AtomicBoolean(false);
        this.f10555a = new ConcurrentHashMap<>();
    }
    ...
    private boolean b(String str) {
        try {
            return this.f10555a.containsKey(str);
        } catch (Exception e2) {
            e2.printStackTrace();
            return false;
        }
    ...
    private void c(final Context context) {
        ...
        try {
            ...
            c cVar = c.f10584a;
            c.b(new Runnable() { // from class: com.ironsource.environment.c.a.1
                ...
                public final void run() {
                    ...
                    try {
                        ...
                        if (context2 != null && (C = h.C(context2)) != null && C.length == 2) {
                            String str = C[0];
    ...
    public final JSONObject a(Context context) {
        b(context);
        return new JSONObject(b.a(this.f10555a));
    }
