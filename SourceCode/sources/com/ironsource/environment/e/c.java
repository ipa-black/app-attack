...
public final class c {
    ...
    private static final Handler f10585b = new Handler(Looper.getMainLooper());

    /* renamed from: c  reason: collision with root package name */
    private static final b f10586c;
    ...
    public static void a(Runnable action, long j) {
        Intrinsics.checkNotNullParameter(action, "action");
        f10585b.postDelayed(action, j);
    }

    public static void b(Runnable action) {
        Intrinsics.checkNotNullParameter(action, "action");
        f10585b.removeCallbacks(action);
    }

    public static void b(Runnable action, long j) {
        Intrinsics.checkNotNullParameter(action, "action");
        f10586c.a(action, j);
    }
