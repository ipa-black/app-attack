...
public final class G {
    ...
    public final boolean equals(Object obj) {
        if (this != obj) {
            if (obj instanceof G) {
                G g2 = (G) obj;
                return Intrinsics.areEqual(this.f10668a, g2.f10668a) && Intrinsics.areEqual(this.f10669b, g2.f10669b);
            }
            return false;
        }
        return true;
    ...
    public final String toString() {
        return "IronSourceAdvId(advId=" + this.f10668a + ", advIdType=" + this.f10669b + ")";
    }
}
