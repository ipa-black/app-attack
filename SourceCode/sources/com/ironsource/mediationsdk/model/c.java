...
public final class c {
    ...
    public final Map<String, String> f11242a;
    ...
    public final boolean equals(Object obj) {
        if (this != obj) {
            return (obj instanceof c) && Intrinsics.areEqual(this.f11242a, ((c) obj).f11242a);
        }
        return true;
    }

    public final int hashCode() {
        Map<String, String> map = this.f11242a;
        if (map != null) {
            return map.hashCode();
        }
        return 0;
    ...
    public final String toString() {
        return "ApplicationExternalSettings(mediationTypes=" + this.f11242a + ")";
    }
}
