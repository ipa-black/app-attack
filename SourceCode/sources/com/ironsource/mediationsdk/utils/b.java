...
public final class b {
    ...
    public b(boolean z, String externalArmEventsUrl, boolean z2) {
        ...
        this.f11401a = z;
        this.f11402b = externalArmEventsUrl;
        this.f11403c = z2;
    }
    ...
    public final boolean equals(Object obj) {
        if (this != obj) {
            if (obj instanceof b) {
                b bVar = (b) obj;
                return this.f11401a == bVar.f11401a && Intrinsics.areEqual(this.f11402b, bVar.f11402b) && this.f11403c == bVar.f11403c;
            }
            return false;
        }
        return true;
    ...
    public final int hashCode() {
        ...
        boolean z2 = this.f11403c;
        return hashCode + (z2 ? 1 : z2 ? 1 : 0);
    }

    public final String toString() {
        return "ApplicationGeneralSettings(isExternalArmEventsEnabled=" + this.f11401a + ", externalArmEventsUrl=" + this.f11402b + ", shouldUseAppSet=" + this.f11403c + ")";
    }
}
