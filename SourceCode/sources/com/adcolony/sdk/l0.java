...
public final class l0 extends c1 {
    ...
    private final class f {
        ...
        public final void a() {
            ...
            c0.b(info, IabUtils.KEY_WIDTH, (int) (l0Var.getCurrentWidth() / s));
            c0.b(info, IabUtils.KEY_HEIGHT, (int) (l0Var.getCurrentHeight() / s));
    ...
    private final void r() {
        ...
        Rect w = com.adcolony.sdk.a.b().n().w();
    ...
    protected /* synthetic */ void k() {
        if (getMraidFilepath().length() > 0) {
            setMUrl(a(new Regex("script\\s*src\\s*=\\s*\"mraid.js\"").replaceFirst(getMUrl(), "script src=\"file://" + getMraidFilepath() + Typography.quote), c0.h(c0.f(getInfo(), "device_info"), "iab_filepath")));
        }
    }
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    @Override // com.adcolony.sdk.c1, com.adcolony.sdk.b1
    public /* synthetic */ void a(h0 h0Var, int i, com.adcolony.sdk.c cVar) {
        f1 a2 = h0Var.a();
