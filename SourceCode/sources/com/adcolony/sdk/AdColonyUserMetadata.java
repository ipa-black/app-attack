...
public class AdColonyUserMetadata {
    ...
    public AdColonyUserMetadata addUserInterest(String str) {
        if (z0.e(str)) {
            c0.a(this.f113a, str);
            c0.a(this.f114b, "adc_interests", this.f113a);
        }
        return this;
    }
    ...
    public AdColonyUserMetadata clearUserInterests() {
        e1 a2 = c0.a();
        this.f113a = a2;
        c0.a(this.f114b, "adc_interests", a2);
        return this;
    }

    public Object getMetadata(String str) {
        return c0.g(this.f114b, str);
    }

    public int getUserAge() {
        return c0.d(this.f114b, "adc_age");
    }

    public int getUserAnnualHouseholdIncome() {
        return c0.d(this.f114b, "adc_household_income");
    }

    public String getUserEducation() {
        return c0.h(this.f114b, "adc_education");
    }

    public String getUserGender() {
        return c0.h(this.f114b, "adc_gender");
    }
    ...
    public String getUserMaritalStatus() {
        return c0.h(this.f114b, "adc_marital_status");
    }

    public String getUserZipCode() {
        return c0.h(this.f114b, "adc_zip");
    }

    public AdColonyUserMetadata setMetadata(String str, boolean z) {
        if (z0.e(str)) {
            c0.b(this.f114b, str, z);
        }
        return this;
    }
