...
public abstract class AdSessionStatePublisher {
    ...
    private com.iab.omid.library.ironsrc.e.b f10423a;

    /* renamed from: b  reason: collision with root package name */
    private AdEvents f10424b;

    /* renamed from: c  reason: collision with root package name */
    private MediaEvents f10425c;
    ...
    public AdSessionStatePublisher() {
        i();
        this.f10423a = new com.iab.omid.library.ironsrc.e.b(null);
    }
    ...
    public void a(WebView webView) {
        this.f10423a = new com.iab.omid.library.ironsrc.e.b(webView);
    }

    public void a(AdEvents adEvents) {
        this.f10424b = adEvents;
    }
    ...
    public void a(String str, long j) {
        if (j >= this.f10427e) {
            this.f10426d = a.AD_STATE_VISIBLE;
    ...
    public void b(String str, long j) {
        if (j < this.f10427e || this.f10426d == a.AD_STATE_NOTVISIBLE) {
            return;
        }
        this.f10426d = a.AD_STATE_NOTVISIBLE;
        e.a().b(getWebView(), str);
    }
    ...
    public WebView getWebView() {
        return (WebView) this.f10423a.get();
    }
    ...
    public void i() {
        this.f10427e = com.iab.omid.library.ironsrc.d.d.a();
        this.f10426d = a.AD_STATE_IDLE;
    }
}
