...
public class b {
    ...
    private static WindowManager f9868b;

    /* renamed from: c  reason: collision with root package name */
    private static String[] f9869c = {"x", "y", IabUtils.KEY_WIDTH, IabUtils.KEY_HEIGHT};

    /* renamed from: a  reason: collision with root package name */
    static float f9867a = Resources.getSystem().getDisplayMetrics().density;
    ...
    public static void a(Context context) {
        if (context != null) {
            f9867a = context.getResources().getDisplayMetrics().density;
            f9868b = (WindowManager) context.getSystemService("window");
        }
    }
    ...
    public static void a(JSONObject jSONObject) {
        a b2 = b(jSONObject);
        try {
            jSONObject.put(IabUtils.KEY_WIDTH, b2.f9870a);
            jSONObject.put(IabUtils.KEY_HEIGHT, b2.f9871b);
        } catch (JSONException e2) {
            e2.printStackTrace();
        }
    }

    public static void a(JSONObject jSONObject, a.C0299a c0299a) {
        com.iab.omid.library.adcolony.b.c a2 = c0299a.a();
        JSONArray jSONArray = new JSONArray();
        for (String str : c0299a.b()) {
            jSONArray.put(str);
        }
        try {
    ...
    private static a b(JSONObject jSONObject) {
        ...
        if (f9868b != null) {
            ...
            f9868b.getDefaultDisplay().getRealSize(point);
            f2 = a(point.x);
            f3 = a(point.y);
        } else {
            f2 = 0.0f;
