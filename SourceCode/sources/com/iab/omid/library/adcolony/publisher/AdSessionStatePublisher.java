...
public abstract class AdSessionStatePublisher {
    ...
    private com.iab.omid.library.adcolony.e.b f9872a;

    /* renamed from: b  reason: collision with root package name */
    private AdEvents f9873b;

    /* renamed from: c  reason: collision with root package name */
    private MediaEvents f9874c;
    ...
    public AdSessionStatePublisher() {
        i();
        this.f9872a = new com.iab.omid.library.adcolony.e.b(null);
    }
    ...
    public void a(WebView webView) {
        this.f9872a = new com.iab.omid.library.adcolony.e.b(webView);
    }

    public void a(AdEvents adEvents) {
        this.f9873b = adEvents;
    }
    ...
    public void a(com.iab.omid.library.adcolony.adsession.a aVar, AdSessionContext adSessionContext, JSONObject jSONObject) {
        ...
        com.iab.omid.library.adcolony.d.b.a(jSONObject3, "partnerName", adSessionContext.getPartner().getName());
        com.iab.omid.library.adcolony.d.b.a(jSONObject3, "partnerVersion", adSessionContext.getPartner().getVersion());
    ...
    public void a(String str, long j) {
        if (j >= this.f9876e) {
            this.f9875d = a.AD_STATE_VISIBLE;
    ...
    public void i() {
        this.f9876e = com.iab.omid.library.adcolony.d.d.a();
        this.f9875d = a.AD_STATE_IDLE;
    }
}
