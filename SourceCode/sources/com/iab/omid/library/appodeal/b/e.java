...
public class e {
    ...
    private static e f10174a = new e();
    ...
    void a(WebView webView, String str, Object... objArr) {
        if (webView == null) {
            com.iab.omid.library.appodeal.d.c.a("The WebView is null for " + str);
            return;
        }
    ...
    void a(final WebView webView, StringBuilder sb) {
        ...
        if (handler == null || Looper.myLooper() == handler.getLooper()) {
            ...
            handler.post(new Runnable() { // from class: com.iab.omid.library.appodeal.b.e.1
