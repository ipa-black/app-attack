...
public class b {
    ...
    private static WindowManager f10196b;

    /* renamed from: c  reason: collision with root package name */
    private static String[] f10197c = {"x", "y", IabUtils.KEY_WIDTH, IabUtils.KEY_HEIGHT};

    /* renamed from: a  reason: collision with root package name */
    static float f10195a = Resources.getSystem().getDisplayMetrics().density;
    ...
    public static void a(Context context) {
        if (context != null) {
            f10195a = context.getResources().getDisplayMetrics().density;
            f10196b = (WindowManager) context.getSystemService("window");
        }
    }
    ...
    public static void a(JSONObject jSONObject) {
        a b2 = b(jSONObject);
        try {
            jSONObject.put(IabUtils.KEY_WIDTH, b2.f10198a);
            jSONObject.put(IabUtils.KEY_HEIGHT, b2.f10199b);
        } catch (JSONException e2) {
            e2.printStackTrace();
        }
    }

    public static void a(JSONObject jSONObject, a.C0308a c0308a) {
        com.iab.omid.library.appodeal.b.c a2 = c0308a.a();
        JSONArray jSONArray = new JSONArray();
        for (String str : c0308a.b()) {
            jSONArray.put(str);
        }
        try {
    ...
    private static a b(JSONObject jSONObject) {
        ...
        if (f10196b != null) {
            ...
            f10196b.getDefaultDisplay().getRealSize(point);
            f2 = a(point.x);
            f3 = a(point.y);
        } else {
            f2 = 0.0f;
