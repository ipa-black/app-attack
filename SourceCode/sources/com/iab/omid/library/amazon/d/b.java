...
public class b {
    ...
    private static WindowManager f9975b;

    /* renamed from: c  reason: collision with root package name */
    private static String[] f9976c = {"x", "y", IabUtils.KEY_WIDTH, IabUtils.KEY_HEIGHT};

    /* renamed from: a  reason: collision with root package name */
    static float f9974a = Resources.getSystem().getDisplayMetrics().density;
    ...
    public static void a(Context context) {
        if (context != null) {
            f9974a = context.getResources().getDisplayMetrics().density;
            f9975b = (WindowManager) context.getSystemService("window");
        }
    }
    ...
    public static void a(JSONObject jSONObject) {
        a b2 = b(jSONObject);
        try {
            jSONObject.put(IabUtils.KEY_WIDTH, b2.f9977a);
            jSONObject.put(IabUtils.KEY_HEIGHT, b2.f9978b);
        } catch (JSONException e2) {
            e2.printStackTrace();
        }
    }

    public static void a(JSONObject jSONObject, a.C0302a c0302a) {
        com.iab.omid.library.amazon.b.c a2 = c0302a.a();
        JSONArray jSONArray = new JSONArray();
        for (String str : c0302a.b()) {
            jSONArray.put(str);
        }
        try {
    ...
    private static a b(JSONObject jSONObject) {
        ...
        if (f9975b != null) {
            ...
            f9975b.getDefaultDisplay().getRealSize(point);
            f2 = a(point.x);
            f3 = a(point.y);
        } else {
            f2 = 0.0f;
