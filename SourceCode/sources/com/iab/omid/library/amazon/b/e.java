...
public class e {
    ...
    void a(WebView webView, String str, Object... objArr) {
        if (webView == null) {
            com.iab.omid.library.amazon.d.c.a("The WebView is null for " + str);
            return;
        }
    ...
    void a(final WebView webView, StringBuilder sb) {
        ...
        if (handler == null || Looper.myLooper() == handler.getLooper()) {
            ...
            handler.post(new Runnable() { // from class: com.iab.omid.library.amazon.b.e.1
