...
public abstract class AdSessionStatePublisher {
    ...
    private com.iab.omid.library.amazon.e.b f9979a;

    /* renamed from: b  reason: collision with root package name */
    private AdEvents f9980b;

    /* renamed from: c  reason: collision with root package name */
    private MediaEvents f9981c;
    ...
    public AdSessionStatePublisher() {
        i();
        this.f9979a = new com.iab.omid.library.amazon.e.b(null);
    }
    ...
    public void a(WebView webView) {
        this.f9979a = new com.iab.omid.library.amazon.e.b(webView);
    }

    public void a(AdEvents adEvents) {
        this.f9980b = adEvents;
    }
    ...
    public void a(com.iab.omid.library.amazon.adsession.a aVar, AdSessionContext adSessionContext, JSONObject jSONObject) {
        ...
        for (VerificationScriptResource verificationScriptResource : adSessionContext.getVerificationScriptResources()) {
            com.iab.omid.library.amazon.d.b.a(jSONObject5, verificationScriptResource.getVendorKey(), verificationScriptResource.getVerificationParameters());
        }
        e.a().a(getWebView(), adSessionId, jSONObject2, jSONObject5, jSONObject);
    }

    public void a(MediaEvents mediaEvents) {
        this.f9981c = mediaEvents;
    }
    ...
    public void a(String str, long j) {
        if (j >= this.f9983e) {
            this.f9982d = a.AD_STATE_VISIBLE;
    ...
    public void b(String str, long j) {
        if (j < this.f9983e || this.f9982d == a.AD_STATE_NOTVISIBLE) {
            return;
        }
        this.f9982d = a.AD_STATE_NOTVISIBLE;
        e.a().b(getWebView(), str);
    }
    ...
    public WebView getWebView() {
        return (WebView) this.f9979a.get();
    }
    ...
    public void i() {
        this.f9983e = com.iab.omid.library.amazon.d.d.a();
        this.f9982d = a.AD_STATE_IDLE;
    }
}
