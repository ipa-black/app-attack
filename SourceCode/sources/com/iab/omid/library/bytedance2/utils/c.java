...
public class c {
    ...
    private static WindowManager f10323a;

    /* renamed from: b  reason: collision with root package name */
    private static String[] f10324b = {"x", "y", IabUtils.KEY_WIDTH, IabUtils.KEY_HEIGHT};

    /* renamed from: c  reason: collision with root package name */
    static float f10325c = Resources.getSystem().getDisplayMetrics().density;
    ...
    private static b a(JSONObject jSONObject) {
        ...
        if (f10323a != null) {
            ...
            f10323a.getDefaultDisplay().getRealSize(point);
            f2 = a(point.x);
            f3 = a(point.y);
        } else {
            f2 = 0.0f;
    ...
    public static void a(Context context) {
        if (context != null) {
            f10325c = context.getResources().getDisplayMetrics().density;
            f10323a = (WindowManager) context.getSystemService("window");
        }
    }
    ...
    public static void a(JSONObject jSONObject, a.C0311a c0311a) {
        com.iab.omid.library.bytedance2.internal.e a2 = c0311a.a();
        JSONArray jSONArray = new JSONArray();
        for (String str : c0311a.b()) {
            jSONArray.put(str);
        }
        try {
    ...
    private static boolean a(OutputDeviceStatus outputDeviceStatus) {
        return a.f10326a[outputDeviceStatus.ordinal()] == 1;
    }
    ...
    public static void b(JSONObject jSONObject) {
        b a2 = a(jSONObject);
        try {
            jSONObject.put(IabUtils.KEY_WIDTH, a2.f10327a);
            jSONObject.put(IabUtils.KEY_HEIGHT, a2.f10328b);
        } catch (JSONException unused) {
        }
    }
