...
public class d implements a {
    ...
    private void a(ViewGroup viewGroup, JSONObject jSONObject, a.InterfaceC0304a interfaceC0304a, boolean z) {
        for (int i = 0; i < viewGroup.getChildCount(); i++) {
            interfaceC0304a.a(viewGroup.getChildAt(i), this, jSONObject, z);
        }
    }

    private void b(ViewGroup viewGroup, JSONObject jSONObject, a.InterfaceC0304a interfaceC0304a, boolean z) {
        ...
        while (it.hasNext()) {
            ...
            while (it2.hasNext()) {
                interfaceC0304a.a((View) it2.next(), this, jSONObject, z);
            }
        }
    }
    ...
    public void a(View view, JSONObject jSONObject, a.InterfaceC0304a interfaceC0304a, boolean z, boolean z2) {
        if (view instanceof ViewGroup) {
            ...
            if (z) {
                b(viewGroup, jSONObject, interfaceC0304a, z2);
            } else {
                a(viewGroup, jSONObject, interfaceC0304a, z2);
            }
        }
    }
}
