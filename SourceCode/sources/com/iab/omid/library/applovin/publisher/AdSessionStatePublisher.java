...
public abstract class AdSessionStatePublisher {
    ...
    private com.iab.omid.library.applovin.weakreference.b f10086a;
    ...
    public AdSessionStatePublisher() {
        a();
        this.f10086a = new com.iab.omid.library.applovin.weakreference.b(null);
    }

    public void a() {
        this.f10090e = f.b();
        this.f10089d = a.AD_STATE_IDLE;
    }
    ...
    public void a(WebView webView) {
        this.f10086a = new com.iab.omid.library.applovin.weakreference.b(webView);
    }
    ...
    public void b(String str, long j) {
        if (j >= this.f10090e) {
            this.f10089d = a.AD_STATE_VISIBLE;
            g.a().a(getWebView(), str);
        }
    }
