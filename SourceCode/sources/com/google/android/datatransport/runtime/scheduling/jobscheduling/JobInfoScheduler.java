...
public class JobInfoScheduler implements WorkScheduler {
    ...
    int getJobId(TransportContext transportContext) {
        ...
        adler32.update(this.context.getPackageName().getBytes(Charset.forName(C.UTF8_NAME)));
        adler32.update(transportContext.getBackendName().getBytes(Charset.forName(C.UTF8_NAME)));
