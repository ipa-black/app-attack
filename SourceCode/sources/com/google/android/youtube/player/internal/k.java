...
public interface k extends IInterface {
    ...
    public static abstract class a extends Binder implements k {
        ...
        /* loaded from: classes4.dex */
        private static class C0274a implements k {

            /* renamed from: a  reason: collision with root package name */
            private IBinder f9741a;
            ...
            public final void a() throws RemoteException {
                ...
                try {
                    ...
                    this.f9741a.transact(3, obtain, obtain2, 0);
            ...
            public final void a(String str) throws RemoteException {
                ...
                try {
                    ...
                    this.f9741a.transact(1, obtain, obtain2, 0);
                    obtain2.readException();
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
            ...
            public final void a(String str, int i) throws RemoteException {
                ...
                try {
                    ...
                    obtain.writeString(str);
                    obtain.writeInt(i);
                    this.f9741a.transact(2, obtain, obtain2, 0);
                    obtain2.readException();
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
            ...
            public final void b() throws RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken("com.google.android.youtube.player.internal.IThumbnailLoaderService");
                    this.f9741a.transact(4, obtain, obtain2, 0);
                    obtain2.readException();
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
            ...
            public final void c() throws RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken("com.google.android.youtube.player.internal.IThumbnailLoaderService");
                    this.f9741a.transact(5, obtain, obtain2, 0);
                    obtain2.readException();
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
            ...
            public final void d() throws RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken("com.google.android.youtube.player.internal.IThumbnailLoaderService");
                    this.f9741a.transact(6, obtain, obtain2, 0);
                    obtain2.readException();
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
        ...
        public static k a(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof k)) ? new C0274a(iBinder) : (k) queryLocalInterface;
        }
