...
public final class x {
    public static Map<String, String> a(Locale locale) {
        ...
        a(hashMap, new StringBuilder(String.valueOf(valueOf).length() + 1 + String.valueOf(valueOf2).length()).append(valueOf).append("_").append(valueOf2).toString());
        return hashMap;
    }
    ...
    private static void a(Map<String, String> map, String str) {
        ...
        } else if (ScarConstants.IN_SIGNAL_KEY.equals(str)) {
