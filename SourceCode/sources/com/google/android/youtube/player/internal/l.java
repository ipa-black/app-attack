...
public interface l extends IInterface {
    ...
    public static abstract class a extends Binder implements l {
        ...
        /* loaded from: classes4.dex */
        private static class C0275a implements l {

            /* renamed from: a  reason: collision with root package name */
            private IBinder f9742a;
            ...
            public final IBinder a() throws RemoteException {
                ...
                try {
                    ...
                    this.f9742a.transact(1, obtain, obtain2, 0);
            ...
            public final k a(j jVar) throws RemoteException {
                ...
                try {
                    ...
                    this.f9742a.transact(2, obtain, obtain2, 0);
                    obtain2.readException();
            ...
            public final void a(boolean z) throws RemoteException {
                ...
                try {
                    ...
                    this.f9742a.transact(3, obtain, obtain2, 0);
                    obtain2.readException();
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
        ...
        public static l a(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof l)) ? new C0275a(iBinder) : (l) queryLocalInterface;
        }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            ...
            if (i == 1) {
                ...
                if (readStrongBinder == null) {
                    ...
                    c0273a = (queryLocalInterface == null || !(queryLocalInterface instanceof j)) ? new j.a.C0273a(readStrongBinder) : (j) queryLocalInterface;
                }
                k a3 = a(c0273a);
                parcel2.writeNoException();
