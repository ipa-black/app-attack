...
public interface f extends IInterface {
    ...
    public static abstract class a extends Binder implements f {
        ...
        /* loaded from: classes4.dex */
        public static class C0269a implements f {

            /* renamed from: a  reason: collision with root package name */
            private IBinder f9736a;
            ...
            public final void a() throws RemoteException {
                ...
                try {
                    ...
                    this.f9736a.transact(1, obtain, obtain2, 0);
            ...
            public final void a(int i) throws RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken("com.google.android.youtube.player.internal.IPlaybackEventListener");
                    obtain.writeInt(i);
                    this.f9736a.transact(5, obtain, obtain2, 0);
                    obtain2.readException();
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
            ...
            public final void a(boolean z) throws RemoteException {
                ...
                try {
                    ...
                    this.f9736a.transact(4, obtain, obtain2, 0);
                    obtain2.readException();
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
            ...
            public final void b() throws RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken("com.google.android.youtube.player.internal.IPlaybackEventListener");
                    this.f9736a.transact(2, obtain, obtain2, 0);
                    obtain2.readException();
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
            ...
            public final void c() throws RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken("com.google.android.youtube.player.internal.IPlaybackEventListener");
                    this.f9736a.transact(3, obtain, obtain2, 0);
                    obtain2.readException();
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
