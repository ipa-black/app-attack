...
abstract class DateFormatTextWatcher implements TextWatcher {
    ...
    public void onTextChanged(CharSequence charSequence, int i, int i2, int i3) {
        ...
        try {
            ...
            this.textInputLayout.setError(string + "\n" + format + "\n" + String.format(this.textInputLayout.getContext().getString(R.string.mtrl_picker_invalid_format_example), this.dateFormat.format(new Date(UtcDates.getTodayCalendar().getTimeInMillis()))));
            onInvalidDate();
        }
    }
}
