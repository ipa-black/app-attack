        ...
        this.dragCallback = new ViewDragHelper.Callback() { // from class: com.google.android.material.bottomsheet.BottomSheetBehavior.3
            ...
            public void onViewReleased(View view, float f2, float f3) {
                ...
                if (f3 < 0.0f) {
                    ...
                    i2 = 3;
                } else if (BottomSheetBehavior.this.hideable && BottomSheetBehavior.this.shouldHide(view, f3) && (view.getTop() > BottomSheetBehavior.this.collapsedOffset || Math.abs(f2) < Math.abs(f3))) {
