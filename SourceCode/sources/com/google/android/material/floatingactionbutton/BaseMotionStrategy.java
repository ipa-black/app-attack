...
abstract class BaseMotionStrategy implements MotionStrategy {
    ...
    public AnimatorSet createAnimator(MotionSpec motionSpec) {
        ...
        if (motionSpec.hasPropertyValues(IabUtils.KEY_WIDTH)) {
            arrayList.add(motionSpec.getAnimator(IabUtils.KEY_WIDTH, this.fab, ExtendedFloatingActionButton.WIDTH));
        }
        if (motionSpec.hasPropertyValues(IabUtils.KEY_HEIGHT)) {
            arrayList.add(motionSpec.getAnimator(IabUtils.KEY_HEIGHT, this.fab, ExtendedFloatingActionButton.HEIGHT));
        }
