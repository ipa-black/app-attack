...
class FloatingActionButtonImplLollipop extends FloatingActionButtonImpl {
    ...
    void onElevationsChanged(float f2, float f3, float f4) {
        ...
        stateListAnimator.addState(PRESSED_ENABLED_STATE_SET, createElevationAnimator(f2, f4));
        stateListAnimator.addState(HOVERED_FOCUSED_ENABLED_STATE_SET, createElevationAnimator(f2, f3));
        stateListAnimator.addState(FOCUSED_ENABLED_STATE_SET, createElevationAnimator(f2, f3));
        stateListAnimator.addState(HOVERED_ENABLED_STATE_SET, createElevationAnimator(f2, f3));
