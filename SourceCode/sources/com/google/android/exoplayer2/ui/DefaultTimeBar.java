...
public class DefaultTimeBar extends View implements TimeBar {
    ...
    private static int dpToPx(float f2, int i) {
        return (int) ((i * f2) + 0.5f);
    }

    private static int pxToDp(float f2, int i) {
        return (int) (i / f2);
    }
    ...
    public DefaultTimeBar(Context context, AttributeSet attributeSet, int i, AttributeSet attributeSet2, int i2) {
        ...
        int dpToPx = dpToPx(f2, 4);
        int dpToPx2 = dpToPx(f2, 26);
        int dpToPx3 = dpToPx(f2, 4);
        int dpToPx4 = dpToPx(f2, 12);
        int dpToPx5 = dpToPx(f2, 0);
        int dpToPx6 = dpToPx(f2, 16);
        ...
        this.stopScrubbingRunnable = new Runnable() { // from class: com.google.android.exoplayer2.ui.DefaultTimeBar$$ExternalSyntheticLambda0
            ...
            public final void run() {
                DefaultTimeBar.this.m394lambda$new$0$comgoogleandroidexoplayer2uiDefaultTimeBar();
            }
        };
        ...
        valueAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.google.android.exoplayer2.ui.DefaultTimeBar$$ExternalSyntheticLambda1
            ...
            public final void onAnimationUpdate(ValueAnimator valueAnimator2) {
                DefaultTimeBar.this.m395lambda$new$1$comgoogleandroidexoplayer2uiDefaultTimeBar(valueAnimator2);
            }
        });
    ...
    public /* synthetic */ void m394lambda$new$0$comgoogleandroidexoplayer2uiDefaultTimeBar() {
        stopScrubbing(false);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    /* renamed from: lambda$new$1$com-google-android-exoplayer2-ui-DefaultTimeBar  reason: not valid java name */
    public /* synthetic */ void m395lambda$new$1$comgoogleandroidexoplayer2uiDefaultTimeBar(ValueAnimator valueAnimator) {
    ...
    */
    ...
    private void positionScrubber(float f2) {
        this.scrubberBar.right = Util.constrainValue((int) f2, this.progressBar.left, this.progressBar.right);
    }
