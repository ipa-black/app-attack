...
public final class SpannedToHtmlConverter {
    ...
    public static HtmlAndCss convert(CharSequence charSequence, float f2) {
        ...
        for (Integer num : hashSet) {
            ...
            hashMap.put(HtmlUtils.cssAllClassDescendantsSelector(new StringBuilder(14).append("bg_").append(intValue).toString()), Util.formatInvariant("background-color:%s;", HtmlUtils.toCssRgba(intValue)));
        }
    ...
    private static String getClosingTag(Object obj) {
        ...
        if (obj instanceof StyleSpan) {
            ...
            return new StringBuilder(String.valueOf(escapeHtml).length() + 16).append("<rt>").append(escapeHtml).append("</rt></ruby>").toString();
        } else if (obj instanceof UnderlineSpan) {
            return "</u>";
        }
        return null;
