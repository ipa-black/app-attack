...
public class StyledPlayerControlView extends FrameLayout {
    ...
    public void updateProgress() {
        ...
        if (isVisible() && this.isAttachedToWindow) {
            ...
            postDelayed(this.updateProgressAction, Util.constrainValue(player.getPlaybackParameters().speed > 0.0f ? ((float) min) / f2 : 1000L, this.timeBarMinUpdateIntervalMs, 1000L));
        }
    }
    ...
    public final class SettingViewHolder extends RecyclerView.ViewHolder {
        ...
        public SettingViewHolder(View view) {
            ...
            view.setOnClickListener(new View.OnClickListener() { // from class: com.google.android.exoplayer2.ui.StyledPlayerControlView$SettingViewHolder$$ExternalSyntheticLambda0
                ...
                public final void onClick(View view2) {
                    StyledPlayerControlView.SettingViewHolder.this.m402xbf8efbb9(view2);
                }
            });
        }
        ...
        public /* synthetic */ void m402xbf8efbb9(View view) {
    ...
    public final class PlaybackSpeedAdapter extends RecyclerView.Adapter<SubSettingViewHolder> {
        ...
        public void onBindViewHolder(SubSettingViewHolder subSettingViewHolder, final int i) {
            ...
            subSettingViewHolder.itemView.setOnClickListener(new View.OnClickListener() { // from class: com.google.android.exoplayer2.ui.StyledPlayerControlView$PlaybackSpeedAdapter$$ExternalSyntheticLambda0
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    StyledPlayerControlView.PlaybackSpeedAdapter.this.m401xdf46b9b2(i, view);
                }
            });
        }
        ...
        public /* synthetic */ void m401xdf46b9b2(int i, View view) {
    ...
    public final class TextTrackSelectionAdapter extends TrackSelectionAdapter {
        ...
        public void onBindViewHolderAtZeroPosition(SubSettingViewHolder subSettingViewHolder) {
            ...
            subSettingViewHolder.itemView.setOnClickListener(new View.OnClickListener() { // from class: com.google.android.exoplayer2.ui.StyledPlayerControlView$TextTrackSelectionAdapter$$ExternalSyntheticLambda0
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    StyledPlayerControlView.TextTrackSelectionAdapter.this.m403xcc051aee(view);
                }
            });
        }
        ...
        public /* synthetic */ void m403xcc051aee(View view) {
    ...
    public final class AudioTrackSelectionAdapter extends TrackSelectionAdapter {
        ...
        public void onBindViewHolderAtZeroPosition(SubSettingViewHolder subSettingViewHolder) {
            ...
            subSettingViewHolder.itemView.setOnClickListener(new View.OnClickListener() { // from class: com.google.android.exoplayer2.ui.StyledPlayerControlView$AudioTrackSelectionAdapter$$ExternalSyntheticLambda0
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    StyledPlayerControlView.AudioTrackSelectionAdapter.this.m400x5e042c6b(view);
                }
            });
        }
        ...
        public /* synthetic */ void m400x5e042c6b(View view) {
            if (StyledPlayerControlView.this.player == null) {
                return;
            }
            TrackSelectionParameters trackSelectionParameters = StyledPlayerControlView.this.player.getTrackSelectionParameters();
    ...
    public abstract class TrackSelectionAdapter extends RecyclerView.Adapter<SubSettingViewHolder> {
        ...
        public void onBindViewHolder(SubSettingViewHolder subSettingViewHolder, int i) {
            ...
            if (((Player) Assertions.checkNotNull(StyledPlayerControlView.this.player)).getTrackSelectionParameters().trackSelectionOverrides.getOverride(trackGroup) == null || !trackInformation.isSelected()) {
                z = false;
            }
            ...
            subSettingViewHolder.itemView.setOnClickListener(new View.OnClickListener() { // from class: com.google.android.exoplayer2.ui.StyledPlayerControlView$TrackSelectionAdapter$$ExternalSyntheticLambda0
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    StyledPlayerControlView.TrackSelectionAdapter.this.m404x30db9e7f(trackGroup, trackInformation, view);
                }
            });
        }
        ...
        public /* synthetic */ void m404x30db9e7f(TrackGroup trackGroup, TrackInformation trackInformation, View view) {
            if (StyledPlayerControlView.this.player == null) {
                return;
            }
            TrackSelectionParameters trackSelectionParameters = StyledPlayerControlView.this.player.getTrackSelectionParameters();
            TrackSelectionOverrides build = trackSelectionParameters.trackSelectionOverrides.buildUpon().setOverrideForType(new TrackSelectionOverrides.TrackSelectionOverride(trackGroup, ImmutableList.of(Integer.valueOf(trackInformation.trackIndex)))).build();
            HashSet hashSet = new HashSet(trackSelectionParameters.disabledTrackTypes);
