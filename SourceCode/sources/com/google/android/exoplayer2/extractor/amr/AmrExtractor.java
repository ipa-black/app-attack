...
public final class AmrExtractor implements Extractor {
    ...
    private int peekNextSampleSize(ExtractorInput extractorInput) throws IOException {
        ...
        if ((b2 & 131) > 0) {
            throw ParserException.createForMalformedContainer(new StringBuilder(42).append("Invalid padding bits for frame header ").append((int) b2).toString(), null);
        }
    ...
    private int getFrameSizeInBytes(int i) throws ParserException {
        ...
        throw ParserException.createForMalformedContainer(new StringBuilder(str.length() + 35).append("Illegal AMR ").append(str).append(" frame type ").append(i).toString(), null);
    }
