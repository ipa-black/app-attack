...
abstract class Atom {
    ...
    static final class ContainerAtom extends Atom {
        ...
        public String toString() {
            ...
            return new StringBuilder(String.valueOf(atomTypeString).length() + 22 + String.valueOf(arrays).length() + String.valueOf(arrays2).length()).append(atomTypeString).append(" leaves: ").append(arrays).append(" containers: ").append(arrays2).toString();
        }
    }

    public static String getAtomTypeString(int i) {
        return new StringBuilder(4).append((char) ((i >> 24) & 255)).append((char) ((i >> 16) & 255)).append((char) ((i >> 8) & 255)).append((char) (i & 255)).toString();
    }
}
