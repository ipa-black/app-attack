...
public final class Mp4Extractor implements Extractor, SeekMap {
    ...
    private void processMoovAtom(Atom.ContainerAtom containerAtom) throws ParserException {
        ...
        List<TrackSampleTable> parseTraks = AtomParsers.parseTraks(containerAtom, gaplessInfoHolder, C.TIME_UNSET, null, (this.flags & 1) != 0, z, new Function() { // from class: com.google.android.exoplayer2.extractor.mp4.Mp4Extractor$$ExternalSyntheticLambda0
        ...
        while (i4 < size) {
            ...
            if (trackSampleTable.sampleCount == 0) {
                ...
                if (track.type == 2 && j2 > 0 && trackSampleTable.sampleCount > 1) {
                    buildUpon.setFrameRate(trackSampleTable.sampleCount / (((float) j2) / 1000000.0f));
                }
                ...
                MetadataUtil.setFormatMetadata(i7, metadata2, parseMdtaFromMeta, buildUpon, metadataArr);
