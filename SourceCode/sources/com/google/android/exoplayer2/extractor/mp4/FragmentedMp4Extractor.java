...
public class FragmentedMp4Extractor implements Extractor {
    ...
    private void onEmsgLeafAtomRead(ParsableByteArray parsableByteArray) {
        ...
        if (parseFullAtomVersion == 0) {
            ...
            Log.w(TAG, new StringBuilder(46).append("Skipping unsupported emsg version: ").append(parseFullAtomVersion).toString());
            return;
        }
    ...
    private static void parseSaiz(TrackEncryptionBox trackEncryptionBox, ParsableByteArray parsableByteArray, TrackFragment trackFragment) throws ParserException {
        ...
        if (readUnsignedIntToInt > trackFragment.sampleCount) {
            throw ParserException.createForMalformedContainer(new StringBuilder(78).append("Saiz sample count ").append(readUnsignedIntToInt).append(" is greater than fragment sample count").append(trackFragment.sampleCount).toString(), null);
        }
    ...
    private static void parseSaio(ParsableByteArray parsableByteArray, TrackFragment trackFragment) throws ParserException {
        ...
        if (readUnsignedIntToInt != 1) {
            throw ParserException.createForMalformedContainer(new StringBuilder(40).append("Unexpected saio entry count: ").append(readUnsignedIntToInt).toString(), null);
        }
    ...
    private static int checkNonNegative(int i) throws ParserException {
        ...
        throw ParserException.createForMalformedContainer(new StringBuilder(38).append("Unexpected negative value: ").append(i).toString(), null);
    }
    ...
    private static void parseSenc(ParsableByteArray parsableByteArray, int i, TrackFragment trackFragment) throws ParserException {
        ...
        if (readUnsignedIntToInt == 0) {
            ...
            throw ParserException.createForMalformedContainer(new StringBuilder(80).append("Senc sample count ").append(readUnsignedIntToInt).append(" is different from fragment sample count").append(trackFragment.sampleCount).toString(), null);
        } else {
