...
public final class VorbisUtil {
    ...
    public static boolean verifyVorbisHeaderCapturePattern(int i, ParsableByteArray parsableByteArray, boolean z) throws ParserException {
        if (parsableByteArray.bytesLeft() < 7) {
            ...
            throw ParserException.createForMalformedContainer(new StringBuilder(29).append("too short header: ").append(parsableByteArray.bytesLeft()).toString(), null);
    ...
    private static void readMappings(int i, VorbisBitArray vorbisBitArray) throws ParserException {
        ...
        for (int i2 = 0; i2 < readBits; i2++) {
            ...
            if (readBits2 != 0) {
                Log.e(TAG, new StringBuilder(52).append("mapping type other than 0 not supported: ").append(readBits2).toString());
            } else {
    ...
    private static void readFloors(VorbisBitArray vorbisBitArray) throws ParserException {
        ...
        for (int i = 0; i < readBits; i++) {
            ...
            if (readBits2 == 0) {
                ...
                throw ParserException.createForMalformedContainer(new StringBuilder(52).append("floor type greater than 1 not decodable: ").append(readBits2).toString(), null);
            }
        }
    }
    ...
    private static CodeBook readBook(VorbisBitArray vorbisBitArray) throws ParserException {
        if (vorbisBitArray.readBits(24) != 5653314) {
            throw ParserException.createForMalformedContainer(new StringBuilder(66).append("expected code book to start with [0x56, 0x43, 0x42] at ").append(vorbisBitArray.getPosition()).toString(), null);
        }
        ...
        int readBits5 = vorbisBitArray.readBits(4);
        if (readBits5 > 2) {
            throw ParserException.createForMalformedContainer(new StringBuilder(53).append("lookup type greater than 2 not decodable: ").append(readBits5).toString(), null);
        }
