...
public class MatroskaExtractor implements Extractor {
    ...
    protected void integerElement(int i, long j) throws ParserException {
        if (i == ID_CONTENT_ENCODING_ORDER) {
            if (j != 0) {
                throw ParserException.createForMalformedContainer(new StringBuilder(55).append("ContentEncodingOrder ").append(j).append(" not supported").toString(), null);
            }
        } else if (i == ID_CONTENT_ENCODING_SCOPE) {
            if (j != 1) {
                throw ParserException.createForMalformedContainer(new StringBuilder(55).append("ContentEncodingScope ").append(j).append(" not supported").toString(), null);
            }
        } else {
            switch (i) {
                case ID_TRACK_TYPE /* 131 */:
                ...
                case ID_CONTENT_COMPRESSION_ALGORITHM /* 16980 */:
                    if (j != 3) {
                        throw ParserException.createForMalformedContainer(new StringBuilder(50).append("ContentCompAlgo ").append(j).append(" not supported").toString(), null);
                    }
                    return;
                case ID_DOC_TYPE_READ_VERSION /* 17029 */:
                    if (j < 1 || j > 2) {
                        throw ParserException.createForMalformedContainer(new StringBuilder(53).append("DocTypeReadVersion ").append(j).append(" not supported").toString(), null);
                    }
                    return;
                case ID_EBML_READ_VERSION /* 17143 */:
                    if (j != 1) {
                        throw ParserException.createForMalformedContainer(new StringBuilder(50).append("EBMLReadVersion ").append(j).append(" not supported").toString(), null);
                    }
                    return;
                case ID_CONTENT_ENCRYPTION_ALGORITHM /* 18401 */:
                    if (j != 5) {
                        throw ParserException.createForMalformedContainer(new StringBuilder(49).append("ContentEncAlgo ").append(j).append(" not supported").toString(), null);
                    }
                    return;
                case ID_CONTENT_ENCRYPTION_AES_SETTINGS_CIPHER_MODE /* 18408 */:
                    if (j != 1) {
                        throw ParserException.createForMalformedContainer(new StringBuilder(56).append("AESSettingsCipherMode ").append(j).append(" not supported").toString(), null);
                    }
                    return;
                case ID_SEEK_POSITION /* 21420 */:
    ...
    protected void stringElement(int i, String str) throws ParserException {
        if (i == 134) {
            ...
            if (!DOC_TYPE_WEBM.equals(str) && !DOC_TYPE_MATROSKA.equals(str)) {
                throw ParserException.createForMalformedContainer(new StringBuilder(String.valueOf(str).length() + 22).append("DocType ").append(str).append(" not supported").toString(), null);
            }
        } else if (i == ID_NAME) {
    ...
    */
    ...
    private void assertInTrackEntry(int i) throws ParserException {
        if (this.currentTrack == null) {
            throw ParserException.createForMalformedContainer(new StringBuilder(43).append("Element ").append(i).append(" must be in a TrackEntry").toString(), null);
        }
    }
    ...
    private void assertInCues(int i) throws ParserException {
        if (this.cueTimesUs == null || this.cueClusterPositions == null) {
            throw ParserException.createForMalformedContainer(new StringBuilder(37).append("Element ").append(i).append(" must be in a Cues").toString(), null);
        }
    }
    ...
    */
    private void commitSampleToOutput(com.google.android.exoplayer2.extractor.mkv.MatroskaExtractor.Track r18, long r19, int r21, int r22, int r23) {
        /*
            ...
            if (r2 == 0) goto L1e
            com.google.android.exoplayer2.extractor.TrueHdSampleRechunker r2 = r1.trueHdSampleRechunker
            com.google.android.exoplayer2.extractor.TrackOutput r3 = r1.output
        ...
        Lae:
            ...
            com.google.android.exoplayer2.util.ParsableByteArray r5 = r0.blockAdditionalData
            r6 = 2
