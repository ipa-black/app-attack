...
public final class SntpClient {
    ...
    private static long loadNtpTimeOffsetMs() throws IOException {
        ...
        try {
            ...
            checkValidServerReply((byte) ((b2 >> 6) & 3), (byte) (b2 & 7), bArr[1] & 255, readTimestamp3);
    ...
    private static void checkValidServerReply(byte b2, byte b3, int i, long j) throws IOException {
        ...
        if (b3 != 4 && b3 != 5) {
            throw new IOException(new StringBuilder(26).append("SNTP: Untrusted mode: ").append((int) b3).toString());
        }
        if (i == 0 || i > 15) {
            throw new IOException(new StringBuilder(36).append("SNTP: Untrusted stratum: ").append(i).toString());
        }
        if (j == 0) {
