...
public final class NalUnitUtil {
    ...
    public static final class SpsData {
        ...
        public SpsData(int i, int i2, int i3, int i4, int i5, int i6, float f2, boolean z, boolean z2, int i7, int i8, int i9, boolean z3) {
            this.profileIdc = i;
    ...
    public static final class H265SpsData {
        ...
        public H265SpsData(int i, boolean z, int i2, int i3, int[] iArr, int i4, int i5, int i6, int i7, float f2) {
    ...
    */
    ...
    public static H265SpsData parseH265SpsNalUnitPayload(byte[] bArr, int i, int i2) {
        ...
        for (int i9 = parsableNalUnitBitArray.readBit() ? 0 : readBits; i9 <= readBits; i9++) {
            parsableNalUnitBitArray.readUnsignedExpGolombCodedInt();
            parsableNalUnitBitArray.readUnsignedExpGolombCodedInt();
            parsableNalUnitBitArray.readUnsignedExpGolombCodedInt();
        }
            ...
            if (parsableNalUnitBitArray.readBit()) {
                ...
                if (readBits5 == 255) {
                    ...
                    if (readBits5 < fArr.length) {
                        ...
                        Log.w(TAG, new StringBuilder(46).append("Unexpected aspect_ratio_idc value: ").append(readBits5).toString());
                    }
                }
            }
            if (parsableNalUnitBitArray.readBit()) {
        ...
        return new H265SpsData(readBits2, readBit, readBits3, i3, iArr, readBits4, readUnsignedExpGolombCodedInt, i8, readUnsignedExpGolombCodedInt4, f2);
    }
