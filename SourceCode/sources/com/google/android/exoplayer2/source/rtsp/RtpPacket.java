...
public final class RtpPacket {
    ...
    public static RtpPacket parse(ParsableByteArray parsableByteArray) {
        ...
        return new Builder().setPadding(z).setMarker(z2).setPayloadType(b4).setSequenceNumber(readUnsignedShort).setTimestamp(readUnsignedInt).setSsrc(readInt).setCsrc(bArr).setPayloadData(bArr2).build();
    }
    ...
    public int hashCode() {
        ...
        return ((((((((IronSourceError.ERROR_NON_EXISTENT_INSTANCE + this.payloadType) * 31) + this.sequenceNumber) * 31) + (this.marker ? 1 : 0)) * 31) + ((int) (j ^ (j >>> 32)))) * 31) + this.ssrc;
    }
