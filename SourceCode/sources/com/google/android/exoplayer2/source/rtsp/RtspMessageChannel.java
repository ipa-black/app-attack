...
public final class RtspMessageChannel implements Closeable {
    ...
    public final class Sender implements Closeable {
        ...
        public void send(final List<String> list) {
            ...
            this.senderThreadHandler.post(new Runnable() { // from class: com.google.android.exoplayer2.source.rtsp.RtspMessageChannel$Sender$$ExternalSyntheticLambda0
                ...
                public final void run() {
                    RtspMessageChannel.Sender.this.m389x9fa6909d(convertMessageToByteArray, list);
                }
            });
        }
        ...
        public /* synthetic */ void m389x9fa6909d(byte[] bArr, List list) {
            try {
    ...
    private final class Receiver implements Loader.Loadable {
        ...
        private void handleRtspMessage(byte b2) throws IOException {
            ...
            RtspMessageChannel.this.messageListener.onRtspMessageReceived(this.messageParser.parseNext(b2, this.dataInputStream));
        }
