...
public final class DashUtil {
    ...
    private static ChunkExtractor newChunkExtractor(int i, Format format) {
        ...
        return new BundledChunkExtractor((str == null || !(str.startsWith("video/webm") || str.startsWith(MimeTypes.AUDIO_WEBM))) ? new FragmentedMp4Extractor() : new MatroskaExtractor(), i, format);
    }
