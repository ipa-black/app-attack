...
public class DashManifestParser extends DefaultHandler implements ParsingLoadable.Parser<DashManifest> {
    ...
    /* JADX WARN: Removed duplicated region for block: B:82:0x01eb A[LOOP:0: B:25:0x00a4->B:82:0x01eb, LOOP_END] */
    ...
    */
    ...
    protected ServiceDescriptionElement parseServiceDescription(XmlPullParser xmlPullParser) throws XmlPullParserException, IOException {
        ...
        while (true) {
            ...
            if (XmlPullParserUtil.isStartTag(xmlPullParser, "Latency")) {
                ...
                j3 = parseLong(xmlPullParser, AppLovinMediationProvider.MAX, C.TIME_UNSET);
            } else if (XmlPullParserUtil.isStartTag(xmlPullParser, "PlaybackRate")) {
                f2 = parseFloat(xmlPullParser, "min", -3.4028235E38f);
                f3 = parseFloat(xmlPullParser, AppLovinMediationProvider.MAX, -3.4028235E38f);
            }
            long j4 = j;
            long j5 = j2;
            long j6 = j3;
            ...
            if (XmlPullParserUtil.isEndTag(xmlPullParser, "ServiceDescription")) {
                return new ServiceDescriptionElement(j4, j5, j6, f4, f5);
            }
            j = j4;
            j2 = j5;
            j3 = j6;
    ...
    /* JADX WARN: Removed duplicated region for block: B:71:0x0312 A[LOOP:0: B:3:0x007c->B:71:0x0312, LOOP_END] */
    ...
    */
    ...
    protected Format buildFormat(String str, String str2, int i, int i2, float f2, int i3, int i4, int i5, String str3, List<Descriptor> list, List<Descriptor> list2, String str4, List<Descriptor> list3, List<Descriptor> list4) {
    ...
    protected List<SegmentBase.SegmentTimelineElement> parseSegmentTimeline(XmlPullParser xmlPullParser, long j, long j2) throws XmlPullParserException, IOException {
        ...
        do {
            ...
            if (XmlPullParserUtil.isStartTag(xmlPullParser, ExifInterface.LATITUDE_SOUTH)) {
                long parseLong = parseLong(xmlPullParser, d.COLUMN_TYPE, C.TIME_UNSET);
                if (z) {
                ...
                j4 = parseLong(xmlPullParser, com.ironsource.sdk.c.d.f11571a, C.TIME_UNSET);
    ...
    protected static float parseFrameRate(XmlPullParser xmlPullParser, float f2) {
    ...
    protected static float parseFloat(XmlPullParser xmlPullParser, String str, float f2) {
        String attributeValue = xmlPullParser.getAttributeValue(null, str);
