    ...
    public long selectTracks(ExoTrackSelection[] exoTrackSelectionArr, boolean[] zArr, SampleStream[] sampleStreamArr, boolean[] zArr2, long j) {
        ...
        while (true) {
            ...
            if (exoTrackSelection2 != null) {
                TrackGroup trackGroup = (TrackGroup) Assertions.checkNotNull(this.childTrackGroupByMergedTrackGroup.get(exoTrackSelection2.getTrackGroup()));
                int i2 = 0;
                while (true) {
        ...
        while (true) {
            ...
            if (i2 < mediaPeriodArr.length) {
                ...
                while (i5 < i4) {
                    ...
                    String str = trackGroup.id;
                    TrackGroup copyWithId = trackGroup.copyWithId(new StringBuilder(String.valueOf(str).length() + 12).append(i2).append(":").append(str).toString());
