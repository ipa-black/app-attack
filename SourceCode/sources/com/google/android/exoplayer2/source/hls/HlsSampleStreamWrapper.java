...
public final class HlsSampleStreamWrapper implements Loader.Callback<Chunk>, Loader.ReleaseCallback, SequenceableLoader, ExtractorOutput, SampleQueue.UpstreamFormatChangedListener {
    ...
    */
    ...
    private void buildTracksFromSampleStreams() {
        ...
        while (i7 < length) {
            ...
            if (i7 == i3) {
                ...
                Format format4 = (i2 == i && MimeTypes.isAudio(format2.sampleMimeType)) ? this.muxedAudioFormat : null;
                String str2 = this.uid;
                trackGroupArr[i7] = new TrackGroup(new StringBuilder(String.valueOf(str2).length() + 18).append(str2).append(":muxed:").append(i7 < i3 ? i7 : i7 - 1).toString(), deriveFormat(format4, format2, false));
            }
            i7++;
            i = 2;
        }
    ...
    private static DummyTrackOutput createFakeTrackOutput(int i, int i2) {
        Log.w(TAG, new StringBuilder(54).append("Unmapped track with id ").append(i).append(" of type ").append(i2).toString());
        ...
        public void sampleMetadata(long j, int i, int i2, int i3, TrackOutput.CryptoData cryptoData) {
            ...
            if (!Util.areEqual(this.format.sampleMimeType, this.delegateFormat.sampleMimeType)) {
                if (MimeTypes.APPLICATION_EMSG.equals(this.format.sampleMimeType)) {
                    ...
                    Log.w(HlsSampleStreamWrapper.TAG, valueOf.length() != 0 ? "Ignoring sample for unsupported format: ".concat(valueOf) : new String("Ignoring sample for unsupported format: "));
                    return;
                }
            }
