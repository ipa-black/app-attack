...
public final class HlsPlaylistParser implements ParsingLoadable.Parser<HlsPlaylist> {
    ...
    private static HlsMediaPlaylist parseMediaPlaylist(HlsMultivariantPlaylist hlsMultivariantPlaylist, HlsMediaPlaylist hlsMediaPlaylist, LineIterator lineIterator, String str) throws IOException {
                    ...
                    if (next.startsWith(TAG_MEDIA_SEQUENCE)) {
                        ...
                        if (next.startsWith(TAG_DEFINE)) {
                            ...
                            if (next.startsWith(TAG_SKIP)) {
                                ...
                                long j18 = j14;
                                while (i8 < i9) {
                                    HlsMediaPlaylist.Segment segment3 = hlsMediaPlaylist2.segments.get(i8);
                                    ...
                                    int i10 = segment3.relativeDiscontinuitySequence;
                                    HlsMediaPlaylist.Segment segment4 = segment3.initializationSegment;
                                    Object obj3 = segment3.drmInitData;
                                        ...
                                        if (next.startsWith(TAG_PROGRAM_DATE_TIME)) {
                                            ...
                                            if (next.startsWith(TAG_PRELOAD_HINT)) {
                                                if (part2 == null && TYPE_PART.equals(parseStringAttr(next, REGEX_PRELOAD_HINT_TYPE, hashMap))) {
                                                    ...
                                                    int i11 = (parseOptionalLongAttr > (-1L) ? 1 : (parseOptionalLongAttr == (-1L) ? 0 : -1));
                                                    if (i11 == 0 || parseOptionalLongAttr2 != -1) {
                                                        part2 = new HlsMediaPlaylist.Part(parseStringAttr4, segment2, 0L, i5, j12, obj2, str5, segmentEncryptionIV, i11 != 0 ? parseOptionalLongAttr : 0L, parseOptionalLongAttr2, false, false, true);
                                                    }
                                                    hlsMultivariantPlaylist2 = hlsMultivariantPlaylist;
                                                    hlsMediaPlaylist2 = hlsMediaPlaylist;
                                                    j15 = j19;
        ...
        HashMap hashMap3 = new HashMap();
        for (int i15 = z4 ? 1 : 0; i15 < arrayList5.size(); i15++) {
            ...
            if (i16 == -1 && j10 != C.TIME_UNSET) {
                i16 = (arrayList11.isEmpty() ? ((HlsMediaPlaylist.Segment) Iterables.getLast(arrayList3)).parts : arrayList11).size() - 1;
            }
            hashMap3.put(renditionReport.playlistUri, new HlsMediaPlaylist.RenditionReport(renditionReport.playlistUri, j21, i16));
        }
        if (part4 != null) {
            arrayList11.add(part4);
        }
        return new HlsMediaPlaylist(i14, str, arrayList12, j6, z6, j7, z7, i4, j8, i6, j9, j10, z5, z8, j7 != 0, drmInitData, arrayList3, arrayList11, serverControl2, hashMap3);
    }
    ...
    private static String parseStringAttr(String str, Pattern pattern, Map<String, String> map) throws ParserException {
        ...
        throw ParserException.createForMalformedManifest(new StringBuilder(String.valueOf(pattern2).length() + 19 + String.valueOf(str).length()).append("Couldn't match ").append(pattern2).append(" in ").append(str).toString(), null);
    }
