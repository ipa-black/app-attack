    ...
    public static final class InternalHandler extends Handler {
            ...
            if (str == null) {
                ...
                if (download != null) {
                    ...
                    try {
                        ...
                        Log.e(DownloadManager.TAG, valueOf.length() != 0 ? "Failed to set manual stop reason: ".concat(valueOf) : new String("Failed to set manual stop reason: "), e3);
                    }
                }
            }
            syncTasks();
        ...
        private void onTaskStopped(Task task) {
            ...
            if (exc != null) {
                ...
                Log.e(DownloadManager.TAG, new StringBuilder(String.valueOf(valueOf).length() + 20).append("Task failed: ").append(valueOf).append(", ").append(z).toString(), exc);
            }
        ...
        private Download getDownload(String str, boolean z) {
            ...
            if (z) {
                try {
                    ...
                    String valueOf = String.valueOf(str);
                    Log.e(DownloadManager.TAG, valueOf.length() != 0 ? "Failed to load download: ".concat(valueOf) : new String("Failed to load download: "), e2);
                    return null;
                }
            }
            return null;
