...
public abstract class DownloadService extends Service {
    ...
    public int onStartCommand(Intent intent, int i, int i2) {
        ...
        switch (c2) {
            ...
            default:
                ...
                Log.e(TAG, valueOf.length() != 0 ? "Ignored unrecognized action: ".concat(valueOf) : new String("Ignored unrecognized action: "));
                break;
        }
    ...
    public final class ForegroundNotificationUpdater {
        ...
        public void update() {
            ...
            if (!this.notificationDisplayed) {
                ...
                ((NotificationManager) DownloadService.this.getSystemService(OneSignalDbContract.NotificationTable.TABLE_NAME)).notify(this.notificationId, foregroundNotification);
            }
    ...
    public static final class DownloadManagerHelper implements DownloadManager.Listener {
        ...
        public void attachService(final DownloadService downloadService) {
            ...
            if (this.downloadManager.isInitialized()) {
                Util.createHandlerForCurrentOrMainLooper().postAtFrontOfQueue(new Runnable() { // from class: com.google.android.exoplayer2.offline.DownloadService$DownloadManagerHelper$$ExternalSyntheticLambda0
                    @Override // java.lang.Runnable
                    public final void run() {
                        DownloadService.DownloadManagerHelper.this.m356x5d17c8bb(downloadService);
                    }
                });
            }
        }
        ...
        public /* synthetic */ void m356x5d17c8bb(DownloadService downloadService) {
