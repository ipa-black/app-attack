...
public final class DownloadHelper {
    ...
    public static RendererCapabilities[] getRendererCapabilities(RenderersFactory renderersFactory) {
        ...
        }, new TextOutput() { // from class: com.google.android.exoplayer2.offline.DownloadHelper$$ExternalSyntheticLambda4
            @Override // com.google.android.exoplayer2.text.TextOutput
            public final void onCues(List list) {
                DownloadHelper.lambda$getRendererCapabilities$0(list);
            }
        }, new MetadataOutput() { // from class: com.google.android.exoplayer2.offline.DownloadHelper$$ExternalSyntheticLambda5
        ...
        if (this.mediaSource != null) {
            ...
            this.callbackHandler.post(new Runnable() { // from class: com.google.android.exoplayer2.offline.DownloadHelper$$ExternalSyntheticLambda3
                ...
                public final void run() {
                    DownloadHelper.this.m352xf9781d7d(callback);
                }
            });
        }
    }
    ...
    public /* synthetic */ void m352xf9781d7d(Callback callback) {
    ...
    public void onMediaPrepared() {
        ...
        ((Handler) Assertions.checkNotNull(this.callbackHandler)).post(new Runnable() { // from class: com.google.android.exoplayer2.offline.DownloadHelper$$ExternalSyntheticLambda6
            @Override // java.lang.Runnable
            public final void run() {
                DownloadHelper.this.m351xbc158121();
            }
        });
    }
    ...
    public /* synthetic */ void m351xbc158121() {
    ...
    public void onMediaPreparationFailed(final IOException iOException) {
        ((Handler) Assertions.checkNotNull(this.callbackHandler)).post(new Runnable() { // from class: com.google.android.exoplayer2.offline.DownloadHelper$$ExternalSyntheticLambda2
            @Override // java.lang.Runnable
            public final void run() {
                DownloadHelper.this.m350xa7571479(iOException);
            }
        });
    }
    ...
    public /* synthetic */ void m350xa7571479(IOException iOException) {
    ...
    private static MediaSource createMediaSourceInternal(MediaItem mediaItem, DataSource.Factory factory, final DrmSessionManager drmSessionManager) {
        return new DefaultMediaSourceFactory(factory, ExtractorsFactory.EMPTY).setDrmSessionManagerProvider(drmSessionManager != null ? new DrmSessionManagerProvider() { // from class: com.google.android.exoplayer2.offline.DownloadHelper$$ExternalSyntheticLambda1
        ...
        } : null).createMediaSource(mediaItem);
    }
