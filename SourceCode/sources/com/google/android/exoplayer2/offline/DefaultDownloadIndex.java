...
public final class DefaultDownloadIndex implements WritableDownloadIndex {
    ...
    public void setStopReason(String str, int i) throws DatabaseIOException {
        ...
        try {
            ...
            writableDatabase.update(str2, contentValues, new StringBuilder(String.valueOf(str3).length() + 11).append(str3).append(" AND id = ?").toString(), new String[]{str});
        } catch (SQLException e2) {
            throw new DatabaseIOException(e2);
        }
    }
            ...
            try {
                ...
                if (version != 3) {
                    ...
                    try {
                        ...
                        writableDatabase.execSQL(new StringBuilder(String.valueOf(str).length() + TTAdConstant.VIDEO_COVER_URL_CODE).append("CREATE TABLE ").append(str).append(" (id TEXT PRIMARY KEY NOT NULL,mime_type TEXT,uri TEXT NOT NULL,stream_keys TEXT NOT NULL,custom_cache_key TEXT,data BLOB NOT NULL,state INTEGER NOT NULL,start_time_ms INTEGER NOT NULL,update_time_ms INTEGER NOT NULL,content_length INTEGER NOT NULL,stop_reason INTEGER NOT NULL,failure_reason INTEGER NOT NULL,percent_downloaded REAL NOT NULL,bytes_downloaded INTEGER NOT NULL,key_set_id BLOB NOT NULL)").toString());
