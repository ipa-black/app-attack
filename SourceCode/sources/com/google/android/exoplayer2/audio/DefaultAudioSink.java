...
public final class DefaultAudioSink implements AudioSink {
    ...
    interface AudioTrackBufferSizeProvider {
        ...
        int getBufferSizeInBytes(int i, int i2, int i3, int i4, int i5, double d2);
    }
    ...
    public void configure(Format format, int i, int[] iArr) throws AudioSink.ConfigurationException {
        ...
        if (i8 == 0) {
            ...
            throw new AudioSink.ConfigurationException(new StringBuilder(String.valueOf(valueOf2).length() + 48).append("Invalid output encoding (mode=").append(i7).append(") for: ").append(valueOf2).toString(), format);
        } else if (intValue == 0) {
            String valueOf3 = String.valueOf(format);
            throw new AudioSink.ConfigurationException(new StringBuilder(String.valueOf(valueOf3).length() + 54).append("Invalid output channel config (mode=").append(i7).append(") for: ").append(valueOf3).toString(), format);
        } else {
    ...
    private static Pair<Integer, Integer> getEncodingAndChannelConfigForPassthrough(Format format, AudioCapabilities audioCapabilities) {
        ...
        if (encoding == 5 || encoding == 6 || encoding == 18 || encoding == 17 || encoding == 7 || encoding == 8 || encoding == 14) {
            ...
            if (audioCapabilities.supportsEncoding(encoding)) {
                if (encoding == 18) {
                    if (Util.SDK_INT >= 29) {
                        i = getMaxSupportedChannelCountForPassthroughV29(18, format.sampleRate != -1 ? format.sampleRate : OpusUtil.SAMPLE_RATE);
                        if (i == 0) {
