...
public final class Cea608Decoder extends CeaDecoder {
    ...
    private static final int[] SPECIAL_PT_DE_CHARACTER_SET = {195, 227, LossReason.LOSS_REASON_CREATIVE_FILTERED_ADVERTISER_EXCLUSIONS_VALUE, 204, 236, LossReason.LOSS_REASON_CREATIVE_FILTERED_AD_TYPE_EXCLUSIONS_VALUE, 242, 213, 245, 123, 125, 92, 94, 95, 124, 126, 196, 228, 214, 246, 223, 165, 164, 9474, 197, 229, 216, 248, 9484, 9488, 9492, 9496};
    ...
    */
    ...
    public static final class CueBuilder {
        ...
        public Cue build(int i) {
            ...
            return new Cue.Builder().setText(spannableStringBuilder).setTextAlignment(Layout.Alignment.ALIGN_NORMAL).setLine(i6, 1).setPosition(f2).setPositionAnchor(i).build();
        }
