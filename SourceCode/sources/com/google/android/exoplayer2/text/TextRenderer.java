...
public final class TextRenderer extends BaseRenderer implements Handler.Callback {
    ...
    private void handleDecoderError(SubtitleDecoderException subtitleDecoderException) {
        ...
        Log.e(TAG, new StringBuilder(String.valueOf(valueOf).length() + 39).append("Subtitle decoding failed. streamFormat=").append(valueOf).toString(), subtitleDecoderException);
        clearOutput();
        replaceDecoder();
    }
}
