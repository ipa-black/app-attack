...
public final class SsaStyle {
    ...
    public static SsaStyle fromStyleLine(String str, Format format) {
        ...
        try {
            ...
            Log.w(TAG, new StringBuilder(String.valueOf(str).length() + 36).append("Skipping malformed 'Style:' line: '").append(str).append("'").toString(), e2);
            return null;
        }
    }
    ...
    public static Integer parseColor(String str) {
        ...
        try {
            ...
            Assertions.checkArgument(parseLong <= ArrayUnsignedIntList.MAX_VALUE);
            ...
            Log.w(TAG, new StringBuilder(String.valueOf(str).length() + 36).append("Failed to parse color expression: '").append(str).append("'").toString(), e2);
            return null;
        }
    }
    ...
    private static float parseFontSize(String str) {
        try {
            ...
            Log.w(TAG, new StringBuilder(String.valueOf(str).length() + 29).append("Failed to parse font size: '").append(str).append("'").toString(), e2);
    ...
    private static boolean parseBooleanValue(String str) {
        try {
            ...
            Log.w(TAG, new StringBuilder(String.valueOf(str).length() + 33).append("Failed to parse boolean value: '").append(str).append("'").toString(), e2);
            return false;
        }
    }
