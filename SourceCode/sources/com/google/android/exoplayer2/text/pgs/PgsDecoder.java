    ...
    public static final class CueBuilder {
        ...
        public void parsePaletteSection(ParsableByteArray parsableByteArray, int i) {
            ...
            for (int i3 = 0; i3 < i2; i3++) {
                ...
                this.colors[readUnsignedByte] = (Util.constrainValue((int) ((d2 - (0.34414d * d4)) - (d3 * 0.71414d)), 0, 255) << 8) | (parsableByteArray.readUnsignedByte() << 24) | (Util.constrainValue((int) ((1.402d * d3) + d2), 0, 255) << 16) | Util.constrainValue((int) (d2 + (d4 * 1.772d)), 0, 255);
            }
            this.colorsSet = true;
        }
