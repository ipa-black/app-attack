...
public class AdaptiveTrackSelection extends BaseTrackSelection {
    ...
    public static class Factory implements ExoTrackSelection.Factory {
        ...
        public Factory(int i, int i2, int i3, float f2) {
            this(i, i2, i3, AdaptiveTrackSelection.DEFAULT_MAX_WIDTH_TO_DISCARD, AdaptiveTrackSelection.DEFAULT_MAX_HEIGHT_TO_DISCARD, f2, 0.75f, Clock.DEFAULT);
        }

        public Factory(int i, int i2, int i3, int i4, int i5, float f2) {
            this(i, i2, i3, i4, i5, f2, 0.75f, Clock.DEFAULT);
        }

        public Factory(int i, int i2, int i3, float f2, float f3, Clock clock) {
            this(i, i2, i3, AdaptiveTrackSelection.DEFAULT_MAX_WIDTH_TO_DISCARD, AdaptiveTrackSelection.DEFAULT_MAX_HEIGHT_TO_DISCARD, f2, f3, clock);
        }
    ...
    protected AdaptiveTrackSelection(TrackGroup trackGroup, int[] iArr, int i, BandwidthMeter bandwidthMeter, long j, long j2, long j3, int i2, int i3, float f2, float f3, List<AdaptationCheckpoint> list, Clock clock) {
    ...
    private long getTotalAllocatableBandwidth(long j) {
        ...
        float f2 = (float) j;
        return (((float) bitrateEstimate) * Math.max((f2 / this.playbackSpeed) - ((float) timeToFirstByteEstimateUs), 0.0f)) / f2;
    }
