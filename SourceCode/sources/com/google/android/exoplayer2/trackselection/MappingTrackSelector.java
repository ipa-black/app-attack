...
public abstract class MappingTrackSelector extends TrackSelector {
    ...
    public static final class MappedTrackInfo {
        ...
        public int getRendererSupport(int i) {
            int[][] iArr;
            int i2 = 0;
            for (int[] iArr2 : this.rendererFormatSupports[i]) {
                for (int i3 : iArr2) {
        ...
        for (int i = 0; i < mappedTrackInfo.getRendererCount(); i++) {
            ...
            for (int i2 = 0; i2 < trackGroups.length; i2++) {
                ...
                for (int i3 = 0; i3 < trackGroup.length; i3++) {
                    ...
                    zArr[i3] = (trackSelection == null || !trackSelection.getTrackGroup().equals(trackGroup) || trackSelection.indexOf(i3) == -1) ? false : true;
                }
                builder.add((ImmutableList.Builder) new TracksInfo.TrackGroupInfo(trackGroup, iArr, mappedTrackInfo.getRendererType(i), zArr));
            }
        }
