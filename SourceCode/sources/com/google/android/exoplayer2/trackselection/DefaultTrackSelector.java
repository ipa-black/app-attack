...
public class DefaultTrackSelector extends MappingTrackSelector {
    ...
    public static final class ParametersBuilder extends TrackSelectionParameters.Builder {
        ...
        private void setSelectionOverridesFromBundle(Bundle bundle) {
            ...
            List fromBundleNullableList = BundleableUtil.fromBundleNullableList(TrackGroupArray.CREATOR, bundle.getParcelableArrayList(Parameters.keyForField(1012)), ImmutableList.of());
        ...
        static {
            ...
            CREATOR = new Bundleable.Creator() { // from class: com.google.android.exoplayer2.trackselection.DefaultTrackSelector$Parameters$$ExternalSyntheticLambda0
                ...
                public final Bundleable fromBundle(Bundle bundle) {
                    ...
                    build2 = new DefaultTrackSelector.ParametersBuilder(bundle).build();
                    return build2;
                }
            };
        }
    ...
    protected final Pair<RendererConfiguration[], ExoTrackSelection[]> selectTracks(MappingTrackSelector.MappedTrackInfo mappedTrackInfo, int[][][] iArr, int[] iArr2, MediaSource.MediaPeriodId mediaPeriodId, Timeline timeline) throws ExoPlaybackException {
        ...
        for (int i4 = 0; i4 < rendererCount; i4++) {
            rendererConfigurationArr[i4] = (parameters.getRendererDisabled(i4) || parameters.disabledTrackTypes.contains(Integer.valueOf(mappedTrackInfo.getRendererType(i4))) || (mappedTrackInfo.getRendererType(i4) != -2 && createTrackSelections[i4] == null)) ? null : RendererConfiguration.DEFAULT;
        }
    ...
    protected Pair<ExoTrackSelection.Definition, Integer> selectAudioTrack(MappingTrackSelector.MappedTrackInfo mappedTrackInfo, int[][][] iArr, int[] iArr2, final Parameters parameters) throws ExoPlaybackException {
        ...
        return selectTracksForType(1, mappedTrackInfo, iArr, new TrackInfo.Factory() { // from class: com.google.android.exoplayer2.trackselection.DefaultTrackSelector$$ExternalSyntheticLambda4
            ...
            public final List create(int i2, TrackGroup trackGroup, int[] iArr3) {
                List createForTrackGroup;
                createForTrackGroup = DefaultTrackSelector.AudioTrackInfo.createForTrackGroup(i2, trackGroup, DefaultTrackSelector.Parameters.this, iArr3, z);
                return createForTrackGroup;
            }
    ...
    */
    ...
    public static final class AudioTrackInfo extends TrackInfo<AudioTrackInfo> implements Comparable<AudioTrackInfo> {
        ...
        public static ImmutableList<AudioTrackInfo> createForTrackGroup(int i, TrackGroup trackGroup, Parameters parameters, int[] iArr, boolean z) {
            ImmutableList.Builder builder = ImmutableList.builder();
            for (int i2 = 0; i2 < trackGroup.length; i2++) {
                builder.add((ImmutableList.Builder) new AudioTrackInfo(i, trackGroup, i2, parameters, iArr[i2], z));
            }
            return builder.build();
        }
