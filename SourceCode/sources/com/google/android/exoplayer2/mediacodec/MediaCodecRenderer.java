...
public abstract class MediaCodecRenderer extends BaseRenderer {
    ...
    public void render(long j, long j2) throws ExoPlaybackException {
        ...
        try {
            ...
            if (isMediaCodecException(e2)) {
                ...
                throw createRendererException(createDecoderException(e2, getCodecInfo()), this.inputFormat, z, PlaybackException.ERROR_CODE_DECODING_FAILED);
            }
            throw e2;
        }
    }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    private void maybeInitCodecWithFallback(android.media.MediaCrypto r9, boolean r10) throws com.google.android.exoplayer2.mediacodec.MediaCodecRenderer.DecoderInitializationException {
        /*
            r8 = this;
            java.util.ArrayDeque<com.google.android.exoplayer2.mediacodec.MediaCodecInfo> r0 = r8.availableCodecInfos
            r1 = 0
            if (r0 != 0) goto L39
            java.util.List r0 = r8.getAvailableCodecInfos(r10)     // Catch: com.google.android.exoplayer2.mediacodec.MediaCodecUtil.DecoderQueryException -> L2d
            java.util.ArrayDeque r2 = new java.util.ArrayDeque     // Catch: com.google.android.exoplayer2.mediacodec.MediaCodecUtil.DecoderQueryException -> L2d
            r2.<init>()     // Catch: com.google.android.exoplayer2.mediacodec.MediaCodecUtil.DecoderQueryException -> L2d
            r8.availableCodecInfos = r2     // Catch: com.google.android.exoplayer2.mediacodec.MediaCodecUtil.DecoderQueryException -> L2d
            boolean r3 = r8.enableDecoderFallback     // Catch: com.google.android.exoplayer2.mediacodec.MediaCodecUtil.DecoderQueryException -> L2d
            if (r3 == 0) goto L18
        ...
        L18:
            ...
            if (r2 != 0) goto L2a
            java.util.ArrayDeque<com.google.android.exoplayer2.mediacodec.MediaCodecInfo> r2 = r8.availableCodecInfos     // Catch: com.google.android.exoplayer2.mediacodec.MediaCodecUtil.DecoderQueryException -> L2d
            r3 = 0
        ...
        L2a:
            r8.preferredDecoderInitializationException = r1     // Catch: com.google.android.exoplayer2.mediacodec.MediaCodecUtil.DecoderQueryException -> L2d
            goto L39
        L2d:
            r9 = move-exception
        ...
        L49:
            com.google.android.exoplayer2.mediacodec.MediaCodecAdapter r2 = r8.codec
            if (r2 != 0) goto Lc1
            java.util.ArrayDeque<com.google.android.exoplayer2.mediacodec.MediaCodecInfo> r2 = r8.availableCodecInfos
            ...
            return
        L5c:
            r8.initCodec(r2, r9)     // Catch: java.lang.Exception -> L60
            goto L49
        L60:
            r3 = move-exception
            ...
            r8.initCodec(r2, r9)     // Catch: java.lang.Exception -> L74
            goto L49
        L73:
        ...
        L74:
            ...
            java.util.ArrayDeque<com.google.android.exoplayer2.mediacodec.MediaCodecInfo> r4 = r8.availableCodecInfos
            r4.removeFirst()
            com.google.android.exoplayer2.mediacodec.MediaCodecRenderer$DecoderInitializationException r4 = new com.google.android.exoplayer2.mediacodec.MediaCodecRenderer$DecoderInitializationException
            com.google.android.exoplayer2.Format r5 = r8.inputFormat
            r4.<init>(r5, r3, r10, r2)
            r8.onCodecError(r4)
            com.google.android.exoplayer2.mediacodec.MediaCodecRenderer$DecoderInitializationException r2 = r8.preferredDecoderInitializationException
            if (r2 != 0) goto Laf
            r8.preferredDecoderInitializationException = r4
            goto Lb5
        Laf:
            com.google.android.exoplayer2.mediacodec.MediaCodecRenderer$DecoderInitializationException r2 = com.google.android.exoplayer2.mediacodec.MediaCodecRenderer.DecoderInitializationException.access$000(r2, r4)
            r8.preferredDecoderInitializationException = r2
        Lb5:
            java.util.ArrayDeque<com.google.android.exoplayer2.mediacodec.MediaCodecInfo> r2 = r8.availableCodecInfos
            ...
            goto L49
        Lbe:
            com.google.android.exoplayer2.mediacodec.MediaCodecRenderer$DecoderInitializationException r9 = r8.preferredDecoderInitializationException
            throw r9
        Lc1:
            r8.availableCodecInfos = r1
            return
        Lc4:
    ...
    private List<MediaCodecInfo> getAvailableCodecInfos(boolean z) throws MediaCodecUtil.DecoderQueryException {
        ...
        if (decoderInfos.isEmpty() && z) {
            ...
            if (!decoderInfos.isEmpty()) {
                ...
                Log.w(TAG, new StringBuilder(String.valueOf(str).length() + 99 + String.valueOf(valueOf).length()).append("Drm session requires secure decoder for ").append(str).append(", but no secure decoder available. Trying to proceed with ").append(valueOf).append(".").toString());
            }
        }
        return decoderInfos;
    }
    ...
    */
    ...
    private void processOutputMediaFormatChanged() {
        ...
        if (this.codecAdaptationWorkaroundMode != 0 && outputFormat.getInteger(IabUtils.KEY_WIDTH) == 32 && outputFormat.getInteger(IabUtils.KEY_HEIGHT) == 32) {
    ...
    private FrameworkCryptoConfig getFrameworkCryptoConfig(DrmSession drmSession) throws ExoPlaybackException {
        ...
        if (cryptoConfig != null && !(cryptoConfig instanceof FrameworkCryptoConfig)) {
            ...
            throw createRendererException(new IllegalArgumentException(new StringBuilder(String.valueOf(valueOf).length() + 43).append("Expecting FrameworkCryptoConfig but found: ").append(valueOf).toString()), this.inputFormat, 6001);
        }
