...
class AsynchronousMediaCodecBufferEnqueuer {
    ...
    public void doHandleMessage(Message message) {
        ...
        if (i == 0) {
            ...
            if (i == 2) {
                ...
                b$$ExternalSyntheticBackportWithForwarding0.m(this.pendingRuntimeException, null, new IllegalStateException(String.valueOf(message.what)));
            }
        } else {
            messageParams = (MessageParams) message.obj;
    ...
    private void doQueueInputBuffer(int i, int i2, int i3, long j, int i4) {
        try {
            ...
            b$$ExternalSyntheticBackportWithForwarding0.m(this.pendingRuntimeException, null, e2);
        }
    }
