    ...
    */
                                ...
                                if (!(secureDecodersExplicit && codecKey.secure == isFeatureSupported2) && (secureDecodersExplicit || codecKey.secure)) {
                                    ...
                                    try {
                                        ...
                                        if (Util.SDK_INT <= 23 && !arrayList.isEmpty()) {
                                            Log.e(TAG, new StringBuilder(String.valueOf(str2).length() + 46).append("Skipping codec ").append(str2).append(" (failed to query capabilities)").toString());
                                            i3 = i + 1;
                                            codecCount = i2;
                                            secureDecodersExplicit = z;
                                        } else {
                                            String str4 = str2;
                                            Log.e(TAG, new StringBuilder(String.valueOf(str4).length() + 25 + String.valueOf(str).length()).append("Failed to query codec ").append(str4).append(" (").append(str).append(")").toString());
                                            throw e;
                                        }
                                    }
                                    i3 = i + 1;
    ...
    private static Pair<Integer, Integer> getAvcProfileAndLevel(String str, String[] strArr) {
        ...
        try {
            ...
            if (avcProfileNumberToConst == -1) {
                Log.w(TAG, new StringBuilder(32).append("Unknown AVC profile: ").append(i).toString());
                return null;
            }
            int avcLevelNumberToConst = avcLevelNumberToConst(parseInt);
            if (avcLevelNumberToConst == -1) {
                Log.w(TAG, new StringBuilder(30).append("Unknown AVC level: ").append(parseInt).toString());
                return null;
            }
    ...
    private static Pair<Integer, Integer> getVp9ProfileAndLevel(String str, String[] strArr) {
        ...
        try {
            ...
            if (vp9ProfileNumberToConst == -1) {
                Log.w(TAG, new StringBuilder(32).append("Unknown VP9 profile: ").append(parseInt).toString());
                return null;
            }
            int vp9LevelNumberToConst = vp9LevelNumberToConst(parseInt2);
            if (vp9LevelNumberToConst == -1) {
                Log.w(TAG, new StringBuilder(30).append("Unknown VP9 level: ").append(parseInt2).toString());
                return null;
            }
    ...
    private static Pair<Integer, Integer> getAv1ProfileAndLevel(String str, String[] strArr, ColorInfo colorInfo) {
        ...
        try {
            ...
            if (parseInt != 0) {
                Log.w(TAG, new StringBuilder(32).append("Unknown AV1 profile: ").append(parseInt).toString());
                return null;
            } else if (parseInt3 != 8 && parseInt3 != 10) {
                Log.w(TAG, new StringBuilder(34).append("Unknown AV1 bit depth: ").append(parseInt3).toString());
                return null;
            } else {
                if (parseInt3 != 8) {
                ...
                if (av1LevelNumberToConst == -1) {
                    Log.w(TAG, new StringBuilder(30).append("Unknown AV1 level: ").append(parseInt2).toString());
                    return null;
                }
