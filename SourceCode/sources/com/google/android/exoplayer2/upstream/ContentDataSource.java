    ...
    public long open(DataSpec dataSpec) throws ContentDataSourceException {
        ...
        try {
            ...
            if (openAssetFileDescriptor == null) {
                ...
                throw new ContentDataSourceException(new IOException(new StringBuilder(String.valueOf(valueOf).length() + 36).append("Could not open file descriptor for: ").append(valueOf).toString()), 2000);
            }
