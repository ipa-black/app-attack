...
public final class DataSchemeDataSource extends BaseDataSource {
    ...
    public long open(DataSpec dataSpec) throws IOException {
        ...
        if (split.length != 2) {
            ...
            throw ParserException.createForMalformedDataOfUnknownType(new StringBuilder(String.valueOf(valueOf2).length() + 23).append("Unexpected URI format: ").append(valueOf2).toString(), null);
        }
        String str = split[1];
