    ...
    */
    public synchronized boolean isCached(java.lang.String r4, long r5, long r7) {
        /*
            ...
            r2 = 0
            r0 = r0 ^ r1
            com.google.android.exoplayer2.util.Assertions.checkState(r0)     // Catch: java.lang.Throwable -> L1d
            com.google.android.exoplayer2.upstream.cache.CachedContentIndex r0 = r3.contentIndex     // Catch: java.lang.Throwable -> L1d
            com.google.android.exoplayer2.upstream.cache.CachedContent r4 = r0.get(r4)     // Catch: java.lang.Throwable -> L1d
            if (r4 == 0) goto L1a
    ...
    public void initialize() {
        ...
        if (loadUid == -1) {
            try {
                ...
                Log.e(TAG, sb2, e3);
                this.initializationException = new Cache.CacheException(sb2, e3);
                return;
            }
        }
        try {
            ...
            Log.e(TAG, sb3, e5);
            this.initializationException = new Cache.CacheException(sb3, e5);
        }
    }
