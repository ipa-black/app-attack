...
public class CachedContentIndex {
    ...
    public static DefaultContentMetadata readContentMetadata(DataInputStream dataInputStream) throws IOException {
        ...
        for (int i = 0; i < readInt; i++) {
            ...
            if (readInt2 < 0) {
                throw new IOException(new StringBuilder(31).append("Invalid value size: ").append(readInt2).toString());
            }
    ...
    private static final class DatabaseStorage implements Storage {
        ...
        private void initializeTable(SQLiteDatabase sQLiteDatabase) throws DatabaseIOException {
            ...
            sQLiteDatabase.execSQL(new StringBuilder(String.valueOf(str).length() + 88).append("CREATE TABLE ").append(str).append(" (id INTEGER PRIMARY KEY NOT NULL,key TEXT NOT NULL,metadata BLOB NOT NULL)").toString());
        }
