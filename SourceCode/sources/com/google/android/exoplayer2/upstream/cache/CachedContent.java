    ...
    public SimpleCacheSpan setLastTouchTimestamp(SimpleCacheSpan simpleCacheSpan, long j, boolean z) {
        ...
        if (z) {
            ...
            if (file.renameTo(cacheFile)) {
                ...
                Log.w(TAG, new StringBuilder(String.valueOf(valueOf).length() + 21 + String.valueOf(valueOf2).length()).append("Failed to rename ").append(valueOf).append(" to ").append(valueOf2).toString());
            }
        }
