    ...
    public long open(DataSpec dataSpec) throws RawResourceDataSourceException {
        ...
        try {
            ...
            if (openRawResourceFd == null) {
                ...
                throw new RawResourceDataSourceException(new StringBuilder(String.valueOf(valueOf3).length() + 24).append("Resource is compressed: ").append(valueOf3).toString(), null, 2000);
            }
