...
final class AudioFocusManager {
    ...
    private static int convertAudioAttributesToFocusGain(AudioAttributes audioAttributes) {
        ...
        switch (audioAttributes.usage) {
            ...
            case 15:
            default:
                Log.w(TAG, new StringBuilder(37).append("Unidentified audio usage: ").append(audioAttributes.usage).toString());
                return 0;
            case 16:
    ...
    private void setAudioFocusState(int i) {
        ...
        float f2 = i == 3 ? VOLUME_MULTIPLIER_DUCK : 1.0f;
    ...
    public void handlePlatformAudioFocusChange(int i) {
        if (i == -3 || i == -2) {
            ...
            Log.w(TAG, new StringBuilder(38).append("Unknown focus change type: ").append(i).toString());
        }
    }
    ...
    public class AudioFocusListener implements AudioManager.OnAudioFocusChangeListener {
        ...
        public /* synthetic */ void m307xa83e850b(int i) {
        ...
        public void onAudioFocusChange(final int i) {
            this.eventHandler.post(new Runnable() { // from class: com.google.android.exoplayer2.AudioFocusManager$AudioFocusListener$$ExternalSyntheticLambda0
                ...
                public final void run() {
                    AudioFocusManager.AudioFocusListener.this.m307xa83e850b(i);
                }
            });
        }
    }
