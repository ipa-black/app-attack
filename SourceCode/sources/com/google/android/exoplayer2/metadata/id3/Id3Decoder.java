...
public final class Id3Decoder extends SimpleMetadataDecoder {
    ...
    public Metadata decode(byte[] bArr, int i) {
        ...
        if (!validateFrames(parsableByteArray, decodeHeader.majorVersion, i2, false)) {
            if (decodeHeader.majorVersion != 4 || !validateFrames(parsableByteArray, 4, i2, true)) {
                Log.w(TAG, new StringBuilder(56).append("Failed to validate ID3 tag with majorVersion=").append(decodeHeader.majorVersion).toString());
                return null;
            }
            z = true;
        }
    ...
    private static Id3Header decodeHeader(ParsableByteArray parsableByteArray) {
        ...
        if (readUnsignedByte == 2) {
            ...
            Log.w(TAG, new StringBuilder(57).append("Skipped ID3 tag with unsupported majorVersion=").append(readUnsignedByte).toString());
            return null;
        } else {
            if ((readUnsignedByte2 & 64) != 0) {
    ...
    */
    ...
    private static PrivFrame decodePrivFrame(ParsableByteArray parsableByteArray, int i) throws UnsupportedEncodingException {
        ...
        return new PrivFrame(new String(bArr, 0, indexOfZeroByte, C.ISO88591_NAME), copyOfRangeIfValid(bArr, indexOfZeroByte + 1, i));
    }
    ...
    private static ApicFrame decodeApicFrame(ParsableByteArray parsableByteArray, int i, int i2) throws UnsupportedEncodingException {
        ...
        if (i2 == 2) {
            ...
            String lowerCase = Ascii.toLowerCase(new String(bArr, 0, indexOfZeroByte, C.ISO88591_NAME));
    ...
    private static ChapterFrame decodeChapterFrame(ParsableByteArray parsableByteArray, int i, int i2, boolean z, int i3, FramePredicate framePredicate) throws UnsupportedEncodingException {
        ...
        long j = readUnsignedInt == ArrayUnsignedIntList.MAX_VALUE ? -1L : readUnsignedInt;
        long readUnsignedInt2 = parsableByteArray.readUnsignedInt();
        long j2 = readUnsignedInt2 == ArrayUnsignedIntList.MAX_VALUE ? -1L : readUnsignedInt2;
        ArrayList arrayList = new ArrayList();
        int i4 = position + i;
