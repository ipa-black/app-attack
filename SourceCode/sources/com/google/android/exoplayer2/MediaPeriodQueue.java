...
public final class MediaPeriodQueue {
    ...
    */
    ...
    private void notifyQueueUpdate() {
        ...
        this.analyticsCollectorHandler.post(new Runnable() { // from class: com.google.android.exoplayer2.MediaPeriodQueue$$ExternalSyntheticLambda0
            ...
            public final void run() {
                MediaPeriodQueue.this.m320xb2cc2342(builder, mediaPeriodId);
            }
        });
    }
    ...
    public /* synthetic */ void m320xb2cc2342(ImmutableList.Builder builder, MediaSource.MediaPeriodId mediaPeriodId) {
