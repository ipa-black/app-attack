...
public class MediaCodecVideoRenderer extends MediaCodecRenderer {
    ...
    protected MediaFormat getMediaFormat(Format format, String str, CodecMaxValues codecMaxValues, float f2, boolean z, int i) {
        ...
        mediaFormat.setInteger(IabUtils.KEY_WIDTH, format.width);
        mediaFormat.setInteger(IabUtils.KEY_HEIGHT, format.height);
    ...
    */
    ...
    /* JADX WARN: Can't fix incorrect switch cases order, some code will duplicate */
    /* JADX WARN: Code restructure failed: missing block: B:581:0x07d2, code lost:
        if (r0.equals("PGN528") == false) goto L42;
     */
    /* JADX WARN: Code restructure failed: missing block: B:616:0x0840, code lost:
