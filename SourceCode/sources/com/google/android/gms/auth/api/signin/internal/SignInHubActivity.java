...
public class SignInHubActivity extends FragmentActivity {
    ...
    public void onCreate(Bundle bundle) {
        ...
        if ("com.google.android.gms.auth.NO_IMPL".equals(action)) {
            ...
            SignInConfiguration signInConfiguration = (SignInConfiguration) intent.getBundleExtra(Constants.CONFIG).getParcelable(Constants.CONFIG);
            ...
            if (signInConfiguration == null) {
                ...
                intent2.putExtra(Constants.CONFIG, this.zzbv);
                try {
