...
public final class zzd implements Runnable {
    ...
    public final void run() {
        ...
        try {
            ...
            logger.e(valueOf2.length() != 0 ? "IOException when revoking access: ".concat(valueOf2) : new String("IOException when revoking access: "), new Object[0]);
        } catch (Exception e3) {
            Logger logger2 = zzbd;
            String valueOf3 = String.valueOf(e3.toString());
            logger2.e(valueOf3.length() != 0 ? "Exception when revoking access: ".concat(valueOf3) : new String("Exception when revoking access: "), new Object[0]);
        }
