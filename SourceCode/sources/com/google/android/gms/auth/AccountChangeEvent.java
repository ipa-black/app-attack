...
public class AccountChangeEvent extends AbstractSafeParcelable {
    ...
    public String toString() {
        ...
        return new StringBuilder(String.valueOf(str2).length() + 91 + str.length() + String.valueOf(str3).length()).append("AccountChangeEvent {accountName = ").append(str2).append(", changeType = ").append(str).append(", changeData = ").append(str3).append(", eventIndex = ").append(this.zzi).append("}").toString();
    }
