...
public final class zzr {
    ...
    public zzr(Context context, String str) {
        ...
        try {
            ...
            com.google.android.gms.ads.internal.util.zze.zzh("Unable to get package version name for reporting", e2);
    ...
    public final void zzf(com.google.android.gms.ads.internal.client.zzl zzlVar, zzchu zzchuVar) {
        ...
        this.zzc.put("SDKVersion", zzchuVar.zza);
        if (((Boolean) zzbkn.zza.zze()).booleanValue()) {
            try {
                Bundle zzc = zzezj.zzc(this.zza, new JSONArray((String) zzbkn.zzb.zze()));
                for (String str3 : zzc.keySet()) {
                    this.zzc.put(str3, zzc.get(str3).toString());
                }
            } catch (JSONException e2) {
                com.google.android.gms.ads.internal.util.zze.zzh("Flag gads:afs:csa_tcf_data_to_collect not a valid JSON array", e2);
            }
        }
    }
}
