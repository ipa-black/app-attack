...
public final class zzbu {
    ...
    public static String zzl(zzfiq zzfiqVar) {
        if (zzfiqVar == null) {
            return null;
        }
        ...
        try {
            ...
            zzn(jsonWriter, zzfiqVar);
            jsonWriter.close();
            return stringWriter.toString();
        } catch (IOException e2) {
            zze.zzh("Error when writing JSON.", e2);
            return null;
        }
    }
    ...
    private static void zzn(JsonWriter jsonWriter, Object obj) throws IOException {
        if (obj == null) {
            ...
            jsonWriter.value((String) obj);
        } else if (obj instanceof zzfiq) {
            zzj(jsonWriter, ((zzfiq) obj).zzd);
