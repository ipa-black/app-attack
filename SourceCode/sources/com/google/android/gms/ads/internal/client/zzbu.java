...
public interface zzbu extends IInterface {
    ...
    void zzC(zzbe zzbeVar) throws RemoteException;

    void zzD(zzbh zzbhVar) throws RemoteException;

    void zzE(zzby zzbyVar) throws RemoteException;

    void zzF(zzq zzqVar) throws RemoteException;

    void zzG(zzcb zzcbVar) throws RemoteException;
    ...
    void zzO(zzbke zzbkeVar) throws RemoteException;
    ...
    void zzS(zzccx zzccxVar) throws RemoteException;
