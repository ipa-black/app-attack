...
public final class zzag extends zzgk {
    ...
    private final String zzB(String str, String str2) {
        try {
            String str3 = (String) Class.forName("android.os.SystemProperties").getMethod(Constants.GET, String.class, String.class).invoke(null, str, "");
    ...
    */
    ...
    public final boolean zzs(String str, zzdt zzdtVar) {
        ...
        return ((Boolean) zzdtVar.zza(Boolean.valueOf(IcyHeaders.REQUEST_HEADER_ENABLE_METADATA_VALUE.equals(zza)))).booleanValue();
    }
