...
public final class zzgj extends zzdw {
    ...
    public final List zze(zzq zzqVar, boolean z) {
        ...
        try {
            ...
            this.zza.zzay().zzd().zzc("Failed to get user properties. appId", zzeh.zzn(zzqVar.zza), e2);
            return null;
        }
    }
    ...
    public final List zzh(String str, String str2, boolean z, zzq zzqVar) {
        ...
        try {
            ...
            this.zza.zzay().zzd().zzc("Failed to query user properties. appId", zzeh.zzn(zzqVar.zza), e2);
            return Collections.emptyList();
        }
    }
    ...
    public final List zzi(String str, String str2, String str3, boolean z) {
        ...
        try {
            ...
            this.zza.zzay().zzd().zzc("Failed to get user properties as. appId", zzeh.zzn(str), e2);
            return Collections.emptyList();
        }
    }
    ...
    public final byte[] zzu(zzaw zzawVar, String str) {
        ...
        try {
            ...
            this.zza.zzay().zzd().zzd("Failed to log and bundle. appId, event, error", zzeh.zzn(str), this.zza.zzj().zzd(zzawVar.zza), e2);
            return null;
        }
    }
    ...
    public final /* synthetic */ void zzw(String str, Bundle bundle) {
        ...
        try {
            ...
            zzi.zzt.zzay().zzd().zzc("Error storing default event parameters. appId", zzeh.zzn(str), e2);
        }
    }
