                ...
                if (zzj == null) {
                    ...
                    if (zzh.zzi(zzah.AD_STORAGE) && zzj.zzah()) {
                        ...
                        if (zzj.zzah() && !TextUtils.isEmpty((CharSequence) zzd.first)) {
                            try {
                                ...
                                zzr.zzt.zzay().zzc().zzb("Resettable device id encryption failed", e2.getMessage());
                                bArr = new byte[0];
                                zzktVar3 = zzr.zzf;
                            }
                        }
                    ...
                    try {
                        ...
                        if (zzkyVar == null || zzkyVar.zze == null) {
                            zzky zzkyVar2 = new zzky(zzt2, "auto", "_lte", zzr.zzt.zzav().currentTimeMillis(), 0L);
                            zzu.add(zzkyVar2);
                        ...
                        if (zzu2.zzt.zzg().zze()) {
                            ...
                            if (zzj.zzah() && zzu2.zzf.zzo().zzn(zzt3)) {
                                ...
                                zzu.add(new zzky(zzt3, "auto", "_npa", zzu2.zzt.zzav().currentTimeMillis(), 1L));
                            }
                        }
                        ...
                        for (int i = 0; i < zzu.size(); i++) {
                            ...
                            zzgmVarArr[i] = (com.google.android.gms.internal.measurement.zzgm) zzd2.zzaC();
                        }
                        ...
                        try {
                            ...
                            zzr.zzt.zzay().zzd().zzc("Data loss. Failed to bundle and serialize. appId", zzeh.zzn(str3), e3);
                            return str2;
                        }
                    } catch (SecurityException e4) {
                        zzr.zzt.zzay().zzc().zzb("app instance id encryption failed", e4.getMessage());
