...
public abstract class zzba implements Iterable, Serializable {
    ...
    public final String toString() {
        return String.format(Locale.ROOT, "<ByteString@%s size=%d contents=\"%s\">", Integer.toHexString(System.identityHashCode(this)), Integer.valueOf(zzd()), zzd() <= 50 ? zzee.zza(this) : zzee.zza(zzf(0, 47)).concat(APSSharedUtil.TRUNCATE_SEPARATOR));
    }
