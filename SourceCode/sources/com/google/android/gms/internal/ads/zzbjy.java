...
public final class zzbjy {
    ...
    public static final zzbjv zzf() {
        return new zzbjv(com.google.android.gms.ads.internal.zzt.zzB().elapsedRealtime(), null, null);
    }
    ...
    public final zzbjx zza() {
        ...
        synchronized (this.zzc) {
            for (zzbjv zzbjvVar : this.zza) {
                long zza = zzbjvVar.zza();
                String zzc = zzbjvVar.zzc();
                zzbjv zzb = zzbjvVar.zzb();
                if (zzb != null && zza > 0) {
                    sb.append(zzc);
                    sb.append('.');
            ...
            zzbjxVar = new zzbjx(sb.toString(), str);
        }
        return zzbjxVar;
    }
    ...
    public final void zzc(zzbjy zzbjyVar) {
        synchronized (this.zzc) {
        }
    }
    ...
    public final void zzd(String str, String str2) {
        ...
        synchronized (this.zzc) {
            zzbju zza = zzf.zza(str);
            Map map = this.zzb;
            map.put(str, zza.zza((String) map.get(str), str2));
        }
    }

    public final boolean zze(zzbjv zzbjvVar, long j, String... strArr) {
        synchronized (this.zzc) {
            for (int i = 0; i <= 0; i++) {
                this.zza.add(new zzbjv(j, strArr[i], zzbjvVar));
            }
        }
        return true;
    }
