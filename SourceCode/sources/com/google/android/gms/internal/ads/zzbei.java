...
public final class zzbei extends AbstractSafeParcelable {
    ...
    public static zzbei zza(Uri uri) {
        try {
            if ("gcache".equals(uri.getScheme())) {
                List<String> pathSegments = uri.getPathSegments();
                if (pathSegments.size() != 2) {
                    int size = pathSegments.size();
                    com.google.android.gms.ads.internal.util.zze.zzj("Expected 2 path parts for namespace and id, found :" + size);
                    return null;
                }
            ...
            com.google.android.gms.ads.internal.util.zze.zzk("Unable to parse Uri into cache offering.", e2);
            return null;
        }
    }
