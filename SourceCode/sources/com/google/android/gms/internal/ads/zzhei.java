...
public final class zzhei {
    ...
    public final boolean equals(Object obj) {
        ...
        zzhei zzheiVar = (zzhei) obj;
        return Double.compare(zzheiVar.zzh, this.zzh) == 0 && Double.compare(zzheiVar.zzi, this.zzi) == 0 && Double.compare(zzheiVar.zzj, this.zzj) == 0 && Double.compare(zzheiVar.zzk, this.zzk) == 0 && Double.compare(zzheiVar.zzl, this.zzl) == 0 && Double.compare(zzheiVar.zzm, this.zzm) == 0 && Double.compare(zzheiVar.zze, this.zze) == 0 && Double.compare(zzheiVar.zzf, this.zzf) == 0 && Double.compare(zzheiVar.zzg, this.zzg) == 0;
    }
