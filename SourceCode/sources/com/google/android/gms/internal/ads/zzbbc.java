...
public final class zzbbc extends HandlerThread implements SurfaceTexture.OnFrameAvailableListener, Handler.Callback {
    ...
    public final boolean handleMessage(Message message) {
        ...
        try {
            ...
            try {
                ...
                zzbaj.zzf(eglGetDisplay != null, "eglGetDisplay failed");
                int[] iArr = new int[2];
                zzbaj.zzf(EGL14.eglInitialize(eglGetDisplay, iArr, 0, iArr, 1), "eglInitialize failed");
                EGLConfig[] eGLConfigArr = new EGLConfig[1];
                int[] iArr2 = new int[1];
                zzbaj.zzf(EGL14.eglChooseConfig(eglGetDisplay, new int[]{12352, 4, 12324, 8, 12323, 8, 12322, 8, 12321, 8, 12325, 0, 12327, 12344, 12339, 4, 12344}, 0, eGLConfigArr, 0, 1, iArr2, 0) && iArr2[0] > 0 && eGLConfigArr[0] != null, "eglChooseConfig failed");
                ...
                zzbaj.zzf(eglCreateContext != null, "eglCreateContext failed");
                ...
                zzbaj.zzf(eglCreatePbufferSurface != null, "eglCreatePbufferSurface failed");
                zzbaj.zzf(EGL14.eglMakeCurrent(eglGetDisplay, eglCreatePbufferSurface, eglCreatePbufferSurface, eglCreateContext), "eglMakeCurrent failed");
                ...
                this.zzf = new zzbbe(this, this.zzc, z, null);
                synchronized (this) {
                    notify();
                }
            } catch (Error e2) {
    ...
    public final zzbbe zza(boolean z) {
        boolean z2;
        start();
