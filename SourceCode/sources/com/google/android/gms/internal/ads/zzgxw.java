...
final class zzgxw extends zzgwf implements RandomAccess, zzgym, zzgzu {
    private static final zzgxw zza;
    private float[] zzb;
    private int zzc;

    static {
        zzgxw zzgxwVar = new zzgxw(new float[0], 0);
        zza = zzgxwVar;
        zzgxwVar.zzb();
    }
    ...
    public final boolean addAll(Collection collection) {
        ...
        if (Integer.MAX_VALUE - i2 >= i) {
            ...
            System.arraycopy(zzgxwVar.zzb, 0, this.zzb, this.zzc, zzgxwVar.zzc);
            this.zzc = i3;
            this.modCount++;
            return true;
        }
    ...
    public final boolean equals(Object obj) {
        ...
        if (this.zzc != zzgxwVar.zzc) {
            return false;
        }
        float[] fArr = zzgxwVar.zzb;
    ...
    public final /* bridge */ /* synthetic */ zzgym zzd(int i) {
        ...
        return new zzgxw(Arrays.copyOf(this.zzb, i), this.zzc);
    }
    ...
    private zzgxw(float[] fArr, int i) {
        this.zzb = fArr;
        this.zzc = i;
    }
