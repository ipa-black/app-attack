        ...
        if ("tick".equals(str)) {
            ...
            if (TextUtils.isEmpty(str2)) {
                ...
                try {
                    ...
                    zzcnoVar.zzo().zzc(str2, str3, elapsedRealtime);
                } catch (NumberFormatException e2) {
                    com.google.android.gms.ads.internal.util.zze.zzk("Malformed timestamp for CSI tick.", e2);
                }
            }
            ...
            if (TextUtils.isEmpty(str7)) {
                ...
                zzcnoVar.zzo().zza().zzd(str6, str7);
            }
        }
    }
}
