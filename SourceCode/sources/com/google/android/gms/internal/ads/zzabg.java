...
public final class zzabg {
    ...
    public zzabg(int i, int i2, long j, int i3, zzaaq zzaaqVar) {
        i2 = i2 != 1 ? 2 : i2;
        this.zzd = j;
        this.zze = i3;
        this.zza = zzaaqVar;
    ...
    private final zzaan zzk(int i) {
        return new zzaan(this.zzl[i] * zzj(1), this.zzk[i]);
    }

    public final zzaak zza(long j) {
        int zzj = (int) (j / zzj(1));
        int zzc = zzen.zzc(this.zzl, zzj, true, true);
        if (this.zzl[zzc] == zzj) {
            zzaan zzk = zzk(zzc);
            return new zzaak(zzk, zzk);
        }
        zzaan zzk2 = zzk(zzc);
        int i = zzc + 1;
        return i < this.zzk.length ? new zzaak(zzk2, zzk(i)) : new zzaak(zzk2, zzk2);
    }
    ...
    public final boolean zzh(zzzk zzzkVar) throws IOException {
        int i = this.zzg;
        int zze = i - this.zza.zze(zzzkVar, i, false);
        this.zzg = zze;
        boolean z = zze == 0;
        if (z) {
            if (this.zzf > 0) {
