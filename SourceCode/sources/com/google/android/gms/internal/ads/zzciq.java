...
final class zzciq extends zzcir implements ViewTreeObserver.OnScrollChangedListener {
    private final WeakReference zza;

    public zzciq(View view, ViewTreeObserver.OnScrollChangedListener onScrollChangedListener) {
        super(view);
