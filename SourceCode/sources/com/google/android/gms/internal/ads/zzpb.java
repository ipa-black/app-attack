...
final class zzpb {
    ...
    public zzpb(int i, int i2, float f2, float f3, int i3) {
        this.zza = i;
        this.zzb = i2;
        this.zzc = f2;
        this.zzd = f3;
    ...
    public final void zze() {
        ...
        float f2 = this.zzc;
        float f3 = this.zzd;
        int i3 = this.zzm + ((int) ((((i2 / (f2 / f3)) + this.zzo) / (this.zze * f3)) + 0.5f));
        short[] sArr = this.zzj;
        int i4 = this.zzh;
                    ...
                    if (i13 > 0) {
                        ...
                        if (d2 > 1.0d) {
                            ...
                            if (f4 >= 2.0f) {
                                ...
                                this.zzr = (int) ((i23 * (2.0f - f4)) / ((-1.0f) + f4));
                                i3 = i23;
                            }
                            ...
                            if (f4 < 0.5f) {
                                ...
                                this.zzr = (int) ((i25 * ((f4 + f4) - 1.0f)) / (f6 - f4));
                                i2 = i25;
                            }
                            int i26 = i25 + i2;
