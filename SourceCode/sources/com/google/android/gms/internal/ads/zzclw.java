...
public final class zzclw implements Runnable {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public zzclw(zzcma zzcmaVar, String str, String str2, int i, int i2, long j, long j2, boolean z, int i3, int i4) {
        this.zzj = zzcmaVar;
        this.zza = str;
        this.zzb = str2;
        this.zzc = i;
    ...
    public final void run() {
        ...
        hashMap.put("cacheReady", true != this.zzg ? "0" : IcyHeaders.REQUEST_HEADER_ENABLE_METADATA_VALUE);
