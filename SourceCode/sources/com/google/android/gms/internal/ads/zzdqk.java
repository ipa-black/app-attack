...
public final class zzdqk extends zzdql {
    ...
    public zzdqk(zzfil zzfilVar, JSONObject jSONObject) {
        ...
        this.zzh = ((Boolean) com.google.android.gms.ads.internal.client.zzba.zzc().zzb(zzbjj.zzeC)).booleanValue() ? jSONObject.optJSONObject("omid_settings") : null;
    }

    @Override // com.google.android.gms.internal.ads.zzdql
    public final zzfjj zza() {
        JSONObject jSONObject = this.zzh;
        return jSONObject != null ? new zzfjj(jSONObject) : this.zza.zzW;
    }
