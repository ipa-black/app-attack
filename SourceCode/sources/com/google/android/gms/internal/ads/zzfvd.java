...
class zzfvd {
    ...
    public zzfvd(Context context, String str, String str2, String str3) {
    ...
    public final zzfvc zzb(String str, String str2, long j, boolean z) throws IOException {
        ...
        String zze2 = zze(z2);
        if (zze2 != null || z) {
            return new zzfvc(zze2, zza(z2));
        }
        return zzc(str, str2);
    }

    final zzfvc zzc(String str, String str2) throws IOException {
        if (str == null) {
    ...
    final zzfvc zzd(String str, boolean z) throws IOException {
        long currentTimeMillis = System.currentTimeMillis();
        if (currentTimeMillis < 0) {
            throw new IllegalStateException(this.zzg.concat(": Invalid negative current timestamp. Updating PAID failed"));
        }
