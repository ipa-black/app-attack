...
final class zzgxm extends zzgwf implements RandomAccess, zzgym, zzgzu {
    private static final zzgxm zza;
    private double[] zzb;
    private int zzc;

    static {
        zzgxm zzgxmVar = new zzgxm(new double[0], 0);
        zza = zzgxmVar;
        zzgxmVar.zzb();
    }
    ...
    public final boolean addAll(Collection collection) {
        ...
        if (Integer.MAX_VALUE - i2 >= i) {
            ...
            System.arraycopy(zzgxmVar.zzb, 0, this.zzb, this.zzc, zzgxmVar.zzc);
            this.zzc = i3;
            this.modCount++;
            return true;
        }
    ...
    public final boolean equals(Object obj) {
        ...
        if (this.zzc != zzgxmVar.zzc) {
            return false;
        }
        double[] dArr = zzgxmVar.zzb;
    ...
    public final int hashCode() {
        ...
        for (int i2 = 0; i2 < this.zzc; i2++) {
            i = (i * 31) + zzgyn.zzc(Double.doubleToLongBits(this.zzb[i2]));
        }
        return i;
    }
    ...
    public final /* bridge */ /* synthetic */ zzgym zzd(int i) {
        ...
        return new zzgxm(Arrays.copyOf(this.zzb, i), this.zzc);
    }
    ...
    private zzgxm(double[] dArr, int i) {
        this.zzb = dArr;
        this.zzc = i;
    }
