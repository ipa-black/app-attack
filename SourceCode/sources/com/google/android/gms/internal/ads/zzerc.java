...
public final class zzerc extends com.google.android.gms.ads.internal.client.zzbt {
    ...
    public final void zzP(com.google.android.gms.ads.internal.client.zzdg zzdgVar) {
        if (((Boolean) com.google.android.gms.ads.internal.client.zzba.zzc().zzb(zzbjj.zzjA)).booleanValue()) {
            zzesb zzesbVar = this.zzc.zzc;
            if (zzesbVar != null) {
                zzesbVar.zzh(zzdgVar);
                return;
            }
            return;
        }
