...
public final class zzcnn extends WebChromeClient {
    private final zzcno zza;

    public zzcnn(zzcno zzcnoVar) {
        this.zza = zzcnoVar;
    }
    ...
    private static final Context zzb(WebView webView) {
        ...
        return zzk != null ? zzk : zzcnoVar.getContext();
    }
    ...
    public final void onCloseWindow(WebView webView) {
        ...
        com.google.android.gms.ads.internal.overlay.zzl zzN = ((zzcno) webView).zzN();
        if (zzN == null) {
    ...
    public final boolean onConsoleMessage(ConsoleMessage consoleMessage) {
        ...
        int i = zzcnm.zza[consoleMessage.messageLevel().ordinal()];
        if (i == 1) {
    ...
    protected final boolean zza(Context context, String str, String str2, String str3, String str4, JsResult jsResult, JsPromptResult jsPromptResult, boolean z) {
        ...
        try {
            ...
            com.google.android.gms.ads.internal.util.zze.zzk("Fail to display Dialog.", e2);
        }
        if (zzcnoVar == null || zzcnoVar.zzP() == null || this.zza.zzP().zzd() == null || (zzd = this.zza.zzP().zzd()) == null || zzd.zzc()) {
            com.google.android.gms.ads.internal.zzt.zzp();
            AlertDialog.Builder zzG = com.google.android.gms.ads.internal.util.zzs.zzG(context);
            zzG.setTitle(str2);
            if (!z) {
                zzG.setMessage(str3).setPositiveButton(17039370, new zzcni(jsResult)).setNegativeButton(17039360, new zzcnh(jsResult)).setOnCancelListener(new zzcng(jsResult)).create().show();
            } else {
                ...
                zzG.setView(linearLayout).setPositiveButton(17039370, new zzcnl(jsPromptResult, editText)).setNegativeButton(17039360, new zzcnk(jsPromptResult)).setOnCancelListener(new zzcnj(jsPromptResult)).create().show();
            }
            return true;
        }
