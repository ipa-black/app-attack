...
public final class zzfqy {
    ...
    private static final String[] zzc = {"x", "y", IabUtils.KEY_WIDTH, IabUtils.KEY_HEIGHT};
    ...
    public static JSONObject zza(int i, int i2, int i3, int i4) {
        ...
        try {
            ...
            jSONObject.put(IabUtils.KEY_WIDTH, i3 / zza);
            jSONObject.put(IabUtils.KEY_HEIGHT, i4 / zza);
        } catch (JSONException e2) {
            zzfqz.zza("Error with creating viewStateObject", e2);
        }
        return jSONObject;
    }
    ...
    public static void zzb(JSONObject jSONObject, String str) {
        try {
            ...
            zzfqz.zza("Error with setting ad session id", e2);
        }
    }
    ...
    public static void zzd(JSONObject jSONObject, zzfrc zzfrcVar) {
        ...
        try {
            ...
            zzfqz.zza("Error with setting friendly obstruction", e2);
        }
    }
    ...
    public static void zze(JSONObject jSONObject, Boolean bool) {
        try {
            ...
            zzfqz.zza("Error with setting not visible reason", e2);
        }
    }
    ...
    public static void zzh(JSONObject jSONObject, String str, Object obj) {
        try {
            ...
            zzfqz.zza("JSONException during JSONObject.put for name [" + str + "]", e2);
        }
    }
    ...
    public static void zzi(JSONObject jSONObject) {
        ...
        try {
            jSONObject.put(IabUtils.KEY_WIDTH, f2);
            jSONObject.put(IabUtils.KEY_HEIGHT, f3);
        } catch (JSONException e2) {
            e2.printStackTrace();
        }
    }
