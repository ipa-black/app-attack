...
public final class zzarf extends zzarx {
    ...
    public zzarf(zzaqj zzaqjVar, String str, String str2, zzaml zzamlVar, int i, int i2, Map map, View view, Context context) {
        super(zzaqjVar, "FdWssDbNTznwvaSwEiy9othUceULqhXS0NiSaXeIdQIZaN4heVunXmsWFB1bgBsj", "TzSf4nrBofZD4sG4/0KqSG9VhwNKl95AgxoEIclkVIM=", zzamlVar, i, 85);
        this.zzi = map;
        this.zzj = view;
        this.zzk = context;
    }
