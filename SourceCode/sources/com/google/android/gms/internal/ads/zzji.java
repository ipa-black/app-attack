...
final class zzji {
    ...
    public zzji(zzsh zzshVar, long j, long j2, long j3, long j4, boolean z, boolean z2, boolean z3, boolean z4) {
        boolean z5 = true;
        zzdd.zzd(!z4 || z2);
        if (z3 && !z2) {
            z5 = false;
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj != null && getClass() == obj.getClass()) {
            ...
            if (this.zzb == zzjiVar.zzb && this.zzc == zzjiVar.zzc && this.zzd == zzjiVar.zzd && this.zze == zzjiVar.zze && this.zzg == zzjiVar.zzg && this.zzh == zzjiVar.zzh && this.zzi == zzjiVar.zzi && zzen.zzT(this.zza, zzjiVar.zza)) {
                return true;
            }
        }
        return false;
