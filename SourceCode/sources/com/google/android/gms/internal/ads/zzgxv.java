...
public enum zzgxv {
    ...
    private static final zzgxv[] zzZ;
    ...
    static {
        zzgxv[] values = values();
        zzZ = new zzgxv[values.length];
        for (zzgxv zzgxvVar : values) {
            zzZ[zzgxvVar.zzac] = zzgxvVar;
        }
    }

    zzgxv(int i, int i2, zzgyr zzgyrVar) {
        this.zzac = i;
        this.zzab = zzgyrVar;
        zzgyr zzgyrVar2 = zzgyr.VOID;
        int i3 = i2 - 1;
        if (i3 == 1) {
            this.zzad = zzgyrVar.zza();
        } else if (i3 != 3) {
            this.zzad = null;
        } else {
            this.zzad = zzgyrVar.zza();
