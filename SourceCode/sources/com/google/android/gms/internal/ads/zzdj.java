...
public final class zzdj implements SurfaceTexture.OnFrameAvailableListener, Runnable {
    ...
    public final void zzb(int i) throws zzdk {
        ...
        int[] iArr = new int[2];
        zzdl.zza(EGL14.eglInitialize(eglGetDisplay, iArr, 0, iArr, 1), "eglInitialize failed");
        this.zzd = eglGetDisplay;
        EGLConfig[] eGLConfigArr = new EGLConfig[1];
        int[] iArr2 = new int[1];
        boolean eglChooseConfig = EGL14.eglChooseConfig(eglGetDisplay, zza, 0, eGLConfigArr, 0, 1, iArr2, 0);
        zzdl.zza(eglChooseConfig && iArr2[0] > 0 && eGLConfigArr[0] != null, zzen.zzI("eglChooseConfig failed: success=%b, numConfigs[0]=%d, configs[0]=%s", Boolean.valueOf(eglChooseConfig), Integer.valueOf(iArr2[0]), eGLConfigArr[0]));
