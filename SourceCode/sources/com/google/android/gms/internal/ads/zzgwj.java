...
final class zzgwj extends zzgwf implements RandomAccess, zzgym, zzgzu {
    private static final zzgwj zza;
    private boolean[] zzb;
    private int zzc;

    static {
        zzgwj zzgwjVar = new zzgwj(new boolean[0], 0);
        zza = zzgwjVar;
        zzgwjVar.zzb();
    }
    ...
    public final boolean addAll(Collection collection) {
        ...
        if (!(collection instanceof zzgwj)) {
        ...
        if (Integer.MAX_VALUE - i2 >= i) {
            ...
            System.arraycopy(zzgwjVar.zzb, 0, this.zzb, this.zzc, zzgwjVar.zzc);
            this.zzc = i3;
            this.modCount++;
            return true;
        }
    ...
    public final boolean equals(Object obj) {
        ...
        if (this.zzc != zzgwjVar.zzc) {
            return false;
        }
        boolean[] zArr = zzgwjVar.zzb;
    ...
    public final /* bridge */ /* synthetic */ zzgym zzd(int i) {
        ...
        return new zzgwj(Arrays.copyOf(this.zzb, i), this.zzc);
    }
    ...
    private zzgwj(boolean[] zArr, int i) {
        this.zzb = zArr;
        this.zzc = i;
    }
