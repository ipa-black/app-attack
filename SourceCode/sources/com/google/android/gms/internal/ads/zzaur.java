...
final class zzaur {
    ...
    public final void zzc() {
        ...
        float f2 = this.zzo;
        float f3 = this.zzp;
        int i3 = this.zzr + ((int) ((((i2 / (f2 / f3)) + this.zzs) / f3) + 0.5f));
        int i4 = this.zze;
        zzj(i4 + i4 + i2);
        int i5 = 0;
        while (true) {
                ...
                while (true) {
                    ...
                    if (i13 > 0) {
                        ...
                        if (this.zzb == i10 && i15 == i10) {
                            i = zzg(sArr, i12, this.zzc, this.zzd);
                        } else {
                            zzi(sArr, i12, i15);
                            int zzg = zzg(this.zzf, 0, this.zzc / i15, this.zzd / i15);
                            if (i15 != i10) {
                                int i16 = zzg * i15;
                                int i17 = i15 * 4;
                                int i18 = i16 - i17;
                                ...
                                if (this.zzb == i10) {
                                    i = zzg(sArr, i12, i18, i19);
                                } else {
                                    zzi(sArr, i12, i10);
                                    i = zzg(this.zzf, 0, i18, i19);
                                }
                            } else {
                                i = zzg;
                            }
                        ...
                        if (d2 > 1.0d) {
                            ...
                            if (f2 >= 2.0f) {
                                ...
                                this.zzt = (int) ((i23 * (2.0f - f2)) / ((-1.0f) + f2));
                                i3 = i23;
                            }
                            zzk(i3);
                            int i24 = i3;
                            zzl(i3, this.zzb, this.zzj, this.zzr, sArr2, i12, sArr2, i12 + i23);
                            this.zzr += i24;
                            i12 += i23 + i24;
                        } else {
                            int i25 = i23;
                            ...
                            if (f2 < 0.5f) {
                                ...
                                this.zzt = (int) ((i25 * ((f2 + f2) - 1.0f)) / (1.0f - f2));
                                i2 = i25;
                            }
                            int i26 = i25 + i2;
                            zzk(i26);
                            ...
                            zzl(i2, this.zzb, this.zzj, this.zzr + i25, sArr3, i25 + i12, sArr3, i12);
                            this.zzr += i26;
                            i12 += i2;
                        }
                    }
