...
interface zzgzy {
    ...
    @Deprecated
    void zzC(List list, zzhag zzhagVar, zzgxp zzgxpVar) throws IOException;

    void zzD(List list) throws IOException;

    void zzE(List list) throws IOException;

    void zzF(List list, zzhag zzhagVar, zzgxp zzgxpVar) throws IOException;
    ...
    zzgwv zzp() throws IOException;

    String zzr() throws IOException;

    String zzs() throws IOException;

    void zzt(Object obj, zzhag zzhagVar, zzgxp zzgxpVar) throws IOException;

    void zzu(Object obj, zzhag zzhagVar, zzgxp zzgxpVar) throws IOException;
