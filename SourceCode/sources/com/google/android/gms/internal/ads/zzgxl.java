...
final class zzgxl {
    ...
    private zzgxl(zzgxk zzgxkVar) {
        zzgyn.zzf(zzgxkVar, "output");
        this.zza = zzgxkVar;
        zzgxkVar.zze = this;
    }

    public static zzgxl zza(zzgxk zzgxkVar) {
        zzgxl zzgxlVar = zzgxkVar.zze;
        return zzgxlVar != null ? zzgxlVar : new zzgxl(zzgxkVar);
    }
    ...
    public final void zzd(int i, zzgwv zzgwvVar) throws IOException {
        this.zza.zzQ(i, zzgwvVar);
    }
    ...
    public final void zzq(int i, Object obj, zzhag zzhagVar) throws IOException {
        zzgxk zzgxkVar = this.zza;
        zzgxkVar.zzq(i, 3);
        zzhagVar.zzn((zzgzn) obj, zzgxkVar.zze);
        zzgxkVar.zzq(i, 4);
    }
    ...
    public final void zzv(int i, Object obj, zzhag zzhagVar) throws IOException {
        this.zza.zzn(i, (zzgzn) obj, zzhagVar);
    }
    ...
    public final void zzB(int i, List list, boolean z) throws IOException {
        ...
        if (!z) {
            while (i2 < list.size()) {
                ...
                zzgxkVar.zzr(i, (intValue >> 31) ^ (intValue + intValue));
                i2++;
            }
            return;
        }
        ...
        for (int i4 = 0; i4 < list.size(); i4++) {
            ...
            i3 += zzgxk.zzE((intValue2 >> 31) ^ (intValue2 + intValue2));
        }
        this.zza.zzs(i3);
        while (i2 < list.size()) {
            zzgxk zzgxkVar2 = this.zza;
            int intValue3 = ((Integer) list.get(i2)).intValue();
            zzgxkVar2.zzs((intValue3 >> 31) ^ (intValue3 + intValue3));
            i2++;
        }
    }
    ...
    public final void zzD(int i, List list, boolean z) throws IOException {
        ...
        if (!z) {
            while (i2 < list.size()) {
                ...
                zzgxkVar.zzt(i, (longValue >> 63) ^ (longValue + longValue));
                i2++;
            }
            return;
        }
        ...
        for (int i4 = 0; i4 < list.size(); i4++) {
            ...
            i3 += zzgxk.zzF((longValue2 >> 63) ^ (longValue2 + longValue2));
        }
        this.zza.zzs(i3);
        while (i2 < list.size()) {
            zzgxk zzgxkVar2 = this.zza;
            long longValue3 = ((Long) list.get(i2)).longValue();
            zzgxkVar2.zzu((longValue3 >> 63) ^ (longValue3 + longValue3));
            i2++;
        }
    }
