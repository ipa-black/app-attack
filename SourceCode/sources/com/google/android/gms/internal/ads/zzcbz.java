...
public final class zzcbz extends AbstractSafeParcelable {
    ...
    public final void writeToParcel(Parcel parcel, int i) {
        ...
        if (this.zza == null) {
            ...
            try {
                ...
                try {
                    zzcib.zza.execute(new Runnable() { // from class: com.google.android.gms.internal.ads.zzcby
                        ...
                        public final void run() {
                            ...
                            try {
                                ...
                                com.google.android.gms.ads.internal.util.zze.zzh("Error transporting the ad response", e);
    ...
    public final SafeParcelable zza(Parcelable.Creator creator) {
        if (this.zzc) {
            if (this.zza == null) {
                com.google.android.gms.ads.internal.util.zze.zzg("File descriptor is empty, returning null.");
                return null;
            }
            ...
            try {
                try {
                    ...
                    com.google.android.gms.ads.internal.util.zze.zzh("Could not read from parcel file descriptor", e2);
                    IOUtils.closeQuietly(dataInputStream);
                    return null;
                }
            } catch (Throwable th2) {
