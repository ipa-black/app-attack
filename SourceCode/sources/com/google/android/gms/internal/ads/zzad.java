...
public final class zzad {
    ...
    public /* synthetic */ zzad(zzaf zzafVar, zzac zzacVar) {
        this.zza = zzafVar.zzb;
        this.zzb = zzafVar.zzc;
        this.zzc = zzafVar.zzd;
        this.zzd = zzafVar.zze;
        this.zze = zzafVar.zzg;
        this.zzf = zzafVar.zzh;
        this.zzg = zzafVar.zzj;
        this.zzh = zzafVar.zzk;
        this.zzi = zzafVar.zzl;
        this.zzj = zzafVar.zzm;
        this.zzk = zzafVar.zzn;
        this.zzl = zzafVar.zzo;
        this.zzm = zzafVar.zzp;
        this.zzn = zzafVar.zzq;
        this.zzo = zzafVar.zzr;
        this.zzp = zzafVar.zzs;
        this.zzq = zzafVar.zzt;
        this.zzr = zzafVar.zzu;
        this.zzs = zzafVar.zzv;
        this.zzt = zzafVar.zzw;
        this.zzu = zzafVar.zzx;
        this.zzv = zzafVar.zzy;
        this.zzw = zzafVar.zzz;
        this.zzx = zzafVar.zzA;
        this.zzy = zzafVar.zzB;
        this.zzz = zzafVar.zzC;
        this.zzA = zzafVar.zzD;
        this.zzB = zzafVar.zzE;
        this.zzC = zzafVar.zzF;
    }
