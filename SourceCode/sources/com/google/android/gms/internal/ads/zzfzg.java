...
final class zzfzg extends zzfzj implements NavigableMap {
    final /* synthetic */ zzfzp zzc;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public zzfzg(zzfzp zzfzpVar, NavigableMap navigableMap) {
    ...
    public final NavigableMap descendingMap() {
        return new zzfzg(this.zzc, ((NavigableMap) ((SortedMap) this.zza)).descendingMap());
    }
    ...
    @Override // com.google.android.gms.internal.ads.zzfzj, java.util.SortedMap, java.util.NavigableMap
    ...
    @Override // com.google.android.gms.internal.ads.zzfzj, com.google.android.gms.internal.ads.zzfzc, com.google.android.gms.internal.ads.zzgbo, java.util.AbstractMap, java.util.Map
    ...
    final Map.Entry zzc(Iterator it) {
        if (it.hasNext()) {
            ...
            it.remove();
            return new zzgaq(entry.getKey(), this.zzc.zzb(zza));
        }
        return null;
    }
    ...
    public final NavigableSet zzg() {
        return new zzfzh(this.zzc, (NavigableMap) ((SortedMap) this.zza));
    }
    ...
    public final NavigableMap headMap(Object obj, boolean z) {
        return new zzfzg(this.zzc, ((NavigableMap) ((SortedMap) this.zza)).headMap(obj, z));
    }

    @Override // java.util.NavigableMap
    public final NavigableMap subMap(Object obj, boolean z, Object obj2, boolean z2) {
        return new zzfzg(this.zzc, ((NavigableMap) ((SortedMap) this.zza)).subMap(obj, z, obj2, z2));
    }

    @Override // java.util.NavigableMap
    public final NavigableMap tailMap(Object obj, boolean z) {
        return new zzfzg(this.zzc, ((NavigableMap) ((SortedMap) this.zza)).tailMap(obj, z));
    }
}
