...
final class zzahl {
    ...
    private final zzahk zzi = new zzahk(null);
    private final zzahk zzj = new zzahk(null);
    private boolean zzk = false;

    public zzahl(zzaaq zzaaqVar, boolean z, boolean z2) {
        this.zza = zzaaqVar;
    ...
    public final void zza(zzaae zzaaeVar) {
        this.zzc.append(zzaaeVar.zza, zzaaeVar);
    }

    public final void zzb(zzaaf zzaafVar) {
        this.zzb.append(zzaafVar.zzd, zzaafVar);
    }
