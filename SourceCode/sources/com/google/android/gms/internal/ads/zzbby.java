...
public final class zzbby implements View.OnAttachStateChangeListener, ViewTreeObserver.OnGlobalLayoutListener, ViewTreeObserver.OnScrollChangedListener, Application.ActivityLifecycleCallbacks {
    private static final long zzc = ((Long) com.google.android.gms.ads.internal.client.zzba.zzc().zzb(zzbjj.zzbf)).longValue();
    ...
    */
    ...
    private final void zzl(View view) {
        ...
        if (application != null) {
            try {
                ...
                com.google.android.gms.ads.internal.util.zze.zzh("Error registering activity lifecycle callbacks.", e2);
            }
        }
    }
    ...
    private final void zzm(View view) {
        try {
            ...
            com.google.android.gms.ads.internal.util.zze.zzh("Error while unregistering listeners from the last ViewTreeObserver.", e2);
        }
        try {
            ...
            com.google.android.gms.ads.internal.util.zze.zzh("Error while unregistering listeners from the ViewTreeObserver.", e3);
        }
        if (this.zza != null) {
            try {
                com.google.android.gms.ads.internal.zzt.zzv().zzd(this.zzd, this.zza);
            } catch (IllegalStateException e4) {
                com.google.android.gms.ads.internal.util.zze.zzh("Failed trying to unregister the receiver", e4);
            } catch (Exception e5) {
                com.google.android.gms.ads.internal.zzt.zzo().zzu(e5, "ActiveViewUnit.stopScreenStatusMonitoring");
            }
            this.zza = null;
        }
        Application application = this.zze;
        if (application != null) {
            try {
                ...
                com.google.android.gms.ads.internal.util.zze.zzh("Error registering activity lifecycle callbacks.", e6);
            }
        }
    }
    ...
    public final void zzc(zzbbx zzbbxVar) {
        this.zzn.add(zzbbxVar);
        zzj(3);
    }
    ...
    public final void zze(zzbbx zzbbxVar) {
        this.zzn.remove(zzbbxVar);
    }
