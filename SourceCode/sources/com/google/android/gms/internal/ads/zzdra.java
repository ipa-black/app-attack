...
public final class zzdra extends zzbmu implements ViewTreeObserver.OnGlobalLayoutListener, ViewTreeObserver.OnScrollChangedListener, zzdsc {
    ...
    public zzdra(View view, HashMap hashMap, HashMap hashMap2) {
        ...
        this.zzf = new zzbby(view.getContext(), view);
    }

    @Override // android.view.View.OnClickListener
    public final synchronized void onClick(View view) {
        zzdqb zzdqbVar = this.zze;
        if (zzdqbVar != null) {
            zzdqbVar.zzz(view, zzf(), zzl(), zzm(), true);
        }
    }
    ...
    public final synchronized void onGlobalLayout() {
        zzdqb zzdqbVar = this.zze;
        if (zzdqbVar != null) {
            zzdqbVar.zzx(zzf(), zzl(), zzm(), zzdqb.zzT(zzf()));
        }
    }
    ...
    public final synchronized boolean onTouch(View view, MotionEvent motionEvent) {
        zzdqb zzdqbVar = this.zze;
        if (zzdqbVar != null) {
            zzdqbVar.zzG(view, motionEvent, zzf());
        }
        return false;
    }
    ...
    public final synchronized JSONObject zzp() {
        zzdqb zzdqbVar = this.zze;
        if (zzdqbVar != null) {
            return zzdqbVar.zzh(zzf(), zzl(), zzm());
        }
        return null;
    }
