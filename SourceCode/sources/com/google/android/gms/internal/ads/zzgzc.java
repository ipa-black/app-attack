...
public final class zzgzc extends zzgwf implements RandomAccess, zzgyl, zzgzu {
    private static final zzgzc zza;
    private long[] zzb;
    private int zzc;

    static {
        zzgzc zzgzcVar = new zzgzc(new long[0], 0);
        zza = zzgzcVar;
        zzgzcVar.zzb();
    }
    ...
    /* renamed from: zza */
    public final zzgyl zzd(int i) {
        if (i < this.zzc) {
            throw new IllegalArgumentException();
        }
        return new zzgzc(Arrays.copyOf(this.zzb, i), this.zzc);
    }
