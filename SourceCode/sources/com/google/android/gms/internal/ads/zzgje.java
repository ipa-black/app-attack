...
public final class zzgje {
    public static byte[] zza(byte[] bArr, byte[] bArr2) {
        ...
        while (true) {
            ...
            if (i2 < length) {
                ...
                long zzc = (((j23 & j30) | (j25 & 67108863 & j31) | (j32 << 26)) & ArrayUnsignedIntList.MAX_VALUE) + zzc(bArr, 16);
                long zzc2 = (((j32 >> 6) | (j33 << 20)) & ArrayUnsignedIntList.MAX_VALUE) + zzc(bArr, 20) + (zzc >> 32);
                long zzc3 = (((j33 >> 12) | (j34 << 14)) & ArrayUnsignedIntList.MAX_VALUE) + zzc(bArr, 24) + (zzc2 >> 32);
                long zzc4 = zzc(bArr, 28);
                byte[] bArr4 = new byte[16];
                zzd(bArr4, zzc & ArrayUnsignedIntList.MAX_VALUE, 0);
                zzd(bArr4, zzc2 & ArrayUnsignedIntList.MAX_VALUE, 4);
                zzd(bArr4, zzc3 & ArrayUnsignedIntList.MAX_VALUE, 8);
                zzd(bArr4, ((((((j29 & j31) | (j21 & j30)) << 8) | (j34 >> 18)) & ArrayUnsignedIntList.MAX_VALUE) + zzc4 + (zzc3 >> 32)) & ArrayUnsignedIntList.MAX_VALUE, 12);
                return bArr4;
            }
        }
    }
    ...
    private static long zzc(byte[] bArr, int i) {
        return (((bArr[i + 3] & 255) << 24) | (bArr[i] & 255) | ((bArr[i + 1] & 255) << 8) | ((bArr[i + 2] & 255) << 16)) & ArrayUnsignedIntList.MAX_VALUE;
    }
