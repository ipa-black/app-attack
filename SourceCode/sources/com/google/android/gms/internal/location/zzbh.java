...
public final class zzbh extends AbstractSafeParcelable implements Geofence {
    ...
    public zzbh(String str, int i, short s, double d2, double d3, float f2, long j, int i2, int i3) {
    ...
    public final int hashCode() {
        ...
        return ((((((((((int) (doubleToLongBits ^ (doubleToLongBits >>> 32))) + 31) * 31) + ((int) ((doubleToLongBits2 >>> 32) ^ doubleToLongBits2))) * 31) + Float.floatToIntBits(this.zzaj)) * 31) + this.zzag) * 31) + this.zzae;
    }
