...
public final class zzv extends zzai {
    ...
    public final zzap zza(zzg zzgVar, List list) {
        ...
        this.zza.zza(zzi, zzamVar.zzt(Constants.FirelogAnalytics.PARAM_PRIORITY) ? zzh.zzb(zzamVar.zzf(Constants.FirelogAnalytics.PARAM_PRIORITY).zzh().doubleValue()) : 1000, (zzao) zzb, zzamVar.zzf(SessionDescription.ATTR_TYPE).zzi());
        return zzap.zzf;
    }
}
