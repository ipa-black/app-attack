...
public final class zznp implements zzno {
    ...
    static {
        ...
        zzc = zza2.zzd("measurement.config.cache_time", Constants.MILLIS_IN_DAY);
        ...
        zzn = zza2.zzd("measurement.monitoring.sample_period_millis", Constants.MILLIS_IN_DAY);
        ...
        zzt = zza2.zzd("measurement.upload.stale_data_deletion_interval", Constants.MILLIS_IN_DAY);
        ...
        zzK = zza2.zzd("measurement.upload.retry_time", CycledLeScanner.ANDROID_N_MAX_SCAN_DURATION_MILLIS);
