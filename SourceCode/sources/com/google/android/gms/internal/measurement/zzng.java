...
interface zzng {
    ...
    void zzd(int i, zzje zzjeVar) throws IOException;

    void zze(int i, List list) throws IOException;

    void zzf(int i, double d2) throws IOException;
    ...
    void zzo(int i, float f2) throws IOException;

    void zzp(int i, List list, boolean z) throws IOException;

    @Deprecated
    void zzq(int i, Object obj, zzlx zzlxVar) throws IOException;
    ...
    void zzv(int i, Object obj, zzlx zzlxVar) throws IOException;
