...
public final class zzr extends FastSafeParcelableJsonResponse implements Person {
    ...
    public static final class zzb extends FastSafeParcelableJsonResponse implements Person.Cover {
        ...
        /* loaded from: classes4.dex */
        public static final class C0264zzb extends FastSafeParcelableJsonResponse implements Person.Cover.CoverPhoto {
            public static final Parcelable.Creator<C0264zzb> CREATOR = new zzw();
            private static final HashMap<String, FastJsonResponse.Field<?, ?>> zzao;
            private final Set<Integer> zzap;
            private int zzbu;
            private int zzbv;
            ...
            static {
                HashMap<String, FastJsonResponse.Field<?, ?>> hashMap = new HashMap<>();
                zzao = hashMap;
                hashMap.put(IabUtils.KEY_HEIGHT, FastJsonResponse.Field.forInteger(IabUtils.KEY_HEIGHT, 2));
                hashMap.put("url", FastJsonResponse.Field.forString("url", 3));
                hashMap.put(IabUtils.KEY_WIDTH, FastJsonResponse.Field.forInteger(IabUtils.KEY_WIDTH, 4));
            }
            ...
            /* JADX INFO: Access modifiers changed from: package-private */
            public C0264zzb(Set<Integer> set, int i, int i2, String str, int i3) {
                this.zzap = set;
                this.zzw = i;
                this.zzbu = i2;
                this.zzk = str;
            ...
            @Override // com.google.android.gms.common.server.response.FastSafeParcelableJsonResponse
            public final boolean equals(Object obj) {
                if (obj instanceof C0264zzb) {
                    if (this == obj) {
                        return true;
                    }
                    C0264zzb c0264zzb = (C0264zzb) obj;
                    for (FastJsonResponse.Field<?, ?> field : zzao.values()) {
                        if (isFieldSet(field)) {
                            if (!c0264zzb.isFieldSet(field) || !getFieldValue(field).equals(c0264zzb.getFieldValue(field))) {
                                return false;
                            }
                        } else if (c0264zzb.isFieldSet(field)) {
                            return false;
                        }
                    }
                    return true;
        ...
        static {
            ...
            hashMap.put("coverPhoto", FastJsonResponse.Field.forConcreteType("coverPhoto", 3, C0264zzb.class));
            hashMap.put(TtmlNode.TAG_LAYOUT, FastJsonResponse.Field.withConverter(TtmlNode.TAG_LAYOUT, 4, new StringToIntConverter().add("banner", 0), false));
        }
        ...
        /* JADX INFO: Access modifiers changed from: package-private */
        public zzb(Set<Integer> set, int i, zza zzaVar, C0264zzb c0264zzb, int i2) {
            this.zzap = set;
            this.zzw = i;
            this.zzbp = zzaVar;
            this.zzbq = c0264zzb;
    ...
    public static final class zze extends FastSafeParcelableJsonResponse implements Person.Organizations {
        ...
        static {
            ...
            hashMap.put(SessionDescription.ATTR_TYPE, FastJsonResponse.Field.withConverter(SessionDescription.ATTR_TYPE, 10, new StringToIntConverter().add("work", 0).add("school", 1), false));
        }
    ...
    public static final class zzg extends FastSafeParcelableJsonResponse implements Person.Urls {
        ...
        static {
            ...
            hashMap.put(SessionDescription.ATTR_TYPE, FastJsonResponse.Field.withConverter(SessionDescription.ATTR_TYPE, 6, new StringToIntConverter().add("home", 0).add("work", 1).add("blog", 2).add(Scopes.PROFILE, 3).add("other", 4).add("otherProfile", 5).add("contributor", 6).add("website", 7), false));
    ...
    static {
        ...
        hashMap.put("gender", FastJsonResponse.Field.withConverter("gender", 12, new StringToIntConverter().add(AdColonyUserMetadata.USER_MALE, 0).add(AdColonyUserMetadata.USER_FEMALE, 1).add("other", 2), false));
