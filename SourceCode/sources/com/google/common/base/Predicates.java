...
public final class Predicates {
    ...
    public static class CompositionPredicate<A, B> implements Predicate<A>, Serializable {
        ...
        final Function<A, ? extends B> f9805f;
        final Predicate<B> p;

        private CompositionPredicate(Predicate<B> predicate, Function<A, ? extends B> function) {
            this.p = (Predicate) Preconditions.checkNotNull(predicate);
            this.f9805f = (Function) Preconditions.checkNotNull(function);
        }

        @Override // com.google.common.base.Predicate
        public boolean apply(@ParametricNullness A a2) {
            return this.p.apply(this.f9805f.apply(a2));
        }
        ...
        public boolean equals(@CheckForNull Object obj) {
            if (obj instanceof CompositionPredicate) {
                ...
                return this.f9805f.equals(compositionPredicate.f9805f) && this.p.equals(compositionPredicate.p);
            }
            return false;
        }

        public int hashCode() {
            return this.f9805f.hashCode() ^ this.p.hashCode();
        }

        public String toString() {
            String valueOf = String.valueOf(this.p);
            String valueOf2 = String.valueOf(this.f9805f);
