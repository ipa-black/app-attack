...
public final class Quantiles {
    ...
    public static final class ScaleAndIndexes {
        ...
        public Map<Integer, Double> computeInPlace(double... dArr) {
            ...
            Quantiles.selectAllInPlace(iArr6, 0, i3 - 1, dArr, 0, dArr.length - 1);
            ...
            while (true) {
                ...
                if (i < iArr7.length) {
                    ...
                    if (i7 == 0) {
                        ...
                        linkedHashMap2.put(Integer.valueOf(iArr7[i]), Double.valueOf(Quantiles.interpolate(dArr[i6], dArr[i6 + 1], i7, this.scale)));
                    }
                    i++;
                } else {
