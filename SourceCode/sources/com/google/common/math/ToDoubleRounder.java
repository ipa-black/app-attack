...
abstract class ToDoubleRounder<X extends Number & Comparable<X>> {
    ...
    abstract X toX(double d2, RoundingMode roundingMode);
        ...
        switch (AnonymousClass1.$SwitchMap$java$math$RoundingMode[roundingMode.ordinal()]) {
            ...
            case 4:
                if (compareTo >= 0) {
                    ...
                    x2 = toX(d2, RoundingMode.CEILING);
                } else {
                ...
                if (i == 2) {
                    ...
                    return sign(x) >= 0 ? roundToDoubleArbitrarily : d2;
                } else if (i == 4) {
                    return sign(x) >= 0 ? d2 : roundToDoubleArbitrarily;
                } else {
