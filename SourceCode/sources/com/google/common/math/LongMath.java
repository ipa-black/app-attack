...
public final class LongMath {
    ...
    static final long[] powersOf10 = {1, 10, 100, 1000, 10000, 100000, 1000000, 10000000, 100000000, C.NANOS_PER_SECOND, 10000000000L, 100000000000L, MediaPeriodQueue.INITIAL_RENDERER_POSITION_OFFSET_US, 10000000000000L, 100000000000000L, 1000000000000000L, 10000000000000000L, 100000000000000000L, 1000000000000000000L};
    static final long[] halfPowersOf10 = {3, 31, 316, 3162, 31622, 316227, 3162277, 31622776, 316227766, 3162277660L, 31622776601L, 316227766016L, 3162277660168L, 31622776601683L, 316227766016837L, 3162277660168379L, 31622776601683793L, 316227766016837933L, 3162277660168379331L};
    static final long[] factorials = {1, 1, 2, 6, 24, 120, 720, 5040, 40320, 362880, 3628800, 39916800, 479001600, 6227020800L, 87178291200L, 1307674368000L, 20922789888000L, 355687428096000L, 6402373705728000L, 121645100408832000L, 2432902008176640000L};
    static final int[] biggestBinomials = {Integer.MAX_VALUE, Integer.MAX_VALUE, Integer.MAX_VALUE, 3810779, 121977, 16175, 4337, 1733, 887, 534, 361, 265, LossReason.LOSS_REASON_CREATIVE_FILTERED_NOT_SECURE_VALUE, 169, 143, 125, 111, 101, 94, 88, 83, 79, 76, 74, 72, 70, 69, 68, 67, 67, 66, 66, 66, 66};
    ...
    public enum MillerRabinTester {
        ...
        LARGE { // from class: com.google.common.math.LongMath.MillerRabinTester.2
            ...
            long mulMod(long j, long j2, long j3) {
                long j4 = j >>> 32;
                long j5 = j2 >>> 32;
                long j6 = j & ArrayUnsignedIntList.MAX_VALUE;
                long j7 = j2 & ArrayUnsignedIntList.MAX_VALUE;
            ...
            long squareMod(long j, long j2) {
                long j3 = j >>> 32;
                long j4 = j & ArrayUnsignedIntList.MAX_VALUE;
    ...
    public static double roundToDouble(long j, RoundingMode roundingMode) {
        ...
        switch (AnonymousClass1.$SwitchMap$java$math$RoundingMode[roundingMode.ordinal()]) {
            case 1:
                ...
                return d3;
            case 2:
                return j >= 0 ? compare >= 0 ? d3 : DoubleUtils.nextDown(d3) : compare <= 0 ? d3 : Math.nextUp(d3);
            case 3:
                return compare >= 0 ? d3 : DoubleUtils.nextDown(d3);
            case 4:
                return j >= 0 ? compare <= 0 ? d3 : Math.nextUp(d3) : compare >= 0 ? d3 : DoubleUtils.nextDown(d3);
            case 5:
