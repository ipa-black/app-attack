...
public class LocalCache<K, V> extends AbstractMap<K, V> implements ConcurrentMap<K, V> {
    ...
    public enum EntryFactory {
        ...
        static {
            ...
            factories = new EntryFactory[]{r0, entryFactory, entryFactory2, entryFactory3, entryFactory4, entryFactory5, entryFactory6, entryFactory7};
        }
    ...
    public static class Segment<K, V> extends ReentrantLock {
        ...
        V compute(K k, int i, BiFunction<? super K, ? super V, ? extends V> biFunction) {
            ...
            try {
                ...
                LoadingValueReference<K, V> computingValueReference = new ComputingValueReference<>(valueReference);
                if (referenceEntry2 == null) {
                    referenceEntry2 = newEntry(k, i, referenceEntry);
    ...
    */
    ...
    public V computeIfAbsent(final K k, final java.util.function.Function<? super K, ? extends V> function) {
        ...
        return compute(k, new BiFunction() { // from class: com.google.common.cache.LocalCache$$ExternalSyntheticLambda1
    ...
    public V computeIfPresent(K k, final BiFunction<? super K, ? super V, ? extends V> biFunction) {
        Preconditions.checkNotNull(k);
        Preconditions.checkNotNull(biFunction);
        return compute(k, new BiFunction() { // from class: com.google.common.cache.LocalCache$$ExternalSyntheticLambda2
            @Override // java.util.function.BiFunction
            public final Object apply(Object obj, Object obj2) {
    ...
    public V merge(K k, final V v, final BiFunction<? super V, ? super V, ? extends V> biFunction) {
        ...
        Preconditions.checkNotNull(v);
        Preconditions.checkNotNull(biFunction);
        return compute(k, new BiFunction() { // from class: com.google.common.cache.LocalCache$$ExternalSyntheticLambda0
            @Override // java.util.function.BiFunction
            public final Object apply(Object obj, Object obj2) {
