...
public class CycleDetectingLockFactory {
    ...
    public static final class WithExplicitOrdering<E extends Enum<E>> extends CycleDetectingLockFactory {
        ...
        public ReentrantLock newReentrantLock(E e2, boolean z) {
            ...
            return new CycleDetectingReentrantLock((LockGraphNode) Objects.requireNonNull(this.lockGraphNodes.get(e2)), z);
        }
        ...
        public ReentrantReadWriteLock newReentrantReadWriteLock(E e2, boolean z) {
            ...
            return new CycleDetectingReentrantReadWriteLock((LockGraphNode) Objects.requireNonNull(this.lockGraphNodes.get(e2)), z);
        }
    }
