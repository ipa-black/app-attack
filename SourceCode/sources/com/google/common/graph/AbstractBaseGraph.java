    ...
    public class AnonymousClass2 extends IncidentEdgeSet<N> {
        ...
        public UnmodifiableIterator<EndpointPair<N>> iterator() {
            if (this.graph.isDirected()) {
                return Iterators.unmodifiableIterator(Iterators.concat(Iterators.transform(this.graph.predecessors((BaseGraph<N>) this.node).iterator(), new Function() { // from class: com.google.common.graph.AbstractBaseGraph$2$$ExternalSyntheticLambda0
                    ...
                    public final Object apply(Object obj) {
                        return AbstractBaseGraph.AnonymousClass2.this.m452lambda$iterator$0$comgooglecommongraphAbstractBaseGraph$2(obj);
                    }
                    ...
                    @Override // com.google.common.base.Function, java.util.function.Function
                    public final Object apply(Object obj) {
                        return AbstractBaseGraph.AnonymousClass2.this.m453lambda$iterator$1$comgooglecommongraphAbstractBaseGraph$2(obj);
                    }
                })));
            }
            return Iterators.unmodifiableIterator(Iterators.transform(this.graph.adjacentNodes(this.node).iterator(), new Function() { // from class: com.google.common.graph.AbstractBaseGraph$2$$ExternalSyntheticLambda2
                @Override // com.google.common.base.Function, java.util.function.Function
                public final Object apply(Object obj) {
                    return AbstractBaseGraph.AnonymousClass2.this.m454lambda$iterator$2$comgooglecommongraphAbstractBaseGraph$2(obj);
                }
            }));
        }
        ...
        public /* synthetic */ EndpointPair m452lambda$iterator$0$comgooglecommongraphAbstractBaseGraph$2(Object obj) {
        ...
        public /* synthetic */ EndpointPair m453lambda$iterator$1$comgooglecommongraphAbstractBaseGraph$2(Object obj) {
        ...
        public /* synthetic */ EndpointPair m454lambda$iterator$2$comgooglecommongraphAbstractBaseGraph$2(Object obj) {
