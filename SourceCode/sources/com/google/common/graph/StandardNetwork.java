...
public class StandardNetwork<N, E> extends AbstractNetwork<N, E> {
    ...
    public EndpointPair<N> incidentNodes(E e2) {
        ...
        return EndpointPair.of(this, checkedReferenceNode, ((NetworkConnections) Objects.requireNonNull(this.nodeConnections.get(checkedReferenceNode))).adjacentNode(e2));
    }
