...
final class SipHashFunction extends AbstractHashFunction implements Serializable {
    ...
    public Hasher newHasher() {
        return new SipHasher(this.f9809c, this.f9810d, this.k0, this.k1);
    }
    ...
    public boolean equals(@CheckForNull Object obj) {
        if (obj instanceof SipHashFunction) {
            ...
            return this.f9809c == sipHashFunction.f9809c && this.f9810d == sipHashFunction.f9810d && this.k0 == sipHashFunction.k0 && this.k1 == sipHashFunction.k1;
        }
        return false;
    }

    public int hashCode() {
        return (int) ((((getClass().hashCode() ^ this.f9809c) ^ this.f9810d) ^ this.k0) ^ this.k1);
    }
    ...
    private static final class SipHasher extends AbstractStreamingHasher {
        ...
        protected void processRemaining(ByteBuffer byteBuffer) {
            this.f9811b += byteBuffer.remaining();
            int i = 0;
