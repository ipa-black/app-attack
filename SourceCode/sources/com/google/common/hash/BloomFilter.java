...
public final class BloomFilter<T> implements Predicate<T>, Serializable {
    ...
    public static <T> Collector<T, ?, BloomFilter<T>> toBloomFilter(final Funnel<? super T> funnel, final long j, final double d2) {
        ...
        return Collector.of(new Supplier() { // from class: com.google.common.hash.BloomFilter$$ExternalSyntheticLambda0
            ...
            /*  JADX ERROR: JadxRuntimeException in pass: InlineMethods
                jadx.core.utils.exceptions.JadxRuntimeException: Failed to process method for inline: com.google.common.hash.BloomFilter.lambda$toBloomFilter$1(com.google.common.hash.BloomFilter, com.google.common.hash.BloomFilter):com.google.common.hash.BloomFilter
            ...
            public final java.lang.Object apply(java.lang.Object r1, java.lang.Object r2) {
                /*
                    r0 = this;
                    com.google.common.hash.BloomFilter r1 = (com.google.common.hash.BloomFilter) r1
                    com.google.common.hash.BloomFilter r2 = (com.google.common.hash.BloomFilter) r2
                    com.google.common.hash.BloomFilter r1 = com.google.common.hash.BloomFilter.lambda$toBloomFilter$1(r1, r2)
                    return r1
                */
                throw new UnsupportedOperationException("Method not decompiled: com.google.common.hash.BloomFilter$$ExternalSyntheticLambda2.apply(java.lang.Object, java.lang.Object):java.lang.Object");
            }
    ...
    static <T> BloomFilter<T> create(Funnel<? super T> funnel, long j, double d2, Strategy strategy) {
        ...
        try {
            ...
            throw new IllegalArgumentException(new StringBuilder(57).append("Could not create BloomFilter of ").append(optimalNumOfBits).append(" bits").toString(), e2);
        }
    }
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    i3 = readByte;
                    i = i5;
                    throw new IOException(new StringBuilder((int) TsExtractor.TS_STREAM_TYPE_SPLICE_INFO).append("Unable to deserialize BloomFilter from InputStream. strategyOrdinal: ").append(i3).append(" numHashFunctions: ").append(i2).append(" dataLength: ").append(i).toString(), e);
                }
