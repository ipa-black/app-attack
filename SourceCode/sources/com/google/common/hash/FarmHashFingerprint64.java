...
final class FarmHashFingerprint64 extends AbstractNonStreamingHashFunction {
    ...
    private static long hashLength0to16(byte[] bArr, int i, int i2) {
        if (i2 >= 8) {
            ...
            return hashLength16(i2 + ((LittleEndianByteArray.load32(bArr, i) & ArrayUnsignedIntList.MAX_VALUE) << 3), LittleEndianByteArray.load32(bArr, (i + i2) - 4) & ArrayUnsignedIntList.MAX_VALUE, (i2 * 2) + K2);
        } else if (i2 > 0) {
    ...
    private static long hashLength65Plus(byte[] bArr, int i, int i2) {
        ...
        while (true) {
            ...
            if (i9 == i4) {
                ...
                jArr[0] = j6;
                jArr2[0] = jArr2[0] + j6;
                long rotateRight4 = (Long.rotateRight(((rotateRight3 + load642) + jArr[0]) + LittleEndianByteArray.load64(bArr, i6 - 55), 37) * j4) ^ (jArr2[1] * 9);
                long rotateRight5 = (Long.rotateRight(load642 + jArr[1] + LittleEndianByteArray.load64(bArr, i6 - 15), 42) * j4) + (jArr[0] * 9) + LittleEndianByteArray.load64(bArr, i6 - 23);
                long rotateRight6 = Long.rotateRight(j3 + jArr2[0], 33) * j4;
                weakHashLength32WithSeeds(bArr, i7, jArr[1] * j4, rotateRight4 + jArr2[0], jArr);
                weakHashLength32WithSeeds(bArr, i6 - 31, rotateRight6 + jArr2[1], rotateRight5 + LittleEndianByteArray.load64(bArr, i6 - 47), jArr2);
