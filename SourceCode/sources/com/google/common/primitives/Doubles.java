...
public final class Doubles extends DoublesMethodsForWeb {
    ...
    */
    ...
    private static Pattern fpPattern() {
        ...
        return Pattern.compile(new StringBuilder(String.valueOf(concat).length() + 23 + String.valueOf(sb).length()).append("[+-]?(?:NaN|Infinity|").append(concat).append("|").append(sb).append(")").toString().replace("#", Marker.ANY_NON_NULL_MARKER));
    }
