...
public final class MinMaxPriorityQueue<E> extends AbstractQueue<E> {
    ...
    private MoveDesc<E> fillHole(int i, E e2) {
        ...
        if (bubbleUpAlternatingLevels == fillHoleAt) {
            return heapForIndex.tryCrossOverAndBubbleUp(i, fillHoleAt, e2);
        }
    ...
    public class Heap {
        ...
        MoveDesc<E> tryCrossOverAndBubbleUp(int i, int i2, E e2) {
            ...
            if (this.otherHeap.bubbleUpAlternatingLevels(crossOver, e2) < i) {
        ...
        void bubbleUp(int i, E e2) {
            Heap heap;
            int crossOverUp = crossOverUp(i, e2);
            if (crossOverUp == i) {
                crossOverUp = i;
                heap = this;
            } else {
