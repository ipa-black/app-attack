...
public final class TreeMultiset<E> extends AbstractSortedMultiset<E> implements Serializable {
    ...
    public static final class AvlNode<E> {
        ...
        AvlNode(@ParametricNullness E e2, int i) {
            Preconditions.checkArgument(i > 0);
            this.elem = e2;
            this.elemCount = i;
            this.totalCount = i;
        ...
        private AvlNode<E> addRightChild(@ParametricNullness E e2, int i) {
        ...
        private AvlNode<E> addLeftChild(@ParametricNullness E e2, int i) {
        ...
        /* JADX WARN: Multi-variable type inference failed */
        AvlNode<E> add(Comparator<? super E> comparator, @ParametricNullness E e2, int i, int[] iArr) {
            int compare = comparator.compare(e2, getElement());
            if (compare < 0) {
                AvlNode<E> avlNode = this.left;
                if (avlNode == null) {
                ...
                AvlNode<E> add = avlNode.add(comparator, e2, i, iArr);
                this.left = add;
                if (iArr[0] == 0) {
                    this.distinctElements++;
                }
                ...
                AvlNode<E> add2 = avlNode2.add(comparator, e2, i, iArr);
                this.right = add2;
                if (iArr[0] == 0) {
                    this.distinctElements++;
                }
        ...
        /* JADX WARN: Multi-variable type inference failed */
        @CheckForNull
        AvlNode<E> remove(Comparator<? super E> comparator, @ParametricNullness E e2, int i, int[] iArr) {
            int compare = comparator.compare(e2, getElement());
            if (compare < 0) {
                AvlNode<E> avlNode = this.left;
                if (avlNode == null) {
        ...
        /* JADX WARN: Multi-variable type inference failed */
        @CheckForNull
        AvlNode<E> setCount(Comparator<? super E> comparator, @ParametricNullness E e2, int i, int[] iArr) {
            int i2;
            int compare = comparator.compare(e2, getElement());
            if (compare < 0) {
                AvlNode<E> avlNode = this.left;
        ...
        /* JADX WARN: Multi-variable type inference failed */
        @CheckForNull
        AvlNode<E> setCount(Comparator<? super E> comparator, @ParametricNullness E e2, int i, int i2, int[] iArr) {
            int compare = comparator.compare(e2, getElement());
            if (compare < 0) {
                AvlNode<E> avlNode = this.left;
                if (avlNode == null) {
                    iArr[0] = 0;
                    return (i != 0 || i2 <= 0) ? this : addLeftChild(e2, i2);
                }
                ...
                if (avlNode2 == null) {
                    iArr[0] = 0;
                    return (i != 0 || i2 <= 0) ? this : addRightChild(e2, i2);
                }
