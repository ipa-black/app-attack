...
public class StandardTable<R, C, V> extends AbstractTable<R, C, V> implements Serializable {
    ...
    Spliterator<Table.Cell<R, C, V>> cellSpliterator() {
        return CollectSpliterators.flatMap(this.backingMap.entrySet().spliterator(), new Function() { // from class: com.google.common.collect.StandardTable$$ExternalSyntheticLambda0
            @Override // java.util.function.Function
            public final Object apply(Object obj) {
                Spliterator map;
                map = CollectSpliterators.map(((Map) r1.getValue()).entrySet().spliterator(), new Function() { // from class: com.google.common.collect.StandardTable$$ExternalSyntheticLambda1
                    @Override // java.util.function.Function
