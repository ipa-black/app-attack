...
final class SortedLists {
    ...
    public enum KeyPresentBehavior {
        ANY_PRESENT { // from class: com.google.common.collect.SortedLists.KeyPresentBehavior.1
            ...
            <E> int resultIndex(Comparator<? super E> comparator, @ParametricNullness E e2, List<? extends E> list, int i) {
                return i;
            }
        },
        ...
        FIRST_AFTER { // from class: com.google.common.collect.SortedLists.KeyPresentBehavior.4
            @Override // com.google.common.collect.SortedLists.KeyPresentBehavior
            public <E> int resultIndex(Comparator<? super E> comparator, @ParametricNullness E e2, List<? extends E> list, int i) {
        ...
        abstract <E> int resultIndex(Comparator<? super E> comparator, @ParametricNullness E e2, List<? extends E> list, int i);
    }
    ...
    public static <E> int binarySearch(List<? extends E> list, @ParametricNullness E e2, Comparator<? super E> comparator, KeyPresentBehavior keyPresentBehavior, KeyAbsentBehavior keyAbsentBehavior) {
