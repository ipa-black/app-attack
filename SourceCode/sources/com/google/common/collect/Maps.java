...
public final class Maps {
    ...
    public static class AsMapView<K, V> extends ViewCachingAbstractMap<K, V> {
        ...
        public void forEach(final BiConsumer<? super K, ? super V> biConsumer) {
            ...
            backingSet().forEach(new Consumer() { // from class: com.google.common.collect.Maps$AsMapView$$ExternalSyntheticLambda0
                ...
                public final void accept(Object obj) {
                    Maps.AsMapView.this.m443lambda$forEach$0$comgooglecommoncollectMaps$AsMapView(biConsumer, obj);
                }
            });
        }
        ...
        public /* synthetic */ void m443lambda$forEach$0$comgooglecommoncollectMaps$AsMapView(BiConsumer biConsumer, Object obj) {
    ...
    public static final class NavigableAsMapView<K, V> extends AbstractNavigableMap<K, V> {
        ...
        Spliterator<Map.Entry<K, V>> entrySpliterator() {
            return CollectSpliterators.map(this.set.spliterator(), new java.util.function.Function() { // from class: com.google.common.collect.Maps$NavigableAsMapView$$ExternalSyntheticLambda1
                @Override // java.util.function.Function
                public final Object apply(Object obj) {
                    return Maps.NavigableAsMapView.this.m445x81c42c54(obj);
                }
            });
        }
        ...
        public /* synthetic */ Map.Entry m445x81c42c54(Object obj) {
            return Maps.immutableEntry(obj, this.function.apply(obj));
        }

        @Override // java.util.Map
        public void forEach(final BiConsumer<? super K, ? super V> biConsumer) {
            this.set.forEach(new Consumer() { // from class: com.google.common.collect.Maps$NavigableAsMapView$$ExternalSyntheticLambda0
                @Override // java.util.function.Consumer
                public final void accept(Object obj) {
                    Maps.NavigableAsMapView.this.m446xe3778d9a(biConsumer, obj);
                }
            });
        }
        ...
        public /* synthetic */ void m446xe3778d9a(BiConsumer biConsumer, Object obj) {
            biConsumer.accept(obj, this.function.apply(obj));
        }
    ...
    public static class TransformedEntriesMap<K, V1, V2> extends IteratorBasedAbstractMap<K, V2> {
        ...
        public void forEach(final BiConsumer<? super K, ? super V2> biConsumer) {
            ...
            this.fromMap.forEach(new BiConsumer() { // from class: com.google.common.collect.Maps$TransformedEntriesMap$$ExternalSyntheticLambda0
                ...
                public final void accept(Object obj, Object obj2) {
                    Maps.TransformedEntriesMap.this.m447x4954b592(biConsumer, obj, obj2);
                }
            });
        }
        ...
        public /* synthetic */ void m447x4954b592(BiConsumer biConsumer, Object obj, Object obj2) {
    ...
    public static final class FilteredEntryBiMap<K, V> extends FilteredEntryMap<K, V> implements BiMap<K, V> {
        ...
        public void replaceAll(final BiFunction<? super K, ? super V, ? extends V> biFunction) {
            unfiltered().replaceAll(new BiFunction() { // from class: com.google.common.collect.Maps$FilteredEntryBiMap$$ExternalSyntheticLambda0
                ...
                public final Object apply(Object obj, Object obj2) {
                    return Maps.FilteredEntryBiMap.this.m444x30717e5c(biFunction, obj, obj2);
                }
            });
        }
        ...
        public /* synthetic */ Object m444x30717e5c(BiFunction biFunction, Object obj, Object obj2) {
    ...
    public static <E> ImmutableMap<E, Integer> indexMap(Collection<E> collection) {
        ...
        int i = 0;
        for (E e2 : collection) {
            builder.put(e2, Integer.valueOf(i));
            i++;
        }
        return builder.buildOrThrow();
    }
