...
public final class Multisets {
    ...
    public static class ImmutableEntry<E> extends AbstractEntry<E> implements Serializable {
        ...
        /* JADX INFO: Access modifiers changed from: package-private */
        public ImmutableEntry(@ParametricNullness E e2, int i) {
            this.element = e2;
            this.count = i;
    ...
    private static <E> boolean addAllImpl(final Multiset<E> multiset, Multiset<? extends E> multiset2) {
        ...
        multiset2.forEachEntry(new ObjIntConsumer() { // from class: com.google.common.collect.Multisets$$ExternalSyntheticLambda0
    ...
    public static <E> Spliterator<E> spliteratorImpl(Multiset<E> multiset) {
        ...
        return CollectSpliterators.flatMap(spliterator, new Function() { // from class: com.google.common.collect.Multisets$$ExternalSyntheticLambda1
