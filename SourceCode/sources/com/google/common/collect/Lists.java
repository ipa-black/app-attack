...
public final class Lists {
    ...
    public static class TransformingSequentialList<F, T> extends AbstractSequentialList<T> implements Serializable {
        ...
        public boolean removeIf(final Predicate<? super T> predicate) {
            ...
            return this.fromList.removeIf(new Predicate() { // from class: com.google.common.collect.Lists$TransformingSequentialList$$ExternalSyntheticLambda0
                ...
                public final boolean test(Object obj) {
                    return Lists.TransformingSequentialList.this.m442x40996e79(predicate, obj);
                }
            });
        }
        ...
        public /* synthetic */ boolean m442x40996e79(Predicate predicate, Object obj) {
    ...
    public static class TransformingRandomAccessList<F, T> extends AbstractList<T> implements RandomAccess, Serializable {
        ...
        public boolean removeIf(final Predicate<? super T> predicate) {
            ...
            return this.fromList.removeIf(new Predicate() { // from class: com.google.common.collect.Lists$TransformingRandomAccessList$$ExternalSyntheticLambda0
                @Override // java.util.function.Predicate
                public final boolean test(Object obj) {
                    return Lists.TransformingRandomAccessList.this.m441xeef9d281(predicate, obj);
                }
            });
        }
        ...
        public /* synthetic */ boolean m441xeef9d281(Predicate predicate, Object obj) {
            return predicate.test(this.function.apply(obj));
        }
    ...
    private static class AbstractListWrapper<E> extends AbstractList<E> {
        ...
        public E set(int i, @ParametricNullness E e2) {
            return this.backingList.set(i, e2);
        }
