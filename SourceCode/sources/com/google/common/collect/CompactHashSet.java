...
public class CompactHashSet<E> extends AbstractSet<E> implements Serializable {
    ...
    public boolean add(@ParametricNullness E e2) {
        ...
        if (tableGet != 0) {
            ...
            while (true) {
                ...
                if (CompactHashing.getHashPrefix(i6, hashTableMask) == hashPrefix && Objects.equal(e2, requireElements[i5])) {
                    return false;
                }
        ...
        resizeMeMaybe(i2);
        insertEntry(i, e2, smearedHash, hashTableMask);
        this.size = i2;
        incrementModCount();
        return true;
    }
    ...
    public Iterator<E> iterator() {
        ...
        return new Iterator<E>() { // from class: com.google.common.collect.CompactHashSet.1
            ...
            public E next() {
                ...
                E e2 = (E) CompactHashSet.this.element(i);
    ...
    public Spliterator<E> spliterator() {
        ...
        return Spliterators.spliterator(requireElements(), 0, this.size, 17);
    }
