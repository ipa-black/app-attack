...
public final class Multimaps {
    ...
    private static class CustomSortedSetMultimap<K, V> extends AbstractSortedSetMultimap<K, V> {
        ...
        private void readObject(ObjectInputStream objectInputStream) throws IOException, ClassNotFoundException {
            objectInputStream.defaultReadObject();
            com.google.common.base.Supplier<? extends SortedSet<V>> supplier = (com.google.common.base.Supplier) objectInputStream.readObject();
    ...
    static class Keys<K, V> extends AbstractMultiset<K> {
        ...
        public Spliterator<K> spliterator() {
            return CollectSpliterators.map(this.multimap.entries().spliterator(), new ImmutableMap$$ExternalSyntheticLambda0());
        }
