...
public class FirebaseInstallations implements FirebaseInstallationsApi {
    ...
    public Task<String> getId() {
        ...
        this.backgroundExecutor.execute(new Runnable() { // from class: com.google.firebase.installations.FirebaseInstallations$$ExternalSyntheticLambda1
            ...
            public final void run() {
                FirebaseInstallations.this.m468x9bfaa81c();
            }
        });
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* renamed from: lambda$getId$0$com-google-firebase-installations-FirebaseInstallations  reason: not valid java name */
    public /* synthetic */ void m468x9bfaa81c() {
        m469x4bb3eea9(false);
    }
    ...
    public Task<InstallationTokenResult> getToken(final boolean z) {
        ...
        this.backgroundExecutor.execute(new Runnable() { // from class: com.google.firebase.installations.FirebaseInstallations$$ExternalSyntheticLambda3
            @Override // java.lang.Runnable
            public final void run() {
                FirebaseInstallations.this.m469x4bb3eea9(z);
            }
        });
    ...
    public final void m469x4bb3eea9(final boolean z) {
        ...
        this.networkExecutor.execute(new Runnable() { // from class: com.google.firebase.installations.FirebaseInstallations$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
                FirebaseInstallations.this.m467x349c6181(z);
            }
        });
    }
    ...
    */
    public void m467x349c6181(boolean r3) {
        /*
            r2 = this;
        ...
        L5f:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.firebase.installations.FirebaseInstallations.m467x349c6181(boolean):void");
    }
