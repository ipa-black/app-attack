...
public class NotificationParams {
    ...
    public String getLocalizedString(Resources resources, String str, String str2) {
        ...
        try {
            ...
            Log.w("NotificationParams", new StringBuilder(String.valueOf(userFriendlyKey2).length() + 58 + String.valueOf(arrays).length()).append("Missing format argument for ").append(userFriendlyKey2).append(": ").append(arrays).append(" Default value will be used.").toString(), e2);
            return null;
        }
    }
