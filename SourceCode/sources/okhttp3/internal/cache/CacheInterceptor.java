...
public final class CacheInterceptor implements Interceptor {
    ...
    private static Headers combine(Headers headers, Headers headers2) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if ((!"Warning".equalsIgnoreCase(name) || !value.startsWith(IcyHeaders.REQUEST_HEADER_ENABLE_METADATA_VALUE)) && (isContentSpecificHeader(name) || !isEndToEnd(name) || headers2.get(name) == null)) {
