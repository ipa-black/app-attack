...
public final class RealConnection extends Http2Connection.Listener implements Connection {
    ...
    /* JADX WARN: Removed duplicated region for block: B:18:0x007d A[Catch: IOException -> 0x00e6, TRY_LEAVE, TryCatch #0 {IOException -> 0x00e6, blocks: (B:16:0x0075, B:18:0x007d), top: B:62:0x0075 }] */
    ...
    /* JADX WARN: Removed duplicated region for block: B:59:0x012f A[EDGE_INSN: B:72:0x012f->B:59:0x012f ?: BREAK  ] */
    /*
    ...
    */
    ...
    private Request createTunnelRequest() {
        return new Request.Builder().url(this.route.address().url()).header(com.google.common.net.HttpHeaders.HOST, Util.hostHeader(this.route.address().url(), true)).header("Proxy-Connection", com.google.common.net.HttpHeaders.KEEP_ALIVE).header("User-Agent", Version.userAgent()).build();
    }
