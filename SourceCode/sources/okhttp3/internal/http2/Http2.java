...
public final class Http2 {
    ...
    public static String frameLog(boolean z, int i, int i2, byte b2, byte b3) {
        ...
        return Util.format("%s 0x%08x %5d %-13s %s", z ? "<<" : ">>", Integer.valueOf(i), Integer.valueOf(i2), b2 < strArr.length ? strArr[b2] : Util.format("0x%02x", Byte.valueOf(b2)), formatFlags(b2, b3));
    }
