...
public class SlidingPaneLayout extends ViewGroup {
                    ...
                    if (childAt2.getVisibility() != i4) {
                        ...
                        if (z2 && childAt2 != this.mSlideableView) {
                            if (layoutParams2.width < 0 && (measuredWidth2 > i10 || layoutParams2.weight > 0.0f)) {
                                ...
                                childAt2.measure(View.MeasureSpec.makeMeasureSpec(i10, i6), makeMeasureSpec2);
                            }
    ...
    boolean smoothSlideTo(float f2, int i) {
        ...
        if (this.mCanSlide) {
            ...
            LayoutParams layoutParams = (LayoutParams) this.mSlideableView.getLayoutParams();
            if (isLayoutRtlSupport) {
                paddingLeft = (int) (getWidth() - (((getPaddingRight() + layoutParams.rightMargin) + (f2 * this.mSlideRange)) + this.mSlideableView.getWidth()));
            } else {
                paddingLeft = (int) (getPaddingLeft() + layoutParams.leftMargin + (f2 * this.mSlideRange));
            }
