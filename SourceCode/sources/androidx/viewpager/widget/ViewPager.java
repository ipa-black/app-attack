...
public class ViewPager extends ViewGroup {
    ...
    */
    ...
    private boolean pageScrolled(int i) {
        ...
        float f3 = ((i / f2) - infoForCurrentScrollPosition.offset) / (infoForCurrentScrollPosition.widthFactor + (i2 / f2));
        this.mCalledSuper = false;
    ...
    */
    ...
    private ItemInfo infoForCurrentScrollPosition() {
        ...
        while (i2 < this.mItems.size()) {
            ...
            f2 = itemInfo3.offset;
            float f5 = itemInfo3.widthFactor + f2 + f3;
            if (!z && scrollX < f2) {
                return itemInfo;
            }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        while (i2 < i3) {
            ...
            if (i2 == itemInfo.position) {
                f3 = (itemInfo.offset + itemInfo.widthFactor) * width2;
                f2 = itemInfo.offset + itemInfo.widthFactor + f5;
            } else {
