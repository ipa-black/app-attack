...
public class AnimatorInflaterCompat {
    ...
    private static void parseAnimatorFromTypeArray(ValueAnimator valueAnimator, TypedArray typedArray, TypedArray typedArray2, float f2, XmlPullParser xmlPullParser) {
        long namedInt = TypedArrayUtils.getNamedInt(typedArray, xmlPullParser, "duration", 1, VastError.ERROR_CODE_GENERAL_WRAPPER);
    ...
    */
    ...
    private static void dumpKeyframes(Object[] objArr, String str) {
        ...
        for (int i = 0; i < length; i++) {
            ...
            Object obj = "null";
            StringBuilder append = new StringBuilder("Keyframe ").append(i).append(": fraction ").append(keyframe.getFraction() < 0.0f ? "null" : Float.valueOf(keyframe.getFraction())).append(", , value : ");
