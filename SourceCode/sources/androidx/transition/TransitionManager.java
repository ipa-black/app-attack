...
public class TransitionManager {
    ...
    private static void changeScene(Scene scene, Transition transition) {
        ...
        mo32clone.setSceneRoot(sceneRoot);
        if (currentScene != null && currentScene.isCreatedFromLayoutResource()) {
            mo32clone.setCanRemoveViews(true);
        }
        sceneChangeSetup(sceneRoot, mo32clone);
        scene.enter();
        sceneChangeRunTransition(sceneRoot, mo32clone);
    }
    ...
    public static void beginDelayedTransition(ViewGroup viewGroup, Transition transition) {
        ...
        Transition mo32clone = transition.mo32clone();
        sceneChangeSetup(viewGroup, mo32clone);
        Scene.setCurrentScene(viewGroup, null);
        sceneChangeRunTransition(viewGroup, mo32clone);
    }
