...
public class ConstraintSet {
    ...
    */
    ...
    public static class Constraint {
        ...
        public static class Delta {
            ...
            void applyDelta(Constraint c2) {
                for (int i = 0; i < this.mCountInt; i++) {
                    ConstraintSet.setDeltaValue(c2, this.mTypeInt[i], this.mValueInt[i]);
                }
                for (int i2 = 0; i2 < this.mCountFloat; i2++) {
                    ConstraintSet.setDeltaValue(c2, this.mTypeFloat[i2], this.mValueFloat[i2]);
                }
                for (int i3 = 0; i3 < this.mCountString; i3++) {
                    ConstraintSet.setDeltaValue(c2, this.mTypeString[i3], this.mValueString[i3]);
                }
                for (int i4 = 0; i4 < this.mCountBoolean; i4++) {
                    ConstraintSet.setDeltaValue(c2, this.mTypeBoolean[i4], this.mValueBoolean[i4]);
                }
            }
    ...
    private String sideToString(int side) {
        switch (side) {
            ...
            case 3:
                return JavaLdapSupport.TOP_ATTR;
            case 4:
                return "bottom";
            case 5:
                return "baseline";
    ...
    */
    ...
    private static void populateOverride(Context ctx, Constraint c2, TypedArray a2) {
        ...
        for (int i = 0; i < indexCount; i++) {
            ...
            switch (overrideMapToConstant.get(index)) {
                case 2:
                    delta.add(2, a2.getDimensionPixelSize(index, c2.layout.bottomMargin));
                    break;
                case 3:
                case 4:
                case 9:
                ...
                default:
                    ...
                    break;
                case 5:
                    delta.add(5, a2.getString(index));
                    break;
                case 6:
                    delta.add(6, a2.getDimensionPixelOffset(index, c2.layout.editorAbsoluteX));
                    break;
                case 7:
                    delta.add(7, a2.getDimensionPixelOffset(index, c2.layout.editorAbsoluteY));
                    break;
                case 8:
                    delta.add(8, a2.getDimensionPixelSize(index, c2.layout.endMargin));
                    break;
                case 11:
                    delta.add(11, a2.getDimensionPixelSize(index, c2.layout.goneBottomMargin));
                    break;
                case 12:
                    delta.add(12, a2.getDimensionPixelSize(index, c2.layout.goneEndMargin));
                    break;
                case 13:
                    delta.add(13, a2.getDimensionPixelSize(index, c2.layout.goneLeftMargin));
                    break;
                case 14:
                    delta.add(14, a2.getDimensionPixelSize(index, c2.layout.goneRightMargin));
                    break;
                case 15:
                    delta.add(15, a2.getDimensionPixelSize(index, c2.layout.goneStartMargin));
                    break;
                case 16:
                    delta.add(16, a2.getDimensionPixelSize(index, c2.layout.goneTopMargin));
                    break;
                case 17:
                    delta.add(17, a2.getDimensionPixelOffset(index, c2.layout.guideBegin));
                    break;
                case 18:
                    delta.add(18, a2.getDimensionPixelOffset(index, c2.layout.guideEnd));
                    break;
                case 19:
                    delta.add(19, a2.getFloat(index, c2.layout.guidePercent));
                    break;
                case 20:
                    delta.add(20, a2.getFloat(index, c2.layout.horizontalBias));
                    break;
                case 21:
                    delta.add(21, a2.getLayoutDimension(index, c2.layout.mHeight));
                    break;
                case 22:
                    delta.add(22, VISIBILITY_FLAGS[a2.getInt(index, c2.propertySet.visibility)]);
                    break;
                case 23:
                    delta.add(23, a2.getLayoutDimension(index, c2.layout.mWidth));
                    break;
                case 24:
                    delta.add(24, a2.getDimensionPixelSize(index, c2.layout.leftMargin));
                    break;
                case 27:
                    delta.add(27, a2.getInt(index, c2.layout.orientation));
                    break;
                case 28:
                    delta.add(28, a2.getDimensionPixelSize(index, c2.layout.rightMargin));
                    break;
                case 31:
                    delta.add(31, a2.getDimensionPixelSize(index, c2.layout.startMargin));
                    break;
                case 34:
                    delta.add(34, a2.getDimensionPixelSize(index, c2.layout.topMargin));
                    break;
                case 37:
                    delta.add(37, a2.getFloat(index, c2.layout.verticalBias));
                    break;
                case 38:
                    c2.mViewId = a2.getResourceId(index, c2.mViewId);
                    delta.add(38, c2.mViewId);
                    break;
                case 39:
                    delta.add(39, a2.getFloat(index, c2.layout.horizontalWeight));
                    break;
                case 40:
                    delta.add(40, a2.getFloat(index, c2.layout.verticalWeight));
                    break;
                case 41:
                    delta.add(41, a2.getInt(index, c2.layout.horizontalChainStyle));
                    break;
                case 42:
                    delta.add(42, a2.getInt(index, c2.layout.verticalChainStyle));
                    break;
                case 43:
                    delta.add(43, a2.getFloat(index, c2.propertySet.alpha));
                    break;
                case 44:
                    delta.add(44, true);
                    delta.add(44, a2.getDimension(index, c2.transform.elevation));
                    break;
                case 45:
                    delta.add(45, a2.getFloat(index, c2.transform.rotationX));
                    break;
                case 46:
                    delta.add(46, a2.getFloat(index, c2.transform.rotationY));
                    break;
                case 47:
                    delta.add(47, a2.getFloat(index, c2.transform.scaleX));
                    break;
                case 48:
                    delta.add(48, a2.getFloat(index, c2.transform.scaleY));
                    break;
                case 49:
                    delta.add(49, a2.getDimension(index, c2.transform.transformPivotX));
                    break;
                case 50:
                    delta.add(50, a2.getDimension(index, c2.transform.transformPivotY));
                    break;
                case 51:
                    delta.add(51, a2.getDimension(index, c2.transform.translationX));
                    break;
                case 52:
                    delta.add(52, a2.getDimension(index, c2.transform.translationY));
                    break;
                case 53:
                    delta.add(53, a2.getDimension(index, c2.transform.translationZ));
                    break;
                case 54:
                    delta.add(54, a2.getInt(index, c2.layout.widthDefault));
                    break;
                case 55:
                    delta.add(55, a2.getInt(index, c2.layout.heightDefault));
                    break;
                case 56:
                    delta.add(56, a2.getDimensionPixelSize(index, c2.layout.widthMax));
                    break;
                case 57:
                    delta.add(57, a2.getDimensionPixelSize(index, c2.layout.heightMax));
                    break;
                case 58:
                    delta.add(58, a2.getDimensionPixelSize(index, c2.layout.widthMin));
                    break;
                case 59:
                    delta.add(59, a2.getDimensionPixelSize(index, c2.layout.heightMin));
                    break;
                case 60:
                    delta.add(60, a2.getFloat(index, c2.transform.rotation));
                    break;
                case 62:
                    delta.add(62, a2.getDimensionPixelSize(index, c2.layout.circleRadius));
                    break;
                case 63:
                    delta.add(63, a2.getFloat(index, c2.layout.circleAngle));
                    break;
                case 64:
                    delta.add(64, lookupID(a2, index, c2.motion.mAnimateRelativeTo));
                    break;
                case 65:
                    if (a2.peekValue(index).type == 3) {
                        delta.add(65, a2.getString(index));
                        break;
                    } else {
                        delta.add(65, Easing.NAMED_EASING[a2.getInteger(index, 0)]);
                        break;
                    }
                case 66:
                    delta.add(66, a2.getInt(index, 0));
                    break;
                case 67:
                    delta.add(67, a2.getFloat(index, c2.motion.mPathRotate));
                    break;
                case 68:
                    delta.add(68, a2.getFloat(index, c2.propertySet.mProgress));
                    break;
                case 69:
                    delta.add(69, a2.getFloat(index, 1.0f));
                    break;
                case 70:
                    delta.add(70, a2.getFloat(index, 1.0f));
                    break;
                case 71:
                    Log.e(TAG, "CURRENTLY UNSUPPORTED");
                    break;
                case 72:
                    delta.add(72, a2.getInt(index, c2.layout.mBarrierDirection));
                    break;
                case 73:
                    delta.add(73, a2.getDimensionPixelSize(index, c2.layout.mBarrierMargin));
                    break;
                case 74:
                    delta.add(74, a2.getString(index));
                    break;
                case 75:
                    delta.add(75, a2.getBoolean(index, c2.layout.mBarrierAllowsGoneWidgets));
                    break;
                case 76:
                    delta.add(76, a2.getInt(index, c2.motion.mPathMotionArc));
                    break;
                case 77:
                    delta.add(77, a2.getString(index));
                    break;
                case 78:
                    delta.add(78, a2.getInt(index, c2.propertySet.mVisibilityMode));
                    break;
                case 79:
                    delta.add(79, a2.getFloat(index, c2.motion.mMotionStagger));
                    break;
                case 80:
                    delta.add(80, a2.getBoolean(index, c2.layout.constrainedWidth));
                    break;
                case 81:
                    delta.add(81, a2.getBoolean(index, c2.layout.constrainedHeight));
                    break;
                case 82:
                    delta.add(82, a2.getInteger(index, c2.motion.mAnimateCircleAngleTo));
                    break;
                case 83:
                    delta.add(83, lookupID(a2, index, c2.transform.transformPivotTarget));
                    break;
                case 84:
                    delta.add(84, a2.getInteger(index, c2.motion.mQuantizeMotionSteps));
                    break;
                case 85:
                    delta.add(85, a2.getFloat(index, c2.motion.mQuantizeMotionPhase));
                    break;
                case 86:
                    TypedValue peekValue = a2.peekValue(index);
                    if (peekValue.type == 1) {
                        c2.motion.mQuantizeInterpolatorID = a2.getResourceId(index, -1);
                        delta.add(89, c2.motion.mQuantizeInterpolatorID);
                        if (c2.motion.mQuantizeInterpolatorID != -1) {
                        ...
                        c2.motion.mQuantizeInterpolatorString = a2.getString(index);
                        delta.add(90, c2.motion.mQuantizeInterpolatorString);
                        if (c2.motion.mQuantizeInterpolatorString.indexOf("/") > 0) {
                            c2.motion.mQuantizeInterpolatorID = a2.getResourceId(index, -1);
                            delta.add(89, c2.motion.mQuantizeInterpolatorID);
                            c2.motion.mQuantizeInterpolatorType = -2;
                            delta.add(88, c2.motion.mQuantizeInterpolatorType);
                        ...
                        c2.motion.mQuantizeInterpolatorType = a2.getInteger(index, c2.motion.mQuantizeInterpolatorID);
                        delta.add(88, c2.motion.mQuantizeInterpolatorType);
                        break;
                    }
                case 87:
                    ...
                    break;
                case 93:
                    delta.add(93, a2.getDimensionPixelSize(index, c2.layout.baselineMargin));
                    break;
                case 94:
                    delta.add(94, a2.getDimensionPixelSize(index, c2.layout.goneBaselineMargin));
                    break;
                case 95:
                    parseDimensionConstraints(delta, a2, index, 0);
                    break;
                case 96:
                    parseDimensionConstraints(delta, a2, index, 1);
                    break;
                case 97:
                    delta.add(97, a2.getInt(index, c2.layout.mWrapBehavior));
                    break;
                case 98:
                ...
                case 99:
                    delta.add(99, a2.getBoolean(index, c2.layout.guidelineUseRtl));
                    break;
            }
        }
    }
            ...
            if (type == 39) {
                ...
                switch (type) {
                    case 43:
                        ...
                        return;
                    case 44:
                        c2.transform.elevation = value;
                        c2.transform.applyElevation = true;
                        return;
                    case 45:
    ...
    public static void setDeltaValue(Constraint c2, int type, String value) {
        if (type == 5) {
            ...
            c2.layout.mReferenceIdString = value;
            c2.layout.mReferenceIds = null;
        } else if (type == 77) {
    ...
    private void populateConstraint(Context ctx, Constraint c2, TypedArray a2, boolean override) {
        if (override) {
            populateOverride(ctx, c2, a2);
            return;
        }
        int indexCount = a2.getIndexCount();
        for (int i = 0; i < indexCount; i++) {
            ...
            switch (mapToConstant.get(index)) {
                case 1:
                    c2.layout.baselineToBaseline = lookupID(a2, index, c2.layout.baselineToBaseline);
                    break;
                case 2:
                    c2.layout.bottomMargin = a2.getDimensionPixelSize(index, c2.layout.bottomMargin);
                    break;
                case 3:
                    c2.layout.bottomToBottom = lookupID(a2, index, c2.layout.bottomToBottom);
                    break;
                case 4:
                    c2.layout.bottomToTop = lookupID(a2, index, c2.layout.bottomToTop);
                    break;
                case 5:
                    c2.layout.dimensionRatio = a2.getString(index);
                    break;
                case 6:
                    c2.layout.editorAbsoluteX = a2.getDimensionPixelOffset(index, c2.layout.editorAbsoluteX);
                    break;
                case 7:
                    c2.layout.editorAbsoluteY = a2.getDimensionPixelOffset(index, c2.layout.editorAbsoluteY);
                    break;
                case 8:
                    c2.layout.endMargin = a2.getDimensionPixelSize(index, c2.layout.endMargin);
                    break;
                case 9:
                    c2.layout.endToEnd = lookupID(a2, index, c2.layout.endToEnd);
                    break;
                case 10:
                    c2.layout.endToStart = lookupID(a2, index, c2.layout.endToStart);
                    break;
                case 11:
                    c2.layout.goneBottomMargin = a2.getDimensionPixelSize(index, c2.layout.goneBottomMargin);
                    break;
                case 12:
                    c2.layout.goneEndMargin = a2.getDimensionPixelSize(index, c2.layout.goneEndMargin);
                    break;
                case 13:
                    c2.layout.goneLeftMargin = a2.getDimensionPixelSize(index, c2.layout.goneLeftMargin);
                    break;
                case 14:
                    c2.layout.goneRightMargin = a2.getDimensionPixelSize(index, c2.layout.goneRightMargin);
                    break;
                case 15:
                    c2.layout.goneStartMargin = a2.getDimensionPixelSize(index, c2.layout.goneStartMargin);
                    break;
                case 16:
                    c2.layout.goneTopMargin = a2.getDimensionPixelSize(index, c2.layout.goneTopMargin);
                    break;
                case 17:
                    c2.layout.guideBegin = a2.getDimensionPixelOffset(index, c2.layout.guideBegin);
                    break;
                case 18:
                    c2.layout.guideEnd = a2.getDimensionPixelOffset(index, c2.layout.guideEnd);
                    break;
                case 19:
                    c2.layout.guidePercent = a2.getFloat(index, c2.layout.guidePercent);
                    break;
                case 20:
                    c2.layout.horizontalBias = a2.getFloat(index, c2.layout.horizontalBias);
                    break;
                case 21:
                    c2.layout.mHeight = a2.getLayoutDimension(index, c2.layout.mHeight);
                    break;
                case 22:
                    c2.propertySet.visibility = a2.getInt(index, c2.propertySet.visibility);
                    c2.propertySet.visibility = VISIBILITY_FLAGS[c2.propertySet.visibility];
                    break;
                case 23:
                    c2.layout.mWidth = a2.getLayoutDimension(index, c2.layout.mWidth);
                    break;
                case 24:
                    c2.layout.leftMargin = a2.getDimensionPixelSize(index, c2.layout.leftMargin);
                    break;
                case 25:
                    c2.layout.leftToLeft = lookupID(a2, index, c2.layout.leftToLeft);
                    break;
                case 26:
                    c2.layout.leftToRight = lookupID(a2, index, c2.layout.leftToRight);
                    break;
                case 27:
                    c2.layout.orientation = a2.getInt(index, c2.layout.orientation);
                    break;
                case 28:
                    c2.layout.rightMargin = a2.getDimensionPixelSize(index, c2.layout.rightMargin);
                    break;
                case 29:
                    c2.layout.rightToLeft = lookupID(a2, index, c2.layout.rightToLeft);
                    break;
                case 30:
                    c2.layout.rightToRight = lookupID(a2, index, c2.layout.rightToRight);
                    break;
                case 31:
                    c2.layout.startMargin = a2.getDimensionPixelSize(index, c2.layout.startMargin);
                    break;
                case 32:
                    c2.layout.startToEnd = lookupID(a2, index, c2.layout.startToEnd);
                    break;
                case 33:
                    c2.layout.startToStart = lookupID(a2, index, c2.layout.startToStart);
                    break;
                case 34:
                    c2.layout.topMargin = a2.getDimensionPixelSize(index, c2.layout.topMargin);
                    break;
                case 35:
                    c2.layout.topToBottom = lookupID(a2, index, c2.layout.topToBottom);
                    break;
                case 36:
                    c2.layout.topToTop = lookupID(a2, index, c2.layout.topToTop);
                    break;
                case 37:
                    c2.layout.verticalBias = a2.getFloat(index, c2.layout.verticalBias);
                    break;
                case 38:
                    c2.mViewId = a2.getResourceId(index, c2.mViewId);
                    break;
                case 39:
                    c2.layout.horizontalWeight = a2.getFloat(index, c2.layout.horizontalWeight);
                    break;
                case 40:
                    c2.layout.verticalWeight = a2.getFloat(index, c2.layout.verticalWeight);
                    break;
                case 41:
                    c2.layout.horizontalChainStyle = a2.getInt(index, c2.layout.horizontalChainStyle);
                    break;
                case 42:
                    c2.layout.verticalChainStyle = a2.getInt(index, c2.layout.verticalChainStyle);
                    break;
                case 43:
                    c2.propertySet.alpha = a2.getFloat(index, c2.propertySet.alpha);
                    break;
                case 44:
                    c2.transform.applyElevation = true;
                    c2.transform.elevation = a2.getDimension(index, c2.transform.elevation);
                    break;
                case 45:
                    c2.transform.rotationX = a2.getFloat(index, c2.transform.rotationX);
                    break;
                case 46:
                    c2.transform.rotationY = a2.getFloat(index, c2.transform.rotationY);
                    break;
                case 47:
                    c2.transform.scaleX = a2.getFloat(index, c2.transform.scaleX);
                    break;
                case 48:
                    c2.transform.scaleY = a2.getFloat(index, c2.transform.scaleY);
                    break;
                case 49:
                    c2.transform.transformPivotX = a2.getDimension(index, c2.transform.transformPivotX);
                    break;
                case 50:
                    c2.transform.transformPivotY = a2.getDimension(index, c2.transform.transformPivotY);
                    break;
                case 51:
                    c2.transform.translationX = a2.getDimension(index, c2.transform.translationX);
                    break;
                case 52:
                    c2.transform.translationY = a2.getDimension(index, c2.transform.translationY);
                    break;
                case 53:
                    c2.transform.translationZ = a2.getDimension(index, c2.transform.translationZ);
                    break;
                case 54:
                    c2.layout.widthDefault = a2.getInt(index, c2.layout.widthDefault);
                    break;
                case 55:
                    c2.layout.heightDefault = a2.getInt(index, c2.layout.heightDefault);
                    break;
                case 56:
                    c2.layout.widthMax = a2.getDimensionPixelSize(index, c2.layout.widthMax);
                    break;
                case 57:
                    c2.layout.heightMax = a2.getDimensionPixelSize(index, c2.layout.heightMax);
                    break;
                case 58:
                    c2.layout.widthMin = a2.getDimensionPixelSize(index, c2.layout.widthMin);
                    break;
                case 59:
                    c2.layout.heightMin = a2.getDimensionPixelSize(index, c2.layout.heightMin);
                    break;
                case 60:
                    c2.transform.rotation = a2.getFloat(index, c2.transform.rotation);
                    break;
                case 61:
                    c2.layout.circleConstraint = lookupID(a2, index, c2.layout.circleConstraint);
                    break;
                case 62:
                    c2.layout.circleRadius = a2.getDimensionPixelSize(index, c2.layout.circleRadius);
                    break;
                case 63:
                    c2.layout.circleAngle = a2.getFloat(index, c2.layout.circleAngle);
                    break;
                case 64:
                    c2.motion.mAnimateRelativeTo = lookupID(a2, index, c2.motion.mAnimateRelativeTo);
                    break;
                case 65:
                    if (a2.peekValue(index).type == 3) {
                        c2.motion.mTransitionEasing = a2.getString(index);
                        break;
                    } else {
                        c2.motion.mTransitionEasing = Easing.NAMED_EASING[a2.getInteger(index, 0)];
                        break;
                    }
                case 66:
                    c2.motion.mDrawPath = a2.getInt(index, 0);
                    break;
                case 67:
                    c2.motion.mPathRotate = a2.getFloat(index, c2.motion.mPathRotate);
                    break;
                case 68:
                    c2.propertySet.mProgress = a2.getFloat(index, c2.propertySet.mProgress);
                    break;
                case 69:
                    c2.layout.widthPercent = a2.getFloat(index, 1.0f);
                    break;
                case 70:
                    c2.layout.heightPercent = a2.getFloat(index, 1.0f);
                    break;
                case 71:
                    Log.e(TAG, "CURRENTLY UNSUPPORTED");
                    break;
                case 72:
                    c2.layout.mBarrierDirection = a2.getInt(index, c2.layout.mBarrierDirection);
                    break;
                case 73:
                    c2.layout.mBarrierMargin = a2.getDimensionPixelSize(index, c2.layout.mBarrierMargin);
                    break;
                case 74:
                    c2.layout.mReferenceIdString = a2.getString(index);
                    break;
                case 75:
                    c2.layout.mBarrierAllowsGoneWidgets = a2.getBoolean(index, c2.layout.mBarrierAllowsGoneWidgets);
                    break;
                case 76:
                    c2.motion.mPathMotionArc = a2.getInt(index, c2.motion.mPathMotionArc);
                    break;
                case 77:
                    c2.layout.mConstraintTag = a2.getString(index);
                    break;
                case 78:
                    c2.propertySet.mVisibilityMode = a2.getInt(index, c2.propertySet.mVisibilityMode);
                    break;
                case 79:
                    c2.motion.mMotionStagger = a2.getFloat(index, c2.motion.mMotionStagger);
                    break;
                case 80:
                    c2.layout.constrainedWidth = a2.getBoolean(index, c2.layout.constrainedWidth);
                    break;
                case 81:
                    c2.layout.constrainedHeight = a2.getBoolean(index, c2.layout.constrainedHeight);
                    break;
                case 82:
                    c2.motion.mAnimateCircleAngleTo = a2.getInteger(index, c2.motion.mAnimateCircleAngleTo);
                    break;
                case 83:
                    c2.transform.transformPivotTarget = lookupID(a2, index, c2.transform.transformPivotTarget);
                    break;
                case 84:
                    c2.motion.mQuantizeMotionSteps = a2.getInteger(index, c2.motion.mQuantizeMotionSteps);
                    break;
                case 85:
                    c2.motion.mQuantizeMotionPhase = a2.getFloat(index, c2.motion.mQuantizeMotionPhase);
                    break;
                case 86:
                    TypedValue peekValue = a2.peekValue(index);
                    if (peekValue.type == 1) {
                ...
                default:
                    ...
                    break;
                case 91:
                    c2.layout.baselineToTop = lookupID(a2, index, c2.layout.baselineToTop);
                    break;
                case 92:
                    c2.layout.baselineToBottom = lookupID(a2, index, c2.layout.baselineToBottom);
                    break;
                case 93:
                    c2.layout.baselineMargin = a2.getDimensionPixelSize(index, c2.layout.baselineMargin);
                    break;
                case 94:
                    c2.layout.goneBaselineMargin = a2.getDimensionPixelSize(index, c2.layout.goneBaselineMargin);
                    break;
                case 95:
                    parseDimensionConstraints(c2.layout, a2, index, 0);
                    break;
                case 96:
                    parseDimensionConstraints(c2.layout, a2, index, 1);
                    break;
                case 97:
                    c2.layout.mWrapBehavior = a2.getInt(index, c2.layout.mWrapBehavior);
                    break;
            }
        }
        if (c2.layout.mReferenceIdString != null) {
            c2.layout.mReferenceIds = null;
        }
    }
    ...
    class WriteXmlEngine {
        ...
        void writeLayout() throws IOException {
            ...
            for (Integer num : ConstraintSet.this.mConstraints.keySet()) {
                ...
                writeEnum("app:barrierDirection", layout.mBarrierDirection, new String[]{TtmlNode.LEFT, TtmlNode.RIGHT, JavaLdapSupport.TOP_ATTR, "bottom", TtmlNode.START, TtmlNode.END}, -1);
    ...
    class WriteJsonEngine {
        ...
        void writeLayout() throws IOException {
            ...
            for (Integer num : ConstraintSet.this.mConstraints.keySet()) {
                ...
                Layout layout = ((Constraint) ConstraintSet.this.mConstraints.get(num)).layout;
                writeDimension(IabUtils.KEY_HEIGHT, layout.mHeight, layout.heightDefault, layout.heightPercent, layout.heightMin, layout.heightMax, layout.constrainedHeight);
                writeDimension(IabUtils.KEY_WIDTH, layout.mWidth, layout.widthDefault, layout.widthPercent, layout.widthMin, layout.widthMax, layout.constrainedWidth);
