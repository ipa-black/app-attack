...
public class Motion implements TypedValues {
    ...
    public void buildPath(float[] fArr, int i) {
        ...
        while (i2 < i) {
            ...
            if (easing != null) {
                ...
                d2 = (((float) easing.get((f9 - f7) / f2)) * (f10 - f7)) + f7;
            }
            double d3 = d2;
            ...
            if (keyCycleOscillator != null) {
                ...
                fArr[i3] = fArr[i3] + splineSet.get(f9);
            }
    ...
    private float getPreCycleDistance() {
        ...
        while (i < 100) {
            ...
            f4 = i2 > 0 ? (float) (f8 + Math.hypot(d3 - fArr[1], d2 - fArr[0])) : f8;
            d2 = fArr[0];
            i = i2 + 1;
            d3 = fArr[1];
        }
    ...
    float getKeyFrameParameter(int i, float f2, float f3) {
        ...
        float f6 = this.mStartMotionPath.x + (this.mStartMotionPath.width / 2.0f);
        float f7 = this.mStartMotionPath.y + (this.mStartMotionPath.height / 2.0f);
    ...
    public void setup(int i, int i2, float f2, long j) {
        ...
        for (String str5 : this.mEndMotionPath.customAttributes.keySet()) {
            if (this.mStartMotionPath.customAttributes.containsKey(str5) && !hashSet2.contains("CUSTOM," + str5)) {
                hashSet4.add(str5);
            }
        }
        ...
        while (true) {
            ...
            for (int i18 = 0; i18 < i4; i18++) {
                if (motionPathsArr[i18].hasCustomData(str8)) {
                    if (dArr4 == null) {
                        dArr3 = new double[i4];
                        dArr4 = (double[][]) Array.newInstance(Double.TYPE, i4, motionPathsArr[i18].getCustomDataCount(str8));
                    }
        ...
        if (motionPathsArr[0].mPathMotionArc != -1) {
            ...
            double[][] dArr6 = (double[][]) Array.newInstance(Double.TYPE, i4, 2);
        ...
        if (curveFitArr != null) {
            ...
            if (this.mKeyTriggers != null) {
                ...
                while (true) {
                    ...
                    motionKeyTriggerArr[i3].conditionallyFire(f6, motionWidget);
                    i3++;
                }
            }
        } else {
            float f7 = this.mStartMotionPath.x + ((this.mEndMotionPath.x - this.mStartMotionPath.x) * f6) + 0.5f;
            float f8 = this.mStartMotionPath.y + ((this.mEndMotionPath.y - this.mStartMotionPath.y) * f6) + 0.5f;
            motionWidget.layout((int) f7, (int) f8, (int) (f7 + this.mStartMotionPath.width + ((this.mEndMotionPath.width - this.mStartMotionPath.width) * f6)), (int) (f8 + this.mStartMotionPath.height + ((this.mEndMotionPath.height - this.mStartMotionPath.height) * f6)));
        }
    ...
    void getDpDt(float f2, float f3, float f4, float[] fArr) {
        ...
        float f6 = this.mEndMotionPath.x - this.mStartMotionPath.x;
        float f7 = this.mEndMotionPath.y - this.mStartMotionPath.y;
