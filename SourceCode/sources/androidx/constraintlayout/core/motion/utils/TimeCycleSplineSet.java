...
public abstract class TimeCycleSplineSet {
    ...
    public static class CustomSet extends TimeCycleSplineSet {
        ...
        public void setPoint(int i, CustomAttribute customAttribute, float f2, int i2, float f3) {
        ...
        public boolean setProperty(MotionWidget motionWidget, float f2, long j, KeyCache keyCache) {
            ...
            this.last_cycle = (float) ((this.last_cycle + ((j2 * 1.0E-9d) * f3)) % 1.0d);
            this.last_time = j;
    ...
    public static class CustomVarSet extends TimeCycleSplineSet {
        ...
        public void setPoint(int i, CustomVariable customVariable, float f2, int i2, float f3) {
