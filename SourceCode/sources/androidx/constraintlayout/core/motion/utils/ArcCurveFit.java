    ...
    public double getPos(double d2, int i) {
        ...
        if (this.mExtrapolate) {
            if (d2 < this.mArcs[0].mTime1) {
                ...
                if (d2 > this.mArcs[arcArr3.length - 1].mTime2) {
                    double d5 = this.mArcs[arcArr4.length - 1].mTime2;
                    d3 = d2 - d5;
                    Arc[] arcArr5 = this.mArcs;
            ...
            if (d2 > this.mArcs[arcArr.length - 1].mTime2) {
                d2 = this.mArcs[arcArr2.length - 1].mTime2;
            }
        }
        while (true) {
            Arc[] arcArr6 = this.mArcs;
        ...
        private void buildTable(double d2, double d3, double d4, double d5) {
            ...
            while (true) {
                ...
                if (binarySearch >= 0) {
                    ...
                    double d14 = dArr4[i5];
                    this.mLut[i3] = (i5 + ((length - d14) / (dArr4[i4 - 1] - d14))) / (dArr4.length - 1);
                }
                i3++;
            }
        }
