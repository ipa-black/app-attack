...
public class ConstraintWidget {
    ...
    private void serializeSize(StringBuilder sb, String str, int i, int i2, int i3, int i4, int i5, int i6, float f2, float f3) {
        ...
        serializeAttribute(sb, AppLovinMediationProvider.MAX, i3, Integer.MAX_VALUE);
    ...
    public StringBuilder serialize(StringBuilder sb) {
        ...
        serializeAnchor(sb, JavaLdapSupport.TOP_ATTR, this.mTop);
        ...
        serializeSize(sb, IabUtils.KEY_WIDTH, this.mWidth, this.mMinWidth, this.mMaxDimension[0], this.mWidthOverride, this.mMatchConstraintMinWidth, this.mMatchConstraintDefaultWidth, this.mMatchConstraintPercentWidth, this.mWeight[0]);
        serializeSize(sb, IabUtils.KEY_HEIGHT, this.mHeight, this.mMinHeight, this.mMaxDimension[1], this.mHeightOverride, this.mMatchConstraintMinHeight, this.mMatchConstraintDefaultHeight, this.mMatchConstraintPercentHeight, this.mWeight[1]);
    ...
    public boolean oppositeDimensionDependsOn(int i) {
        ...
        return dimensionBehaviourArr[i] == DimensionBehaviour.MATCH_CONSTRAINT && dimensionBehaviourArr[c2] == DimensionBehaviour.MATCH_CONSTRAINT;
    }
    ...
    /* JADX WARN: Removed duplicated region for block: B:310:0x0581  */
    ...
    */
    ...
    /* JADX WARN: Removed duplicated region for block: B:234:0x03a8 A[ADDED_TO_REGION] */
    ...
    /* JADX WARN: Removed duplicated region for block: B:254:0x0412  */
    /* JADX WARN: Removed duplicated region for block: B:263:0x0434  */
    /* JADX WARN: Removed duplicated region for block: B:265:0x0438 A[ADDED_TO_REGION] */
    /* JADX WARN: Removed duplicated region for block: B:276:0x0452  */
    /* JADX WARN: Removed duplicated region for block: B:307:0x049c  */
    /* JADX WARN: Removed duplicated region for block: B:314:0x04ae A[ADDED_TO_REGION] */
    /* JADX WARN: Removed duplicated region for block: B:327:0x04d4 A[ADDED_TO_REGION] */
    ...
    */
    ...
    public void getSceneString(StringBuilder sb) {
        ...
        getSceneString(sb, JavaLdapSupport.TOP_ATTR, this.mTop);
