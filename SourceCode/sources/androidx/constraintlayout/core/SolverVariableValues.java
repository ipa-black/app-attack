...
public class SolverVariableValues implements ArrayRow.ArrayRowVariables {
    ...
    private void addVariable(int i, SolverVariable solverVariable, float f2) {
    ...
    private void insertVariable(int i, SolverVariable solverVariable, float f2) {
    ...
    public void put(SolverVariable solverVariable, float f2) {
        ...
        insertVariable(i3, solverVariable, f2);
    }
    ...
    public float use(ArrayRow arrayRow, boolean z) {
        ...
        while (i2 < currentSize) {
            if (solverVariableValues.variables[i3] != -1) {
                add(this.mCache.mIndexedVariables[solverVariableValues.variables[i3]], solverVariableValues.values[i3] * f2, z);
                i2++;
            }
            i3++;
        }
