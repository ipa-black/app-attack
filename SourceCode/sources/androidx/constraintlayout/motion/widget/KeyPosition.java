...
public class KeyPosition extends KeyPositionBase {
    ...
    private void calcScreenPosition(int layoutWidth, int layoutHeight) {
        ...
        float f3 = 0;
        this.mCalculatedPositionX = (layoutWidth * f2) + f3;
        this.mCalculatedPositionY = (layoutHeight * f2) + f3;
    }
    ...
    private static class Loader {
        ...
        public static void read(KeyPosition c2, TypedArray a2) {
                ...
                switch (mAttrMap.get(index)) {
                    ...
                    case 3:
                        if (a2.peekValue(index).type == 3) {
                            ...
                            c2.mTransitionEasing = Easing.NAMED_EASING[a2.getInteger(index, 0)];
                            break;
                        }
                    case 4:
                        ...
                        break;
                    case 5:
                        c2.mDrawPath = a2.getInt(index, c2.mDrawPath);
                        break;
                    case 6:
                        c2.mPercentX = a2.getFloat(index, c2.mPercentX);
                        break;
                    case 7:
                        c2.mPercentY = a2.getFloat(index, c2.mPercentY);
                        break;
                    case 8:
                        float f2 = a2.getFloat(index, c2.mPercentHeight);
                        c2.mPercentWidth = f2;
                        c2.mPercentHeight = f2;
                        break;
                    case 9:
                        c2.mPositionType = a2.getInt(index, c2.mPositionType);
                        break;
                    case 10:
                        c2.mPathMotionArc = a2.getInt(index, c2.mPathMotionArc);
                        break;
                    case 11:
                        c2.mPercentWidth = a2.getFloat(index, c2.mPercentWidth);
                        break;
                    case 12:
                        c2.mPercentHeight = a2.getFloat(index, c2.mPercentHeight);
                        break;
                    default:
