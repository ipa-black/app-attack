...
public class MotionController {
    ...
    public void buildPath(float[] points, int pointCount) {
        ...
        while (i < pointCount) {
            ...
            if (viewOscillator != null) {
                ...
                points[i2] = points[i2] + viewSpline.get(f9);
            }
    ...
    public float getKeyFrameParameter(int type, float x, float y) {
        ...
        if (type != 0) {
            ...
            return (float) Math.sqrt((hypot * hypot) - (f8 * f8));
        }
        return f8 / hypot;
    }
    ...
    public void setup(int parentWidth, int parentHeight, float transitionDuration, long currentTime) {
        ...
        double[][] dArr2 = (double[][]) Array.newInstance(Double.TYPE, i, this.mInterpolateVariables.length);
        ...
        if (motionPathsArr[0].mPathMotionArc != Key.UNSET) {
            ...
            double[][] dArr7 = (double[][]) Array.newInstance(Double.TYPE, i, 2);
        ...
        if (curveFitArr != null) {
            ...
            if (this.mKeyTriggers != null) {
                ...
                while (true) {
                    ...
                    keyTriggerArr[i3].conditionallyFire(f5, child);
                    i3++;
                }
            }
        } else {
            i = 1;
            float f6 = this.mStartMotionPath.x + ((this.mEndMotionPath.x - this.mStartMotionPath.x) * f5);
            float f7 = f6 + 0.5f;
            int i4 = (int) f7;
            float f8 = this.mStartMotionPath.y + ((this.mEndMotionPath.y - this.mStartMotionPath.y) * f5) + 0.5f;
            int i5 = (int) f8;
            int i6 = (int) (f7 + this.mStartMotionPath.width + ((this.mEndMotionPath.width - this.mStartMotionPath.width) * f5));
            int i7 = (int) (f8 + this.mStartMotionPath.height + ((this.mEndMotionPath.height - this.mStartMotionPath.height) * f5));
            int i8 = i6 - i4;
            int i9 = i7 - i5;
        ...
        if (hashMap4 != null) {
            for (ViewOscillator viewOscillator : hashMap4.values()) {
                if (viewOscillator instanceof ViewOscillator.PathRotateSet) {
                    ...
                    ((ViewOscillator.PathRotateSet) viewOscillator).setPathRotate(child, f5, dArr4[0], dArr4[i]);
                } else {
    ...
    public void getDpDt(float position, float locationX, float locationY, float[] mAnchorDpDt) {
        ...
        float f5 = (this.mEndMotionPath.height - this.mStartMotionPath.height) + f4;
        mAnchorDpDt[0] = (f3 * (1.0f - locationX)) + (((this.mEndMotionPath.width - this.mStartMotionPath.width) + f3) * locationX);
        mAnchorDpDt[1] = (f4 * (1.0f - locationY)) + (f5 * locationY);
    }
