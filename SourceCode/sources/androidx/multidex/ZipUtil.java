    ...
    static CentralDirectory findCentralDirectory(RandomAccessFile randomAccessFile) throws IOException, ZipException {
        ...
        do {
            ...
            if (randomAccessFile.readInt() == reverseBytes) {
                ...
                centralDirectory.size = Integer.reverseBytes(randomAccessFile.readInt()) & ArrayUnsignedIntList.MAX_VALUE;
                centralDirectory.offset = Integer.reverseBytes(randomAccessFile.readInt()) & ArrayUnsignedIntList.MAX_VALUE;
