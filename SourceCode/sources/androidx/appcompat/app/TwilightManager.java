...
class TwilightManager {
    ...
    private void updateState(Location location) {
        ...
        twilightCalculator.calculateTwilight(currentTimeMillis - Constants.MILLIS_IN_DAY, location.getLatitude(), location.getLongitude());
        ...
        twilightCalculator.calculateTwilight(Constants.MILLIS_IN_DAY + currentTimeMillis, location.getLatitude(), location.getLongitude());
