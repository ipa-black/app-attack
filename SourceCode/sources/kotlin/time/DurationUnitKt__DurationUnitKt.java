...
class DurationUnitKt__DurationUnitKt extends DurationUnitKt__DurationUnitJvmKt {
    ...
    public static final DurationUnit durationUnitByShortName(String shortName) {
        ...
        if (hashCode != 100) {
            if (hashCode != 104) {
                ...
                } else if (shortName.equals(m.o)) {
                    return DurationUnit.MINUTES;
                }
            } else if (shortName.equals("h")) {
                return DurationUnit.HOURS;
            }
        } else if (shortName.equals(d.f11571a)) {
    ...
    public static final DurationUnit durationUnitByIsoChar(char c2, boolean z) {
        if (!z) {
            ...
            throw new IllegalArgumentException(Intrinsics.stringPlus("Invalid or unsupported duration ISO non-time unit: ", Character.valueOf(c2)));
        } else if (c2 == 'H') {
            return DurationUnit.HOURS;
        } else {
            if (c2 == 'M') {
            ...
            throw new IllegalArgumentException(Intrinsics.stringPlus("Invalid duration ISO time unit: ", Character.valueOf(c2)));
        }
    }
}
