...
public final class DurationKt {
    ...
    public static final long toDuration(double d2, DurationUnit unit) {
        Intrinsics.checkNotNullParameter(unit, "unit");
        double convertDurationUnit = DurationUnitKt.convertDurationUnit(d2, unit, DurationUnit.NANOSECONDS);
        ...
        return durationOfMillisNormalized(MathKt.roundToLong(DurationUnitKt.convertDurationUnit(d2, unit, DurationUnit.MILLISECONDS)));
    }
    ...
    private static final long m1934timesmvk6XK0(int i, long j) {
        return Duration.m1846timesUwyO8pc(j, i);
    }

    /* renamed from: times-kIfJnKk */
    private static final long m1933timeskIfJnKk(double d2, long j) {
        return Duration.m1845timesUwyO8pc(j, d2);
    }
    ...
    public static final long parseDuration(String str, boolean z) {
        ...
        long m1910getZEROUwyO8pc = Duration.Companion.m1910getZEROUwyO8pc();
        ...
        if (str.charAt(i) == 'P') {
            ...
            while (i2 < length) {
                if (str.charAt(i2) != 'T') {
                    ...
                    if (length2 < 0 || length2 > StringsKt.getLastIndex(str3)) {
                        throw new IllegalArgumentException(Intrinsics.stringPlus("Missing unit for value ", substring));
                    }
                    ...
                    if (durationUnitByIsoChar == DurationUnit.SECONDS && indexOf$default > 0) {
                        ...
                        long m1844plusLRDsOJo = Duration.m1844plusLRDsOJo(m1910getZEROUwyO8pc, toDuration(parseOverLongIsoComponent(substring2), durationUnitByIsoChar));
                        String substring3 = substring.substring(indexOf$default);
                        Intrinsics.checkNotNullExpressionValue(substring3, "this as java.lang.String).substring(startIndex)");
                        m1910getZEROUwyO8pc = Duration.m1844plusLRDsOJo(m1844plusLRDsOJo, toDuration(Double.parseDouble(substring3), durationUnitByIsoChar));
                    } else {
                        m1910getZEROUwyO8pc = Duration.m1844plusLRDsOJo(m1910getZEROUwyO8pc, toDuration(parseOverLongIsoComponent(substring), durationUnitByIsoChar));
                    }
            ...
            if (StringsKt.regionMatches(str, i, "Infinity", 0, Math.max(length - i, 8), true)) {
                m1910getZEROUwyO8pc = Duration.Companion.m1908getINFINITEUwyO8pc();
            } else {
                boolean z7 = !z4;
                ...
                while (i < length) {
                    ...
                    if (indexOf$default2 > 0) {
                        ...
                        long m1844plusLRDsOJo2 = Duration.m1844plusLRDsOJo(m1910getZEROUwyO8pc, toDuration(Long.parseLong(substring6), durationUnitByShortName));
                        String substring7 = substring4.substring(indexOf$default2);
                        Intrinsics.checkNotNullExpressionValue(substring7, "this as java.lang.String).substring(startIndex)");
                        m1910getZEROUwyO8pc = Duration.m1844plusLRDsOJo(m1844plusLRDsOJo2, toDuration(Double.parseDouble(substring7), durationUnitByShortName));
                        if (i < length) {
                            throw new IllegalArgumentException("Fractional component must be last");
                        }
                    } else {
                        m1910getZEROUwyO8pc = Duration.m1844plusLRDsOJo(m1910getZEROUwyO8pc, toDuration(Long.parseLong(substring4), durationUnitByShortName));
                    }
                    str4 = str6;
        ...
        return z2 ? Duration.m1860unaryMinusUwyO8pc(m1910getZEROUwyO8pc) : m1910getZEROUwyO8pc;
    }
    ...
    public static final long durationOfNanos(long j) {
        return Duration.m1808constructorimpl(j << 1);
    }

    public static final long durationOfMillis(long j) {
        return Duration.m1808constructorimpl((j << 1) + 1);
    }

    public static final long durationOf(long j, int i) {
        return Duration.m1808constructorimpl((j << 1) + i);
    }
