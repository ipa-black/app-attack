...
final class AdjustedTimeMark extends TimeMark {
    ...
    public final long m1803getAdjustmentUwyO8pc() {
    ...
    public long mo1801elapsedNowUwyO8pc() {
        return Duration.m1843minusLRDsOJo(this.mark.mo1801elapsedNowUwyO8pc(), m1803getAdjustmentUwyO8pc());
    }

    @Override // kotlin.time.TimeMark
    /* renamed from: plus-LRDsOJo */
    public TimeMark mo1802plusLRDsOJo(long j) {
        return new AdjustedTimeMark(this.mark, Duration.m1844plusLRDsOJo(m1803getAdjustmentUwyO8pc(), j), null);
    }
}
