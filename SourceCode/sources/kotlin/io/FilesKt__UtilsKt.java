...
public class FilesKt__UtilsKt extends FilesKt__FileTreeWalkKt {
    ...
    private static final String toRelativeStringOrNull$FilesKt__UtilsKt(File file, File file2) {
        ...
        if (Intrinsics.areEqual(normalize$FilesKt__UtilsKt.getRoot(), normalize$FilesKt__UtilsKt2.getRoot())) {
            ...
            if (i < size2) {
                ...
                CollectionsKt.joinTo(CollectionsKt.drop(normalize$FilesKt__UtilsKt.getSegments(), i), sb, (r14 & 2) != 0 ? ", " : separator, (r14 & 4) != 0 ? "" : null, (r14 & 8) != 0 ? "" : null, (r14 & 16) != 0 ? -1 : 0, (r14 & 32) != 0 ? APSSharedUtil.TRUNCATE_SEPARATOR : null, (r14 & 64) != 0 ? null : null);
            }
            return sb.toString();
        }
        return null;
        ...
        try {
            Iterator<File> it = FilesKt.walkTopDown(file).onFail(new Function2<File, IOException, Unit>() { // from class: kotlin.io.FilesKt__UtilsKt$copyRecursively$2
                ...
                public final void invoke2(File f2, IOException e2) {
                    ...
                    if (onError.invoke(f2, e2) == OnErrorAction.TERMINATE) {
    ...
    public static final File resolve(File file, File relative) {
        ...
        String str = file2;
        return (str.length() == 0 || StringsKt.endsWith$default((CharSequence) str, File.separatorChar, false, 2, (Object) null)) ? new File(Intrinsics.stringPlus(file2, relative)) : new File(file2 + File.separatorChar + relative);
    }
