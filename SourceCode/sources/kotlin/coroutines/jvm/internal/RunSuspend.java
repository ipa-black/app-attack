...
final class RunSuspend implements Continuation<Unit> {
    ...
    public final Result<Unit> m1688getResultxLWZpok() {
        return this.result;
    }
    ...
    public void resumeWith(Object obj) {
        synchronized (this) {
            setResult(Result.m500boximpl(obj));
            notifyAll();
    ...
    public final void await() {
        synchronized (this) {
            while (true) {
                Result<Unit> m1688getResultxLWZpok = m1688getResultxLWZpok();
                if (m1688getResultxLWZpok == null) {
                    wait();
                } else {
                    ResultKt.throwOnFailure(m1688getResultxLWZpok.m510unboximpl());
                }
            }
        }
    }
