            ...
            public final Caller<? extends Member> invoke() {
                ...
                if (constructor instanceof Constructor) {
                    ...
                    if (!Modifier.isStatic(method3.getModifiers())) {
                        createJvmStaticInObjectCaller = KFunctionImpl.this.createInstanceMethodCaller(method3);
                    } else {
                        createJvmStaticInObjectCaller = KFunctionImpl.this.getDescriptor().getAnnotations().mo1757findAnnotation(UtilKt.getJVM_STATIC()) != null ? KFunctionImpl.this.createJvmStaticInObjectCaller(method3) : KFunctionImpl.this.createStaticMethodCaller(method3);
                    }
        ...
        this.defaultCaller$delegate = ReflectProperties.lazy(new Function0<Caller<? extends Member>>() { // from class: kotlin.reflect.jvm.internal.KFunctionImpl$defaultCaller$2
            ...
            public final Caller<? extends Member> invoke() {
                ...
                if (mapSignature instanceof JvmFunctionSignature.KotlinFunction) {
                    ...
                    Intrinsics.checkNotNull(KFunctionImpl.this.getCaller().mo1750getMember());
                    constructor = container.findDefaultMethod(methodName, methodDesc, !Modifier.isStatic(mo1750getMember.getModifiers()));
                ...
                if (constructor instanceof Constructor) {
                    ...
                    method = (KFunctionImpl.this.getDescriptor().getAnnotations().mo1757findAnnotation(UtilKt.getJVM_STATIC()) == null || ((ClassDescriptor) KFunctionImpl.this.getDescriptor().getContainingDeclaration()).isCompanionObject()) ? KFunctionImpl.this.createStaticMethodCaller((Method) constructor) : KFunctionImpl.this.createJvmStaticInObjectCaller((Method) constructor);
                } else {
                    method = null;
                }
                if (method == null) {
