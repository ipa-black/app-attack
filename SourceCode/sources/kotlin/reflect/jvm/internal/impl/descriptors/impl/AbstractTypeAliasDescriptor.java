...
public abstract class AbstractTypeAliasDescriptor extends DeclarationDescriptorNonRootImpl implements TypeAliasDescriptor {
    ...
    public AbstractTypeAliasDescriptor(DeclarationDescriptor containingDeclaration, Annotations annotations, Name name, SourceElement sourceElement, DescriptorVisibility visibilityImpl) {
        ...
        this.typeConstructor = new TypeConstructor() { // from class: kotlin.reflect.jvm.internal.impl.descriptors.impl.AbstractTypeAliasDescriptor$typeConstructor$1
            ...
            public TypeAliasDescriptor mo1763getDeclarationDescriptor() {
            ...
            public Collection<KotlinType> mo1764getSupertypes() {
                Collection<KotlinType> mo1764getSupertypes = mo1763getDeclarationDescriptor().getUnderlyingType().getConstructor().mo1764getSupertypes();
                Intrinsics.checkNotNullExpressionValue(mo1764getSupertypes, "declarationDescriptor.un…pe.constructor.supertypes");
                return mo1764getSupertypes;
            }

            @Override // kotlin.reflect.jvm.internal.impl.types.TypeConstructor
            public KotlinBuiltIns getBuiltIns() {
                return DescriptorUtilsKt.getBuiltIns(mo1763getDeclarationDescriptor());
            }

            public String toString() {
                return "[typealias " + mo1763getDeclarationDescriptor().getName().asString() + ']';
            }
        ...
        return TypeUtils.contains(getUnderlyingType(), new Function1<UnwrappedType, Boolean>() { // from class: kotlin.reflect.jvm.internal.impl.descriptors.impl.AbstractTypeAliasDescriptor$isInner$1
            ...
            public final Boolean invoke(UnwrappedType type) {
                ...
                if (!KotlinTypeKt.isError(type)) {
                    ...
                    ClassifierDescriptor mo1763getDeclarationDescriptor = type.getConstructor().mo1763getDeclarationDescriptor();
                    if ((mo1763getDeclarationDescriptor instanceof TypeParameterDescriptor) && !Intrinsics.areEqual(((TypeParameterDescriptor) mo1763getDeclarationDescriptor).getContainingDeclaration(), abstractTypeAliasDescriptor)) {
                        z = true;
