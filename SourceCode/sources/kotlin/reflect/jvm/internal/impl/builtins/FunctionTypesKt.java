...
public final class FunctionTypesKt {
    public static final boolean isFunctionType(KotlinType kotlinType) {
        ...
        return (mo1763getDeclarationDescriptor == null ? null : getFunctionalClassKind(mo1763getDeclarationDescriptor)) == FunctionClassKind.Function;
    }

    public static final boolean isSuspendFunctionType(KotlinType kotlinType) {
        Intrinsics.checkNotNullParameter(kotlinType, "<this>");
        ClassifierDescriptor mo1763getDeclarationDescriptor = kotlinType.getConstructor().mo1763getDeclarationDescriptor();
        return (mo1763getDeclarationDescriptor == null ? null : getFunctionalClassKind(mo1763getDeclarationDescriptor)) == FunctionClassKind.SuspendFunction;
    }

    public static final boolean isBuiltinFunctionalType(KotlinType kotlinType) {
        Intrinsics.checkNotNullParameter(kotlinType, "<this>");
        ClassifierDescriptor mo1763getDeclarationDescriptor = kotlinType.getConstructor().mo1763getDeclarationDescriptor();
        return mo1763getDeclarationDescriptor != null && isBuiltinFunctionalClassDescriptor(mo1763getDeclarationDescriptor);
    }
    ...
    private static final boolean isTypeAnnotatedWithExtensionFunctionType(KotlinType kotlinType) {
        return kotlinType.getAnnotations().mo1757findAnnotation(StandardNames.FqNames.extensionFunctionType) != null;
    }
    ...
    */
    public static final kotlin.reflect.jvm.internal.impl.name.Name extractParameterNameFromFunctionTypeArgument(kotlin.reflect.jvm.internal.impl.types.KotlinType r2) {
        /*
            ...
            kotlin.reflect.jvm.internal.impl.descriptors.annotations.AnnotationDescriptor r2 = r2.mo1757findAnnotation(r0)
            r0 = 0
            if (r2 != 0) goto L13
            return r0
        L13:
