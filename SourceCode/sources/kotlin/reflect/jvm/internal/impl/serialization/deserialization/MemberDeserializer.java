...
public final class MemberDeserializer {
    ...
    private final DeserializationContext f16382c;
    ...
    public final PropertyDescriptor loadProperty(final ProtoBuf.Property proto) {
        ...
        DeclarationDescriptor containingDeclaration = this.f16382c.getContainingDeclaration();
        ...
        Name name = NameResolverUtilKt.getName(this.f16382c.getNameResolver(), proto.getName());
        ...
        final DeserializedPropertyDescriptor deserializedPropertyDescriptor = new DeserializedPropertyDescriptor(containingDeclaration, null, annotations, modality, descriptorVisibility, booleanValue, name, memberKind, booleanValue2, booleanValue3, booleanValue4, booleanValue5, bool6.booleanValue(), proto, this.f16382c.getNameResolver(), this.f16382c.getTypeTable(), this.f16382c.getVersionRequirementTable(), this.f16382c.getContainerSource());
        List<ProtoBuf.TypeParameter> typeParameterList = proto.getTypeParameterList();
        Intrinsics.checkNotNullExpressionValue(typeParameterList, "proto.typeParameterList");
        DeserializationContext childContext$default = DeserializationContext.childContext$default(this.f16382c, deserializedPropertyDescriptor, typeParameterList, null, null, null, null, 60, null);
        ...
        KotlinType type = childContext$default.getTypeDeserializer().type(ProtoTypeTableUtilKt.returnType(proto, this.f16382c.getTypeTable()));
        ...
        ProtoBuf.Type receiverType = ProtoTypeTableUtilKt.receiverType(proto, this.f16382c.getTypeTable());
        ...
        if (bool16.booleanValue()) {
            deserializedPropertyDescriptor.setCompileTimeInitializer(this.f16382c.getStorageManager().createNullableLazyValue(new Function0<ConstantValue<?>>() { // from class: kotlin.reflect.jvm.internal.impl.serialization.deserialization.MemberDeserializer$loadProperty$3
                ...
                public final ConstantValue<?> invoke() {
                    ...
                    deserializationContext = memberDeserializer.f16382c;
                    ...
                    deserializationContext2 = MemberDeserializer.this.f16382c;
    ...
    public final SimpleFunctionDescriptor loadFunction(ProtoBuf.Function proto) {
        ...
        if (Intrinsics.areEqual(DescriptorUtilsKt.getFqNameSafe(this.f16382c.getContainingDeclaration()).child(NameResolverUtilKt.getName(this.f16382c.getNameResolver(), proto.getName())), SuspendFunctionTypeUtilKt.KOTLIN_SUSPEND_BUILT_IN_FUNCTION_FQ_NAME)) {
            versionRequirementTable = VersionRequirementTable.Companion.getEMPTY();
        } else {
            versionRequirementTable = this.f16382c.getVersionRequirementTable();
        }
        DeserializedSimpleFunctionDescriptor deserializedSimpleFunctionDescriptor = new DeserializedSimpleFunctionDescriptor(this.f16382c.getContainingDeclaration(), null, annotations, NameResolverUtilKt.getName(this.f16382c.getNameResolver(), proto.getName()), ProtoEnumFlagsUtilsKt.memberKind(ProtoEnumFlags.INSTANCE, Flags.MEMBER_KIND.get(flags)), proto, this.f16382c.getNameResolver(), this.f16382c.getTypeTable(), versionRequirementTable, this.f16382c.getContainerSource(), null, 1024, null);
        List<ProtoBuf.TypeParameter> typeParameterList = proto.getTypeParameterList();
        Intrinsics.checkNotNullExpressionValue(typeParameterList, "proto.typeParameterList");
        DeserializationContext childContext$default = DeserializationContext.childContext$default(this.f16382c, deserializedSimpleFunctionDescriptor, typeParameterList, null, null, null, null, 60, null);
        ProtoBuf.Type receiverType = ProtoTypeTableUtilKt.receiverType(proto, this.f16382c.getTypeTable());
        ...
        Pair<CallableDescriptor.UserDataKey<?>, Object> deserializeContractFromFunction = this.f16382c.getComponents().getContractDeserializer().deserializeContractFromFunction(proto, deserializedSimpleFunctionDescriptor, this.f16382c.getTypeTable(), childContext$default.getTypeDeserializer());
    ...
    public final TypeAliasDescriptor loadTypeAlias(ProtoBuf.TypeAlias proto) {
        ...
        for (ProtoBuf.Annotation it : list) {
            ...
            arrayList.add(annotationDeserializer.deserializeAnnotation(it, this.f16382c.getNameResolver()));
        }
        DeserializedTypeAliasDescriptor deserializedTypeAliasDescriptor = new DeserializedTypeAliasDescriptor(this.f16382c.getStorageManager(), this.f16382c.getContainingDeclaration(), companion.create(arrayList), NameResolverUtilKt.getName(this.f16382c.getNameResolver(), proto.getName()), ProtoEnumFlagsUtilsKt.descriptorVisibility(ProtoEnumFlags.INSTANCE, Flags.VISIBILITY.get(proto.getFlags())), proto, this.f16382c.getNameResolver(), this.f16382c.getTypeTable(), this.f16382c.getVersionRequirementTable(), this.f16382c.getContainerSource());
        List<ProtoBuf.TypeParameter> typeParameterList = proto.getTypeParameterList();
        Intrinsics.checkNotNullExpressionValue(typeParameterList, "proto.typeParameterList");
        DeserializationContext childContext$default = DeserializationContext.childContext$default(this.f16382c, deserializedTypeAliasDescriptor, typeParameterList, null, null, null, null, 60, null);
        deserializedTypeAliasDescriptor.initialize(childContext$default.getTypeDeserializer().getOwnTypeParameters(), childContext$default.getTypeDeserializer().simpleType(ProtoTypeTableUtilKt.underlyingType(proto, this.f16382c.getTypeTable()), false), childContext$default.getTypeDeserializer().simpleType(ProtoTypeTableUtilKt.expandedType(proto, this.f16382c.getTypeTable()), false));
    ...
    public final ClassConstructorDescriptor loadConstructor(ProtoBuf.Constructor proto, boolean z) {
        Intrinsics.checkNotNullParameter(proto, "proto");
        ClassDescriptor classDescriptor = (ClassDescriptor) this.f16382c.getContainingDeclaration();
        ProtoBuf.Constructor constructor = proto;
        DeserializedClassConstructorDescriptor deserializedClassConstructorDescriptor = new DeserializedClassConstructorDescriptor(classDescriptor, null, getAnnotations(constructor, proto.getFlags(), AnnotatedCallableKind.FUNCTION), z, CallableMemberDescriptor.Kind.DECLARATION, proto, this.f16382c.getNameResolver(), this.f16382c.getTypeTable(), this.f16382c.getVersionRequirementTable(), this.f16382c.getContainerSource(), null, 1024, null);
        MemberDeserializer memberDeserializer = DeserializationContext.childContext$default(this.f16382c, deserializedClassConstructorDescriptor, CollectionsKt.emptyList(), null, null, null, null, 60, null).getMemberDeserializer();
        List<ProtoBuf.ValueParameter> valueParameterList = proto.getValueParameterList();
        Intrinsics.checkNotNullExpressionValue(valueParameterList, "proto.valueParameterList");
    ...
    private final Annotations getAnnotations(final MessageLite messageLite, int i, final AnnotatedCallableKind annotatedCallableKind) {
        ...
        return new NonEmptyDeserializedAnnotations(this.f16382c.getStorageManager(), new Function0<List<? extends AnnotationDescriptor>>() { // from class: kotlin.reflect.jvm.internal.impl.serialization.deserialization.MemberDeserializer$getAnnotations$1
            /* JADX INFO: Access modifiers changed from: package-private */
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(0);
            ...
            public final List<? extends AnnotationDescriptor> invoke() {
                ...
                if (asProtoContainer == null) {
                    ...
                    deserializationContext2 = memberDeserializer2.f16382c;
    ...
    private final Annotations getPropertyFieldAnnotations(final ProtoBuf.Property property, final boolean z) {
        ...
        return new NonEmptyDeserializedAnnotations(this.f16382c.getStorageManager(), new Function0<List<? extends AnnotationDescriptor>>() { // from class: kotlin.reflect.jvm.internal.impl.serialization.deserialization.MemberDeserializer$getPropertyFieldAnnotations$1
            /* JADX INFO: Access modifiers changed from: package-private */
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(0);
            ...
            public final List<? extends AnnotationDescriptor> invoke() {
                ...
                if (asProtoContainer == null) {
                    ...
                    if (z2) {
                        deserializationContext3 = memberDeserializer2.f16382c;
    ...
    private final Annotations getReceiverParameterAnnotations(final MessageLite messageLite, final AnnotatedCallableKind annotatedCallableKind) {
        return new DeserializedAnnotations(this.f16382c.getStorageManager(), new Function0<List<? extends AnnotationDescriptor>>() { // from class: kotlin.reflect.jvm.internal.impl.serialization.deserialization.MemberDeserializer$getReceiverParameterAnnotations$1
            /* JADX INFO: Access modifiers changed from: package-private */
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(0);
    ...
    */
    ...
    public final ProtoContainer asProtoContainer(DeclarationDescriptor declarationDescriptor) {
        if (declarationDescriptor instanceof PackageFragmentDescriptor) {
            return new ProtoContainer.Package(((PackageFragmentDescriptor) declarationDescriptor).getFqName(), this.f16382c.getNameResolver(), this.f16382c.getTypeTable(), this.f16382c.getContainerSource());
        }
