...
public final class DeserializedTypeParameterDescriptor extends AbstractLazyTypeParameterDescriptor {
    ...
    private final DeserializationContext f16386c;
    ...
    */
    ...
    protected List<KotlinType> resolveUpperBounds() {
        List<ProtoBuf.Type> upperBounds = ProtoTypeTableUtilKt.upperBounds(this.proto, this.f16386c.getTypeTable());
        if (upperBounds.isEmpty()) {
            return CollectionsKt.listOf(DescriptorUtilsKt.getBuiltIns(this).getDefaultBound());
        }
        List<ProtoBuf.Type> list = upperBounds;
        TypeDeserializer typeDeserializer = this.f16386c.getTypeDeserializer();
    ...
    public Void mo1766reportSupertypeLoopError(KotlinType type) {
