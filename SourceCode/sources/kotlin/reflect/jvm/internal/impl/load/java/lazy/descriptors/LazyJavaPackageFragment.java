...
public final class LazyJavaPackageFragment extends PackageFragmentDescriptorImpl {
    ...
    private final LazyJavaResolverContext f16376c;
    ...
    public LazyJavaPackageFragment(LazyJavaResolverContext outerContext, JavaPackage jPackage) {
        ...
        this.f16376c = childForClassOrPackage$default;
        this.binaryClasses$delegate = childForClassOrPackage$default.getStorageManager().createLazyValue(new Function0<Map<String, ? extends KotlinJvmBinaryClass>>() { // from class: kotlin.reflect.jvm.internal.impl.load.java.lazy.descriptors.LazyJavaPackageFragment$binaryClasses$2
            ...
            public final Map<String, ? extends KotlinJvmBinaryClass> invoke() {
                ...
                lazyJavaResolverContext = LazyJavaPackageFragment.this.f16376c;
                ...
                for (String str : packagePartProvider.findPackageParts(asString)) {
                    ...
                    lazyJavaResolverContext2 = lazyJavaPackageFragment.f16376c;
    ...
    public String toString() {
        return "Lazy Java package fragment: " + getFqName() + " of module " + this.f16376c.getComponents().getModule();
    }
