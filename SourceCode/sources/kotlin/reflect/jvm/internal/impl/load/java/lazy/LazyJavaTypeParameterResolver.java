...
public final class LazyJavaTypeParameterResolver implements TypeParameterResolver {
    ...
    private final LazyJavaResolverContext f16372c;
    ...
    public LazyJavaTypeParameterResolver(LazyJavaResolverContext c2, DeclarationDescriptor containingDeclaration, JavaTypeParameterListOwner typeParameterOwner, int i) {
        ...
        this.resolve = c2.getStorageManager().createMemoizedFunctionWithNullableValues(new Function1<JavaTypeParameter, LazyJavaTypeParameterDescriptor>() { // from class: kotlin.reflect.jvm.internal.impl.load.java.lazy.LazyJavaTypeParameterResolver$resolve$1
            ...
            public final LazyJavaTypeParameterDescriptor invoke(JavaTypeParameter typeParameter) {
                ...
                lazyJavaResolverContext = lazyJavaTypeParameterResolver.f16372c;
    ...
    public TypeParameterDescriptor resolveTypeParameter(JavaTypeParameter javaTypeParameter) {
        ...
        return invoke == null ? this.f16372c.getTypeParameterResolver().resolveTypeParameter(javaTypeParameter) : invoke;
    }
}
