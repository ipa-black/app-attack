...
public final class KotlinTypeFactory {
    ...
    private final MemberScope computeMemberScope(TypeConstructor typeConstructor, List<? extends TypeProjection> list, KotlinTypeRefiner kotlinTypeRefiner) {
        ...
        if (mo1763getDeclarationDescriptor instanceof TypeParameterDescriptor) {
            return ((TypeParameterDescriptor) mo1763getDeclarationDescriptor).getDefaultType().getMemberScope();
        }
        if (mo1763getDeclarationDescriptor instanceof ClassDescriptor) {
            if (kotlinTypeRefiner == null) {
                kotlinTypeRefiner = DescriptorUtilsKt.getKotlinTypeRefiner(DescriptorUtilsKt.getModule(mo1763getDeclarationDescriptor));
            }
            if (list.isEmpty()) {
                return ModuleAwareClassDescriptorKt.getRefinedUnsubstitutedMemberScopeIfPossible((ClassDescriptor) mo1763getDeclarationDescriptor, kotlinTypeRefiner);
            }
            return ModuleAwareClassDescriptorKt.getRefinedMemberScopeIfPossible((ClassDescriptor) mo1763getDeclarationDescriptor, TypeConstructorSubstitution.Companion.create(typeConstructor, list), kotlinTypeRefiner);
        } else if (mo1763getDeclarationDescriptor instanceof TypeAliasDescriptor) {
            MemberScope createErrorScope = ErrorUtils.createErrorScope(Intrinsics.stringPlus("Scope for abbreviation: ", ((TypeAliasDescriptor) mo1763getDeclarationDescriptor).getName()), true);
            ...
            throw new IllegalStateException("Unsupported classifier: " + mo1763getDeclarationDescriptor + " for constructor: " + typeConstructor);
        }
    }
    ...
    public static final SimpleType simpleType(final Annotations annotations, final TypeConstructor constructor, final List<? extends TypeProjection> arguments, final boolean z, KotlinTypeRefiner kotlinTypeRefiner) {
        ...
        if (annotations.isEmpty() && arguments.isEmpty() && !z && constructor.mo1763getDeclarationDescriptor() != null) {
            ClassifierDescriptor mo1763getDeclarationDescriptor = constructor.mo1763getDeclarationDescriptor();
            Intrinsics.checkNotNull(mo1763getDeclarationDescriptor);
            SimpleType defaultType = mo1763getDeclarationDescriptor.getDefaultType();
    ...
    public final ExpandedTypeOrRefinedConstructor refineConstructor(TypeConstructor typeConstructor, KotlinTypeRefiner kotlinTypeRefiner, List<? extends TypeProjection> list) {
        ClassifierDescriptor mo1763getDeclarationDescriptor = typeConstructor.mo1763getDeclarationDescriptor();
        ClassifierDescriptor refineDescriptor = mo1763getDeclarationDescriptor == null ? null : kotlinTypeRefiner.refineDescriptor(mo1763getDeclarationDescriptor);
