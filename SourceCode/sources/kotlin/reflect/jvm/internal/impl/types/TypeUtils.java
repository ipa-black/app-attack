...
public class TypeUtils {
    ...
    */
    ...
    public static List<KotlinType> getImmediateSupertypes(KotlinType kotlinType) {
        ...
        Collection<KotlinType> mo1764getSupertypes = kotlinType.getConstructor().mo1764getSupertypes();
        ArrayList arrayList = new ArrayList(mo1764getSupertypes.size());
        for (KotlinType kotlinType2 : mo1764getSupertypes) {
    ...
    public static boolean isNullableType(KotlinType kotlinType) {
        ...
        if (constructor instanceof IntersectionTypeConstructor) {
            for (KotlinType kotlinType2 : constructor.mo1764getSupertypes()) {
    ...
    public static boolean hasNullableSuperType(KotlinType kotlinType) {
        ...
        if (kotlinType.getConstructor().mo1763getDeclarationDescriptor() instanceof ClassDescriptor) {
            return false;
        }
    ...
    public static ClassDescriptor getClassDescriptor(KotlinType kotlinType) {
        ...
        if (mo1763getDeclarationDescriptor instanceof ClassDescriptor) {
            return (ClassDescriptor) mo1763getDeclarationDescriptor;
        }
        return null;
    }
        ...
        if (smartSet == null || !smartSet.contains(kotlinType)) {
            ...
            if (function12 == null || !function12.invoke(unwrap).booleanValue()) {
                ...
                if (flexibleType == null || !(contains(flexibleType.getLowerBound(), function1, function12, smartSet) || contains(flexibleType.getUpperBound(), function1, function12, smartSet))) {
                    ...
                    TypeConstructor constructor = kotlinType.getConstructor();
                    if (constructor instanceof IntersectionTypeConstructor) {
                        for (KotlinType kotlinType2 : ((IntersectionTypeConstructor) constructor).mo1764getSupertypes()) {
                    ...
                    for (TypeProjection typeProjection : kotlinType.getArguments()) {
                        if (!typeProjection.isStarProjection() && contains(typeProjection.getType(), function1, function12, smartSet)) {
                            return true;
                        }
                    }
                    return false;
    ...
    public static TypeParameterDescriptor getTypeParameterDescriptorOrNull(KotlinType kotlinType) {
        ...
        if (kotlinType.getConstructor().mo1763getDeclarationDescriptor() instanceof TypeParameterDescriptor) {
            return (TypeParameterDescriptor) kotlinType.getConstructor().mo1763getDeclarationDescriptor();
        }
        return null;
    }
}
