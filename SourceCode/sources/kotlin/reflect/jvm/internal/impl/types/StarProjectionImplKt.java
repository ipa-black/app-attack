        ...
        SimpleType substitute = TypeSubstitutor.create(new TypeConstructorSubstitution() { // from class: kotlin.reflect.jvm.internal.impl.types.StarProjectionImplKt$buildStarProjectionTypeByTypeParameters$1
            ...
            public TypeProjection get(TypeConstructor key) {
                ...
                if (list.contains(key)) {
                    ClassifierDescriptor mo1763getDeclarationDescriptor = key.mo1763getDeclarationDescriptor();
                    if (mo1763getDeclarationDescriptor != null) {
                        return TypeUtils.makeStarProjection((TypeParameterDescriptor) mo1763getDeclarationDescriptor);
                    }
