...
public final class CodedInputStream {
    ...
    public String readString() throws IOException {
        ...
        if (readRawVarint32 > this.bufferSize - this.bufferPos || readRawVarint32 <= 0) {
            ...
            return new String(readRawBytesSlowPath(readRawVarint32), C.UTF8_NAME);
        }
    ...
    public String readStringRequireUtf8() throws IOException {
        ...
        return new String(readRawBytesSlowPath, i, readRawVarint32, C.UTF8_NAME);
    }
