...
public class OverridingUtil {
    ...
    */
    ...
    public OverrideCompatibilityInfo isOverridableByWithoutExternalConditions(CallableDescriptor callableDescriptor, CallableDescriptor callableDescriptor2, boolean z) {
        ...
        while (i < compiledValueParameters.size()) {
            if (!areTypesEquivalent(compiledValueParameters.get(i), compiledValueParameters2.get(i), createTypeChecker)) {
        ...
        if (z) {
            ...
            if (returnType != null && returnType2 != null && ((!KotlinTypeKt.isError(returnType2) || !KotlinTypeKt.isError(returnType)) && !createTypeChecker.getFirst().isSubtypeOf(createTypeChecker.getSecond(), returnType2.unwrap(), returnType.unwrap()))) {
    ...
    */
    ...
    public static <H> H selectMostSpecificMember(Collection<H> collection, Function1<H, CallableDescriptor> function1) {
        ...
        H h4 = (H) CollectionsKt.first(collection);
        CallableDescriptor invoke = function1.invoke(h4);
        for (H h5 : collection) {
            CallableDescriptor invoke2 = function1.invoke(h5);
        ...
        if (arrayList.isEmpty()) {
            ...
            while (true) {
                ...
                h2 = (H) it.next();
                if (!FlexibleTypesKt.isFlexible(function1.invoke(h2).getReturnType())) {
                    break;
                }
            }
            if (h2 != null) {
            ...
            H h7 = (H) CollectionsKt.first((Iterable<? extends Object>) arrayList);
            if (h7 == null) {
                $$$reportNull$$$0(84);
            }
            return h7;
    ...
    public static <H> Collection<H> extractMembersOverridableInBothWays(H h2, Collection<H> collection, Function1<H, CallableDescriptor> function1, Function1<H, Unit> function12) {
        if (h2 == null) {
            $$$reportNull$$$0(99);
        }
        if (collection == null) {
