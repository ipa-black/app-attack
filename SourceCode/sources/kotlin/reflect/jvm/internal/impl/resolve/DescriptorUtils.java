...
public class DescriptorUtils {
    ...
    private static /* synthetic */ void $$$reportNull$$$0(int i) {
        ...
        switch (i) {
            ...
            case 70:
                ...
                break;
            case 71:
                objArr[0] = IronSourceConstants.EVENTS_RESULT;
                break;
            case 72:
    ...
    public static ModuleDescriptor getContainingModuleOrNull(KotlinType kotlinType) {
        ...
        return getContainingModuleOrNull(mo1763getDeclarationDescriptor);
    }
    ...
    public static boolean isDirectSubclass(ClassDescriptor classDescriptor, ClassDescriptor classDescriptor2) {
        ...
        for (KotlinType kotlinType : classDescriptor.getTypeConstructor().mo1764getSupertypes()) {
    ...
    private static boolean isSameClass(KotlinType kotlinType, DeclarationDescriptor declarationDescriptor) {
        ...
        ClassifierDescriptor mo1763getDeclarationDescriptor = kotlinType.getConstructor().mo1763getDeclarationDescriptor();
        if (mo1763getDeclarationDescriptor != null) {
            DeclarationDescriptor original = mo1763getDeclarationDescriptor.getOriginal();
    ...
    public static boolean isSubtypeOfClass(KotlinType kotlinType, DeclarationDescriptor declarationDescriptor) {
        ...
        for (KotlinType kotlinType2 : kotlinType.getConstructor().mo1764getSupertypes()) {
    ...
    public static ClassDescriptor getClassDescriptorForTypeConstructor(TypeConstructor typeConstructor) {
        ...
        ClassDescriptor classDescriptor = (ClassDescriptor) typeConstructor.mo1763getDeclarationDescriptor();
        if (classDescriptor == null) {
            $$$reportNull$$$0(47);
        }
    ...
    private static <D extends CallableDescriptor> void collectAllOverriddenDescriptors(D d2, Set<D> set) {
        if (d2 == null) {
            $$$reportNull$$$0(70);
        }
        if (set == 0) {
        ...
        for (CallableDescriptor callableDescriptor : d2.getOriginal().getOverriddenDescriptors()) {
