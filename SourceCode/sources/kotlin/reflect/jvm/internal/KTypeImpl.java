...
public final class KTypeImpl implements KTypeBase {
    ...
    public final KClassifier convert(KotlinType kotlinType) {
        ...
        if (mo1763getDeclarationDescriptor instanceof ClassDescriptor) {
            ...
            return new KTypeParameterImpl(null, (TypeParameterDescriptor) mo1763getDeclarationDescriptor);
        } else {
            if (mo1763getDeclarationDescriptor instanceof TypeAliasDescriptor) {
