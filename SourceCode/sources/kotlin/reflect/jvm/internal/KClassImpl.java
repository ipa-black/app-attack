...
public final class KClassImpl<T> extends KDeclarationContainerImpl implements KClass<T>, KClassifierImpl, KTypeParameterOwnerImpl {
        ...
        public Data(final KClassImpl this$0) {
            ...
            this.supertypes$delegate = ReflectProperties.lazySoft(new Function0<List<? extends KTypeImpl>>(this) { // from class: kotlin.reflect.jvm.internal.KClassImpl$Data$supertypes$2
                ...
                public final List<? extends KTypeImpl> invoke() {
                    Collection<KotlinType> mo1764getSupertypes = this.this$0.getDescriptor().getTypeConstructor().mo1764getSupertypes();
                    Intrinsics.checkNotNullExpressionValue(mo1764getSupertypes, "descriptor.typeConstructor.supertypes");
                    ArrayList arrayList = new ArrayList(mo1764getSupertypes.size());
                    final KClassImpl<T>.Data data = this.this$0;
                    final KClassImpl<T> kClassImpl = this$0;
                    for (final KotlinType kotlinType : mo1764getSupertypes) {
                        ...
                        arrayList.add(new KTypeImpl(kotlinType, new Function0<Type>() { // from class: kotlin.reflect.jvm.internal.KClassImpl$Data$supertypes$2$1$1
                            ...
                            public final Type invoke() {
                                ClassifierDescriptor mo1763getDeclarationDescriptor = KotlinType.this.getConstructor().mo1763getDeclarationDescriptor();
                                if (!(mo1763getDeclarationDescriptor instanceof ClassDescriptor)) {
                                    throw new KotlinReflectionInternalError(Intrinsics.stringPlus("Supertype not a class: ", mo1763getDeclarationDescriptor));
                                }
                                Class<?> javaClass = UtilKt.toJavaClass((ClassDescriptor) mo1763getDeclarationDescriptor);
                                if (javaClass == null) {
                                    throw new KotlinReflectionInternalError("Unsupported superclass of " + data + ": " + mo1763getDeclarationDescriptor);
                                }
                                ...
                                if (indexOf < 0) {
                                    throw new KotlinReflectionInternalError("No superclass of " + data + " in Java reflection for " + mo1763getDeclarationDescriptor);
                                }
    ...
    public PropertyDescriptor getLocalProperty(int i) {
        ...
        ProtoBuf.Property property = (ProtoBuf.Property) ProtoBufUtilKt.getExtensionOrNull(deserializedClassDescriptor.getClassProto(), classLocalVariable, i);
        if (property == null) {
            return null;
        }
