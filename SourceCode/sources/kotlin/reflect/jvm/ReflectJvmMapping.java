...
public final class ReflectJvmMapping {
    ...
    public static final Method getJavaMethod(KFunction<?> kFunction) {
        ...
        Object mo1750getMember = asKCallableImpl == null ? null : asKCallableImpl.getCaller().mo1750getMember();
        if (mo1750getMember instanceof Method) {
            return (Method) mo1750getMember;
        }
        return null;
    }
    ...
    public static final <T> Constructor<T> getJavaConstructor(KFunction<? extends T> kFunction) {
        ...
        KCallableImpl<?> asKCallableImpl = UtilKt.asKCallableImpl(kFunction);
        Object mo1750getMember = asKCallableImpl == null ? null : asKCallableImpl.getCaller().mo1750getMember();
        if (mo1750getMember instanceof Constructor) {
            return (Constructor) mo1750getMember;
        }
        return null;
    }
