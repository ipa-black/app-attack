...
public final class KClasses {
    ...
    public static final <T> KFunction<T> getPrimaryConstructor(KClass<T> kClass) {
        ...
        while (true) {
            ...
            t = it.next();
            if (((ConstructorDescriptor) ((KFunctionImpl) ((KFunction) t)).getDescriptor()).isPrimary()) {
                break;
            }
        }
        return (KFunction) t;
    ...
    public static final boolean isSubclassOf(KClass<?> kClass, final KClass<?> base) {
        ...
        if (!Intrinsics.areEqual(kClass, base)) {
            ...
            Boolean ifAny = DFS.ifAny(CollectionsKt.listOf(kClass), new DFS.Neighbors() { // from class: kotlin.reflect.full.KClasses$sam$org_jetbrains_kotlin_utils_DFS_Neighbors$0
                @Override // kotlin.reflect.jvm.internal.impl.utils.DFS.Neighbors
