        ...
        if (j5 > 0) {
            if (((-j5) & j5) == j5) {
                ...
                if (i != 0) {
                    ...
                    j4 = (nextBits(RandomKt.fastLog2(i2)) << 32) + (nextInt() & ArrayUnsignedIntList.MAX_VALUE);
                }
                j4 = nextInt & ArrayUnsignedIntList.MAX_VALUE;
            } else {
                do {
                    nextLong = nextLong() >>> 1;
                    j3 = nextLong % j5;
