...
public class NumbersKt__FloorDivModKt extends NumbersKt__BigIntegersKt {
    ...
    private static final int floorDiv(byte b2, short s) {
        int i = b2 / s;
        return ((b2 ^ s) >= 0 || s * i == b2) ? i : i - 1;
    }

    private static final short mod(byte b2, short s) {
        int i = b2 % s;
        return (short) (i + (s & (((i ^ s) & ((-i) | i)) >> 31)));
    }

    private static final int floorDiv(byte b2, int i) {
        int i2 = b2 / i;
        return ((b2 ^ i) >= 0 || i * i2 == b2) ? i2 : i2 - 1;
    }

    private static final int mod(byte b2, int i) {
        int i2 = b2 % i;
    ...
    private static final int floorDiv(short s, byte b2) {
        int i = s / b2;
        return ((s ^ b2) >= 0 || b2 * i == s) ? i : i - 1;
    }

    private static final byte mod(short s, byte b2) {
        int i = s % b2;
    ...
    private static final int floorDiv(int i, byte b2) {
        int i2 = i / b2;
        return ((i ^ b2) >= 0 || b2 * i2 == i) ? i2 : i2 - 1;
    }

    private static final byte mod(int i, byte b2) {
        int i2 = i % b2;
