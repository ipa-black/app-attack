...
public class StringsKt__StringsKt extends StringsKt__StringsJVMKt {
    ...
    public static final String padStart(String str, int i, char c2) {
        Intrinsics.checkNotNullParameter(str, "<this>");
        return StringsKt.padStart((CharSequence) str, i, c2).toString();
    }
    ...
    public static final String padEnd(String str, int i, char c2) {
        Intrinsics.checkNotNullParameter(str, "<this>");
        return StringsKt.padEnd((CharSequence) str, i, c2).toString();
    }
    ...
    public static final String replaceBefore(String str, char c2, String replacement, String missingDelimiterValue) {
        ...
        Intrinsics.checkNotNullParameter(missingDelimiterValue, "missingDelimiterValue");
        String str2 = str;
        int indexOf$default = StringsKt.indexOf$default((CharSequence) str2, c2, 0, false, 6, (Object) null);
    ...
    public static final String replaceAfterLast(String str, char c2, String replacement, String missingDelimiterValue) {
        ...
        Intrinsics.checkNotNullParameter(missingDelimiterValue, "missingDelimiterValue");
        String str2 = str;
        int lastIndexOf$default = StringsKt.lastIndexOf$default((CharSequence) str2, c2, 0, false, 6, (Object) null);
    ...
    public static final boolean regionMatchesImpl(CharSequence charSequence, int i, CharSequence other, int i2, int i3, boolean z) {
        ...
        while (i4 < i3) {
            int i5 = i4 + 1;
            if (!CharsKt.equals(charSequence.charAt(i + i4), other.charAt(i4 + i2), z)) {
                return false;
            }
            i4 = i5;
        }
    ...
    public static final boolean startsWith(CharSequence charSequence, char c2, boolean z) {
        Intrinsics.checkNotNullParameter(charSequence, "<this>");
        return charSequence.length() > 0 && CharsKt.equals(charSequence.charAt(0), c2, z);
    }
    ...
    public static final boolean endsWith(CharSequence charSequence, char c2, boolean z) {
        Intrinsics.checkNotNullParameter(charSequence, "<this>");
        return charSequence.length() > 0 && CharsKt.equals(charSequence.charAt(StringsKt.getLastIndex(charSequence)), c2, z);
    }
    ...
    private static final int indexOf$StringsKt__StringsKt(CharSequence charSequence, CharSequence charSequence2, int i, int i2, boolean z, boolean z2) {
        ...
        if ((charSequence instanceof String) && (charSequence2 instanceof String)) {
            ...
            while (true) {
                int i3 = first + step;
                if (StringsKt.regionMatches((String) charSequence2, 0, (String) charSequence, first, charSequence2.length(), z)) {
                    return first;
                }
                if (first == last) {
                    return -1;
            ...
            while (true) {
                int i4 = first2 + step2;
                if (StringsKt.regionMatchesImpl(charSequence2, 0, charSequence, first2, charSequence2.length(), z)) {
                    return first2;
                }
                if (first2 == last2) {
                    return -1;
    ...
    public static final int indexOf(CharSequence charSequence, char c2, int i, boolean z) {
        Intrinsics.checkNotNullParameter(charSequence, "<this>");
        return (z || !(charSequence instanceof String)) ? StringsKt.indexOfAny(charSequence, new char[]{c2}, i, z) : ((String) charSequence).indexOf(c2, i);
    }
    ...
    public static final int lastIndexOf(CharSequence charSequence, char c2, int i, boolean z) {
        Intrinsics.checkNotNullParameter(charSequence, "<this>");
        return (z || !(charSequence instanceof String)) ? StringsKt.lastIndexOfAny(charSequence, new char[]{c2}, i, z) : ((String) charSequence).lastIndexOf(c2, i);
    }
    ...
    public static final boolean contains(CharSequence charSequence, char c2, boolean z) {
        Intrinsics.checkNotNullParameter(charSequence, "<this>");
        return StringsKt.indexOf$default(charSequence, c2, 0, z, 2, (Object) null) >= 0;
    }
