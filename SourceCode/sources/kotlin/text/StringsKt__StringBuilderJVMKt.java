...
class StringsKt__StringBuilderJVMKt extends StringsKt__RegexExtensionsKt {
    ...
    private static final StringBuilder appendLine(StringBuilder sb, byte b2) {
        Intrinsics.checkNotNullParameter(sb, "<this>");
        StringBuilder append = sb.append((int) b2);
        Intrinsics.checkNotNullExpressionValue(append, "append(value.toInt())");
        StringBuilder append2 = append.append('\n');
        Intrinsics.checkNotNullExpressionValue(append2, "append('\\n')");
        return append2;
    ...
    private static final StringBuilder appendLine(StringBuilder sb, double d2) {
        Intrinsics.checkNotNullParameter(sb, "<this>");
        StringBuilder append = sb.append(d2);
        Intrinsics.checkNotNullExpressionValue(append, "append(value)");
        StringBuilder append2 = append.append('\n');
        Intrinsics.checkNotNullExpressionValue(append2, "append('\\n')");
        return append2;
    ...
    private static final StringBuilder appendln(StringBuilder sb, char c2) {
        Intrinsics.checkNotNullParameter(sb, "<this>");
        StringBuilder append = sb.append(c2);
        Intrinsics.checkNotNullExpressionValue(append, "append(value)");
        return StringsKt.appendln(append);
    }
