...
public class NestableDelegate implements Serializable {
    ...
    static /* synthetic */ Class class$org$apache$ldap$common$util$Nestable = null;
    ...
    public String getMessage(int i) {
        ...
        Class cls = class$org$apache$ldap$common$util$Nestable;
        if (cls == null) {
            cls = class$("org.apache.ldap.common.util.Nestable");
            class$org$apache$ldap$common$util$Nestable = cls;
        }
