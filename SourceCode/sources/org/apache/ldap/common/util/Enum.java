...
public abstract class Enum implements Comparable, Serializable {
    ...
    static /* synthetic */ Class class$org$apache$ldap$common$util$Enum = null;
    static /* synthetic */ Class class$org$apache$ldap$common$util$ValuedEnum = null;
    ...
    private void init(String str) {
        ...
        for (Class<?> cls = getClass(); cls != null; cls = cls.getSuperclass()) {
            Class<?> cls2 = class$org$apache$ldap$common$util$Enum;
            if (cls2 == null) {
                cls2 = class$("org.apache.ldap.common.util.Enum");
                class$org$apache$ldap$common$util$Enum = cls2;
            }
            if (cls == cls2) {
                break;
            }
            Class<?> cls3 = class$org$apache$ldap$common$util$ValuedEnum;
            if (cls3 == null) {
                cls3 = class$("org.apache.ldap.common.util.ValuedEnum");
                class$org$apache$ldap$common$util$ValuedEnum = cls3;
            }
            if (cls == cls3) {
                break;
