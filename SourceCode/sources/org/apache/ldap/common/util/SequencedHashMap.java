...
public class SequencedHashMap implements Map, Cloneable, Externalizable {
    ...
    public static class Entry implements Map.Entry, KeyValue {
        ...
        @Override // java.util.Map.Entry, org.apache.ldap.common.util.KeyValue
    ...
    @Override // java.util.Map
    public Set keySet() {
        return new AbstractSet() { // from class: org.apache.ldap.common.util.SequencedHashMap.1
    ...
    public Collection values() {
        return new AbstractCollection() { // from class: org.apache.ldap.common.util.SequencedHashMap.2
    ...
    @Override // java.util.Map
    public Set entrySet() {
        return new AbstractSet() { // from class: org.apache.ldap.common.util.SequencedHashMap.3
            ...
            if (SequencedHashMap.this.modCount == this.expectedModCount) {
                ...
                if (i != 0) {
                    if (i != 1) {
                        ...
                        throw new Error(new StringBuffer("bad iterator type: ").append(this.returnType).toString());
                    }
                    return entry.getValue();
                }
                return entry.getKey();
