...
public class AddResponseEncoder {
    public static final AddResponseEncoder INSTANCE = new AddResponseEncoder();

    public TupleNode encode(AddResponse addResponse) {
        ...
        DefaultMutableTupleNode defaultMutableTupleNode2 = (DefaultMutableTupleNode) EncoderUtils.encode(addResponse.getMessageId());
        ...
        defaultMutableTupleNode3.getTuple().setTag(LdapTag.ADD_RESPONSE, false);
        defaultMutableTupleNode3.getTuple().setLength(-2);
        LdapResultEncoder.INSTANCE.encode(defaultMutableTupleNode3, addResponse.getLdapResult());
