...
public class UnbindRequestEncoder {
    ...
    public TupleNode encode(UnbindRequest unbindRequest) {
        ...
        DefaultMutableTupleNode defaultMutableTupleNode2 = (DefaultMutableTupleNode) EncoderUtils.encode(unbindRequest.getMessageId());
        ...
        defaultMutableTupleNode3.getTuple().setTag(LdapTag.UNBIND_REQUEST, true);
        defaultMutableTupleNode3.getTuple().setLength(0);
