...
public class ExtendedRequestEncoder {
    ...
    public TupleNode encode(ExtendedRequest extendedRequest) {
        ...
        DefaultMutableTupleNode defaultMutableTupleNode2 = (DefaultMutableTupleNode) EncoderUtils.encode(extendedRequest.getMessageId());
        ...
        defaultMutableTupleNode3.getTuple().setTag(LdapTag.EXTENDED_REQUEST, false);
        defaultMutableTupleNode3.getTuple().setLength(-2);
        DefaultMutableTupleNode defaultMutableTupleNode4 = (DefaultMutableTupleNode) EncoderUtils.encode(LdapTag.CONTEXT_SPECIFIC_TAG_0, extendedRequest.getOid());
        defaultMutableTupleNode3.addLast(defaultMutableTupleNode4);
        defaultMutableTupleNode4.setParent(defaultMutableTupleNode3);
        if (extendedRequest.getPayload() != null) {
            DefaultMutableTupleNode defaultMutableTupleNode5 = (DefaultMutableTupleNode) EncoderUtils.encode(LdapTag.CONTEXT_SPECIFIC_TAG_1, extendedRequest.getPayload());
