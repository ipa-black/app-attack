...
public class AddRequestEncoder {
    ...
    public TupleNode encode(AddRequest addRequest) {
        ...
        DefaultMutableTupleNode defaultMutableTupleNode2 = (DefaultMutableTupleNode) EncoderUtils.encode(addRequest.getMessageId());
        ...
        defaultMutableTupleNode3.getTuple().setTag(LdapTag.ADD_REQUEST, false);
        defaultMutableTupleNode3.getTuple().setLength(-2);
        DefaultMutableTupleNode defaultMutableTupleNode4 = (DefaultMutableTupleNode) EncoderUtils.encode(addRequest.getName());
        defaultMutableTupleNode3.addLast(defaultMutableTupleNode4);
        defaultMutableTupleNode4.setParent(defaultMutableTupleNode3);
        DefaultMutableTupleNode defaultMutableTupleNode5 = (DefaultMutableTupleNode) AttributesEncoder.INSTANCE.encode(addRequest.getEntry());
