...
public class DeleteResponseEncoder {
    public static final DeleteResponseEncoder INSTANCE = new DeleteResponseEncoder();

    public TupleNode encode(DeleteResponse deleteResponse) {
        ...
        DefaultMutableTupleNode defaultMutableTupleNode2 = (DefaultMutableTupleNode) EncoderUtils.encode(deleteResponse.getMessageId());
        ...
        defaultMutableTupleNode3.getTuple().setTag(LdapTag.DEL_RESPONSE, false);
        defaultMutableTupleNode3.getTuple().setLength(-2);
        LdapResultEncoder.INSTANCE.encode(defaultMutableTupleNode3, deleteResponse.getLdapResult());
