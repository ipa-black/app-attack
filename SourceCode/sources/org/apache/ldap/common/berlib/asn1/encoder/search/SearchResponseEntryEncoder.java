...
public class SearchResponseEntryEncoder {
    public static final SearchResponseEntryEncoder INSTANCE = new SearchResponseEntryEncoder();

    public TupleNode encode(SearchResponseEntry searchResponseEntry) {
        ...
        DefaultMutableTupleNode defaultMutableTupleNode2 = (DefaultMutableTupleNode) EncoderUtils.encode(searchResponseEntry.getMessageId());
        ...
        defaultMutableTupleNode3.getTuple().setTag(LdapTag.SEARCH_RESULT_ENTRY, false);
        defaultMutableTupleNode3.getTuple().setLength(-2);
        DefaultMutableTupleNode defaultMutableTupleNode4 = (DefaultMutableTupleNode) EncoderUtils.encode(searchResponseEntry.getObjectName());
        defaultMutableTupleNode3.addLast(defaultMutableTupleNode4);
        defaultMutableTupleNode4.setParent(defaultMutableTupleNode3);
        DefaultMutableTupleNode defaultMutableTupleNode5 = (DefaultMutableTupleNode) AttributesEncoder.INSTANCE.encode(searchResponseEntry.getAttributes());
