...
public final class DoubleOrderedMap extends AbstractMap {
    ...
    class AnonymousClass5 extends AbstractCollection {
        ...
        public boolean removeAll(Collection collection) {
            ...
            for (Object obj : collection) {
                if (DoubleOrderedMap.this.removeValue(obj) != null) {
                    z = true;
                }
            }
            return z;
    ...
    private void insertValue(Node node) throws IllegalArgumentException {
        ...
        while (true) {
            ...
            if (compare == 0) {
                throw new IllegalArgumentException(new StringBuffer("Cannot store a duplicate value (\"").append(node.getData(1)).append("\") in this Map").toString());
            }
            if (compare < 0) {
