...
public class ReferenceMap extends AbstractMap {
    ...
    public ReferenceMap(int i, int i2, int i3, float f2, boolean z) {
        this(i, i2, i3, f2);
        this.purgeValues = z;
    }

    public ReferenceMap(int i, int i2, int i3, float f2) {
    ...
    private void readObject(ObjectInputStream objectInputStream) throws IOException, ClassNotFoundException {
        ...
        this.table = entryArr;
        this.threshold = (int) (entryArr.length * this.loadFactor);
        this.queue = new ReferenceQueue();
    ...
    public Set entrySet() {
        ...
        AbstractSet abstractSet = new AbstractSet() { // from class: org.apache.commons.collections.map.ReferenceMap.1
    ...
    public Set keySet() {
        ...
        AbstractSet abstractSet = new AbstractSet() { // from class: org.apache.commons.collections.map.ReferenceMap.2
            @Override // java.util.AbstractCollection, java.util.Collection, java.util.Set
            public int size() {
                return ReferenceMap.this.size();
            }
    ...
    public Collection values() {
        ...
        AbstractCollection abstractCollection = new AbstractCollection() { // from class: org.apache.commons.collections.map.ReferenceMap.3
    ...
    public class Entry implements Map.Entry, KeyValue {
        ...
        boolean purge(Reference reference) {
            boolean z = (ReferenceMap.this.keyType > 0 && this.key == reference) || (ReferenceMap.this.valueType > 0 && this.value == reference);
            if (z) {
    ...
    public class ValueIterator extends EntryIterator {
        ...
        @Override // org.apache.commons.collections.map.ReferenceMap.EntryIterator, java.util.Iterator
        public Object next() {
