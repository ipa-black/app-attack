...
public class AbstractLinkedMap extends AbstractHashedMap implements OrderedMap {
    ...
    public LinkEntry getEntry(int i) {
        LinkEntry linkEntry;
        if (i < 0) {
            throw new IndexOutOfBoundsException(new StringBuffer("Index ").append(i).append(" is less than zero").toString());
        }
        if (i >= this.size) {
            throw new IndexOutOfBoundsException(new StringBuffer("Index ").append(i).append(" is invalid for size ").append(this.size).toString());
        }
        if (i < this.size / 2) {
    ...
    protected static class LinkMapIterator extends LinkIterator implements OrderedMapIterator {
        ...
        @Override // org.apache.commons.collections.map.AbstractLinkedMap.LinkIterator, org.apache.commons.collections.OrderedIterator
    ...
    protected static class KeySetIterator extends EntrySetIterator {
        ...
        @Override // org.apache.commons.collections.map.AbstractLinkedMap.EntrySetIterator, org.apache.commons.collections.map.AbstractLinkedMap.LinkIterator, java.util.Iterator
        public Object next() {
            return super.nextEntry().getKey();
        }

        @Override // org.apache.commons.collections.map.AbstractLinkedMap.EntrySetIterator, org.apache.commons.collections.map.AbstractLinkedMap.LinkIterator, org.apache.commons.collections.OrderedIterator
        public Object previous() {
            return super.previousEntry().getKey();
        }
    }
