    ...
    public int compare(Object obj, Object obj2) {
        ...
        if (num == null || num2 == null) {
            ...
            if (i == 0) {
                ...
                throw new IllegalArgumentException(new StringBuffer("Attempting to compare unknown object ").append(obj).toString());
            } else {
                throw new UnsupportedOperationException(new StringBuffer("Unknown unknownObjectBehavior: ").append(this.unknownObjectBehavior).toString());
            }
        }
