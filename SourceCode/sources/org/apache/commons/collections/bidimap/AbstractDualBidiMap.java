...
public abstract class AbstractDualBidiMap implements BidiMap {
        ...
        public boolean remove(Object obj) {
            if (obj instanceof Map.Entry) {
                ...
                if (this.parent.containsKey(entry.getKey())) {
                    this.parent.maps[1].remove(this.parent.maps[0].remove(entry.getKey()));
                    return true;
                }
                return false;
            }
    ...
    protected static class BidiMapIterator implements MapIterator, ResettableIterator {
        ...
        public String toString() {
            if (this.last != null) {
                return new StringBuffer("MapIterator[").append(getKey()).append("=").append(getValue()).append("]").toString();
            }
            return "MapIterator[]";
        }
    }
