...
public class InvokerTransformer implements Transformer, Serializable {
    ...
    public Object transform(Object obj) {
        ...
        try {
            ...
            throw new FunctorException(new StringBuffer("InvokerTransformer: The method '").append(this.iMethodName).append("' on '").append(obj.getClass()).append("' threw an exception").toString(), e2);
        }
    }
}
