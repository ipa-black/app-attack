...
public final class TransformerPredicate implements Predicate, Serializable {
    ...
    public boolean evaluate(Object obj) {
        ...
        if (!(transform instanceof Boolean)) {
            throw new FunctorException(new StringBuffer("Transformer must return an instanceof Boolean, it was a ").append(transform == null ? "null object" : transform.getClass().getName()).toString());
        }
