    ...
    public Iterator iterator() {
        return new Iterator() { // from class: org.apache.commons.collections.UnboundedFifoBuffer.1
            ...
            public void remove() {
                ...
                while (true) {
                    i2++;
                    while (i2 != UnboundedFifoBuffer.this.m_tail) {
                        if (i2 >= UnboundedFifoBuffer.this.m_buffer.length) {
                            UnboundedFifoBuffer.this.m_buffer[i2 - 1] = UnboundedFifoBuffer.this.m_buffer[0];
                            i2 = 0;
                        }
                    }
                    this.lastReturnedIndex = -1;
                    ...
                    return;
                    UnboundedFifoBuffer.this.m_buffer[i2 - 1] = UnboundedFifoBuffer.this.m_buffer[i2];
                }
            }
        };
    }
