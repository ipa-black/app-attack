...
public class BeanMap extends AbstractMap implements Cloneable {
    ...
    public String toString() {
        return new StringBuffer("BeanMap<").append(String.valueOf(this.bean)).append(">").toString();
    }
        ...
        try {
            try {
                ...
                try {
                    ...
                    throw new CloneNotSupportedException(new StringBuffer("Unable to copy bean values to cloned bean map: ").append(e3).toString());
                }
            } catch (Exception e4) {
                throw new CloneNotSupportedException(new StringBuffer("Unable to set bean in the cloned bean map: ").append(e4).toString());
            }
        } catch (Exception e5) {
            e = e5;
            throw new CloneNotSupportedException(new StringBuffer("Unable to instantiate the underlying bean \"").append(cls.getName()).append("\": ").append(e).toString());
        }
    }
    ...
    public void clear() {
        ...
        try {
            ...
            throw new UnsupportedOperationException(new StringBuffer("Could not create new instance of class: ").append(cls).toString());
        }
    }
    ...
    public Object put(Object obj, Object obj2) throws IllegalArgumentException, ClassCastException {
        if (this.bean != null) {
            ...
            if (writeMethod == null) {
                throw new IllegalArgumentException(new StringBuffer("The bean of type: ").append(this.bean.getClass().getName()).append(" has no property called: ").append(obj).toString());
            }
            try {
    ...
    private void initialise() {
        ...
        try {
            FeatureDescriptor[] propertyDescriptors = Introspector.getBeanInfo(getBean().getClass()).getPropertyDescriptors();
            if (propertyDescriptors != null) {
                for (FeatureDescriptor featureDescriptor : propertyDescriptors) {
                    if (featureDescriptor != null) {
                        ...
                        HashMap hashMap = this.writeMethods;
                        if (hashMap != null) {
    ...
    protected void logWarn(Exception exc) {
        System.out.println(new StringBuffer("WARN: Exception: ").append(exc).toString());
        exc.printStackTrace();
    }
}
