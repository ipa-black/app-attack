...
public class Validate {
    ...
    public static void isTrue(boolean z, String str, double d2) {
        if (!z) {
            throw new IllegalArgumentException(new StringBuffer().append(str).append(d2).toString());
        }
    }
    ...
    public static void noNullElements(Object[] objArr) {
        ...
        for (int i = 0; i < objArr.length; i++) {
            if (objArr[i] == null) {
                throw new IllegalArgumentException(new StringBuffer("The validated array contains null element at index: ").append(i).toString());
            }
        }
    }
    ...
    public static void noNullElements(Collection collection) {
        ...
        for (Object obj : collection) {
            if (obj == null) {
                throw new IllegalArgumentException(new StringBuffer("The validated collection contains null element at index: ").append(i).toString());
            }
            i++;
        }
    }
