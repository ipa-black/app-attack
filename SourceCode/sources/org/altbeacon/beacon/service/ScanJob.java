...
public class ScanJob extends JobService {
    ...
    public boolean onStartJob(final JobParameters jobParameters) {
        ...
        if (jobParameters.getJobId() == getImmediateScanJobId(this)) {
            LogManager.i(TAG, "Running immediate scan job: instance is " + this, new Object[0]);
        } else {
        ...
        if (startScanning) {
            LogManager.i(str, "Scan job running for " + this.mScanState.getScanJobRuntimeMillis() + " millis", new Object[0]);
            this.mStopHandler.postDelayed(new Runnable() { // from class: org.altbeacon.beacon.service.ScanJob.1
                ...
                public void run() {
                    ...
                    ScanJob.this.mStopHandler.post(new Runnable() { // from class: org.altbeacon.beacon.service.ScanJob.1.1
                        @Override // java.lang.Runnable
                        public void run() {
    ...
    public boolean onStopJob(JobParameters jobParameters) {
        if (jobParameters.getJobId() == getPeriodicScanJobId(this)) {
            LogManager.i(TAG, "onStopJob called for periodic scan " + this, new Object[0]);
        } else {
            LogManager.i(TAG, "onStopJob called for immediate scan " + this, new Object[0]);
        }
        this.mStopHandler.removeCallbacksAndMessages(null);
        stopScanning();
        startPassiveScanIfNeeded();
