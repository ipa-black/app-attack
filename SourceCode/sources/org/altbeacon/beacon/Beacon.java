...
public class Beacon implements Parcelable, Serializable {
    ...
    public double getDistance() {
        if (this.mDistance == null) {
            ...
            this.mDistance = calculateDistance(this.mTxPower, d2);
        }
    ...
    public void writeToParcel(Parcel parcel, int i) {
        ...
        for (Long l : this.mDataFields) {
            parcel.writeLong(l.longValue());
        }
        parcel.writeInt(this.mExtraDataFields.size());
        for (Long l2 : this.mExtraDataFields) {
    ...
    protected static Double calculateDistance(int i, double d2) {
        if (getDistanceCalculator() != null) {
            return Double.valueOf(getDistanceCalculator().calculateDistance(i, d2));
        }
    ...
    public static class Builder {
        ...
        public Builder setRunningAverageRssi(double d2) {
            this.mBeacon.mRunningAverageRssi = Double.valueOf(d2);
            return this;
        }
