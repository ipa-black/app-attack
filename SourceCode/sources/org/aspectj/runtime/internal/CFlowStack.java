...
public class CFlowStack {
    ...
    private static void selectFactoryForVMVersion() {
        String property = System.getProperty("aspectj.runtime.cflowstack.usethreadlocal", "unspecified");
        if (!property.equals("unspecified") ? property.equals("yes") || property.equals("true") : System.getProperty("java.class.version", "0.0").compareTo("46.0") >= 0) {
